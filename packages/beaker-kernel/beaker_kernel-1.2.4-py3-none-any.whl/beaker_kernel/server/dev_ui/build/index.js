...
import { SplitPanel, Widget, Panel } from '@lumino/widgets';
...
async function createApp(manager) {
    ...
    const editor = notebook.activeCell && notebook.activeCell.editor;
    ...
    const handleMessage = (_context, msg) => {
        ...
        if (msg.msg_type === "stream" && ((_a = msg.parent_header) === null || _a === void 0 ? void 0 : _a.msg_type) == "llm_request") {
