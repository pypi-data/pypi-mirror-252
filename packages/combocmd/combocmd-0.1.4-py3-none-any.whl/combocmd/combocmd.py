...
def main():
	...
	parser.add_argument("--AsepB", type=str, default=',', help="If not passing in a command, how to separate A and B within (A, B) in stdout")
	...
	if args.cmd is None and args.cmdAB is None and args.cmdBA is None:
		fmt_pairs = [args.AsepB.join(pair) for pair in pairs]
