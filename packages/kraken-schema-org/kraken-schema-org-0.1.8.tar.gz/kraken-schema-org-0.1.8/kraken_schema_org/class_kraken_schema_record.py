...
class Schema_record:
    ...
    def record_type(self):
        return k.get_record_type(self._record)

    @property
    def record_id(self):
        return k.get_record_id(self._record)

    @property
    def name(self):
        return k.get_record_name(self._record)

    @property
    def summary_record(self):
        return k.get_summary_record(self._record)


    def get_properties(self):
        """Returns Schema_property objects 
        """
