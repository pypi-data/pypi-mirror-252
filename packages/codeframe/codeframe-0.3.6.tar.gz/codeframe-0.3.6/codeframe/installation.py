...
def main( name ):
    """
    1. stage - test local existence
    """
    # f'bin/{name}',
    # f'bin_{name}',
    # f'{name}/__init__.py'
    modules = ['version','key_enter','topbar','config','README.org','distcheck.sh','requirements.txt','.bumpversion.cfg','setup','.gitignore',
               'bin/codeframe','bin_codeframe','codeframe/__init__.py']


    lnmod = ['version','key_enter','topbar','config']
    ...
    #
    prep = [f'mkdir {name}',f'mkdir {name}/bin',f'mkdir {name}/data',f'mkdir {name}/{name}']
