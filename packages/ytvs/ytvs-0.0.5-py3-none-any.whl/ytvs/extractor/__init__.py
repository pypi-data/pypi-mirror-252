...
class YoutubeBasicInfoExtractor:
    ...
    def extract_video_renderer(renderer):
        ...
        length_text = try_get(renderer, lambda x: x['lengthText'])
    ...
    def extract_video(renderer):
        ...
        view_count_text = try_get(
            renderer, lambda x: x['viewCount']['videoViewCountRenderer']['viewCount']['simpleText'], str
        )
        # 해시태그 목록 획득
