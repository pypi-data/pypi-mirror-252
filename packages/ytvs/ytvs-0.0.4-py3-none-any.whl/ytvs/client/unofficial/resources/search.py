...
class SearchResource(Resource):
    ...
    def _request_next_page(self,
        ...
        """
        url = self.build_search_v1_resource_url(continuation_token)
    ...
    def _parse_data(self, raw_data):
        ...
        if item_section_renderer is not None:
            video_renderers = _search_attributes(item_section_renderer, "videoRenderer")
            playlist_renderer = _search_attributes(item_section_renderer, "playlistRenderer")
        ...
        return {
            ...
            'items': items,
            'nextPageToken': continuation_command_renderer['token'],
            'prevPageToken': None,
            'pageInfo': {
