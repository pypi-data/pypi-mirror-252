...
import pyformatters_textranksummarizer


# -- Project information -----------------------------------------------------

project = "pyformatters_textranksummarizer"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyformatters_textranksummarizer.__version__
release = pyformatters_textranksummarizer.__version__
...
apidoc_module_dir = os.path.dirname(pyformatters_textranksummarizer.__file__)
