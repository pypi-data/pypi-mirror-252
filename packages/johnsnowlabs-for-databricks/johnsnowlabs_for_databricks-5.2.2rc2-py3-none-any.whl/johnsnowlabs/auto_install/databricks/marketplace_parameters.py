from johnsnowlabs.auto_install.databricks.endpoints import create_secret_in_scope
...
def deploy(deployed_endpoint_name=None, models_df=models_df):
    ...
    # REMOVE THIS!!
    # model_path = 'john_snow_labs_clinical_de_identification_for_romanian_mask.johnsnowlabs_folder.ro_deid_clinical_cpu'
    endpoint_name = (
