...
mimetypes: List = sorted(
    set([mt for _, _, _, _, mimetypes in LEXERS.values() for mt in mimetypes])
)
...
transform_classes = (
    ...
    PygmentsLatexTransform,
    PygmentsRTFTransform,
    PygmentsSVGTransform,
)
