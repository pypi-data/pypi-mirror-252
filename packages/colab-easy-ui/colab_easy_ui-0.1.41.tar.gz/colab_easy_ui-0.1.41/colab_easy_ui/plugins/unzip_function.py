...
from colab_easy_ui.Functions import ProgressTaskStatus, FunctionCallResponse, JsonApiTaskStatus, ProgressTaskProcessStatus
...
def exec_unzip(_callback: Callable[[JsonApiTaskStatus, ProgressTaskStatus], None], zip_path: str, extract_to: str):
    ...
    open("unzip_log1.txt", "w").write("unzip_log1")
    ...
    open("unzip_log2.txt", "w").write("unzip_log1")
    ...
    open("unzip_log3.txt", "w").write("unzip_log1")
