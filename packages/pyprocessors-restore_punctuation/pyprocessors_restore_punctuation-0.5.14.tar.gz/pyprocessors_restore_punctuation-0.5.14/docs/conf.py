...
import pyprocessors_restore_punctuation


# -- Project information -----------------------------------------------------

project = "pyprocessors_restore_punctuation"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyprocessors_restore_punctuation.__version__
release = pyprocessors_restore_punctuation.__version__
...
apidoc_module_dir = os.path.dirname(pyprocessors_restore_punctuation.__file__)
