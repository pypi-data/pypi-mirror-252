...
class utils(object):
    ...
    def initialize(self, *args, **kwargs):
        r"""
        initialize(self, _python_path=string(""), _distro_data_path=string(""), _default_path=std::vector< std::string >({}), _nogui=bool(false), _agg=bool(false), _pipeline=bool(false)) -> bool
