...
from jsonrpcobjects import errors
    ...
    def _get_result_from_response(self, data: Union[bytes, str, dict[str, Any]]) -> Any:
        try:
            ...
            if json_data.get("error"):
                ...
                error = get_exception_by_code(resp.error.code) or errors.ServerError
                raise error(**resp.error.model_dump())
...
def get_exception_by_code(code: int) -> Optional[Type[errors.JSONRPCError]]:
