...
def compute_digbala():
    ...
    planet_zeroDigbalaPoints = {    "Sun": [data.charts["D1"]["houses"][4-1]["sign-num"], 0,0,0],
                                    "Moon": [data.charts["D1"]["houses"][10-1]["sign-num"], 0,0,0],
                                    "Mars": [data.charts["D1"]["houses"][4-1]["sign-num"], 0,0,0],
                                    "Mercury": [data.charts["D1"]["houses"][7-1]["sign-num"], 0,0,0],
                                    "Jupiter": [data.charts["D1"]["houses"][7-1]["sign-num"], 0,0,0],
                                    "Venus": [data.charts["D1"]["houses"][10-1]["sign-num"], 0,0,0],
                                    "Saturn": [data.charts["D1"]["houses"][1-1]["sign-num"], 0,0,0],
                                }
    for planet in ["Sun", "Moon", "Mars", "Mercury", "Jupiter", "Venus", "Saturn"]:
...
def compute_bhavadrishtibala():
    ...
    for hno in range(12):
        ...
        for aspectingplanet in naturalbenefics:
            ...
            dist_bhavamadhya2aspecting = gen.get_point2planetdistance(data.charts["D1"], [sign_num,15,0,0], aspectingplanet, False)/3600
