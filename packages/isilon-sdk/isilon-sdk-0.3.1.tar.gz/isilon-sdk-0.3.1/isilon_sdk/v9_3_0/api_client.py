...
from isilon_sdk.v9_3_0.configuration import Configuration
import isilon_sdk.v9_3_0.models
from isilon_sdk.v9_3_0 import rest
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'Swagger-Codegen/v0.3.1/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(isilon_sdk.v9_3_0.models, klass)
    ...
    def logout(self):
        """Calls the /session/1/session with a DELETE request. This API deletes the token present on the cluster.
        sets the expiry time of the session to the time at which the logout method has been called. resets the values of the 2 cookies.
        Hence, when a new function is called, new session will be created.
        """
        try:
            if self.call_api('/session/1/session/','DELETE')[1]==204:
