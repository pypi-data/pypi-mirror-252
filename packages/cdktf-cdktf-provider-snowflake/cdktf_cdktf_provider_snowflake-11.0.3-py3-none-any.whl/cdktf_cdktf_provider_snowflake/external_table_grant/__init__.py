...
Refer to the Terraform Registry for docs: [`snowflake_external_table_grant`](https://registry.terraform.io/providers/snowflake-labs/snowflake/0.84.1/docs/resources/external_table_grant).
'''
import abc
import builtins
import datetime
...
class ExternalTableGrant(
    ...
    def __init__(
        ...
        *,
        ...
        :param schema_name: The name of the schema containing the current or future external tables on which to grant privileges. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.84.1/docs/resources/external_table_grant#schema_name ExternalTableGrant#schema_name}
        :param shares: Grants privilege to these shares (only valid if on_future is false). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.84.1/docs/resources/external_table_grant#shares ExternalTableGrant#shares}
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing ExternalTableGrant that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.84.1/docs/resources/external_table_grant#import import section} in the documentation of this resource for the id to use
