...
class BrightpearlApi(BaseAPIWrapper):
    ...
    def _refresh_access_token(self):
        ...
        if response is None:
            ...
            if "access_token" in response:
                ...
                logging.info("Access token refreshed and base url set to api domain")
                return True
            else:
    ...
    def get_all_sales_orders_from_date(self, since_date, page_size):
        ...
        logging.info("Entering get_all_sales_orders()")
    ...
    def get_all_sales_orders_by_ids(self, sales_orders):
        # TODO: add docstring documentation
        logging.info("Entering get_all_sales_orders_by_id()")
    ...
    def _fetch_sales_orders_by_date(self, endpoint, initial_params):
        ...
        while more_pages_available:
            ...
            logging.info(f"Retrieved {data_count} results from index {first_index_returned} to index {last_index_returned}")
        ...
        logging.info(f"Exiting _fetch_sales_orders_by_date()")
    ...
    def _fetch_sales_orders_by_ids(self, endpoint, initial_params, urls):
        ...
        logging.info(f"Exiting _fetch_sales_orders_by_ids()")
