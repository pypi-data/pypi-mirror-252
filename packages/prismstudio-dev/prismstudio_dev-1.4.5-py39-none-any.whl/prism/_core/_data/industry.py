...
from ..._common.const import (
    IndustryComponentType as _IndustryComponentType,
    PeriodType,
)
from .._req_builder._list import _list_dataitem_industry
...
__all__ = [
    ...
    'airlines_dataitems',
    'bank_dataitems',
    'capital_market_dataitems',
    'financial_services_dataitems',
    'healthcare_dataitems',
    'homebuilders_dataitems',
    'hotel_dataitems',
    'insurance_dataitems',
    'internet_dataitems',
    'managed_care_dataitems',
    'mining_dataitems',
    'oil_dataitems',
    'biopharma_dataitems',
    'real_estate_dataitems',
    'restaurant_dataitems',
    'retail_dataitems',
    'semiconductors_dataitems',
    'telecom_dataitems',
    'utility_dataitems',
]
...
def airlines(
    ...
    Examples
    --------
        >>> di = prism.industry.airlines_dataitems()
...
def capital_market(
    ...
    Examples
    --------
        >>> di = prism.industry.capital_market_dataitems()
        >>> di[['dataitemid', 'dataitemname']]
               dataitemid	                           dataitemname
...
def financial_services(
    ...
    Examples
    --------
        >>> di = prism.industry.financial_services_dataitems()
        >>> di[['dataitemid', 'dataitemname']]
               dataitemid                               dataitemname
...
def healthcare(
    ...
    Examples
    --------
        >>> di = prism.industry.healthcare_dataitems()
        >>> di[['dataitemid', 'dataitemname']]
             dataitemid	                                dataitemname
...
def homebuilders(
    ...
    Examples
    --------
        >>> di = prism.industry.homebuilders_dataitems()
        >>> di[['dataitemid', 'dataitemname']]
             dataitemid	                                      dataitemname
...
def hotel(
    ...
    Examples
    --------
        >>> di = prism.industry.hotel_dataitems()
        >>> di[['dataitemid', 'dataitemname']]
             dataitemid                     dataitemname
...
def insurance(
    ...
    Examples
    --------
        >>> di = prism.industry.insurance_dataitems()
        >>> di[['dataitemid', 'dataitemname']]
             dataitemid                                       dataitemname
...
def internet(
    ...
    Examples
    --------
        >>> di = prism.industry.internet_dataitems()
        >>> di[['dataitemid', 'dataitemname']]
           dataitemid                                     dataitemname
...
def managed_care(
    ...
    Examples
    --------
        >>> di = prism.industry.managed_care_dataitems()
        >>> di[['dataitemid', 'dataitemname']]
            dataitemid                             dataitemname
...
def mining(
    ...
    Examples
    --------
        >>> di = prism.industry.mining_dataitems()
        >>> di[['dataitemid', 'dataitemname']]
             dataitemid                                       dataitemname
...
def oil(
    ...
    Examples
    --------
        >>> di = prism.industry.oil_dataitems()
        >>> di[['dataitemid', 'dataitemname']]
             dataitemid                     dataitemname
...
def biopharma(
    ...
    Examples
    --------
        >>> di = prism.industry.biopharma_dataitems()
        >>> di[['dataitemid', 'dataitemname']]
              dataitemid	                                dataitemname
...
def retail(
    ...
    Examples
    --------
        >>> di = prism.industry.retail_dataitems()
        >>> di[['dataitemid', 'dataitemname']]
            dataitemid                              dataitemname
...
def semiconductors(
    ...
    Examples
    --------
        >>> di = prism.industry.semiconductors_dataitems()
        >>> di[['dataitemid', 'dataitemname']]
            dataitemid                    dataitemname
...
def telecom(
    ...
    Examples
    --------
    >>> di = prism.industry.telecom_dataitems()
    >>> di[['dataitemid', 'dataitemname']]
         dataitemid                               dataitemname
...
def utility(
    ...
    Examples
    --------
        >>> di = prism.industry.utility_dataitems()
        >>> di[['dataitemid', 'dataitemname']]
             dataitemid                             dataitemname
...
def dataitems(search: str = None, package: str = None):
    ...
    return _list_dataitem_industry(None, search, package)


@_validate_args
def airlines_dataitems(search: str = None, package: str = None):
    """
    ...
    --------
        ...
        52      100968                             Fuel Expenses
    """
    return _list_dataitem_industry(_IndustryComponentType.AIRLINES, search, package)


@_validate_args
def bank_dataitems(search: str = None, package: str = None):
    """
    ...
    --------
        ...
        375      101344          Specific Allowance
    """
    return _list_dataitem_industry(_IndustryComponentType.BANK, search, package)


@_validate_args
def capital_market_dataitems(search: str = None, package: str = None):
    """
    ...
    --------
        ...
        229    101574                Value of Customer Assets
    """
    return _list_dataitem_industry(_IndustryComponentType.CAPITAL_MARKET, search, package)


@_validate_args
def financial_services_dataitems(search: str = None, package: str = None):
    """
    ...
    --------
        ...
        186    101761   Net Income to Common Excl. Extra Items
    """
    return _list_dataitem_industry(_IndustryComponentType.FINAICIAL_SERVICES, search, package)


@_validate_args
def healthcare_dataitems(search: str = None, package: str = None):
    """
    ...
    --------
        ...
        88     101850                           Growth in Revenues
    """
    return _list_dataitem_industry(_IndustryComponentType.HEALTHCARE, search, package)


@_validate_args
def homebuilders_dataitems(search: str = None, package: str = None):
    """
    ...
    --------
        ...
        138      101989         Warranty Reserves at the End of the Period
    """
    return _list_dataitem_industry(_IndustryComponentType.HOMBUILDERS, search, package)


@_validate_args
def hotel_dataitems(search: str = None, package: str = None):
    """
    ...
    --------
        ...
        >>> di[["dataitemid", "dataitemname"]]
    """
    return _list_dataitem_industry(_IndustryComponentType.HOTEL_AND_GAMING, search, package)


@_validate_args
def insurance_dataitems(search: str = None, package: str = None):
    """
    ...
    --------
        ...
        452    102648  Statutory Surplus (Statutory Capital and Surplus)
    """
    return _list_dataitem_industry(_IndustryComponentType.INSURANCE, search, package)


@_validate_args
def internet_dataitems(search: str = None, package: str = None):
    """
    ...
    --------
        ...
        9      102658  Traffic Acquisition Cost to Total Revenue Ratio
    """
    return _list_dataitem_industry(_IndustryComponentType.INTERNET_MEDIA, search, package)


@_validate_args
def managed_care_dataitems(search: str = None, package: str = None):
    """
    ...
    --------
        ...
        66     102725                Specialty Premiums, Total
    """
    return _list_dataitem_industry(_IndustryComponentType.MANAGED_CARE, search, package)


@_validate_args
def mining_dataitems(search: str = None, package: str = None):
    """
    ...
    --------
        ...
        752    103633                       Zinc, Resources Grade, Total
    """
    return _list_dataitem_industry(_IndustryComponentType.METALS_AND_MINING, search, package)


@_validate_args
def oil_dataitems(search: str = None, package: str = None):
    """
    ...
    --------
        ...
        215    103849             Number of Wells, New
    """
    return _list_dataitem_industry(_IndustryComponentType.OIL_AND_GAS, search, package)


@_validate_args
def biopharma_dataitems(search: str = None, package: str = None):
    """
    ...
    --------
        ...
        13     103863  Number of Products in Research and Development
    """
    return _list_dataitem_industry(_IndustryComponentType.PHARMA, search, package)


@_validate_args
def real_estate_dataitems(search: str = None, package: str = None):
    """
    ...
    --------
        ...
        441    104305                       Units, Total
    """
    return _list_dataitem_industry(_IndustryComponentType.REAL_ESTATE, search, package)


@_validate_args
def restaurant_dataitems(search: str = None, package: str = None):
    """
    ...
    Examples
    --------
        >>> di = prism.industry.restaurant_dataitems()
        >>> di[["dataitemid", "dataitemname"]]
           dataitemid                                    dataitemname
    ...
    """
    return _list_dataitem_industry(_IndustryComponentType.RESTAURANT, search, package)


@_validate_args
def retail_dataitems(search: str = None, package: str = None):
    """
    ...
    --------
        ...
        61     104404                        Wholesale Revenues
    """
    return _list_dataitem_industry(_IndustryComponentType.RETAIL, search, package)


@_validate_args
def semiconductors_dataitems(search: str = None, package: str = None):
    """
    ...
    --------
        ...
        13     104418  Warranty Reserves at Beginning
    """
    return _list_dataitem_industry(_IndustryComponentType.SEMICONDUCTORS, search, package)


@_validate_args
def telecom_dataitems(search: str = None, package: str = None):
    """
    ...
    --------
        ...
        111    104530                Wireless Subscribers, Total
    """
    return _list_dataitem_industry(_IndustryComponentType.TELECOM, search, package)


@_validate_args
def utility_dataitems(search: str = None, package: str = None):
    """
    ...
    --------
        ...
        197    104728   Net Income to Common Excl. Extra Items
    """
    return _list_dataitem_industry(_IndustryComponentType.UTILITY, search, package)
