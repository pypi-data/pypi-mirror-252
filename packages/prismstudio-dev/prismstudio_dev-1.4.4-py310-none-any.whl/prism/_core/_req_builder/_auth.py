...
def logout():
    ...
    """
    if not prismstudio.username:
        return "Error: User not found. Please log in to proceed."
    _delete_token()
...
def change_password(new_password: str):
    ...
    """
    overwrite = input(f"Warning: Are you absolutely certain you want to proceed with changing the password? This action cannot be undone.\n")
    if overwrite.lower() == "n":
        return "Abort changing password."
