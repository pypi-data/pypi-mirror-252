...
from ormspace.annotations import DateField, DateTimeField, ListOfStrings, OptionalDate, PasswordField, \
    ...
    def element_list_group_item(self) -> Element:
        return Element('li', '.list-group-item .text-white', children=[
                Element('div', '.row', children=[
                        Element('h6', '.col-10', NodeText(str(self)), htmx=dict(get=f'/api/prescription/{self.key}', target='#htmx-prescription-container', indicator='#htmx-prescription-indicator')),
