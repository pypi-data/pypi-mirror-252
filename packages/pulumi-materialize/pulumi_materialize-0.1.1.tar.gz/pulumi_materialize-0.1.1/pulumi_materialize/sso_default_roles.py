...
class SSODefaultRolesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] roles: Set of default role names for the SSO configuration.
    ...
    def roles(self) -> pulumi.Input[Sequence[pulumi.Input[str]]]:
        """
        Set of default role names for the SSO configuration.
        """
