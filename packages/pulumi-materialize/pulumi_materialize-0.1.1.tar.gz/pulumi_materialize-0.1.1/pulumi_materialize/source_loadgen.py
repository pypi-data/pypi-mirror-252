...
class SourceLoadgenArgs:
    ...
    def counter_options(self) -> Optional[pulumi.Input['SourceLoadgenCounterOptionsArgs']]:
        """
        Counter Options.
        """
    ...
    def counter_options(self, value: Optional[pulumi.Input['SourceLoadgenCounterOptionsArgs']]):
...
class SourceLoadgen(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="counterOptions")
    def counter_options(self) -> pulumi.Output[Optional['outputs.SourceLoadgenCounterOptions']]:
        """
        Counter Options.
        """
        return pulumi.get(self, "counter_options")
