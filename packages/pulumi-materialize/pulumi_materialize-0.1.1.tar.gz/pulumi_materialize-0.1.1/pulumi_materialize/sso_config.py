...
class SSOConfigArgs:
    def __init__(__self__, *,
                 ...
                 sign_request: pulumi.Input[bool],
                 sso_endpoint: pulumi.Input[str],
                 type: pulumi.Input[str],
                 oidc_client_id: Optional[pulumi.Input[str]] = None,
                 oidc_secret: Optional[pulumi.Input[str]] = None):
        """
        The set of arguments for constructing a SSOConfig resource.
        :param pulumi.Input[bool] enabled: Whether SSO is enabled or not. If enabled, users will be redirected to the SSO endpoint for authentication. The configuration needs to be valid for SSO to work.
        :param pulumi.Input[str] public_certificate: The public certificate of the SSO service. This is used to verify the SSO response. The certificate must be in PEM format. The certificate must be accessible from the browser. If the certificate is not accessible from the browser, you can use the public certificate of the Identity Provider (IdP) instead.
        :param pulumi.Input[bool] sign_request: Indicates whether the SSO request needs to be digitally signed.
        :param pulumi.Input[str] sso_endpoint: The URL endpoint for the SSO service. This is the URL that users will be redirected to for authentication. The URL must be accessible from the browser.
        :param pulumi.Input[str] type: Defines the type of SSO protocol being used (e.g., saml, oidc).
        :param pulumi.Input[str] oidc_client_id: The client ID of the OIDC application. This is used to identify the application to the OIDC service. This is required if the type is OIDC.
        :param pulumi.Input[str] oidc_secret: The client secret of the OIDC application. This is used to authenticate the application to the OIDC service. This is required if the type is OIDC.
        """
    ...
    def sign_request(self) -> pulumi.Input[bool]:
        """
    ...
    @sign_request.setter
    def sign_request(self, value: pulumi.Input[bool]):
        pulumi.set(self, "sign_request", value)

    @property
    @pulumi.getter(name="ssoEndpoint")
    def sso_endpoint(self) -> pulumi.Input[str]:
        """
    ...
    @sso_endpoint.setter
    def sso_endpoint(self, value: pulumi.Input[str]):
    ...
    def oidc_secret(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @oidc_secret.setter
    def oidc_secret(self, value: Optional[pulumi.Input[str]]):
...
class SSOConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sign_request: Optional[pulumi.Input[bool]] = None,
            sso_endpoint: Optional[pulumi.Input[str]] = None,
            type: Optional[pulumi.Input[str]] = None) -> 'SSOConfig':
        """
    ...
    @property
    @pulumi.getter(name="oidcSecret")
    def oidc_secret(self) -> pulumi.Output[Optional[str]]:
        """
        The client secret of the OIDC application. This is used to authenticate the application to the OIDC service. This is required if the type is OIDC.
        """
        return pulumi.get(self, "oidc_secret")
    ...
    @property
    @pulumi.getter(name="signRequest")
    def sign_request(self) -> pulumi.Output[bool]:
        """
        Indicates whether the SSO request needs to be digitally signed.
        """
        return pulumi.get(self, "sign_request")
    ...
    @property
    @pulumi.getter(name="ssoEndpoint")
    def sso_endpoint(self) -> pulumi.Output[str]:
        """
        The URL endpoint for the SSO service. This is the URL that users will be redirected to for authentication. The URL must be accessible from the browser.
        """
        return pulumi.get(self, "sso_endpoint")
