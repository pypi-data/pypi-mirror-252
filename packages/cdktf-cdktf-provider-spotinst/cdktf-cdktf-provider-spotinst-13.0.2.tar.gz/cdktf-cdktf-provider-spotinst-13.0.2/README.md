# CDKTF prebuilt bindings for spotinst/spotinst provider version 1.160.0

This repo builds and publishes the [Terraform spotinst provider](https://registry.terraform.io/providers/spotinst/spotinst/1.160.0/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
* [Terraform spotinst provider](https://registry.terraform.io/providers/spotinst/spotinst/1.160.0)
