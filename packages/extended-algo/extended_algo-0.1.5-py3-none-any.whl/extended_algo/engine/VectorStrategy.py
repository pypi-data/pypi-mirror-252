...
class VectorStrategy(ABC):
    ...
    def _explode_oco_entries(self):
        ...
        # assert 'orders' in df.columns, 'order column missing, please provide OCOEntries([Order(A), Order(B)])'
    ...
    def _calculate_sl_pt_bt_bsl(self, df):
        ...
        if self.breakeven_trigger:
            ...
            df['bt_offset'] = df['bt_offset'].fillna(self.breakeven_trigger)
        ...
        # print(df[['entry_time', 'pt_offset', 'sl_offset', 'bt_offset', 'bsl_offset', 'entry_price', 'pt', 'sl', 'bt', 'bsl','id']])
        return df
