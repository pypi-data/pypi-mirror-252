...
from google.cloud import securitycenter, asset_v1
...
def ensure_secrity_center_api_enabled() -> None:
    """
    Ensures that the Security Center API is enabled
    ...
    os.system(
        f"gcloud services enable securitycenter.googleapis.com --project {GcpVariables.gcpProjectId}"
    )
