...
class StagefileListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by StagefileParser#pythonFile.
    def enterPythonFile(self, ctx:StagefileParser.PythonFileContext):
        pass

    # Exit a parse tree produced by StagefileParser#pythonFile.
    def exitPythonFile(self, ctx:StagefileParser.PythonFileContext):
        pass
