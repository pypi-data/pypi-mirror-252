...
class ResourceRouter(fastapi.APIRouter, Generic[R]):
    ...
    def add_to_application(
        ...
        for verb in self.verbs:
            verb.add_to_router(self, app.register_resource, authorization=authorization)
        ...
        if self.commands_enabled:
            ...
            commands.add_to_router(self, app.register_resource, authorization=authorization)
    ...
    def add_verb(
        ...
        self.verb_factory(cls, permissions=permissions, validator=validator)
    ...
    def subresource(self, methods: list[str], path: str, verb: str, **kwargs: Any):
        assert not str.startswith(path, '/')
        path = f'/{self.resource_model.base_path}/{{name}}/{path}'
    ...
    def verb(
        ...
        **kwargs: Unpack[verbs.VerbParameters]
        ...
        def f(func: Callable[..., Any]) -> Callable[..., Any]:
            ...
            self.verb_factory(impl, **kwargs) # type: ignore
            return func
        return f
