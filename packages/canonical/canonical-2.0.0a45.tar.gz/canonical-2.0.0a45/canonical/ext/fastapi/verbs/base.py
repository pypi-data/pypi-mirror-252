...
class BaseOperation(Generic[T], metaclass=BaseMetaclass):
    ...
    async def inject_existing(
        ...
        ifmatch: str | None = fastapi.Header(
            ...
            description=(
                ...
                "the resource. If the values don't not match then a `412 Precondition "
    ...
    async def __call__(
        ...
        *args: Any, **kwargs: Any
        ...
        media_type: str = getattr(request.state, 'media_type')
    ...
    def _get_openapi_responses(self) -> dict[int, Any]:
        ...
        for status_code, response in responses.items():
            ...
            if self.is_detail() and status_code == 200:
