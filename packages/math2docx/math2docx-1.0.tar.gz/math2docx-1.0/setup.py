...
requirements = ["python-docx", "mathml2omml", "latex2mathml"]
...
setuptools.setup(
    ...
    # Его почта.
    author_email="keh9mark@yandex.ru",
    # Краткое описание, которое будет показано на странице PyPi.
    description="Open source Python library converting math formula to docx",
    # Длинное описание, которое будет отображаться на странице PyPi. Использует README.md репозитория для заполнения.
    long_description="Open source Python library converting math formula to docx",
    ...
    url="https://github.com/keh9mark/math2docx",
