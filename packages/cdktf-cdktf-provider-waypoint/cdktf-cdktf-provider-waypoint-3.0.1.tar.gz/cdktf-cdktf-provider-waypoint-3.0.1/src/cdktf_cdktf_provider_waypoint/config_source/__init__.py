...
class ConfigSource(
    ...
    def generate_config_for_import(
        ...
        '''Generates CDKTF code for importing a ConfigSource resource upon running "cdktf plan ".

        :param scope: The scope in which to define this construct.
        :param import_to_id: The construct id used in the generated config for the ConfigSource to import.
        :param import_from_id: The id of the existing ConfigSource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/waypoint/0.1.0/docs/resources/config_source#import import section} in the documentation of this resource for the id to use
        :param provider: ? Optional instance of the provider where the ConfigSource to import is found.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4c19add3415d7a166f87d33a78bb4bf2a9a923f35c006d1e62d3cbd95663067b)
...
def _typecheckingstub__4c19add3415d7a166f87d33a78bb4bf2a9a923f35c006d1e62d3cbd95663067b(
    scope: _constructs_77d1e7e8.Construct,
    import_to_id: builtins.str,
    import_from_id: builtins.str,
    provider: typing.Optional[_cdktf_9a9027ec.TerraformProvider] = None,
