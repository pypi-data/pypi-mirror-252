...
COMP_INDICATORS_DTYPES = {field: '<f8' for field in CONSENSUS_COMP_INDICATOR_FIELDS + CONSENSUS_COMP_INDICATOR_FIELDS_V}
...
def get_comp_indicators(order_book_ids, start_date=None, end_date=None, fields=None, report_range=0, market='cn'):
    ...
    if fields is None:
        fields = CONSENSUS_COMP_INDICATOR_FIELDS if report_range == 0 else CONSENSUS_COMP_INDICATOR_FIELDS_V
    else:
        fields = ensure_list_of_string(fields, 'consensus_comp_indicator')
        check_items_in_container(
            fields,
            CONSENSUS_COMP_INDICATOR_FIELDS if report_range == 0 else CONSENSUS_COMP_INDICATOR_FIELDS_V,
            'consensus_comp_indicator'
        )
