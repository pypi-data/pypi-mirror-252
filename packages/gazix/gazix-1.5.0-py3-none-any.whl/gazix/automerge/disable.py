...
labels_program = "disable-automerge"


class DisableAutomerge:
    ...
    def disable(self):
        ...
        print("Cancel the automatic merge of the Merge Request " + self._MR)
        self._queries.post(obj=mr, query="cancel_merge_when_pipeline_succeeds")
        return 0
