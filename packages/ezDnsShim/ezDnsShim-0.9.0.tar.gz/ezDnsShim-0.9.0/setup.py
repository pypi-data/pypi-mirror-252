...
setup(
    name='ezDnsShim',
    version='0.9.0',
    description='ezDnsShim',
    url='https://github.com/rabuchaim/ezDnsShim',
    ...
    license='MIT',
    # keywords=['dnsshim','geoip2','geolite2','maxmind','geoip2fast','geolocation','geolocalization','geo ip','ipaddress','ip','geo','ipv4','ipv6','pure-python','purepython','pure python','geoiptofast','geoiptoofast','geoip2dat','mmdb','tools'],
    packages=['ezDnsShim'],
