...
class debiasing:
    def __init__(self, dset,attrib,alpha=None):
        ...
        self.model = AdversarialFairnessRegressor(predictor_model=self.predictor.model, adversary_model=self.adversary.model, alpha=alpha_in_use,learning_rate=self.predictor.lr,epochs=self.predictor.epochs,batch_size=self.predictor.bs)
