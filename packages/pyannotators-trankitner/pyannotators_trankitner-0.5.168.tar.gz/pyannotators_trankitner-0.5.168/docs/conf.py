...
import pyannotators_trankitner


# -- Project information -----------------------------------------------------

project = "pyannotators_trankitner"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyannotators_trankitner.__version__
release = pyannotators_trankitner.__version__
...
apidoc_module_dir = os.path.dirname(pyannotators_trankitner.__file__)
