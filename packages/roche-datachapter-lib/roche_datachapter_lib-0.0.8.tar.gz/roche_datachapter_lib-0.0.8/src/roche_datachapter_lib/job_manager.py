...
from db_config import DB_CONFIG  # pylint:disable=import-error
from result_type import ResultType  # pylint:disable=import-error
...
# jobname = 'AZ_TestJOB_LUCAS_PYTHON'
# user = 'RNUMDMAS\\pepeito'
