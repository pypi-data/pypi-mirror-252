...
import moneti.modules.Edwards_curve_DSA_448.public_key.form as form_Edwards_curve_DSA_448_public_key
import moneti.modules.Edwards_curve_DSA_448.public_key.write as write_Edwards_curve_DSA_448_public_key
...
def smoothly (
	...
	'''
		private key
	'''
	private_key = Edwards_curve_DSA_448_private_key_creator.create (
		utilizes ["seed"], 
	...
	'''
		public key
	'''
	public_key = form_Edwards_curve_DSA_448_public_key.smoothly (
		private_key_instance = private_key_instance
	)
	write_Edwards_curve_DSA_448_public_key.smoothly (
