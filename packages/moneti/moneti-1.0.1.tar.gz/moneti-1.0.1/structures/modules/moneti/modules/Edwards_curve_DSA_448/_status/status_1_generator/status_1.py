...
'''
	python3 insurance.proc.py "modules/Edwards_curve_DSA_448/_status/status_1_generator/status_1.py"
'''
	...
	for seed in seeds:
		for format in formats:
			private_key_path = normpath (
				join (pathlib.Path (__file__).parent.resolve (), "Edwards_curve_DSA_448_private_key")
			) + "." + format
