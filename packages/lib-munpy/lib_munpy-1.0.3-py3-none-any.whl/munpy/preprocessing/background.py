...
from munpy.general import get_nc_index, reshape, dumpBinary, db_to_street_center
...
def process_background_v2(city, key_path, date=None, mode='copernicus', leadtime_hours=48):
    """
...
if __name__ == "__main__":
    process_background_v2('madrid', config.API_KEY, date='2023-11-22', mode='chimere', leadtime_hours=24)
