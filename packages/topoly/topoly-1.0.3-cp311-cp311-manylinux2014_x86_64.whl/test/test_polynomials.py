...
def prepare_knot_polynomials_codes():
    ...
    for algorithm in algorithms_knots.keys():
        ...
        for code in knot_codes:
            ...
            polynomials[algorithm][code] = algorithms_knots[algorithm](data, chiral=True, max_cross=30)
    log.info('Results:')
...
def prepare_knot_polynomials_ideal():
    ...
    for algorithm in algorithms_knots.keys():
        ...
        for curve in knot_ideal.keys():
            ...
            polynomials[algorithm][curve] = algorithms_knots[algorithm](knot_ideal[curve], closure=Closure.CLOSED, chiral=True, max_cross=30)
    log.info('Results:')
