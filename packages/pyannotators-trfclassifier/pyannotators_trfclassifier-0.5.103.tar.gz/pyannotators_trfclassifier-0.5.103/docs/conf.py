...
import pyannotators_trfclassifier


# -- Project information -----------------------------------------------------

project = "pyannotators_trfclassifier"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyannotators_trfclassifier.__version__
release = pyannotators_trfclassifier.__version__
...
apidoc_module_dir = os.path.dirname(pyannotators_trfclassifier.__file__)
