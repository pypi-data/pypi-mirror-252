...
def get_leaderboard(
    ...
    feedback_timestamp_start = feedback_date_range[0] if feedback_date_range else 0
    feedback_timestamp_end = feedback_date_range[1] if feedback_date_range else float('inf')
...
def get_leaderboard_row(submission_item, developer_key=None, feedback_time_range=None, fetch_feedback=False):
    ...
    if fetch_feedback:
        feedback_metrics = get_submission_metrics(
            ...
            developer_key, 
            reload=is_updated, 
            feedback_time_range=feedback_time_range
        )
...
def get_submission_metrics(submission_id, developer_key, reload=True, feedback_time_range=None):
