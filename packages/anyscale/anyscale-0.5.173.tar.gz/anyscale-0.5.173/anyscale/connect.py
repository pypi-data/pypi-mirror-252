...
class ClientBuilder:
    ...
    def __init__(  # noqa: PLR0912
        ...
        self._cluster_compute_version: Optional[int] = None
    ...
    def _fill_unset_configs_from_env(self) -> None:
        ...
        # Only fill cluster_compute from environment if neither a name nor
        # a dict was passed
        cluster_compute_version_unset = (
            self._cluster_compute_version is None and self._cluster_compute_dict is None
        )
        if cluster_compute_version_unset:
            self._fill_config_from_env("cluster_compute_version")
    ...
    def connect(self) -> AnyscaleClientContext:
        ...
        self._prepare_cluster_block = create_prepare_cluster_block(
            ...
            ray=self._ray,
            cluster_compute_version=self._cluster_compute_version,
        )
