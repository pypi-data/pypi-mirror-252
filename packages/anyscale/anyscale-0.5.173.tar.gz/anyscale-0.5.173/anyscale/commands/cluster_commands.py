...
@click.option(
    ...
    type=int,
    help=(
        "The cluster compute version that you want to use. Only applicable if the compute was specified by name. "
        "Versions are positive integers. "
        "Deprecated behavior: Not setting a version is equivalent to setting version to '1'."
    ),
)
