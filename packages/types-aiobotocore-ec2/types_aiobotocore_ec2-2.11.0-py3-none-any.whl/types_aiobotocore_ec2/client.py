...
class EC2Client(AioBaseClient):
    ...
    async def cancel_export_task(self, *, ExportTaskId: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    async def delete_vpc(self, *, VpcId: str, DryRun: bool = ...) -> EmptyResponseMetadataTypeDef:
        """
    ...
    async def disable_image(self, *, ImageId: str, DryRun: bool = ...) -> DisableImageResultTypeDef:
        """
    ...
    async def enable_image(self, *, ImageId: str, DryRun: bool = ...) -> EnableImageResultTypeDef:
        """
    ...
    async def modify_id_format(
        self, *, Resource: str, UseLongIds: bool
    ) -> EmptyResponseMetadataTypeDef:
        """
