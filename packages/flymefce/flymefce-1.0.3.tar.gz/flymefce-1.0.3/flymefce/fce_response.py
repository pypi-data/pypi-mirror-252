...
"""
This module provides a general response class for FCE services.
"""
...
class FceResponse(object):
    ...
    def set_metadata_from_headers(self, headers):
        ...
        for k, v in iteritems(headers):
            if k.startswith(compat.convert_to_string(http_headers.FCE_PREFIX)):
                k = 'ic_' + k[len(compat.convert_to_string(http_headers.FCE_PREFIX)):]
