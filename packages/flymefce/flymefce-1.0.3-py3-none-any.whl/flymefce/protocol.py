...
"""
This module defines constants that represent the communication protocol to use when sending requests to FCE.

Communication over HTTPS is the default, and is more secure than HTTP, which is why FCE recommends using HTTPS. HTTPS
