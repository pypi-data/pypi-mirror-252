...
"""
This module defines a common configuration class for FCE.
"""

from future.utils import iteritems
from builtins import str
from builtins import bytes
import flymefce.protocol
import flymefce.region
from flymefce.retry.retry_policy import BackOffRetryPolicy
from flymefce import compat


class FceClientConfiguration(object):
    """Configuration of Fce client."""
...
DEFAULT_PROTOCOL = flymefce.protocol.HTTP
DEFAULT_REGION = flymefce.region.SHENZHOU
DEFAULT_CONNECTION_TIMEOUT_IN_MILLIS = 50 * 1000
DEFAULT_SEND_BUF_SIZE = 1024 * 1024
DEFAULT_RECV_BUF_SIZE = 10 * 1024 * 1024
DEFAULT_CONFIG = FceClientConfiguration(
