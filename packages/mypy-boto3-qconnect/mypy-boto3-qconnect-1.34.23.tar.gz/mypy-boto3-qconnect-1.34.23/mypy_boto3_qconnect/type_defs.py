...
GroupingConfigurationPaginatorTypeDef = TypedDict(
    "GroupingConfigurationPaginatorTypeDef",
    {
        "criteria": NotRequired[str],
...
QuickResponseSearchResultDataPaginatorTypeDef = TypedDict(
    "QuickResponseSearchResultDataPaginatorTypeDef",
    {
        "contentType": str,
        ...
        "channels": NotRequired[List[str]],
        "description": NotRequired[str],
        "groupingConfiguration": NotRequired[GroupingConfigurationPaginatorTypeDef],
        "language": NotRequired[str],
        "lastModifiedBy": NotRequired[str],
        "shortcutKey": NotRequired[str],
        "tags": NotRequired[Dict[str, str]],
...
SearchQuickResponsesResponsePaginatorTypeDef = TypedDict(
    "SearchQuickResponsesResponsePaginatorTypeDef",
    {
        "nextToken": str,
