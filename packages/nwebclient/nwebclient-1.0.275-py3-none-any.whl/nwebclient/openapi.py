    ...
    def to_markdown(self):
        ...
        for name in self.data['properties'].keys():
            cols = [
                ...
                self.data['properties'][name]['description']]
            res += '| '+(' | '.join(cols))+' |\n'
        return res
...
def main():
    ...
    args.dispatch(
        ...
        mermaid_create=lambda: print(api.to_mermaid()),
        java_create=lambda: print(api.to_java()),
        markdown_create=lambda: print(api.to_markdown())
    )
