...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, base_path=None, name=None, pulp_href=None, pulp_created=None, base_url=None, hidden=False, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
