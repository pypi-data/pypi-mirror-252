...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, hidden=False, base_url=None, pulp_href=None, pulp_labels=None, pulp_created=None, name=None, base_path=None, local_vars_configuration=None):  # noqa: E501
