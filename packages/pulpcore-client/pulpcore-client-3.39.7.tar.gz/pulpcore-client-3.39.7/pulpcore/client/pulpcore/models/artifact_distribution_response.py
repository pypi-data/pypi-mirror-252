...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, name=None, base_path=None, pulp_href=None, content_guard=None, pulp_labels=None, hidden=False, base_url=None, pulp_created=None, local_vars_configuration=None):  # noqa: E501
