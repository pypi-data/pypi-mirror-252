...
box_cleanup_task = None  # keep a strong reference to prevent the task from dying


class OneShot:
    def __init__(self, token: str, scope: str, process: asyncio.subprocess.Process, env: BoxEnvironment):
        self.token = token
        self.scope = scope
