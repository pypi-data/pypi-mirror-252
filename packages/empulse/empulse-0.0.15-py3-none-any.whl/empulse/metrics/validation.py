...
def check_y_true(y_true: ArrayLike) -> np.ndarray:
    y_true = np.asarray(y_true)
    y_true = column_or_1d(y_true)
    check_numeric(y_true)
    check_nan(y_true)
    check_binary(y_true)
    check_variance(y_true)
    return y_true


def check_y_pred(y_pred: ArrayLike) -> np.ndarray:
