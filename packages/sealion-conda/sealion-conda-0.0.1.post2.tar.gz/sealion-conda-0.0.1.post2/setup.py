...
setup(
    name='sealion-conda',
    version='0.0.1.post2',
    description='Sealion-Conda, Created by OpenSealion Organization, a tool to clone, pkg and create a conda environment between machines',
    ...
    entry_points={
        'console_scripts': [
            ...
            'sealion-conda=sealionconda.app:main',
        ]
    },
    ext_modules=[],
