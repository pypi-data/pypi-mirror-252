...
try:
    from pydantic import ConfigDict, Field, field_validator, v1  # noqa: F401
    ...
    def field_validator(  # type: ignore
        ...
        *fields: str,
        ...
        if mode == "after":
            ...
            pre = True
        return validator(__field, *fields, pre=pre, always=True)
...
def make_iterable(value: Any) -> Iterable[Any]:
    ...
    if not isinstance(value, Iterable) or isinstance(value, str) or isinstance(value, pd.DataFrame):
