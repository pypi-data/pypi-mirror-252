...
class RenderingSystem:
    ...
    def Update(self, dt:float=1.0) -> None:
        ...
        # Directly draw visible sprites
        for entity in _ENTITYMAP.values():
            if "SpriteComponent" in entity and _VIEWPORTRECT.colliderect(entity["SpriteComponent"].rect):
                self.screen.blit(entity["SpriteComponent"].image, entity["SpriteComponent"].rect)
    ...
    #             else: self.spriteGroup.remove(entity["SpriteComponent"])
    ...
    #     _VIEWPORTSURF = pg.Surface((_VIEWPORTRECT.width, _VIEWPORTRECT.heixght))
    #     _VIEWPORTSURF.blit(self.screen, (0,0), _VIEWPORTRECT)
