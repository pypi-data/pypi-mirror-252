...
class Systems():
    ...
    def CalculateActiveEntities(self) -> pg.Rect:
        ...
        self._ACTIVE = [entity if "SpriteComponent" in entity and self._VIEWPORTRECT.colliderect(entity["SpriteComponent"].rect) else self.renderSystem._CleanUp(entity) for entity in _ENTITYMAP.values()]
