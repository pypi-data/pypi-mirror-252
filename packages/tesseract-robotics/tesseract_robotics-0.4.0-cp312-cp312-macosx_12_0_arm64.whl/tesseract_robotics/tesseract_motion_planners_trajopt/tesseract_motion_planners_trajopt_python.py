...
@_swig_add_metaclass(_SwigNonDynamicMeta)
class TrajOptPlanProfile(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __setattr__ = _swig_setattr_nondynamic_instance_variable(object.__setattr__)
...
@_swig_add_metaclass(_SwigNonDynamicMeta)
class TrajOptCompositeProfile(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __setattr__ = _swig_setattr_nondynamic_instance_variable(object.__setattr__)
    ...
    def apply(self, pci, start_index, end_index, manip_info, active_links, fixed_indices):
...
@_swig_add_metaclass(_SwigNonDynamicMeta)
class TrajOptSolverProfile(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __setattr__ = _swig_setattr_nondynamic_instance_variable(object.__setattr__)
...
@_swig_add_metaclass(_SwigNonDynamicMeta)
class TrajOptSolverProfileMap(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __setattr__ = _swig_setattr_nondynamic_instance_variable(object.__setattr__)
    __repr__ = _swig_repr
...
@_swig_add_metaclass(_SwigNonDynamicMeta)
class TrajOptCompositeProfileMap(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __setattr__ = _swig_setattr_nondynamic_instance_variable(object.__setattr__)
    __repr__ = _swig_repr
...
@_swig_add_metaclass(_SwigNonDynamicMeta)
class TrajOptPlanProfileMap(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __setattr__ = _swig_setattr_nondynamic_instance_variable(object.__setattr__)
    __repr__ = _swig_repr
...
def ProfileDictionary_hasProfileEntry_TrajOptSolverProfile(profile_dictionary, ns):
...
def ProfileDictionary_removeProfileEntry_TrajOptSolverProfile(profile_dictionary, ns):
...
def ProfileDictionary_getProfileEntry_TrajOptSolverProfile(profile_dictionary, ns):
...
def ProfileDictionary_addProfile_TrajOptSolverProfile(profile_dictionary, ns, profile_name, profile):
...
def ProfileDictionary_getProfile_TrajOptSolverProfile(profile_dictionary, ns, profile_name):
...
def ProfileDictionary_hasProfile_TrajOptSolverProfile(profile_dictionary, ns, profile_name):
...
def ProfileDictionary_removeProfile_TrajOptSolverProfile(profile_dictionary, ns, profile_name):
...
def ProfileDictionary_hasProfileEntry_TrajOptPlanProfile(profile_dictionary, ns):
...
def ProfileDictionary_removeProfileEntry_TrajOptPlanProfile(profile_dictionary, ns):
...
def ProfileDictionary_getProfileEntry_TrajOptPlanProfile(profile_dictionary, ns):
...
def ProfileDictionary_addProfile_TrajOptPlanProfile(profile_dictionary, ns, profile_name, profile):
...
def ProfileDictionary_getProfile_TrajOptPlanProfile(profile_dictionary, ns, profile_name):
...
def ProfileDictionary_hasProfile_TrajOptPlanProfile(profile_dictionary, ns, profile_name):
...
def ProfileDictionary_removeProfile_TrajOptPlanProfile(profile_dictionary, ns, profile_name):
...
def ProfileDictionary_hasProfileEntry_TrajOptCompositeProfile(profile_dictionary, ns):
...
def ProfileDictionary_removeProfileEntry_TrajOptCompositeProfile(profile_dictionary, ns):
...
def ProfileDictionary_getProfileEntry_TrajOptCompositeProfile(profile_dictionary, ns):
...
def ProfileDictionary_addProfile_TrajOptCompositeProfile(profile_dictionary, ns, profile_name, profile):
...
def ProfileDictionary_getProfile_TrajOptCompositeProfile(profile_dictionary, ns, profile_name):
...
def ProfileDictionary_hasProfile_TrajOptCompositeProfile(profile_dictionary, ns, profile_name):
...
def ProfileDictionary_removeProfile_TrajOptCompositeProfile(profile_dictionary, ns, profile_name):
...
class TrajOptDefaultSolverProfile(TrajOptSolverProfile):
    ...
    convex_solver_config = property(_tesseract_motion_planners_trajopt_python.TrajOptDefaultSolverProfile_convex_solver_config_get, _tesseract_motion_planners_trajopt_python.TrajOptDefaultSolverProfile_convex_solver_config_set, doc=r""" The convex solver config to use, if nullptr the default settings are used""")
...
def createCartesianWaypointTermInfo(index, working_frame, c_wp, tcp_frame, tcp_offset, coeffs, type):
...
def createDynamicCartesianWaypointTermInfo(index, working_frame, c_wp, tcp_frame, tcp_offset, coeffs, type):
