...
class TimeOptimalTrajectoryGeneration(object):
    ...
    def computeTimeStamps(self, trajectory, max_velocity, max_acceleration, max_velocity_scaling_factor=1.0, max_acceleration_scaling_factor=1.0):
        return _tesseract_time_parameterization_python.TimeOptimalTrajectoryGeneration_computeTimeStamps(self, trajectory, max_velocity, max_acceleration, max_velocity_scaling_factor, max_acceleration_scaling_factor)
