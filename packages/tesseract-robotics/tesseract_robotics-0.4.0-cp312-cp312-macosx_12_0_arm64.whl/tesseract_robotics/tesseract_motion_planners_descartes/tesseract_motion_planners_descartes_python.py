...
def sampleToolAxis(tool_pose, resolution, axis):
    r"""
...
def sampleToolXAxis(tool_pose, resolution):
    r"""
...
def sampleToolYAxis(tool_pose, resolution):
    r"""
...
def sampleToolZAxis(tool_pose, resolution):
    r"""
...
class DescartesProblemD(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
...
def ProfileDictionary_hasProfileEntry_DescartesPlanProfileD(profile_dictionary, ns):
...
def ProfileDictionary_removeProfileEntry_DescartesPlanProfileD(profile_dictionary, ns):
...
def ProfileDictionary_getProfileEntry_DescartesPlanProfileD(profile_dictionary, ns):
...
def ProfileDictionary_addProfile_DescartesPlanProfileD(profile_dictionary, ns, profile_name, profile):
...
def ProfileDictionary_getProfile_DescartesPlanProfileD(profile_dictionary, ns, profile_name):
...
def ProfileDictionary_hasProfile_DescartesPlanProfileD(profile_dictionary, ns, profile_name):
...
def ProfileDictionary_removeProfile_DescartesPlanProfileD(profile_dictionary, ns, profile_name):
