...
class FeatureStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ResourceLocation = channel.unary_unary(
                '/featureform.serving.proto.Feature/ResourceLocation',
                request_serializer=featureform_dot_proto_dot_serving__pb2.TrainingDataRequest.SerializeToString,
                response_deserializer=featureform_dot_proto_dot_serving__pb2.ResourceFileLocation.FromString,
                )
...
class FeatureServicer(object):
    ...
    def ResourceLocation(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_FeatureServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ResourceLocation': grpc.unary_unary_rpc_method_handler(
                    servicer.ResourceLocation,
                    request_deserializer=featureform_dot_proto_dot_serving__pb2.TrainingDataRequest.FromString,
                    response_serializer=featureform_dot_proto_dot_serving__pb2.ResourceFileLocation.SerializeToString,
            ),
    }
...
class Feature(object):
    ...
    def ResourceLocation(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/featureform.serving.proto.Feature/ResourceLocation',
            featureform_dot_proto_dot_serving__pb2.TrainingDataRequest.SerializeToString,
            featureform_dot_proto_dot_serving__pb2.ResourceFileLocation.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
