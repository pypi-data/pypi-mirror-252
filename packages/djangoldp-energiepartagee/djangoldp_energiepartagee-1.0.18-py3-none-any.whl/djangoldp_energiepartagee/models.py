    ...
    try:
        ...
        if old_instance.villageoise != instance.villageoise:
            for contribution in instance.contributions.all():
                if contribution.year == Contribution.get_current_contribution_year() and contribution.contributionstatus != CONTRIBUTION_CHOICES[3][0] and contribution.contributionstatus != CONTRIBUTION_CHOICES[4][0] :
                    contribution.amount = instance.get_next_contribution_amount()
                    ...
                    if instance.villageoise == True:
                        contribution.discount.add(villageoise)
                    else:
                        contribution.discount.remove(villageoise)
                    contribution.save()
