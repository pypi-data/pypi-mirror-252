...
- orientation (a value equal to: 'columns', 'rows'; default 'columns'):
    ...
    _type = 'Page'
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, orientation=Component.UNDEFINED, errorStatus=Component.UNDEFINED, errorMessage=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'errorMessage', 'errorStatus', 'orientation']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'errorMessage', 'errorStatus', 'orientation']
