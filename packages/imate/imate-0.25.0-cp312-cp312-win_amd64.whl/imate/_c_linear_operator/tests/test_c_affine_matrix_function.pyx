...
import numpy
import scipy.sparse
from ..py_c_affine_matrix_function cimport pycAffineMatrixFunction

__all__ = ['test_c_affine_matrix_function']
...
cdef int _test_dot(A, B, t) except *:
    ...
    cdef pycAffineMatrixFunction Aop = pycAffineMatrixFunction(A, B)
