...
def trexp(
    ...
    .. math::
        ...
        \\mathrm{trace} \\; \\mathrm{exp}
        \\left(c (\\mathbf{A}(t_i))^p \\right), \\quad i=1, \\dots, q.
    ...
    A : numpy.ndarray, scipy.sparse, :class:`imate.Matrix`, or \
        ...
        :ref:`slq method <imate.trexp.slq>`. If ``method=cholesky``, the
    ...
    method : {'eigenvalue', 'slq'}, default='eigenvalue'
        ...
        * :ref:`eigenvalue <imate.trexp.eigenvalue>`
        * :ref:`slq <imate.trexp.slq>`
    ...
    info : dict
        ...
        * ``matrix``:
            ...
            * ``num_inquiries``: `int`, The size of inquiries of each parameter
              ...
              `1`. For more details see :ref:`slq method <imate.trexp.slq>`.
    ...
    * :ref:`eigenvalue <imate.trexp.eigenvalue>`: uses spectral decomposition.
      Suitable for small matrices (:math:`n < 2^{12}`). The solution is exact.
    * :ref:`slq <imate.trexp.slq>`: uses stochastic Lanczos quadrature (SLQ),
    ...
    **Output information:**
    ...
    .. code-block:: python
        ...
        >>> ld, info = trexp(A, return_info=True)
        >>> print(ld)
        138.6294361119891
    ...
    **Matrix operator:**
    ...
    :ref:`slq method <imate.trexp.slq>`.
    ...
    **Affine matrix operator:**
    ...
    in :ref:`slq method <imate.trexp.slq>`.
    ...
    .. code-block:: python
        ...
        >>> trexp(Aop, method='slq', parameters=t)
