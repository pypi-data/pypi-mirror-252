                               ...
                               long double* work, int* info)
{
    ...
    // Calling double method
    lapack_dstev(jobz, n, d_, e_, z_, ldz, work_, info);
...
{
    lapack_sbdsdc(uplo, compq, n, d, e, u, ldu, vt, ldvt, q, iq, work, iwork,
                  info);
}
...
void lapack_xbdsdc<double>(char* uplo, char* compq, int* n, double* d,
                           ...
                           int* iwork, int* info)
{
    lapack_dbdsdc(uplo, compq, n, d, e, u, ldu, vt, ldvt, q, iq, work, iwork,
                  info);
}
                                ...
                                int* iwork, int* info)
{
    ...
    // Call lapack
    lapack_dbdsdc(uplo, compq, n, d_, e_, u_, ldu, vt_, ldvt, q_, iq, work_,
                  iwork, info);
