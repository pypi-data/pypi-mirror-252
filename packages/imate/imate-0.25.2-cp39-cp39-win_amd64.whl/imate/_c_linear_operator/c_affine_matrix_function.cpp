...
template <typename DataType>
DataType cAffineMatrixFunction<DataType>::get_eigenvalue(
...
template <typename DataType>
void cAffineMatrixFunction<DataType>::_add_scaled_vector(
...
template class cAffineMatrixFunction<float>;
template class cAffineMatrixFunction<double>;
template class cAffineMatrixFunction<long double>;
