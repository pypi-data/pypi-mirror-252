"""
Recreate temporal or spatiotemporal binary white noise stimulus sequence
given a seed, length, and spatial dimensions if applicable
...
def recreate(seed, xy=(), num_frames=1, num_trials=1, progress=False):
    yield from _core.recreate(seed, xy, num_frames, num_trials, progress, 1)


def save(basepath, seed, *args, **kwargs):
    _core.save(basepath, seed, *args, **kwargs, mode=1)
