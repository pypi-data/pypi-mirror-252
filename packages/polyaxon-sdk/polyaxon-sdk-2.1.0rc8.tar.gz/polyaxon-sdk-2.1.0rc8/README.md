...
- API version: 2.1.0-rc8
- Package version: 2.1.0-rc8
...
------------ | ------------- | ------------- | -------------
*AgentsV1Api* | [**collect_agent_data**](docs/AgentsV1Api.md#collect_agent_data) | **POST** /streams/v1/{namespace}/{owner}/agents/{uuid}/collect | collect agent
...
*AgentsV1Api* | [**reconcile_agent**](docs/AgentsV1Api.md#reconcile_agent) | **POST** /api/v1/orgs/{owner}/agents/{uuid}/reconcile | Reconcile agent
