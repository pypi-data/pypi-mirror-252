...
import pyconverters_speech


# -- Project information -----------------------------------------------------

project = "pyconverters_speech"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyconverters_speech.__version__
release = pyconverters_speech.__version__
...
apidoc_module_dir = os.path.dirname(pyconverters_speech.__file__)
