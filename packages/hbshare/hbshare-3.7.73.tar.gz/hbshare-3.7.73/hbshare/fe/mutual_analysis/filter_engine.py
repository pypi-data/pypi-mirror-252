...
def factor_test(asofdate1,asofdate2,theme_name,pool_size,save_to_db=False):
    ...
    # jj_daily_ret['ir_theme']=jj_daily_ret['ext_ret'].rolling(250).mean()/jj_daily_ret['ext_ret'].rolling(250).std()
...
if __name__ == '__main__':
    ...
    for theme_name in ['TMT','医药', '消费', '制造']:
        ...
        ic_pvalue_data = []
        print(theme_name)
        # ic_histor,ex_ret_histor,corr,ic_pvalue_histor=factor_test(['20221231'],['20230331'],
    ...
    #
    # for theme_name in ['大盘成长','中小盘成长','大盘价值','中小盘价值','均衡均衡']:
    # for theme_name in ['大盘价值']:
    #     print(theme_name)
    #     ic_histor,ex_ret_histor,corr,ic_pvalue_histor=\
    #         all_market_funds_factor_test(['20220630','20211231','20210630','20201231','20200630','20191231','20190628','20181228','20180629','20171229',],
