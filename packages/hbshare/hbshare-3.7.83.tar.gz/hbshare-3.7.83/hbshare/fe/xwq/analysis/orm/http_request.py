...
class Curl_Request:
    ...
    def get_duration_between_dates(self, start, end):
        df = commonQuery(key='REPTILE_WD_ZSJQ',startDate=start,endDate=end,fields=["zqdm","jyrq","jq","dataSource"])
        return df
...
if __name__ == '__main__':
    # startDate= '20211101',endDate='20231105'
    res = Curl_Request().get_duration_between_dates('20211101', '20231105')
    print(res)