...
class AcmeProvider(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/vancluever/acme/2.19.1/docs acme}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/vancluever/acme/2.19.1/docs acme} Resource.

        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param server_url: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vancluever/acme/2.19.1/docs#server_url AcmeProvider#server_url}.
        :param alias: Alias name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vancluever/acme/2.19.1/docs#alias AcmeProvider#alias}
        '''
        if __debug__:
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing AcmeProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/vancluever/acme/2.19.1/docs#import import section} in the documentation of this resource for the id to use
...
class AcmeProviderConfig:
    ...
    def server_url(self) -> builtins.str:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vancluever/acme/2.19.1/docs#server_url AcmeProvider#server_url}.'''
    ...
    def alias(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vancluever/acme/2.19.1/docs#alias AcmeProvider#alias}
        '''
