...
def main():
    ...
    defmax = int(config['gap_handler']['max_gap']) if config.has_option('gap_handler', 'max_gap') else 14400
    ...
    programs, not_found = which_programs(["python", "omicron-find-gaps",
    ...
    for group in proc_groups:
        ...
        find_args = f'{programs["omicron_find_gaps"]} {out_verbosity} --group {group} --ifo {ifo} ' \
        ...
        find_job.add_classad('executable', f'{programs["python"]}')
