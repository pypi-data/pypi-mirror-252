...
class SkillcornerClient(FitRequest):
    ...
    def _paginate_and_return(
        self, method: RequestMethod, response: dict, raise_for_status: bool = True, **kwargs
    ) -> dict:
        results = []
        while True:
    ...
    def _request(
        ...
        **kwargs,
        ...
        if self._is_response_complete(response):
            return response
        return self._paginate_and_return(method, response, raise_for_status, **kwargs)
    ...
    def _get_tracking_data(
        ...
        **kwargs,
        ...
        data = self._request(method=method, endpoint=endpoint, resource_id=resource_id, **kwargs)
    ...
    def _get_tracking_data_and_save(
        ...
        **kwargs,
        ...
        data = self._get_tracking_data(method=method, endpoint=endpoint, resource_id=resource_id, **kwargs)
