...
class parser:
    def __init__(self):
        self.apple_os_json = pkg_resources.resource_filename('pxgrid_pyshark_test',apple_os_json)
        self.models_json = pkg_resources.resource_filename('pxgrid_pyshark_test',models_json)
