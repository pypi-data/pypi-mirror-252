...
# from pxgrid_pyshark_test import db_dir
...
class ouidb:
    def __init__(self, url, raw_data_file, pipe_file, database_file):
        self.url = url
        self.raw_data_file = pkg_resources.resource_filename('pxgrid_pyshark_test', raw_data_file)
        self.pipe_file = pkg_resources.resource_filename('pxgrid_pyshark_test', pipe_file)
        self.database_file = pkg_resources.resource_filename('pxgrid_pyshark_test', database_file)
    ...
    #         os.mknod(self.raw_data_file)
    #     if not os.path.exists(self.pipe_file):
    #         os.mknod(self.pipe_file)
    #     if not os.path.exists(self.database_file):
    #         os.mknod(self.database_file)
