...
3. Install the module using pip:
        ...
        pip3 install pxgrid_pyshark

# Configuration Examples

Update endpoint details within ISE using the pxGrid 'context-in' API call using the following structure:
```
{
    "opType": "UPDATE",
    "asset": {
...
# Other Points
- Repository only contains code for deployment on collectors.  Custom profile definitions based on observed data and custom policy rule creation referencing custom profiles is the responsibility of the Network Adminstrator and is beyond the scope of this code.
