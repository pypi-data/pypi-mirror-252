...
setup (
    name='pxgrid_pyshark_test',
    version=versioneer.get_version(),
    cmdclass=versioneer.get_cmdclass(),
    description='Custom DPI tool used to passively analyze endpoint data for improved ISE profiling',
    long_description='Custom DPI tool used to passively analyze endpoint data for improved ISE profiling',
    # long_description_content_type='text/markdown',
    packages=['pxgrid_pyshark_test'],
    scripts=[
        'bin/pxgrid_pyshark',
        'bin/pxgrid_pyshark_file'
    ],
    author=__author__,
