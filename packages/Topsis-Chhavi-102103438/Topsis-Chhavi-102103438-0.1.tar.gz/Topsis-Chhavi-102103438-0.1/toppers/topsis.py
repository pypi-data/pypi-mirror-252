...
def main():
    ...
    if len(sys.argv) != 5:
        ...
        print("USAGE : python 102103438.py 102103438-data.csv '1,1,1,1,1' '+,-,+,-,+' 102103438-result.csv ")
        exit(1)
    ...
    # File extension not csv
        ...
        for i in range(1, nCol):    
            ...
            dataset.iloc[:, i] = dataset.iloc[:, i].fillna(
                (dataset.iloc[:, i].mean()))
        ...
        try:
            ...
            print("ERROR : In weights array, please check again. Ensure all elements are integers.")
            exit(1)
        ...
        for i in impact:
            if not (i == '+' or i == '-'):
                ...
                exit(1)
        print("Weights and impact arrays are valid.")
