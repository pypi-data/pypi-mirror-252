...
from skriba.console import Colorize
from skriba.console import add_verbose_info
...
def error(message: str, verbose: bool = False):
    logger_name = os.getenv("SKRIBA_LOGGER_NAME")
...
def critical(message: str, verbose: bool = False):
    logger_name = os.getenv("SKRIBA_LOGGER_NAME")
