...
class Graph(_message.Message):
    __slots__ = ("feature_sets", "resolvers")
...
class ScalarFeatureType(_message.Message):
    __slots__ = (
        ...
        "internal_version",
        "max_staleness_duration",
        "minimum_write_max_staleness_duration",
    ...
    MAX_STALENESS_DURATION_FIELD_NUMBER: _ClassVar[int]
    MINIMUM_WRITE_MAX_STALENESS_DURATION_FIELD_NUMBER: _ClassVar[int]
    ...
    max_staleness_duration: _duration_pb2.Duration
    minimum_write_max_staleness_duration: _duration_pb2.Duration
    ...
    def __init__(
        ...
        max_staleness_duration: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ...,
        minimum_write_max_staleness_duration: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ...,
...
class Resolver(_message.Message):
    ...
    SYNTHETIC_INPUTS_FIELD_NUMBER: _ClassVar[int]
    STRICT_VALIDATIONS_FIELD_NUMBER: _ClassVar[int]
    ...
    synthetic_inputs: _containers.RepeatedScalarFieldContainer[str]
    strict_validations: _containers.RepeatedCompositeFieldContainer[StrictValidation]
    schedule: Schedule
    ...
    def __init__(
        ...
        synthetic_inputs: _Optional[_Iterable[str]] = ...,
        strict_validations: _Optional[_Iterable[_Union[StrictValidation, _Mapping]]] = ...,
...
class SinkResolver(_message.Message):
    ...
    OWNER_FIELD_NUMBER: _ClassVar[int]
    ENVIRONMENTS_FIELD_NUMBER: _ClassVar[int]
    DEFAULT_ARGS_FIELD_NUMBER: _ClassVar[int]
    TIMEOUT_DURATION_FIELD_NUMBER: _ClassVar[int]
    SYNTHETIC_INPUTS_FIELD_NUMBER: _ClassVar[int]
    STRICT_VALIDATIONS_FIELD_NUMBER: _ClassVar[int]
    STATE_FIELD_NUMBER: _ClassVar[int]
    ...
    owner: str
    environments: _containers.RepeatedScalarFieldContainer[str]
    default_args: _containers.RepeatedScalarFieldContainer[str]
    timeout_duration: _duration_pb2.Duration
    synthetic_inputs: _containers.RepeatedScalarFieldContainer[str]
    strict_validations: _containers.RepeatedCompositeFieldContainer[StrictValidation]
    state: ResolverState
    ...
    def __init__(
        ...
        owner: _Optional[str] = ...,
        environments: _Optional[_Iterable[str]] = ...,
        default_args: _Optional[_Iterable[str]] = ...,
        timeout_duration: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ...,
        synthetic_inputs: _Optional[_Iterable[str]] = ...,
        strict_validations: _Optional[_Iterable[_Union[StrictValidation, _Mapping]]] = ...,
        state: _Optional[_Union[ResolverState, _Mapping]] = ...,
...
class StreamResolver(_message.Message):
    ...
    IS_OUTPUT_OPTIONAL_FIELD_NUMBER: _ClassVar[int]
    MODE_FIELD_NUMBER: _ClassVar[int]
    WINDOWED_PSEUDOFEATURES_FIELD_NUMBER: _ClassVar[int]
    ...
    is_output_optional: bool
    mode: WindowMode
    windowed_pseudofeatures: _containers.RepeatedCompositeFieldContainer[WindowedPseudofeaturesForDuration]
    window_index: int
    environments: _containers.RepeatedScalarFieldContainer[str]
    default_args: _containers.RepeatedScalarFieldContainer[str]
    timeout_duration: _duration_pb2.Duration
    ...
    def __init__(
        ...
        windowed_pseudofeatures: _Optional[_Iterable[_Union[WindowedPseudofeaturesForDuration, _Mapping]]] = ...,
...
class StreamResolverParam(_message.Message):
    ...
    def __init__(
        ...
        keyed_state: _Optional[_Union[ResolverState, _Mapping]] = ...,
    ) -> None: ...
...
class WindowedPseudofeature(_message.Message):
    __slots__ = ("base_feature", "pseudofeature")
    BASE_FEATURE_FIELD_NUMBER: _ClassVar[int]
    PSEUDOFEATURE_FIELD_NUMBER: _ClassVar[int]
    base_feature: FeatureReference
    pseudofeature: FeatureReference
    def __init__(
        self,
        base_feature: _Optional[_Union[FeatureReference, _Mapping]] = ...,
        pseudofeature: _Optional[_Union[FeatureReference, _Mapping]] = ...,
    ) -> None: ...

class WindowedPseudofeaturesForDuration(_message.Message):
    __slots__ = ("duration", "features")
    DURATION_FIELD_NUMBER: _ClassVar[int]
    FEATURES_FIELD_NUMBER: _ClassVar[int]
    duration: _duration_pb2.Duration
    features: _containers.RepeatedCompositeFieldContainer[WindowedPseudofeature]
    def __init__(
        self,
        duration: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ...,
        features: _Optional[_Iterable[_Union[WindowedPseudofeature, _Mapping]]] = ...,
    ) -> None: ...
