...
class CustomWindow(object):
    ...
    def bind_drag(self, widget):
        ...
        def move():
            ReleaseCapture()
            SendMessage(GetParent(self.window.winfo_id()), WM_SYSCOMMAND, SC_MOVE + HTCAPTION, 0)
    ...
    def setup(self):
        ...
        self.hwnd = GetParent(self.window.winfo_id())
        ...
        from win32gui import SetWindowPos, UpdateWindow
        from win32con import NULL, SWP_NOSIZE, SWP_NOMOVE, SWP_NOZORDER, SWP_DRAWFRAME
