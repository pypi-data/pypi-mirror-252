...
class User(object):
    ...
    def __init__(self, id=None, firstname=None, lastname=None, email=None, avatar=None, avatars=None, roles=None, root=None, disabled=None, preferences=None, wechat=None, firstlogin=None, lastlogin=None, api_key=None, api_keys=None, created=None, modified=None, deleted=None, central_user_id=None, central_revision=None):  # noqa: E501
