...
setup(
    ...
    url="https://github.com/ewilk0/sklearn_special_ensembles/tree/v1.1.0",
    download_url="https://github.com/ewilk0/sklearn_special_ensembles/archive/refs/tags/v1.1.0.tar.gz",
    packages=[
