...
setup(
    ...
    url="https://github.com/ewilk0/sklearn_special_ensembles/tree/v1.1.1",
    download_url="https://github.com/ewilk0/sklearn_special_ensembles/archive/refs/tags/v1.1.1.tar.gz",
    packages=[
