...
setup(
    ...
    packages=["sklearn_special_ensembles"],
    version="1.0.3",
    license="MIT",
    description="A library of specialized ensembles for sklearn models.",
    author="Ethan Wilk",
    ...
    package_dir={"sklearn_special_ensembles": "sklearn_special_ensembles"},
