...
def parse():
    ...
    help = commands.add_parser("help")
    help.set_defaults(func=helpCmd)

    version = commands.add_parser('version')
    version.set_defaults(func=versionCmd)

    export = commands.add_parser("export")
    export.set_defaults(func=exportCmd)
    export.add_argument("--format", "-f", default="json", type=str, required=False)
    export.add_argument("repo", default="@", type=str, nargs="?")
...
def exportCmd(args):
    ...
    print(f"Export repos: {args.repo}")
