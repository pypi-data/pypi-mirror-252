...
class Prefs(QWidget):
    ...
    def updateTabPrefs(self):
        ...
        self._sporadicDatesList = self._settings.readSettingAsObject('sporadicDates')
    ...
    def _addDateInterval(self, intervalStr: str = None):
        if intervalStr is None:
            ...
            self._settings.writeSetting('sporadicDates', self._sporadicDatesList)
    ...
    def _calculateSporadicBackground(self):
        self._tabStats.calculateSporadicBackground()
