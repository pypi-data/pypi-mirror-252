...
def main():
    enrolment_cycles = config['oars']['tag_enrolment_cycles']
    tag_to_keep_patterns = config['oars']['tag_to_keep_patterns']
    tag_enrolment_class_pattern = config['oars']['tag_enrolment_class_pattern']
    ...
    if enrolment_cycles:
        ...
        enrolment_details_df['to tag'] = enrolment_details_df['name'].apply(
            lambda x: class_selector(x, tag_enrolment_class_pattern))
