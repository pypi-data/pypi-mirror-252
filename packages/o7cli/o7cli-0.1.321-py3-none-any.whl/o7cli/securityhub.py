    ...
    def display_per_account(self):
        ...
        params = TableParam(
            columns = [
                ...
                ColumnParam(title = 'Account',     type = 'str',  data_col = 'AwsAccountId'),
                ColumnParam(title = 'Account Name',     type = 'str',  data_col = 'AccountName'),
                ColumnParam(title = 'Critical'   ,  type = 'int',  data_col = 'Critical', critical_hi=1, footer = 'sum'),
                ColumnParam(title = 'High'   ,  type = 'int',  data_col = 'High', alarm_hi=1, footer = 'sum'),
                ColumnParam(title = 'Medium'   ,  type = 'int',  data_col = 'Medium', warning_hi=1, footer = 'sum'),
                ColumnParam(title = 'Low'   ,  type = 'int',  data_col = 'Low', footer = 'sum'),
