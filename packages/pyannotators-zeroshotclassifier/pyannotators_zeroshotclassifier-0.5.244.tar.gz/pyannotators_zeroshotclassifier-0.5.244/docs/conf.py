...
import pyannotators_zeroshotclassifier


# -- Project information -----------------------------------------------------

project = "pyannotators_zeroshotclassifier"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyannotators_zeroshotclassifier.__version__
release = pyannotators_zeroshotclassifier.__version__
...
apidoc_module_dir = os.path.dirname(pyannotators_zeroshotclassifier.__file__)
