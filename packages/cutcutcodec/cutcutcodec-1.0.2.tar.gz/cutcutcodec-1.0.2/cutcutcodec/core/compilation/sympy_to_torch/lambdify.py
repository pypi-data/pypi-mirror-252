...
def _cast_lambdify_c(
    func: callable, input_args: dict[str, typing.Union[numbers.Real, torch.Tensor]]
...
def _lambdify_c(code: str) -> callable:
    ...
    ** Compile the C source code and import the func. **
    ...
    gcc_insructions = [
        ...
        *(f"-D{mac_in}={mac_out}" for mac_in, mac_out in comp_rules["define_macros"]), # extra macro
...
class Lambdify:
    ...
    ** Convert a sympy expression into an evaluable torch function. **
    ...
    def _cst_tree_func(self,
        input_args: typing.Union[numbers.Number, torch.Tensor]
    ) -> tuple[torch.Tensor]:
        """
    ...
    def _dyn_tree_func(self,
        dyn_args: typing.Union[numbers.Number, torch.Tensor]
    ) -> typing.Union[numbers.Number, torch.Tensor, tuple[torch.Tensor]]:
        """
        ** Evaluation of the dynamic tree. **
    ...
    def args(self) -> list[str]:
        """
        ** The ordered names of the input arguments of this function. **
        """
        return sorted(self._tree["args_str"])

    def forward(self,
        **input_args: dict[str, typing.Union[numbers.Number, torch.Tensor]]
    ) -> typing.Union[numbers.Number, torch.Tensor, tuple[torch.Tensor]]:
        """
