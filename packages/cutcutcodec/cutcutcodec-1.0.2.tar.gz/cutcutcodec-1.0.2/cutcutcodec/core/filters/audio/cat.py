...
"""
** Allows you to temporarily concatenate several audio streams. **
------------------------------------------------------------------
"""
...
from cutcutcodec.core.filters.audio.add import FilterAudioAdd
...
class FilterAudioCat(MetaFilter):
    ...
    ** Concatenate the streams end-to-end. **
    ...
    --------
    >>> import torch
    >>> from cutcutcodec.core.filters.audio.cat import FilterAudioCat
