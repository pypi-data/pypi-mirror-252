...
class FilterCut:
    ...
    ** Splits the stream at the given positions. **
    ...
    def init(self,
        in_streams: typing.Iterable[Stream], stream_cls: type, *limits: numbers.Real
    ):
        """
        Parameters
        ----------
        ...
        assert all(isinstance(l, numbers.Real) and math.isfinite(l) and l >= 0 for l in limits)
        ...
        abs_limits = [l + beginning for l in _limits]
