...
class DocViewer(CutcutcodecWidget, QtWidgets.QWidget):
    ...
    ** Allows to show and hide a documentation. **
    ...
    def __init__(self, parent, dict_settings: dict[str, str], doc_getter: callable):
        ...
        self._params_textbox.textChanged.connect(self.validate)
    ...
    def validate(self, text):
        """
        ** Updates and checks the specific settings. **
        """
