...
class PortalErrorResponse(BaseModel):
    ...
    error_detail: StrictStr = Field(alias="errorDetail")
    errors: List[ErrorMessage]
    __properties: ClassVar[List[str]] = ["statusCode", "errorCode", "errorDetail", "errors"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "errors": [ErrorMessage.from_dict(_item) for _item in obj.get("errors")] if obj.get("errors") is not None else None
        })
        return _obj
