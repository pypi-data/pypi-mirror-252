...
class NotebookInstance(BaseModel):
    ...
    volume_size_gb: StrictInt = Field(alias="volumeSizeGB")
    created_by: StrictStr = Field(alias="createdBy")
    created_at: datetime = Field(alias="createdAt")
    updated_at: datetime = Field(alias="updatedAt")
    __properties: ClassVar[List[str]] = ["id", "name", "status", "instanceType", "acceleratorTypes", "volumeSizeGB", "createdBy", "createdAt", "updatedAt"]
