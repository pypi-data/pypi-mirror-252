...
from qrisp.mcx_algs.circuit_library import jones_toffoli_qc, amy_toffoli_qc, ctrl_state_wrap
...
class JonesToffoli(Operation):
    ...
    def recompile(self):
        ...
        res = ctrl_state_wrap(jones_toffoli_qc, self.ctrl_state).to_op("jones_toffoli")
...
def jones_toffoli(ctrl, target, ctrl_state = "11"):
    ...
    jones_ancilla = QuantumVariable(2)
