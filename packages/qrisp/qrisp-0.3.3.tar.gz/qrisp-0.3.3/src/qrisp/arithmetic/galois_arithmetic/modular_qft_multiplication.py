...
from qrisp.arithmetic.galois_arithmetic.mod_tools import modinv, montgomery_decoder, montgomery_encoder

def QREDC(t, N, m):
    # QFT(t, inv = False, exec_swap = False)
    u = QuantumFloat(0, qs = t.qs, name = "urgh*")
...
def montgomery_mod_mul(a, b, output_qg = None):
    ...
    if a.modulus != b.modulus:
        raise Exception("Tried to multiply two QuantumGalois with differing modulus")
