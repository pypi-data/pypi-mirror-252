...
import pyconverters_deeptranscript


# -- Project information -----------------------------------------------------

project = "pyconverters_deeptranscript"
copyright = "2022, Olivier Terrier"
author = "Olivier Terrier"
version = pyconverters_deeptranscript.__version__
release = pyconverters_deeptranscript.__version__
...
apidoc_module_dir = os.path.dirname(pyconverters_deeptranscript.__file__)
