...
class RDSClient(AioBaseClient):
    ...
    async def cancel_export_task(self, *, ExportTaskIdentifier: str) -> ExportTaskResponseTypeDef:
        """
    ...
    async def delete_integration(self, *, IntegrationIdentifier: str) -> IntegrationResponseTypeDef:
        """
    ...
    async def delete_option_group(self, *, OptionGroupName: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    async def enable_http_endpoint(self, *, ResourceArn: str) -> EnableHttpEndpointResponseTypeDef:
        """
