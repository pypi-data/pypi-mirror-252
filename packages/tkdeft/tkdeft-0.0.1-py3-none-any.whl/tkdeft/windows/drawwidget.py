...
class DDrawWidget(DDrawWidgetCanvas, DObject):
    def __init__(self, *args, **kwargs):
        ...
        self.bind("<Enter>", self._event_enter)
        self.bind("<Leave>", self._event_leave)
        self.bind("<Button-1>", self._event_on_button1)
        self.bind("<ButtonRelease-1>", self._event_off_button1)
        self.bind("<FocusIn>", self._event_focus_in)
        self.bind("<FocusOut>", self._event_focus_out)
