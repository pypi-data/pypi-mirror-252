...
class EvidenceMaximisation:
    ...
    def __init__(self, model: Model, ns_kwargs: Dict[str, Any],
        ...
        self._jit_m_step = jax.jit(self._m_step)
    ...
    def m_step(self, results: NestedSamplerResults, params: hk.MutableParams) -> hk.MutableParams:
        ...
        """
        return self._jit_m_step(results, params)

    def _m_step(self, results: NestedSamplerResults, params: hk.MutableParams) -> hk.MutableParams:
        """
        The M-step is just evidence maximisation.
        ...
        def neg_log_evidence(params: hk.MutableParams):
            ...
            model = self.model(params=params)
            # To make manageable, we could do chunked evaluation, or else mini-batch over samples.
        ...
        solver_results = solver.run(init_params=params)
