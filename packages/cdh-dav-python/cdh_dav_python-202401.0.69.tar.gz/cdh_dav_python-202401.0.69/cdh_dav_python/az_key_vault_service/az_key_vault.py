            ...
            try:
                ...
                if secret_value is None:
                    if self.running_interactive is True:
                        ...
                        try:
                            _ = dbutils  # Try to access the dbutils variable
                        except NameError:
                            dbutils = None  # If it's not defined, set it to None
                        ...
                        if dbutils is not None:
                            ...
                            error_msg = f"dbutils is None: unable to retrieve secret from dbutils"
