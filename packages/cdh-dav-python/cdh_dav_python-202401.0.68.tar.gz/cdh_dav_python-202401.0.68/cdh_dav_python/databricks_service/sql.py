        ...
        with tracer.start_as_current_span("fetch_sql"):
            try:
                ...
                if data is None:
                    ...
                    logger.info("query_text not found in DataBricks SQL")
                    raise ValueError(
                        "query_text not found in DataBricks SQL. Check the query name and permissions"
                    )
                else:
...
# COMMAND ----------
    ...
    def save_pipeline_python(
        ...
        """
        Save a Python pipeline to Databricks.

        Args:
            cls: The class object.
            environment: The environment name.
            content_text: The content of the pipeline.
            databricks_access_token: The access token for Databricks.
            repository_path: The path to the repository.
            data_product_id: The ID of the data product.
            databricks_instance_id: The ID of the Databricks instance.
            pipeline_name: The name of the pipeline.
            running_local: A flag indicating whether the code is running locally.
            data_product_id_root: The root ID of the data product.
