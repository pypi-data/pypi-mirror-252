...
if OS_NAME.lower() == "nt":
    ...
    LOG_FILENAME = ENV_SHARE_PATH / "cdh_dav_logging.txt"
else:
...
DESIRED_LOG_FILENAME = "cdh_dav_logging.txt"
...
try:
    ...
    if not FOLDER_EXISTS:
        if platform.system() != "Windows":
            ...
            LOG_FILENAME = ENV_SHARE_FALLBACK_PATH + "/cdh_dav_logging.txt"
...
class LoggerSingleton:
    ...
    def instance(
        ...
        data_product_id: str = "cdh_dav_core",
        environment: str = "dev",
    ):
        """
        ...
        Args:
            ...
            data_product_id (str, optional): The ID of the data product. Defaults to "cdh_dav_core".
