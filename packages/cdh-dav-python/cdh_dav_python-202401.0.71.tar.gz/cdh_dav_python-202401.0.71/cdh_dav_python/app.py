        ...
        with tracer.start_as_current_span(f"metadata_excel_file_download/{schema_id}"):
            try:
                ...
                manifest_excel_file = schema.download_manifest_excel(
                    schema_id, config, excel_data_definition_file, DATA_PRODUCT_ID, ENVIRONMENT
                )
    ...
    def get(self):
        ...
        with tracer.start_as_current_span(f"connect_api_key_verification"):
            ...
            (
                ...
                response_content,
                api_url,
            ) = posit_connect.verify_api_key(connect_api_key, posit_connect_base_url, DATA_PRODUCT_ID, ENVIRONMENT)
    ...
    def get(self, content_id, bundle_id):
        ...
        with tracer.start_as_current_span("build_deployment_bundle"):
            ...
            (
                ...
                connect_api_key, posit_connect_base_url, content_id, bundle_id, DATA_PRODUCT_ID, ENVIRONMENT
            )
