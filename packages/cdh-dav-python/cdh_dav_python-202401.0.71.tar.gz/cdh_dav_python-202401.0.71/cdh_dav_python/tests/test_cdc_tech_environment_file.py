"""
Module: test_cdc_tech_environment_file
...
def test_execute_script_string():
    ...
    command = "ls -l"
    execute_results = obj_env_file.execute_script_string(command)
...
def test_delete_directory_manifest_downloads_dev():
    ...
    manifest_path = obj_env_file.convert_to_current_os_dir(manifest_path)
...
def test_combine_files():
    ...
    # Go up two levels
    two_levels_up = current_file_dir.parent.parent

    # Get the 'docs' directory
    docs_dir = two_levels_up / "docs"
    ...
    source_path = obj_env_file.convert_to_current_os_dir(source_path)
    destination_path = obj_env_file.convert_to_current_os_dir(destination_path)
