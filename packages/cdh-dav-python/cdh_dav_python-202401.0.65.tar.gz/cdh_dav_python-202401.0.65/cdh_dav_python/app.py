    ...
    with tracer.start_as_current_span(f"get_log_file_tail"):
        try:
            ...
            (
                ...
                number_of_lines,
                log_data,
            ) = logger_singleton.get_log_file_tail(number_of_lines)
            if status_code == 500:
        ...
        with tracer.start_as_current_span(f"metadata_excel_file_download/{schema_id}"):
            try:
                ...
                manifest_excel_file = schema.download_manifest_excel(
                    schema_id, config, excel_data_definition_file
                )
    ...
    def get(self):
        ...
        with tracer.start_as_current_span(f"connect_api_key_verification"):
            ...
            (
                ...
                response_content,
                api_url,
            ) = posit_connect.verify_api_key(connect_api_key, posit_connect_base_url)
