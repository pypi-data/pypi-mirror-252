...
Usage::
    ...
    data: AuthenticateCognitoActionConfigPaginatorTypeDef = ...
    ```
"""
...
AuthenticateCognitoActionConfigPaginatorTypeDef = TypedDict(
    "AuthenticateCognitoActionConfigPaginatorTypeDef",
    {
        "UserPoolArn": str,
...
AuthenticateOidcActionConfigPaginatorTypeDef = TypedDict(
    "AuthenticateOidcActionConfigPaginatorTypeDef",
    {
        "Issuer": str,
...
HostHeaderConditionConfigPaginatorTypeDef = TypedDict(
    "HostHeaderConditionConfigPaginatorTypeDef",
    {
...
HttpHeaderConditionConfigPaginatorTypeDef = TypedDict(
    "HttpHeaderConditionConfigPaginatorTypeDef",
    {
...
HttpRequestMethodConditionConfigPaginatorTypeDef = TypedDict(
    "HttpRequestMethodConditionConfigPaginatorTypeDef",
    {
        "Values": NotRequired[List[str]],
    },
...
PathPatternConditionConfigPaginatorTypeDef = TypedDict(
    "PathPatternConditionConfigPaginatorTypeDef",
    {
        "Values": NotRequired[List[str]],
    },
...
SourceIpConditionConfigPaginatorTypeDef = TypedDict(
    "SourceIpConditionConfigPaginatorTypeDef",
    {
        "Values": NotRequired[List[str]],
    },
...
ForwardActionConfigPaginatorTypeDef = TypedDict(
    "ForwardActionConfigPaginatorTypeDef",
    {
...
QueryStringConditionConfigPaginatorTypeDef = TypedDict(
    "QueryStringConditionConfigPaginatorTypeDef",
    {
...
ActionPaginatorTypeDef = TypedDict(
    "ActionPaginatorTypeDef",
    {
        ...
        "TargetGroupArn": NotRequired[str],
        "AuthenticateOidcConfig": NotRequired[AuthenticateOidcActionConfigPaginatorTypeDef],
        "AuthenticateCognitoConfig": NotRequired[AuthenticateCognitoActionConfigPaginatorTypeDef],
        ...
        "ForwardConfig": NotRequired[ForwardActionConfigPaginatorTypeDef],
    },
)
...
RuleConditionPaginatorTypeDef = TypedDict(
    "RuleConditionPaginatorTypeDef",
    {
        "Field": NotRequired[str],
        "Values": NotRequired[List[str]],
        "HostHeaderConfig": NotRequired[HostHeaderConditionConfigPaginatorTypeDef],
        "PathPatternConfig": NotRequired[PathPatternConditionConfigPaginatorTypeDef],
        "HttpHeaderConfig": NotRequired[HttpHeaderConditionConfigPaginatorTypeDef],
        "QueryStringConfig": NotRequired[QueryStringConditionConfigPaginatorTypeDef],
        "HttpRequestMethodConfig": NotRequired[HttpRequestMethodConditionConfigPaginatorTypeDef],
        "SourceIpConfig": NotRequired[SourceIpConditionConfigPaginatorTypeDef],
    },
)
...
ListenerPaginatorTypeDef = TypedDict(
    "ListenerPaginatorTypeDef",
    {
        "ListenerArn": NotRequired[str],
        "LoadBalancerArn": NotRequired[str],
        ...
        "DefaultActions": NotRequired[List[ActionPaginatorTypeDef]],
...
RulePaginatorTypeDef = TypedDict(
    "RulePaginatorTypeDef",
    {
        ...
        "Conditions": NotRequired[List[RuleConditionPaginatorTypeDef]],
        "Actions": NotRequired[List[ActionPaginatorTypeDef]],
        "IsDefault": NotRequired[bool],
    },
)
...
DescribeListenersOutputPaginatorTypeDef = TypedDict(
    "DescribeListenersOutputPaginatorTypeDef",
    {
        "Listeners": List[ListenerPaginatorTypeDef],
        "NextMarker": str,
        "ResponseMetadata": ResponseMetadataTypeDef,
    },
)
...
DescribeRulesOutputPaginatorTypeDef = TypedDict(
    "DescribeRulesOutputPaginatorTypeDef",
    {
        "Rules": List[RulePaginatorTypeDef],
        "NextMarker": str,
        "ResponseMetadata": ResponseMetadataTypeDef,
    },
)
