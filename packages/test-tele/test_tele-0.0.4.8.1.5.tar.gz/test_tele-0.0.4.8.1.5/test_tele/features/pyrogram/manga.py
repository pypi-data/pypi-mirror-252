...
async def image_keyboard(my_list: dict) -> InlineKeyboardMarkup:
    ...
    if 'manga_url' in my_list:
        ...
        button_name = 'Previous Chapter ◀️'
        see_chapter = my_list['prev_ch']
        optional_button = InlineKeyboardButton('Next Chapter ▶️', switch_inline_query_current_chat=my_list['next_ch'])
