...
def CreateArchive(inputPath:str):
    """Creates a zip archive of inputPath

    :param inputPath: File or Directory to archive
    :return: path to the created archive
    """
    import shutil
    return shutil.make_archive(inputPath, format='zip', root_dir=inputPath)