...
class MessageBox(_TK_BaseDialog):
    def __init__(self):
        ...
        self.style_Header_Expand = True
        self.style_Footer_Expand = False
    ...
    def _FrameHeader_Mapper(self, frame: _tk.Frame):
        ...
        if not (_strings.IsNullOrEmpty(self.settings_Message)): #if empty message skip rendering
...
class RichMessageBox(MessageBox):
    def __init__(self):
        super().__init__()
        self.style_Header_Expand = False
        self.style_Footer_Expand = True #make the large text box rescalable instead with the window
    ...
    def _FrameFooter_Mapper(self, frame: _tk.Frame):
        ...
        self._AddEventHandler_OnLoad(textbox, OnLoad_Textbox)
        if not (_strings.IsNullOrEmpty(self.settings_RichText)): #if empty rich message skip rendering
    ...
    @classmethod
    def Show(cls, text:str, description: str = None, windowTitle: str = None, windowTopMost:bool=None):
        '''
        a large message box with scrollbars and wordwrapping turned off.

        :param description: A small description at header section
        :param richMessage: A large and rich textbox at footer section
        '''
        with cls() as app:
...
class InputBox(MessageBox):
    ...
    @classmethod
    def Show(cls, message: str, windowTitle: str = None, windowTopMost:bool=None, initialValue:str = None):
        '''
...
class RichInputBox(InputBox):
    ...
    def __init__(self):
        super().__init__()
        self.style_Header_Expand = False
        self.style_Footer_Expand = True #make the large input box rescalable instead with the window
...
class ButtonBox(MessageBox):
    def __init__(self, buttons: list[str]):
        ...
        self.style_Header_Expand = False
        self.style_Footer_Expand = True #make the button panel rescalable instead with the window
    ...
    @classmethod
    def Show(cls, buttons: list[str], message: str = "", windowTitle: str = None, windowTopMost:bool=None):
        '''
