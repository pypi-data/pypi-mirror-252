...
#                         video_quality['error'] = 'no_face_detected_in_video'
    ...
    def validate_fields_irq_id(self, complete_ocr_data):
        ...
        if country == 'UAE':
            ...
            if is_colored1:
                try:
                    ...
                    match = re.search(combined_pattern,front_id_text, re.IGNORECASE)
    ...
    def extract_ocr_info(self, data, video, country, report_names, face_match_threshold=0.60):
        ...
        if country == 'IRQ':
            ...
            validation_result = self.validate_fields_irq_id(data)
