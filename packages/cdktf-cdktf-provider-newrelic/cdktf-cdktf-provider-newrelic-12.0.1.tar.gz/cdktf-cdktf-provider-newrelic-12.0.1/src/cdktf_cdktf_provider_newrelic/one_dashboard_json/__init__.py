...
Refer to the Terraform Registry for docs: [`newrelic_one_dashboard_json`](https://registry.terraform.io/providers/newrelic/newrelic/3.29.0/docs/resources/one_dashboard_json).
'''
import abc
import builtins
import datetime
...
class OneDashboardJson(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/newrelic/newrelic/3.29.0/docs/resources/one_dashboard_json newrelic_one_dashboard_json}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.29.0/docs/resources/one_dashboard_json newrelic_one_dashboard_json} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param json: The dashboard's json. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.29.0/docs/resources/one_dashboard_json#json OneDashboardJson#json}
        :param account_id: The New Relic account ID where you want to create the dashboard. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.29.0/docs/resources/one_dashboard_json#account_id OneDashboardJson#account_id}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.29.0/docs/resources/one_dashboard_json#id OneDashboardJson#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.29.0/docs/resources/one_dashboard_json#timeouts OneDashboardJson#timeouts}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing OneDashboardJson that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.29.0/docs/resources/one_dashboard_json#import import section} in the documentation of this resource for the id to use
    ...
    def put_timeouts(
        ...
        *,
        ...
        '''
        :param create: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.29.0/docs/resources/one_dashboard_json#create OneDashboardJson#create}.
        :param update: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.29.0/docs/resources/one_dashboard_json#update OneDashboardJson#update}.
        '''
...
class OneDashboardJsonConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def json(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.29.0/docs/resources/one_dashboard_json#json OneDashboardJson#json}
        '''
    ...
    def account_id(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.29.0/docs/resources/one_dashboard_json#account_id OneDashboardJson#account_id}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.29.0/docs/resources/one_dashboard_json#id OneDashboardJson#id}.
    ...
    def timeouts(self) -> typing.Optional["OneDashboardJsonTimeouts"]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.29.0/docs/resources/one_dashboard_json#timeouts OneDashboardJson#timeouts}
        '''
...
class OneDashboardJsonTimeouts:
    ...
    def create(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.29.0/docs/resources/one_dashboard_json#create OneDashboardJson#create}.'''
        result = self._values.get("create")
        return typing.cast(typing.Optional[builtins.str], result)

    @builtins.property
    def update(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.29.0/docs/resources/one_dashboard_json#update OneDashboardJson#update}.'''
