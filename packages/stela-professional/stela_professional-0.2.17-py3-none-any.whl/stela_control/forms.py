    ...
    def __init__(self, *args, **kwargs):
        ...
        for field in self.fields.values():
            ...
            self.fields['logo'].widget.attrs.update(
                {'class': 'form-control'})
            self.fields['name'].validators=[text_regex]
            self.fields['description'].validators=[text_regex]
            self.fields['email'].validators=[email_regex]
            self.fields['web'].validators=[text_regex]
            self.fields['address'].validators=[text_regex]
...
class ServicesForm(forms.ModelForm):
    ...
    class Meta:
        model = Elements
        fields = ['status', 'title', 'subtitle', 'description', 'image', 'price']
        widgets = {
            'status': forms.Select(attrs={
                'placeholder': 'Choose status...',
                'class': 'form-control',  
