...
def get_browser_functions(ai: "OpenAI"):
    ...
    visit_page_max_context_length = (
        100000 if "gpt-4-1106-preview" in visit_page_model_name else 10000
    )
    ...
    def quick_search(ascii_espaced_query: str) -> str:
        """Searche the given query and summarize the search results.

        :param ascii_espaced_query: The query to search. For example, `Where is \\u65e5\\u672c`.
        :type ascii_espaced_query: str
        :return: summarized search results.
        :rtype: str
        """
        search_query = ascii_espaced_query
    ...
    def visit_page(summarization_points_of_view: str, url: str) -> str:
        ...
        :param summarization_points_of_view: The summarization points of view. For example, `Price, Performance, Design`.
