...
# sources: blickfeld/secure/services/account.proto, blickfeld/secure/services/application_key.proto, blickfeld/secure/services/authentication.proto, blickfeld/secure/services/device_credentials.proto, blickfeld/secure/services/session.proto
...
class AccountResetResponse(betterproto.Message):
    """
    Response after account has been reset. [NOTE] ==== The generated activation
    password in plain text will be returned only once. ====
    """
