...
from .core.collections.transformation_functions import TransformationFunctions
from .core.config import ConfigUtils
from .core.credentials import CredentialsHelper
from .core.dashboard import Dashboard
from .core.data_source_wrappers import SparkDataFrame, get_raw_data_location
...
class Client:
    ...
    def __init_internal(self, url: str, secure: bool, root_certificates: str, config: ClientConfig):
        ...
        self.projects = Projects(self._stub, rest_stub)
