...
class ArgumentParser(argparse.ArgumentParser):
    ...
    def _setup_scanprofile_commands(self, subparsers):
        ...
        self._add_command(
            ...
            description="List all assets CIDRs associated with the specified scan profile.\n"
        )
        self._add_command(
            scanprofiles_subparsers, "assets_cidr_attach", ScanProfilesAssetCIDRAttachCommand, "scanprofile_id", "network_id",
            description="Attach an asset CIDR to the specified scan profile.\n"
        )
        self._add_command(
            scanprofiles_subparsers, "assets_cidr_detach", ScanProfilesAssetCIDRDetachCommand, "scanprofile_id", "network_id",
            description="Detach an asset CIDR from the specified scan profile.\n"
        )
