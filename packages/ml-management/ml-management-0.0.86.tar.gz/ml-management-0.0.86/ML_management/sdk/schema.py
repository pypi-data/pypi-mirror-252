...
class ExecutorVersion(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('name', 'version', 'source_path', 'tags', 'description', 'status', 'status_message', 'creation_timestamp', 'last_updated_timestamp', 'executor_method_schema', 'executor_method_schema_name', 'desired_model_methods', 'upload_model_modes', 'desired_model_patterns', 'run', 'executor', 'list_deployed_jobs', 'pagination_deployed_jobs', 'job_json_schema', 'available_models', 'pagination_available_models', 'available_model_versions', 'pagination_available_model_versions', 'available_dataset_loaders', 'pagination_available_dataset_loaders', 'available_dataset_loader_versions', 'pagination_available_dataset_loader_versions', 'available_collectors', 'pagination_available_collectors')
    name = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='name')
