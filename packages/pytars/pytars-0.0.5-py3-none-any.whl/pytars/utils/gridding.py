...
def bin_grid_2d(
    ...
    """
    Bin the values in z into the bins defined by xi and yi.
...
def bin_grid_1d(
    ...
    """
    Bin the values in y into the bins defined by xi.
    fun is a function that takes a 1d array and returns a scalar.
    """
    if is_bin_center:
        xi = bin_center_to_bin_edge(xi)

    return binned_statistic(x, y, statistic=fun, bins=xi).statistic
