...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_created=None, description=None, versions_href=None, retain_repo_versions=None, pulp_href=None, latest_version_href=None, manifest_signing_service=None, name=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
