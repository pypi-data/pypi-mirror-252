...
class PatchedcontainerContainerDistribution(object):
    ...
    def __init__(self, base_path=None, repository=None, hidden=False, content_guard=None, name=None, pulp_labels=None, repository_version=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
