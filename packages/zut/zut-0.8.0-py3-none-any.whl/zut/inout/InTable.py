...
class InTable:
    ...
    def __init__(self, src, *, dir: str|Path|None = None, title: str|None = None, debug: bool = None, tz_if_naive: tzinfo = None, formatters: dict[int|str,type|Callable|None] = None, **kwargs):
