...
def in_table(src: Path|str|IOBase, query: str = None, *args, dir: str|Path|None = None, title: str|None = None, encoding: str = 'utf-8', delimiter: str = None, quotechar: str = None, nullval: str = None, formatters: dict[int|str,Callable] = None, debug: bool = False, offset: int = None, limit: int = None, **kwargs) -> InTable:
    clazz: InTable = None
    ...
    return clazz(src, query=query, *args, dir=dir, title=title, encoding=encoding, delimiter=delimiter, quotechar=quotechar, nullval=nullval, formatters=formatters, debug=debug, offset=offset, limit=limit, **kwargs)


def transfer_table(src: Path|str|IOBase, out: str|Path|IOBase, *, formatters: dict[int|str,Callable] = None, headers: list[str]|dict[str, Any] = None, dir: str|Path|None = None, append: bool = False, encoding: str = 'utf-8', delimiter: str = None, quotechar: str = None, nullval: str = None, **kwargs):
    """
    ...
    with in_table(src, dir=dir, formatters=formatters, encoding=encoding, delimiter=delimiter, quotechar=quotechar, nullval=nullval, **kwargs) as _src_table:
