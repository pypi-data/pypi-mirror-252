...
def load_from_csv(source: IOBase|os.PathLike, formatters: dict[str,type|Callable] = None, encoding: str = 'utf-8', delimiter: str = None, quotechar: str = None, nullval: str = None):
    """
    Load a list of dicts from CSV.
    """
    from .inout import InCsv

    with InCsv(source, formatters=formatters, encoding=encoding, delimiter=delimiter, quotechar=quotechar, nullval=nullval) as i:
