...
class ActionFailedException(Exception):
    ...
    def __init__(self, message: str, action: ActionItem):
...
def check_state_transition(current_state: ActionState, new_state: ActionState):
    ...
    if current_state == ActionState.PAUSED or new_state == ActionState.PAUSED:
...
class ActionItem(ABC):
    ...
    def __init__(
        ...
        self._children: dict[str, ActionItem] = {}
    ...
    def get_child(self, name: str) -> ActionItem:
        """get child by name"""
        try:
