...
class SloveneG2P:
    ...
    def __init__(self):
        self.ipa_converter = SloveneG2P(phoneme_set_option="ipa_symbol", representation_option="cjvt_ipa_detailed_representation", output_option="phoneme_string")
        self.sampa_converter = SloveneG2P(phoneme_set_option="sampa_symbol", representation_option="cjvt_sampa_detailed_representation", output_option="phoneme_string")

    def ipa(self, word, msd, mpc):
        self.ipa_converter.convert_to_phonetic_transcription(word, msd, mpc)

    def sampa(self, word, msd, mpc):
        self.sampa_converter.convert_to_phonetic_transcription(word, msd, mpc)
