...
if __name__ == "__main__":
    onenet = OneNet()
    onenet.set_get_url("http://api.heclouds.com/devices")
    onenet.set_get_device("1184037843")
    onenet.set_datastream_id("Longitude")
    onenet.set_limit(3)
    onenet.set_authorization(
        "version=2018-10-31&res=products%2F625345&et=1708148372&method=sha1&sign=ErqWNzsypfIR2glza9DGbrVOMf0%3D")
    onenet.set_time_delta_milliseconds(845764631)
    print(onenet.Getdata())

    onenet.set_push_url("https://api.heclouds.com/cmds?device_id=")
    onenet.set_push_device("1184037843")
    onenet.set_masterkey("l3B=eDzEyxgnOAvm6oJLs2nCGxE=")  # Replace with your master key
    print(onenet.Pushdata("[{key:272662}]"))
