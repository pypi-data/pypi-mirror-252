...
class GeneratePyproject(object):
    ...
    default_license_file : str
        path to a default license file
        will be a fallback if none provided in the 'src' dir of the project
    project_name : str
    ...
    set_license_file()
        ...
        If not found a copy of the default_license_file will be used.
        The copy of the default_license_file will be named 'license.txt'
    set_init_file()
    ...
    def set_license_file(self):
        ...
        # Make a copy of the default_license_file and name it 'license.txt'
        ...
        logging.warning("'src' dir in project dir does not contain a license file."
                        "Default licence file (MIT) used instead.")
...
def main():
    if not REPO_NAME:
        logging.error("REPO_NAME not set.")
        exit(2)

    version = verify_version(GITHUB_REF_NAME)
    if not version:
        logging.error(f"{str(GITHUB_REF_NAME)} is not a valid version.")
        exit(2)

    project_name = f"ste-test-{REPO_NAME}"
