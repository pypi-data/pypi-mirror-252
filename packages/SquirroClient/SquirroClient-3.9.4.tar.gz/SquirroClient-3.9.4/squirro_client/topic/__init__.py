...
class TopicApiBaseMixin:
    ...
    def _build_item_update(self, star, read, keywords, entities, title: Optional[str]):
    ...
    def modify_item(
        ...
        data = self._build_item_update(star, read, keywords, entities, title)
    ...
    def modify_items(
        ...
        for item_set in item_sets:
            ...
            for item in item_set:
                ...
                update = self._build_item_update(star, read, keywords, entities, title)
