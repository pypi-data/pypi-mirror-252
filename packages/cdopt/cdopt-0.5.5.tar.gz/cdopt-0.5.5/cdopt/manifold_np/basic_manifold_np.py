...
class basic_manifold_np(basic_manifold):
    """
    This class provides a framework for defining manifolds with NumPy numerical backbone.
    ...
    Methods:
        - C: Abstract method that defines constraints on the manifold. Must be implemented in subclasses.
        - v2m: Converts a flattened array to its manifold-shaped counterpart.
        - m2v: Flattens a manifold-shaped array into a vector.
        - array2tensor: Identity function here, as NumPy arrays are used directly.
        - tensor2array: Identity function here, as NumPy arrays are used directly.
        - Init_point: Generates a random point on the manifold.
    """
    def __init__(self,name,variable_shape, constraint_shape,  regularize_value = 0.01, safeguard_value = 0) -> None:
        self.name = name
        ...
        super().__init__(self.name,self.var_shape, self.con_shape,  regularize_value = self.regularize_value, safeguard_value = self.safeguard_value, backbone = 'autograd',)
...
class complex_basic_manifold_np(basic_manifold):
    """
    This class provides a framework for defining manifolds with NumPy numerical backbone, with support for complex numbers.
