...
class basic_manifold_jax(basic_manifold):
    """
        A class that extends basic_manifold to work with JAX for automatic differentiation.
        ...
        Attributes:
            ...
            - device: The JAX device to be used for computations.

        Methods:
            - C: Abstract method that defines constraints on the manifold. Must be implemented in subclasses.
            - v2m: Converts a flattened JAX array to its manifold-shaped counterpart.
            - m2v: Flattens a manifold-shaped JAX array into a vector.
            - Init_point: Generates a random point on the manifold using JAX's random module.
    """
...
class complex_basic_manifold_jax(complex_basic_manifold):
    """
    A class that extends complex_basic_manifold to work with complex numbers in JAX.

    This class provides similar functionality to basic_manifold_jax but is tailored for complex manifolds.
    """
    ...
    def Init_point(self, Xinit = None, seed = 0):
        # The random function in JAX requires explicit configuration of the random seed. 
        # We fix random seed to 0 as our default setting.  
