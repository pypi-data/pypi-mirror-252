...
from .utils import wvt_identical
...
class RNNBase_cdopt(Module):
    ...
    def __init__(self, mode: str, input_size: int, hidden_size: int,
                 ...
                 device=None, dtype=None, manifold_class = euclidean_torch, penalty_param = 0, weight_var_transfer = wvt_identical, manifold_args = {}) -> None:
        ...
        self.manifold = manifold_class(self.var_shape,  device= device, dtype= dtype,**self.manifold_args)
...
class RNNCellBase_cdopt(Module):
    ...
    def __init__(self, input_size: int, hidden_size: int, bias: bool, num_chunks: int,
        ...
        self.feasibility = lambda : torch.linalg.norm(self.C(self.weight_hh).flatten())
...
class RNNCell_cdopt(RNNCellBase_cdopt):
    ...
    def __init__(self, input_size: int, hidden_size: int, bias: bool = True, nonlinearity: str = "tanh",
        ...
        factory_kwargs = {'device': device, 'dtype': dtype}
        super(RNNCell_cdopt, self).__init__(input_size, hidden_size, bias, num_chunks=1, device=device, dtype=dtype, manifold_class= manifold_class, penalty_param = penalty_param, manifold_args = manifold_args )
...
class LSTMCell_cdopt(RNNCellBase_cdopt):
    ...
    def __init__(self, input_size: int, hidden_size: int, bias: bool = True,
                 device=None, dtype=None, manifold_class = euclidean_torch, penalty_param = 0, manifold_args = {}) -> None:
        factory_kwargs = {'device': device, 'dtype': dtype}
        super(LSTMCell_cdopt, self).__init__(input_size, hidden_size, bias, num_chunks=4,  device=device, dtype=dtype, 
        manifold_class= manifold_class, penalty_param = penalty_param, manifold_args = manifold_args)
...
class GRUCell_cdopt(RNNCellBase_cdopt):
    ...
    def __init__(self, input_size: int, hidden_size: int, bias: bool = True,
                 device=None, dtype=None,  manifold_class = euclidean_torch, penalty_param = 0, manifold_args ={}) -> None:
        factory_kwargs = {'device': device, 'dtype': dtype}
        super(GRUCell_cdopt, self).__init__(input_size, hidden_size, bias, num_chunks=3, device=device, dtype=dtype, 
        manifold_class= manifold_class, penalty_param=penalty_param, manifold_args=manifold_args)
