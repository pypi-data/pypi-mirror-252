...
class BaseReportingMixin:
    ...
    def plot_segmented_loss(
        ...
        feyn.plots.plot_segmented_loss(
            self, data, by=by, loss_function=loss_function, title=title, ax=ax, figsize=figsize, filename=filename
        )
    ...
    def plot_probability_scores(
        ...
        **kwargs
        ...
        feyn.plots.plot_probability_scores(true, pred, title, nbins, ax, figsize, filename,**kwargs)
