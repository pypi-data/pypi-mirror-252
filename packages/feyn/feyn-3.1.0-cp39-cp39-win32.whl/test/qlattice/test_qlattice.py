...
class TestQLattice(unittest.TestCase):
    ...
    def test_can_sample_classification_models_from_qlattice(self):
        ql = QLattice()
        models = ql.sample_models(["age", "smoker", "sex"], "charges", kind="classification", max_complexity=2)

        self.assertTrue(models)

    def test_can_sample_regression_models_from_qlattice(self):
        ql = QLattice()
        models = ql.sample_models(["age", "smoker", "sex"], "charges", kind="regression", max_complexity=2)
    ...
    def test_lattice_auto_run_validates_data(self):
        ...
        with self.assertRaises(ValueError):
            models = ql.auto_run(data, "insurable", "classification", max_complexity=2, n_epochs=1)
    ...
    def test_update_lattice_with_models(self):
        ...
        models = ql.sample_models(["age", "smoker", "insurable"], "insurable", max_complexity=2)
    ...
    def test_can_sample_models_with_function_names(self):
        ...
        models = ql.sample_models(columns, 'smoker', max_complexity=2, function_names=fnames)
        self.assertTrue(models)
    ...
    def test_can_sample_models_with_query(self):
        ...
        models = ql.sample_models(list("xy"), "out", max_complexity=3, query_string="'x' + 'y'")
    ...
    def test_cant_sample_models_with_complex_query(self):
        ...
        with self.assertRaises(ValueError):
            _ = ql.sample_models(list("xy"), "out", max_complexity=3, query_string="'x' + func('y')")
