...
# Definition of the ConfigManager class responsible for handling configuration data
class ConfigManager:
    # Default configuration settings used by Penelopa project
    DEFAULT_CONFIG = {        'project': 'penelopa-project',
        'path': os.getcwd(),
