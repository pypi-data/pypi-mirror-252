...
import pyprocessors_q_and_a


# -- Project information -----------------------------------------------------

project = "pyprocessors_q_and_a"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyprocessors_q_and_a.__version__
release = pyprocessors_q_and_a.__version__
...
apidoc_module_dir = os.path.dirname(pyprocessors_q_and_a.__file__)
