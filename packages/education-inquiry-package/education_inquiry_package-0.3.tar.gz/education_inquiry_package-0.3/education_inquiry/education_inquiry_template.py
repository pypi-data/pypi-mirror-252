...
def get_user_response(user_query):
    ...
    # Load GloVe model
    glove_model_path = 'D:/Aditi/Education Inquiry/Experiment/Feature_Experiment/2-intent-demo/final-template/glove.6B.300d.txt'
    glove_model = KeyedVectors.load_word2vec_format(glove_model_path, binary=False, limit=None, no_header=True)

    # Load your DataFrame
    df = pd.read_csv('2-intent-dataset-basic-dictionary.csv')
    ...
    # Load ML model
    ml_model_path = "2-intent-demo-intent-classification.pkl"
