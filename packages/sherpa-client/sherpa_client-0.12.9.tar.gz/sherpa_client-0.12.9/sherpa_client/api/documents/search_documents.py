...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[DocumentHits]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[DocumentHits]:
    return Response(
