...
from pyrogramv2.crypto import aes, rsa, prime
from pyrogramv2.errors import SecurityCheckMismatch
from pyrogramv2.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "pyrogramv2.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
