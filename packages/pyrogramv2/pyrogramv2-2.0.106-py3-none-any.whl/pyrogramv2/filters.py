...
from pyrogramv2.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "pyrogramv2.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~pyrogramv2.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~pyrogramv2.handlers.MessageHandler` the *update* argument will be a :obj:`~pyrogramv2.types.Message`; in a :obj:`~pyrogramv2.handlers.CallbackQueryHandler` the *update* will be a :obj:`~pyrogramv2.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~pyrogramv2.filters.command` or :meth:`~pyrogramv2.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~pyrogramv2.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~pyrogramv2.types.Document` objects."""
...
"""Filter messages that contain :obj:`~pyrogramv2.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~pyrogramv2.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~pyrogramv2.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~pyrogramv2.types.Game` objects."""
...
"""Filter messages that contain :obj:`~pyrogramv2.types.Video` objects."""
...
"""Filter messages that contain :obj:`~pyrogramv2.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~pyrogramv2.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~pyrogramv2.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~pyrogramv2.types.Location` objects."""
...
"""Filter messages that contain :obj:`~pyrogramv2.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~pyrogramv2.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~pyrogramv2.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~pyrogramv2.types.Message`.
    ...
    async def func(flt, client: pyrogramv2.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~pyrogramv2.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~pyrogramv2.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~pyrogramv2.types.InlineQuery`: The filter will match ``query``.
