...
class ExportChatlistInvite(TLObject):  # type: ignore
    ...
    Parameters:
        chatlist (:obj:`InputChatlist <pyrogramv2.raw.base.InputChatlist>`):
            N/A

        title (``str``):
            N/A

        peers (List of :obj:`InputPeer <pyrogramv2.raw.base.InputPeer>`):
            N/A

    Returns:
        :obj:`chatlists.ExportedChatlistInvite <pyrogramv2.raw.base.chatlists.ExportedChatlistInvite>`
    """
