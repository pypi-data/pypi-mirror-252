...
class JoinGroupCall(TLObject):  # type: ignore
    ...
    Parameters:
        call (:obj:`InputGroupCall <pyrogramv2.raw.base.InputGroupCall>`):
            N/A

        join_as (:obj:`InputPeer <pyrogramv2.raw.base.InputPeer>`):
            N/A

        params (:obj:`DataJSON <pyrogramv2.raw.base.DataJSON>`):
            N/A
