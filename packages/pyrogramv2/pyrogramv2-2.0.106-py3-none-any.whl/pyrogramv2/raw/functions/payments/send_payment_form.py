...
class SendPaymentForm(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        credentials (:obj:`InputPaymentCredentials <pyrogramv2.raw.base.InputPaymentCredentials>`):
            N/A
    ...
    Returns:
        :obj:`payments.PaymentResult <pyrogramv2.raw.base.payments.PaymentResult>`
    """
