...
class RecoverPassword(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        new_settings (:obj:`account.PasswordInputSettings <pyrogramv2.raw.base.account.PasswordInputSettings>`, *optional*):
            N/A

    Returns:
        :obj:`auth.Authorization <pyrogramv2.raw.base.auth.Authorization>`
    """
