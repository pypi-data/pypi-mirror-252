...
class GetAdminLog(TLObject):  # type: ignore
    ...
    Parameters:
        channel (:obj:`InputChannel <pyrogramv2.raw.base.InputChannel>`):
            N/A
        ...
        events_filter (:obj:`ChannelAdminLogEventsFilter <pyrogramv2.raw.base.ChannelAdminLogEventsFilter>`, *optional*):
            N/A

        admins (List of :obj:`InputUser <pyrogramv2.raw.base.InputUser>`, *optional*):
            N/A

    Returns:
        :obj:`channels.AdminLogResults <pyrogramv2.raw.base.channels.AdminLogResults>`
    """
