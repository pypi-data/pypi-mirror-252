...
class GetParticipants(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        filter (:obj:`ChannelParticipantsFilter <pyrogramv2.raw.base.ChannelParticipantsFilter>`):
            N/A
    ...
    Returns:
        :obj:`channels.ChannelParticipants <pyrogramv2.raw.base.channels.ChannelParticipants>`
    """
