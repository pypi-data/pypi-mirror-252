...
class SetPrivacy(TLObject):  # type: ignore
    ...
    Parameters:
        key (:obj:`InputPrivacyKey <pyrogramv2.raw.base.InputPrivacyKey>`):
            N/A

        rules (List of :obj:`InputPrivacyRule <pyrogramv2.raw.base.InputPrivacyRule>`):
            N/A

    Returns:
        :obj:`account.PrivacyRules <pyrogramv2.raw.base.account.PrivacyRules>`
    """
