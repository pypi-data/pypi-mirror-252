...
class InitConnection(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        query (Any function from :obj:`~pyrogramv2.raw.functions`):
            N/A

        proxy (:obj:`InputClientProxy <pyrogramv2.raw.base.InputClientProxy>`, *optional*):
            N/A

        params (:obj:`JSONValue <pyrogramv2.raw.base.JSONValue>`, *optional*):
            N/A

    Returns:
        Any object from :obj:`~pyrogramv2.raw.types`
    """
