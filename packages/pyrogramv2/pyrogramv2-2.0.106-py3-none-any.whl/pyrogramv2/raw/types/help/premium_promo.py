...
class PremiumPromo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramv2.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        ...
        status_entities (List of :obj:`MessageEntity <pyrogramv2.raw.base.MessageEntity>`):
            N/A

        video_sections (List of ``str``):
            N/A

        videos (List of :obj:`Document <pyrogramv2.raw.base.Document>`):
            N/A

        period_options (List of :obj:`PremiumSubscriptionOption <pyrogramv2.raw.base.PremiumSubscriptionOption>`):
            N/A
