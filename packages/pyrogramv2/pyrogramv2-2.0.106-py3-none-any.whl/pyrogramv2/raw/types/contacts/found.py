...
class Found(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramv2.raw.base.contacts.Found`.
    ...
    Parameters:
        my_results (List of :obj:`Peer <pyrogramv2.raw.base.Peer>`):
            N/A

        results (List of :obj:`Peer <pyrogramv2.raw.base.Peer>`):
            N/A
