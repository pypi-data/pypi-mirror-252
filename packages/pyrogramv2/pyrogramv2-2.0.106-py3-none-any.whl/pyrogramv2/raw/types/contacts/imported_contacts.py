...
class ImportedContacts(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramv2.raw.base.contacts.ImportedContacts`.
    ...
    Parameters:
        imported (List of :obj:`ImportedContact <pyrogramv2.raw.base.ImportedContact>`):
            N/A

        popular_invites (List of :obj:`PopularContact <pyrogramv2.raw.base.PopularContact>`):
            N/A
