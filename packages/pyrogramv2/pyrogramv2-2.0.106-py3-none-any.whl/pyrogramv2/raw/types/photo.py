...
class Photo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramv2.raw.base.Photo`.
    ...
    Parameters:
        ...
        sizes (List of :obj:`PhotoSize <pyrogramv2.raw.base.PhotoSize>`):
            N/A
        ...
        video_sizes (List of :obj:`VideoSize <pyrogramv2.raw.base.VideoSize>`, *optional*):
            N/A
