...
class Document(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramv2.raw.base.Document`.
    ...
    Parameters:
        ...
        thumbs (List of :obj:`PhotoSize <pyrogramv2.raw.base.PhotoSize>`, *optional*):
            N/A

        video_thumbs (List of :obj:`VideoSize <pyrogramv2.raw.base.VideoSize>`, *optional*):
            N/A
