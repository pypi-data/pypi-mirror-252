...
class PollResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramv2.raw.base.PollResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`PollAnswerVoters <pyrogramv2.raw.base.PollAnswerVoters>`, *optional*):
            N/A
        ...
        solution_entities (List of :obj:`MessageEntity <pyrogramv2.raw.base.MessageEntity>`, *optional*):
            N/A
