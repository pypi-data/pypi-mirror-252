...
class PageBlockRelatedArticles(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramv2.raw.base.PageBlock`.
    ...
    Parameters:
        title (:obj:`RichText <pyrogramv2.raw.base.RichText>`):
            N/A

        articles (List of :obj:`PageRelatedArticle <pyrogramv2.raw.base.PageRelatedArticle>`):
            N/A
