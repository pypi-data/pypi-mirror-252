...
class Page(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramv2.raw.base.Page`.
    ...
    Parameters:
        ...
        blocks (List of :obj:`PageBlock <pyrogramv2.raw.base.PageBlock>`):
            N/A

        photos (List of :obj:`Photo <pyrogramv2.raw.base.Photo>`):
            N/A
