...
class AuthorizationForm(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramv2.raw.base.account.AuthorizationForm`.
    ...
    Parameters:
        required_types (List of :obj:`SecureRequiredType <pyrogramv2.raw.base.SecureRequiredType>`):
            N/A

        values (List of :obj:`SecureValue <pyrogramv2.raw.base.SecureValue>`):
            N/A

        errors (List of :obj:`SecureValueError <pyrogramv2.raw.base.SecureValueError>`):
            N/A
