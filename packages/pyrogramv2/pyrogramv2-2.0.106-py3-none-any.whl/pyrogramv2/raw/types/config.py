...
class Config(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramv2.raw.base.Config`.
    ...
    Parameters:
        ...
        dc_options (List of :obj:`DcOption <pyrogramv2.raw.base.DcOption>`):
            N/A
        ...
        reactions_default (:obj:`Reaction <pyrogramv2.raw.base.Reaction>`, *optional*):
            N/A
