...
class ChannelAdminLogEventActionParticipantToggleAdmin(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramv2.raw.base.ChannelAdminLogEventAction`.
    ...
    Parameters:
        prev_participant (:obj:`ChannelParticipant <pyrogramv2.raw.base.ChannelParticipant>`):
            N/A

        new_participant (:obj:`ChannelParticipant <pyrogramv2.raw.base.ChannelParticipant>`):
            N/A
