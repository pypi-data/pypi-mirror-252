...
class ChatInvite(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramv2.raw.base.ChatInvite`.
    ...
    Parameters:
        ...
        photo (:obj:`Photo <pyrogramv2.raw.base.Photo>`):
            N/A
        ...
        participants (List of :obj:`User <pyrogramv2.raw.base.User>`, *optional*):
            N/A
