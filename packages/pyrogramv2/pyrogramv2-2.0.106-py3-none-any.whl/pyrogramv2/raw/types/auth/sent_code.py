...
class SentCode(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramv2.raw.base.auth.SentCode`.
    ...
    Parameters:
        type (:obj:`auth.SentCodeType <pyrogramv2.raw.base.auth.SentCodeType>`):
            N/A

        phone_code_hash (``str``):
            N/A

        next_type (:obj:`auth.CodeType <pyrogramv2.raw.base.auth.CodeType>`, *optional*):
            N/A
