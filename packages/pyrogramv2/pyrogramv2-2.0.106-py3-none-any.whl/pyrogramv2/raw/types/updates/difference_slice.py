...
class DifferenceSlice(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramv2.raw.base.updates.Difference`.
    ...
    Parameters:
        new_messages (List of :obj:`Message <pyrogramv2.raw.base.Message>`):
            N/A

        new_encrypted_messages (List of :obj:`EncryptedMessage <pyrogramv2.raw.base.EncryptedMessage>`):
            N/A

        other_updates (List of :obj:`Update <pyrogramv2.raw.base.Update>`):
            N/A
        ...
        intermediate_state (:obj:`updates.State <pyrogramv2.raw.base.updates.State>`):
            N/A
