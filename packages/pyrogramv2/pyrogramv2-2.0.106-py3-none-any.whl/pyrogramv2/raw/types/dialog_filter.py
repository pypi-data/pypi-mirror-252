...
class DialogFilter(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramv2.raw.base.DialogFilter`.
    ...
    Parameters:
        ...
        pinned_peers (List of :obj:`InputPeer <pyrogramv2.raw.base.InputPeer>`):
            N/A

        include_peers (List of :obj:`InputPeer <pyrogramv2.raw.base.InputPeer>`):
            N/A

        exclude_peers (List of :obj:`InputPeer <pyrogramv2.raw.base.InputPeer>`):
            N/A
