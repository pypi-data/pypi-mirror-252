...
class TopPeerCategoryPeers(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramv2.raw.base.TopPeerCategoryPeers`.
    ...
    Parameters:
        category (:obj:`TopPeerCategory <pyrogramv2.raw.base.TopPeerCategory>`):
            N/A

        count (``int`` ``32-bit``):
            N/A

        peers (List of :obj:`TopPeer <pyrogramv2.raw.base.TopPeer>`):
            N/A
