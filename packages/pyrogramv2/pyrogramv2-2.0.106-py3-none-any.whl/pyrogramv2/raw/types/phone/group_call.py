...
class GroupCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramv2.raw.base.phone.GroupCall`.
    ...
    Parameters:
        call (:obj:`GroupCall <pyrogramv2.raw.base.GroupCall>`):
            N/A

        participants (List of :obj:`GroupCallParticipant <pyrogramv2.raw.base.GroupCallParticipant>`):
            N/A
