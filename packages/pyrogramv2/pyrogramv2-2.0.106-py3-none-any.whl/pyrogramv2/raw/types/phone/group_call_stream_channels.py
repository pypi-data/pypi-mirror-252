...
class GroupCallStreamChannels(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramv2.raw.base.phone.GroupCallStreamChannels`.
    ...
    Parameters:
        channels (List of :obj:`GroupCallStreamChannel <pyrogramv2.raw.base.GroupCallStreamChannel>`):
            N/A
