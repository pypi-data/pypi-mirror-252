...
class ChatlistInviteAlready(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramv2.raw.base.chatlists.ChatlistInvite`.
    ...
    Parameters:
        ...
        missing_peers (List of :obj:`Peer <pyrogramv2.raw.base.Peer>`):
            N/A

        already_peers (List of :obj:`Peer <pyrogramv2.raw.base.Peer>`):
            N/A
