...
class MessageReactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramv2.raw.base.MessageReactions`.
    ...
    Parameters:
        results (List of :obj:`ReactionCount <pyrogramv2.raw.base.ReactionCount>`):
            N/A
        ...
        recent_reactions (List of :obj:`MessagePeerReaction <pyrogramv2.raw.base.MessagePeerReaction>`, *optional*):
            N/A
