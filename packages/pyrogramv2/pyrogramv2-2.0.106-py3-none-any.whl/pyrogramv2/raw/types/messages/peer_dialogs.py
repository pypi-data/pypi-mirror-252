...
class PeerDialogs(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramv2.raw.base.messages.PeerDialogs`.
    ...
    Parameters:
        dialogs (List of :obj:`Dialog <pyrogramv2.raw.base.Dialog>`):
            N/A

        messages (List of :obj:`Message <pyrogramv2.raw.base.Message>`):
            N/A
