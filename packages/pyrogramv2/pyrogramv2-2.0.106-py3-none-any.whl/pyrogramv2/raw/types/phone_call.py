...
class PhoneCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramv2.raw.base.PhoneCall`.
    ...
    Parameters:
        ...
        protocol (:obj:`PhoneCallProtocol <pyrogramv2.raw.base.PhoneCallProtocol>`):
            N/A

        connections (List of :obj:`PhoneConnection <pyrogramv2.raw.base.PhoneConnection>`):
            N/A
