...
import pyrogramv2
from pyrogramv2 import __version__, __license__
from pyrogramv2 import enums
from pyrogramv2 import raw
from pyrogramv2 import utils
from pyrogramv2.crypto import aes
from pyrogramv2.errors import CDNFileHashMismatch
from pyrogramv2.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    BadRequest
)
from pyrogramv2.handlers.handler import Handler
from pyrogramv2.methods import Methods
from pyrogramv2.session import Auth, Session
from pyrogramv2.storage import FileStorage, MemoryStorage
from pyrogramv2.types import User, TermsOfService
from pyrogramv2.utils import ainput
...
class Client(Methods):
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~pyrogramv2.Client.export_session_string` before stopping the client to get a session string you can
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~pyrogramv2.enums.ParseMode`):
    ...
    async def get_file(
        ...
        async with self.get_file_semaphore:
            ...
            except pyrogramv2.StopTransmission:
                raise
            except Exception as e:
                log.exception(e)
            finally:
