...
class ResendCode:
    async def resend_code(
        ...
        :obj:`~pyrogramv2.types.SentCode` object returned by :meth:`send_code`.
        ...
        Returns:
            :obj:`~pyrogramv2.types.SentCode`: On success, an object containing information on the re-sent confirmation
            code is returned.
