...
import pyrogramv2
from pyrogramv2 import StopTransmission, enums
from pyrogramv2 import raw
from pyrogramv2 import types
from pyrogramv2 import utils
from pyrogramv2.errors import FilePartMissing
from pyrogramv2.file_id import FileType


class SendAudio:
    async def send_audio(
        self: "pyrogramv2.Client",
        ...
        For sending voice messages, use the :meth:`~pyrogramv2.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~pyrogramv2.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~pyrogramv2.Client.stop_transmission`, None is returned.
