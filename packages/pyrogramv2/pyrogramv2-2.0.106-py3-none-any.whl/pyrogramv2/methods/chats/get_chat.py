...
class GetChat:
    async def get_chat(
        ...
        Returns:
            :obj:`~pyrogramv2.types.Chat` | :obj:`~pyrogramv2.types.ChatPreview`: On success, if you've already joined the chat, a chat object is returned,
        ...
        Example:
            .. code-block:: python
                ...
                chat = await app.get_chat("pyrogramv2")
                print(chat)
        """
