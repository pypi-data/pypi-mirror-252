...
import pyrogramv2
from pyrogramv2.methods.utilities.idle import idle
...
class Run:
    def run(
        ...
        :meth:`~pyrogramv2.Client.start`, :meth:`~pyrogramv2.idle` and :meth:`~pyrogramv2.Client.stop` in sequence.
        ...
        If you want to run multiple clients at once, see :meth:`pyrogramv2.compose`.
