...
class CreateChatInviteLink:
    async def create_chat_invite_link(
        ...
        The link can be revoked using the method :meth:`~pyrogramv2.Client.revoke_chat_invite_link`.
        ...
        Returns:
            :obj:`~pyrogramv2.types.ChatInviteLink`: On success, the new invite link is returned.
