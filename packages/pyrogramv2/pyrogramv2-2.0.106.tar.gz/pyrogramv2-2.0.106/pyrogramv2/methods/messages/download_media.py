...
from pyrogramv2.file_id import FileId, FileType, PHOTO_TYPES
...
class DownloadMedia:
    async def download_media(
        ...
        Parameters:
            message (:obj:`~pyrogramv2.types.Message` | ``str``):
        ...
        Returns:
            ...
            :meth:`~pyrogramv2.Client.stop_transmission`, None is returned.
