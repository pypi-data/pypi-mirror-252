...
class SendAnimation:
    async def send_animation(
        ...
        Returns:
            :obj:`~pyrogramv2.types.Message` | ``None``: On success, the sent animation message is returned, otherwise,
            in case the upload is deliberately stopped with :meth:`~pyrogramv2.Client.stop_transmission`, None is
            returned.
