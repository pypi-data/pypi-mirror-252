...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~pyrogramv2.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~pyrogramv2.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~pyrogramv2.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "pyrogramv2". Get the first 50 results
                async for message in app.search_global("pyrogramv2", limit=50):
                    print(message.text)
