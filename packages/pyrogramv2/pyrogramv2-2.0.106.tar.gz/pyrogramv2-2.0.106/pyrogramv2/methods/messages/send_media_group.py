...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~pyrogramv2.types.InputMediaPhoto`, :obj:`~pyrogramv2.types.InputMediaVideo`, :obj:`~pyrogramv2.types.InputMediaAudio` and :obj:`~pyrogramv2.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~pyrogramv2.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from pyrogramv2.types import InputMediaPhoto, InputMediaVideo
