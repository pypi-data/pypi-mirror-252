...
class Restart:
    async def restart(
        ...
        This method will first call :meth:`~pyrogramv2.Client.stop` and then :meth:`~pyrogramv2.Client.start` in a row in
        ...
        Returns:
            :obj:`~pyrogramv2.Client`: The restarted client itself.
