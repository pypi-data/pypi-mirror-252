...
import pyrogramv2
from pyrogramv2 import raw, types
...
class GetBotCommands:
    async def get_bot_commands(
        ...
        Parameters:
            scope (:obj:`~pyrogramv2.types.BotCommandScope`, *optional*):
                An object describing the scope of users for which the commands are relevant.
                Defaults to :obj:`~pyrogramv2.types.BotCommandScopeDefault`.
        ...
        Returns:
            List of :obj:`~pyrogramv2.types.BotCommand`: On success, the list of bot commands is returned.
