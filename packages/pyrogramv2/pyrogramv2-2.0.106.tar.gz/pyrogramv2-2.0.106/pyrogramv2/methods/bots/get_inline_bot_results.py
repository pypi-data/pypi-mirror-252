...
from pyrogramv2.errors import UnknownError
...
class GetInlineBotResults:
    async def get_inline_bot_results(
        ...
        You can then send a result using :meth:`~pyrogramv2.Client.send_inline_bot_result`
        ...
        Returns:
            :obj:`BotResults <pyrogramv2.api.types.messages.BotResults>`: On Success.
        ...
        Example:
            .. code-block:: python
                ...
                results = await app.get_inline_bot_results("pyrogramv2bot")
                print(results)
        """
