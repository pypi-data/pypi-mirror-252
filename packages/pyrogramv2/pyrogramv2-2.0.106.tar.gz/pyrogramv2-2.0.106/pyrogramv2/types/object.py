...
class Object:
    def __init__(self, client: "pyrogramv2.Client" = None):
        self._client = client

    def bind(self, client: "pyrogramv2.Client"):
        """Bind a Client instance to this and to all nested Pyrogram objects.

        Parameters:
            client (:obj:`~pyrogramv2.types.Client`):
    ...
    def default(obj: "Object"):
        ...
        # https://t.me/pyrogramv2chat/167281
    ...
    def __repr__(self) -> str:
        return "pyrogramv2.types.{}({})".format(
