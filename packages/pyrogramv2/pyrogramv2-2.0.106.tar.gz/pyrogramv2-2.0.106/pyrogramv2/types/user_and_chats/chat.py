...
class Chat(Object):
    ...
    Parameters:
        ...
        type (:obj:`~pyrogramv2.enums.ChatType`):
            Type of chat.
        ...
        photo (:obj:`~pyrogramv2.types.ChatPhoto`, *optional*):
            Chat photo. Suitable for downloads only.

        bio (``str``, *optional*):
            Bio of the other party in a private chat.
            Returned only in :meth:`~pyrogramv2.Client.get_chat`.
        ...
        restrictions (List of :obj:`~pyrogramv2.types.Restriction`, *optional*):
            The list of reasons why this chat might be unavailable to some users.
            This field is available only in case *is_restricted* is True.

        permissions (:obj:`~pyrogramv2.types.ChatPermissions` *optional*):
            Default chat member permissions, for groups and supergroups.

        distance (``int``, *optional*):
            Distance in meters of this group chat from your location.
            Returned only in :meth:`~pyrogramv2.Client.get_nearby_chats`.

        linked_chat (:obj:`~pyrogramv2.types.Chat`, *optional*):
            The linked discussion group (in case of channels) or the linked channel (in case of supergroups).
            Returned only in :meth:`~pyrogramv2.Client.get_chat`.

        send_as_chat (:obj:`~pyrogramv2.types.Chat`, *optional*):
            The default "send_as" chat.
            Returned only in :meth:`~pyrogramv2.Client.get_chat`.

        available_reactions (:obj:`~pyrogramv2.types.ChatReactions`, *optional*):
    ...
    async def archive(self):
        """Bound method *archive* of :obj:`~pyrogramv2.types.Chat`.
    ...
    async def unarchive(self):
        """Bound method *unarchive* of :obj:`~pyrogramv2.types.Chat`.
    ...
    async def set_title(self, title: str) -> bool:
        """Bound method *set_title* of :obj:`~pyrogramv2.types.Chat`.
    ...
    async def set_description(self, description: str) -> bool:
        """Bound method *set_description* of :obj:`~pyrogramv2.types.Chat`.
    ...
    async def set_photo(
        ...
        *,
        ...
        """Bound method *set_photo* of :obj:`~pyrogramv2.types.Chat`.
        ...
        Parameters:
            photo (``str`` | ``BinaryIO``, *optional*):
                New chat photo. You can pass a :obj:`~pyrogramv2.types.Photo` file_id, a file path to upload a new photo
                from your local machine or a binary file-like object with its attribute
                ".name" set for in-memory uploads.

            video (``str`` | ``BinaryIO``, *optional*):
                New chat video. You can pass a :obj:`~pyrogramv2.types.Video` file_id, a file path to upload a new video
                from your local machine or a binary file-like object with its attribute
                ".name" set for in-memory uploads.
    ...
    async def ban_member(
        ...
        """Bound method *ban_member* of :obj:`~pyrogramv2.types.Chat`.
        ...
        Returns:
            :obj:`~pyrogramv2.types.Message` | ``bool``: On success, a service message will be returned (when applicable), otherwise, in
    ...
    async def unban_member(
        ...
        """Bound method *unban_member* of :obj:`~pyrogramv2.types.Chat`.
    ...
    async def restrict_member(
        ...
        Parameters:
            ...
            permissions (:obj:`~pyrogramv2.types.ChatPermissions`):
        ...
        Returns:
            :obj:`~pyrogramv2.types.Chat`: On success, a chat object is returned.
    ...
    async def promote_member(
        ...
        """Bound method *promote_member* of :obj:`~pyrogramv2.types.Chat`.
        ...
        Parameters:
            ...
            privileges (:obj:`~pyrogramv2.types.ChatPrivileges`, *optional*):
                New user privileges.
    ...
    async def join(self):
        """Bound method *join* of :obj:`~pyrogramv2.types.Chat`.
    ...
    async def leave(self):
        """Bound method *leave* of :obj:`~pyrogramv2.types.Chat`.
    ...
    async def export_invite_link(self):
        """Bound method *export_invite_link* of :obj:`~pyrogramv2.types.Chat`.
    ...
    async def get_member(
        ...
        """Bound method *get_member* of :obj:`~pyrogramv2.types.Chat`.
        ...
        Returns:
            :obj:`~pyrogramv2.types.ChatMember`: On success, a chat member is returned.
        """
    ...
    def get_members(
        ...
        """Bound method *get_members* of :obj:`~pyrogramv2.types.Chat`.
        ...
        Parameters:
            query (``str``, *optional*):
                ...
                A query string is applicable only for :obj:`~pyrogramv2.enums.ChatMembersFilter.SEARCH`,
                :obj:`~pyrogramv2.enums.ChatMembersFilter.BANNED` and :obj:`~pyrogramv2.enums.ChatMembersFilter.RESTRICTED`
                filters only.

            limit (``int``, *optional*):
                Limits the number of members to be retrieved.

            filter (:obj:`~pyrogramv2.enums.ChatMembersFilter`, *optional*):
                Filter used to select the kind of members you want to retrieve. Only applicable for supergroups
                and channels.

        Returns:
            ``Generator``: On success, a generator yielding :obj:`~pyrogramv2.types.ChatMember` objects is returned.
        """
    ...
    async def add_members(
        ...
        """Bound method *add_members* of :obj:`~pyrogramv2.types.Chat`.
    ...
    async def mark_unread(self, ) -> bool:
        """Bound method *mark_unread* of :obj:`~pyrogramv2.types.Chat`.
    ...
    async def set_protected_content(self, enabled: bool) -> bool:
        """Bound method *set_protected_content* of :obj:`~pyrogramv2.types.Chat`.
    ...
    async def unpin_all_messages(self) -> bool:
        """Bound method *unpin_all_messages* of :obj:`~pyrogramv2.types.Chat`.
