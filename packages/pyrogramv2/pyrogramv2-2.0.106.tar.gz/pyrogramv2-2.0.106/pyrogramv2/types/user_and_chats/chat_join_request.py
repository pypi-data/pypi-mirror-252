...
class ChatJoinRequest(Object, Update):
    ...
    Parameters:
        chat (:obj:`~pyrogramv2.types.Chat`):
        ...
        invite_link (:obj:`~pyrogramv2.types.ChatInviteLink`, *optional*):
    ...
    async def approve(self) -> bool:
        """Bound method *approve* of :obj:`~pyrogramv2.types.ChatJoinRequest`.
    ...
    async def decline(self) -> bool:
        """Bound method *decline* of :obj:`~pyrogramv2.types.ChatJoinRequest`.
