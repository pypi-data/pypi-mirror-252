...
import pyrogramv2
from pyrogramv2 import enums, utils
...
class User(Object, Update):
    ...
    Parameters:
        ...
        status (:obj:`~pyrogramv2.enums.UserStatus`, *optional*):
            User's last seen & online status. ``None``, for bots.

        last_online_date (:py:obj:`~datetime.datetime`, *optional*):
            Last online date of a user. Only available in case status is :obj:`~pyrogramv2.enums.UserStatus.OFFLINE`.

        next_offline_date (:py:obj:`~datetime.datetime`, *optional*):
            Date when a user will automatically go offline. Only available in case status is :obj:`~pyrogramv2.enums.UserStatus.ONLINE`.
        ...
        emoji_status (:obj:`~pyrogramv2.types.EmojiStatus`, *optional*):
            Emoji status.
    ...
    async def archive(self):
        """Bound method *archive* of :obj:`~pyrogramv2.types.User`.
    ...
    async def unarchive(self):
        """Bound method *unarchive* of :obj:`~pyrogramv2.types.User`.
    ...
    def block(self):
        """Bound method *block* of :obj:`~pyrogramv2.types.User`.
    ...
    def unblock(self):
        """Bound method *unblock* of :obj:`~pyrogramv2.types.User`.
    ...
    def get_common_chats(self):
        """Bound method *get_common_chats* of :obj:`~pyrogramv2.types.User`.
