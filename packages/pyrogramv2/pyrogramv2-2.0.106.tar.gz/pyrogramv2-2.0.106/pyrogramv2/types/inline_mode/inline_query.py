...
class InlineQuery(Object, Update):
    ...
    Parameters:
        ...
        chat_type (:obj:`~pyrogramv2.enums.ChatType`, *optional*):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the query of this inline query. Only applicable when using :obj:`Filters.regex <pyrogramv2.Filters.regex>`.
    """
    ...
    async def answer(
        ...
        """Bound method *answer* of :obj:`~pyrogramv2.types.InlineQuery`.
        ...
        Parameters:
            results (List of :obj:`~pyrogramv2.types.InlineQueryResult`):
