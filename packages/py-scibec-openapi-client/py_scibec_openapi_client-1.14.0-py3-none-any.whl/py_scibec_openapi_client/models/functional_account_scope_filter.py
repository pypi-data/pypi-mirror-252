...
class FunctionalAccountScopeFilter(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of FunctionalAccountScopeFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of FunctionalAccountScopeFilter from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "where": obj.get("where"),
            "fields": AccessConfigScopeFilterFields.from_dict(obj.get("fields")) if obj.get("fields") is not None else None,
