...
class NewDevice(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["readACL", "writeACL", "owner", "createdAt", "createdBy", "name", "description", "parentId", "sessionId", "enabled", "readOnly", "softwareTrigger", "deviceClass", "deviceTags", "deviceConfig", "readoutPriority", "onFailure", "userParameter"]
