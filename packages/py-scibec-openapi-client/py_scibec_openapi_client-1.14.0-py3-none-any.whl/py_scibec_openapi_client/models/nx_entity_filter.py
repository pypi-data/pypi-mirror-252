...
class NXEntityFilter(BaseModel):
    """
    NXEntityFilter
    """ # noqa: E501
    ...
    fields: Optional[NXEntityFields] = None
    include: Optional[List[NXEntityIncludeFilterInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "fields": NXEntityFields.from_dict(obj.get("fields")) if obj.get("fields") is not None else None,
            "include": [NXEntityIncludeFilterInner.from_dict(_item) for _item in obj.get("include")] if obj.get("include") is not None else None
        })
        return _obj
