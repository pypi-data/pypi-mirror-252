...
class NXEntityWithRelations(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "subentries": [NXEntityWithRelations.from_dict(_item) for _item in obj.get("subentries")] if obj.get("subentries") is not None else None,
            "parent": NXEntityWithRelations.from_dict(obj.get("parent")) if obj.get("parent") is not None else None,
