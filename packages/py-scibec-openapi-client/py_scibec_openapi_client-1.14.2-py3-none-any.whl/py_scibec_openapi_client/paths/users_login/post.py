...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["principal", "password", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["principal", "password", ], str]):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _user_controller_login_oapg(
        self,
...
class UserControllerLogin(BaseApi):
    ...
    def user_controller_login(
        ...
        return self._user_controller_login_oapg(
            body=body,
