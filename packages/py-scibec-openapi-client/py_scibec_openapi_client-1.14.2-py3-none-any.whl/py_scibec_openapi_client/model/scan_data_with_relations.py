...
class ScanDataWithRelations(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id"], typing_extensions.Literal["readACL"], typing_extensions.Literal["writeACL"], typing_extensions.Literal["owner"], typing_extensions.Literal["createdAt"], typing_extensions.Literal["createdBy"], typing_extensions.Literal["name"], typing_extensions.Literal["data"], typing_extensions.Literal["filePath"], typing_extensions.Literal["scanId"], typing_extensions.Literal["scan"], str, ]):
