...
class ScanDataIncludeFilterItems(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def scope() -> typing.Type['ScanDataScopeFilter']:
                return ScanDataScopeFilter
            __annotations__ = {
                "relation": relation,
                "scope": scope,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["scope"]) -> 'ScanDataScopeFilter': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["scope"]) -> typing.Union['ScanDataScopeFilter', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        scope: typing.Union['ScanDataScopeFilter', schemas.Unset] = schemas.unset,
