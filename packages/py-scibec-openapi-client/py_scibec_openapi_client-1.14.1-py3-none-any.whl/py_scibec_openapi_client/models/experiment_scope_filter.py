...
class ExperimentScopeFilter(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ExperimentScopeFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ExperimentScopeFilter from a dict"""
        if obj is None:
            return None
