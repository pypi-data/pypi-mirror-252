...
class ExperimentFieldsOneOf(BaseModel):
    """
    ...
    beamline_id: Optional[StrictBool] = Field(default=None, alias="beamlineId")
    write_account: Optional[StrictBool] = Field(default=None, alias="writeAccount")
    user_id: Optional[StrictBool] = Field(default=None, alias="userId")
    logbook: Optional[StrictBool] = None
    samples: Optional[StrictBool] = None
    experiment_config: Optional[StrictBool] = Field(default=None, alias="experimentConfig")
    experiment_info: Optional[StrictBool] = Field(default=None, alias="experimentInfo")
    active_session: Optional[StrictBool] = Field(default=None, alias="activeSession")
    __properties: ClassVar[List[str]] = ["id", "readACL", "writeACL", "owner", "createdAt", "createdBy", "name", "beamlineId", "writeAccount", "userId", "logbook", "samples", "experimentConfig", "experimentInfo", "activeSession"]
