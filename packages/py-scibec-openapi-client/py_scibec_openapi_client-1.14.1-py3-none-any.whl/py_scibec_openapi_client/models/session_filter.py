...
class SessionFilter(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "fields": SessionFields.from_dict(obj.get("fields")) if obj.get("fields") is not None else None,
            "include": [SessionIncludeFilterInner.from_dict(_item) for _item in obj.get("include")] if obj.get("include") is not None else None
        })
        return _obj
