...
class NewExperiment(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["readACL", "writeACL", "owner", "createdAt", "createdBy", "name", "beamlineId", "writeAccount", "userId", "logbook", "samples", "experimentConfig", "experimentInfo", "activeSession"]
