...
class NewNXEntityNested(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["readACL", "writeACL", "owner", "createdAt", "createdBy", "name", "type", "description", "data", "NXclass", "parentId", "scanId", "subentries"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of NewNXEntityNested from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of NewNXEntityNested from a dict"""
        if obj is None:
            return None
