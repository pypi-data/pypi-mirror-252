...
class DeviceFilter(BaseModel):
    ...
    fields: Optional[DeviceFields] = None
    include: Optional[List[DeviceIncludeFilterInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "fields": DeviceFields.from_dict(obj.get("fields")) if obj.get("fields") is not None else None,
            "include": [DeviceIncludeFilterInner.from_dict(_item) for _item in obj.get("include")] if obj.get("include") is not None else None
        })
        return _obj
