...
class AccessAccountFilter1(BaseModel):
    """
    ...
    fields: Optional[AccessAccountFields] = None
    __properties: ClassVar[List[str]] = ["offset", "limit", "skip", "order", "where", "fields"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "where": obj.get("where"),
            "fields": AccessAccountFields.from_dict(obj.get("fields")) if obj.get("fields") is not None else None
        })
        return _obj
