...
class NewNXEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["readACL", "writeACL", "owner", "createdAt", "createdBy", "name", "type", "description", "data", "NXclass", "parentId", "scanId"]
