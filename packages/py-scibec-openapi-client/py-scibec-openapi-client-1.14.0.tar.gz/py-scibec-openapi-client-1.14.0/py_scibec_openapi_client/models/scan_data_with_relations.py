...
class ScanDataWithRelations(BaseModel):
    """
    (tsType: ScanDataWithRelations, schemaOptions: { includeRelations: true })
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "readACL", "writeACL", "owner", "createdAt", "createdBy", "name", "data", "filePath", "scanId", "scan"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ScanDataWithRelations from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ScanDataWithRelations from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "scan": ScanWithRelations.from_dict(obj.get("scan")) if obj.get("scan") is not None else None
        })
...
ScanDataWithRelations.model_rebuild(raise_errors=False)
