...
class AccessAccountFieldsOneOf(BaseModel):
    """
    AccessAccountFieldsOneOf
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "readACL", "writeACL", "owner", "createdAt", "createdBy", "name", "read", "write", "remote", "token", "isFunctional"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AccessAccountFieldsOneOf from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AccessAccountFieldsOneOf from a dict"""
        if obj is None:
            return None
