...
class ExperimentWithRelations(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "datasets": [SessionWithRelations.from_dict(_item) for _item in obj.get("datasets")] if obj.get("datasets") is not None else None,
            "scans": [ScanWithRelations.from_dict(_item) for _item in obj.get("scans")] if obj.get("scans") is not None else None,
            "experimentAccounts": [ExperimentAccountWithRelations.from_dict(_item) for _item in obj.get("experimentAccounts")] if obj.get("experimentAccounts") is not None else None,
            "sessions": [SessionWithRelations.from_dict(_item) for _item in obj.get("sessions")] if obj.get("sessions") is not None else None
        })
        return _obj
