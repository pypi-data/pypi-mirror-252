...
class TestScanWithRelations(unittest.TestCase):
    """ScanWithRelations unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScanWithRelations:
        """Test ScanWithRelations
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScanWithRelations`
        """
        model = ScanWithRelations()
        if include_optional:
    ...
    def testScanWithRelations(self):
        """Test ScanWithRelations"""
