...
class TestSessionWithRelations(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SessionWithRelations:
        """Test SessionWithRelations
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SessionWithRelations`
        """
        model = SessionWithRelations()
        if include_optional:
    ...
    def testSessionWithRelations(self):
        """Test SessionWithRelations"""
