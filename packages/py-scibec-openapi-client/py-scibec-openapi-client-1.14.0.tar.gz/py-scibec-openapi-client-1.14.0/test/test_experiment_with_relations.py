...
class TestExperimentWithRelations(unittest.TestCase):
    """ExperimentWithRelations unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExperimentWithRelations:
        """Test ExperimentWithRelations
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExperimentWithRelations`
        """
        model = ExperimentWithRelations()
        if include_optional:
    ...
    def testExperimentWithRelations(self):
        """Test ExperimentWithRelations"""
