...
class TestBeamlineWithRelations(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BeamlineWithRelations:
        """Test BeamlineWithRelations
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BeamlineWithRelations`
        """
        model = BeamlineWithRelations()
        if include_optional:
    ...
    def testBeamlineWithRelations(self):
        """Test BeamlineWithRelations"""
