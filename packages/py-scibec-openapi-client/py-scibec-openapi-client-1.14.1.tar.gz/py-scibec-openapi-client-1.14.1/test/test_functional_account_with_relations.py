...
class TestFunctionalAccountWithRelations(unittest.TestCase):
    """FunctionalAccountWithRelations unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FunctionalAccountWithRelations:
        """Test FunctionalAccountWithRelations
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FunctionalAccountWithRelations`
        """
        model = FunctionalAccountWithRelations()
        if include_optional:
            return FunctionalAccountWithRelations(
                ...
                is_functional = True,
                access_config_id = '',
                access_config = py_scibec_openapi_client.models.access_config_with_relations.AccessConfigWithRelations(
                    id = '', 
                    read_acl = [
                        ''
                        ], 
                    ...
                    use_passwords = True, 
                    beamline = py_scibec_openapi_client.models.beamline_with_relations.BeamlineWithRelations(
                        id = '', 
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        created_by = '', 
                        name = '', 
                        ...
                        experiments = [
                            py_scibec_openapi_client.models.experiment_with_relations.ExperimentWithRelations(
                                id = '', 
                                created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                                created_by = '', 
                                name = '', 
    ...
    def testFunctionalAccountWithRelations(self):
        """Test FunctionalAccountWithRelations"""
