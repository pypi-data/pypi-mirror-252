...
class TestExperimentAccountWithRelations(unittest.TestCase):
    """ExperimentAccountWithRelations unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExperimentAccountWithRelations:
        """Test ExperimentAccountWithRelations
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExperimentAccountWithRelations`
        """
        model = ExperimentAccountWithRelations()
        if include_optional:
    ...
    def testExperimentAccountWithRelations(self):
        """Test ExperimentAccountWithRelations"""
