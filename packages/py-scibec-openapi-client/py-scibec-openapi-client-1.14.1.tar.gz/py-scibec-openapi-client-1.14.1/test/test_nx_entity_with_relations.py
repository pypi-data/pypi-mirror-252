...
class TestNXEntityWithRelations(unittest.TestCase):
    """NXEntityWithRelations unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NXEntityWithRelations:
        """Test NXEntityWithRelations
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NXEntityWithRelations`
        """
        model = NXEntityWithRelations()
        if include_optional:
            return NXEntityWithRelations(
                ...
                scan_id = '',
                subentries = [
                    py_scibec_openapi_client.models.nx_entity_with_relations.NXEntityWithRelations(
                        id = '', 
                        read_acl = [
                            ''
                            ], 
                ...
                parent = py_scibec_openapi_client.models.nx_entity_with_relations.NXEntityWithRelations(
                    id = '', 
                    read_acl = [
                        ''
                        ], 
    ...
    def testNXEntityWithRelations(self):
        """Test NXEntityWithRelations"""
