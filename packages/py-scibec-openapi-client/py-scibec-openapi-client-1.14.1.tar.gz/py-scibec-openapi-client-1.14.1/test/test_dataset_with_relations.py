...
class TestDatasetWithRelations(unittest.TestCase):
    """DatasetWithRelations unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DatasetWithRelations:
        """Test DatasetWithRelations
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DatasetWithRelations`
        """
        model = DatasetWithRelations()
        if include_optional:
    ...
    def testDatasetWithRelations(self):
        """Test DatasetWithRelations"""
