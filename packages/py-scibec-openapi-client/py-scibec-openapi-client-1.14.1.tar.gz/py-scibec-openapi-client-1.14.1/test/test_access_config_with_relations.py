...
class TestAccessConfigWithRelations(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AccessConfigWithRelations:
        """Test AccessConfigWithRelations
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccessConfigWithRelations`
        """
        model = AccessConfigWithRelations()
        if include_optional:
    ...
    def testAccessConfigWithRelations(self):
        """Test AccessConfigWithRelations"""
