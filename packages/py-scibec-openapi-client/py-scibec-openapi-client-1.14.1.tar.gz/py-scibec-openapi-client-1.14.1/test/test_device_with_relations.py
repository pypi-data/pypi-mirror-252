...
class TestDeviceWithRelations(unittest.TestCase):
    """DeviceWithRelations unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceWithRelations:
        """Test DeviceWithRelations
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceWithRelations`
        """
        model = DeviceWithRelations()
        if include_optional:
            return DeviceWithRelations(
                ...
                subdevices = [
                    py_scibec_openapi_client.models.device_with_relations.DeviceWithRelations(
                        ...
                        on_failure = 'raise', 
                        user_parameter = py_scibec_openapi_client.models.user_parameter.userParameter(), 
                        parent = py_scibec_openapi_client.models.device_with_relations.DeviceWithRelations(
                            id = '', 
                            created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                            created_by = '', 
                            name = '', 
    ...
    def testDeviceWithRelations(self):
        """Test DeviceWithRelations"""
