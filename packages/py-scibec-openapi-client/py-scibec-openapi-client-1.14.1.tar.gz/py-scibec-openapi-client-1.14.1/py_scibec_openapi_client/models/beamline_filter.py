...
class BeamlineFilter(BaseModel):
    """
    BeamlineFilter
    """ # noqa: E501
    ...
    fields: Optional[BeamlineFields] = None
    include: Optional[List[BeamlineIncludeFilterInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "fields": BeamlineFields.from_dict(obj.get("fields")) if obj.get("fields") is not None else None,
            "include": [BeamlineIncludeFilterInner.from_dict(_item) for _item in obj.get("include")] if obj.get("include") is not None else None
        })
        return _obj
