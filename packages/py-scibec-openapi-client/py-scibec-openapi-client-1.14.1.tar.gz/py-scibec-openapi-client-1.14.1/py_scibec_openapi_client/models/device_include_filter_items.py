...
class DeviceIncludeFilterItems(BaseModel):
    """
    DeviceIncludeFilterItems
    """ # noqa: E501
    relation: Optional[StrictStr] = None
    scope: Optional[DeviceScopeFilter] = None
    ...
    def relation_validate_enum(cls, value):
        ...
        if value not in ('subdevices', 'parent', 'session'):
            raise ValueError("must be one of enum values ('subdevices', 'parent', 'session')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "scope": DeviceScopeFilter.from_dict(obj.get("scope")) if obj.get("scope") is not None else None
        })
        return _obj
