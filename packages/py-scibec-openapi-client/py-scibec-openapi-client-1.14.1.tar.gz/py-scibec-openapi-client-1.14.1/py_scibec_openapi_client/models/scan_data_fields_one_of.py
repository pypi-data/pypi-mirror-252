...
class ScanDataFieldsOneOf(BaseModel):
    """
    ScanDataFieldsOneOf
    """ # noqa: E501
    ...
    file_path: Optional[StrictBool] = Field(default=None, alias="filePath")
    scan_id: Optional[StrictBool] = Field(default=None, alias="scanId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "readACL", "writeACL", "owner", "createdAt", "createdBy", "name", "data", "filePath", "scanId"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ScanDataFieldsOneOf from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ScanDataFieldsOneOf from a dict"""
        if obj is None:
            return None
