...
class BeamlineWithRelations(BaseModel):
    """
    ...
    name: StrictStr
    active_experiment: Optional[StrictStr] = Field(default=None, alias="activeExperiment")
    access_config: Optional[AccessConfigWithRelations] = Field(default=None, alias="accessConfig")
    experiments: Optional[List[ExperimentWithRelations]] = None
    __properties: ClassVar[List[str]] = ["id", "readACL", "writeACL", "owner", "createdAt", "createdBy", "name", "activeExperiment", "accessConfig", "experiments"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "activeExperiment": obj.get("activeExperiment"),
            "accessConfig": AccessConfigWithRelations.from_dict(obj.get("accessConfig")) if obj.get("accessConfig") is not None else None,
            "experiments": [ExperimentWithRelations.from_dict(_item) for _item in obj.get("experiments")] if obj.get("experiments") is not None else None
        })
        return _obj

from py_scibec_openapi_client.models.access_config_with_relations import AccessConfigWithRelations
# TODO: Rewrite to not use raise_errors
BeamlineWithRelations.model_rebuild(raise_errors=False)
