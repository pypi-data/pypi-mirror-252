...
class NXEntityNested(BaseModel):
    """
    NXEntityNested
    """ # noqa: E501
    ...
    subentries: Optional[List[NXEntityNested]] = None
    __properties: ClassVar[List[str]] = ["id", "readACL", "writeACL", "owner", "createdAt", "createdBy", "name", "type", "description", "data", "NXclass", "parentId", "scanId", "subentries"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('group', 'dataset', 'attribute'):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of NXEntityNested from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of NXEntityNested from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "subentries": [NXEntityNested.from_dict(_item) for _item in obj.get("subentries")] if obj.get("subentries") is not None else None
        })
        return _obj

# TODO: Rewrite to not use raise_errors
NXEntityNested.model_rebuild(raise_errors=False)
