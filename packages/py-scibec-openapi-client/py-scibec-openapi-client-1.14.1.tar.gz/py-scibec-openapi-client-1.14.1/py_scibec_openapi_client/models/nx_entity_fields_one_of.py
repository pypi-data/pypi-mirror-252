...
class NXEntityFieldsOneOf(BaseModel):
    """
    NXEntityFieldsOneOf
    """ # noqa: E501
    ...
    n_xclass: Optional[StrictBool] = Field(default=None, alias="NXclass")
    ...
    __properties: ClassVar[List[str]] = ["id", "readACL", "writeACL", "owner", "createdAt", "createdBy", "name", "type", "description", "data", "NXclass", "parentId", "scanId"]
