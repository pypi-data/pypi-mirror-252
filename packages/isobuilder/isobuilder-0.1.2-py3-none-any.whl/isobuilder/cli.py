...
def get_args(args: Optional[List] = None) -> Namespace:
    ...
    parser.add_argument(
        ...
        default="/tmp/cdrom/",
        type=Path,
        help="Where to mount the source iso image",
    )
    parser.add_argument(
        "--build-dir",
        default="/tmp/build/",
        type=Path,
        help="The directory used to build the customised image.",
    )
    parser.add_argument(
        "-d",
        "--nodes-dir",
        type=Path,
        default="/etc/hieradata/nodes",
    ...
    parser.add_argument(
        "-o",
        "--output-dir",
        default="/etc/puppetlabs/installer/remote/",
        type=Path,
