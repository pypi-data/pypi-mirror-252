...
def get_args(args: Union[List, Tuple] = ()) -> Namespace:
    ...
    parser.add_argument('-P', '--drac-pass', default='calvin')
...
def main() -> int:  # pragma: no cover
    ...
    gateway = IPv4Address(yaml_data['network::interfaces'][ipv6_primary]['gw4'])
