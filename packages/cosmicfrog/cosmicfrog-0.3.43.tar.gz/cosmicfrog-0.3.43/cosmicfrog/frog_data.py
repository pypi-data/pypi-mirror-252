...
def create_engine_with_retry(logger,    
    connection_string: str, max_retries: int = 5, retry_delay: int = 5
) -> sqlalchemy.Engine:
    """
...
class FrogModel:
    ...
    def __init__(
        ...
        if model_name and not (connection_string or engine):
            ...
            self.engine = create_engine_with_retry(self.log, connection_string)
