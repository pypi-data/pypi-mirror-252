...
if sys.platform != "win32":
    ext_modules = [
        Extension(
            ...
            extra_compile_args=[f"-DGE_VERSION={GECODE_VERSION}"],
        )
    ]
else:
    ext_modules = [
        Extension(
            ...
            extra_compile_args=[f"/DGE_VERSION={GECODE_VERSION}", "/EHsc"],
...
install_requires = [
    ...
    "logilab-constraint >= 1.0.0, < 2.0.0",  # fallback if the gecode compiled module is missing
