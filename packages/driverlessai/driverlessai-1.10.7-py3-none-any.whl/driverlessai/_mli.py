...
class Interpretation(_commons.ServerJob):
    ...
    def gui(self) -> _utils.Hyperlink:
        """Get the full URL for the interpretation's
        page on the Driverless AI server."""
...
class MLI:
    ...
    def list(
        ...
        Args:
            start_index: The index number
                on Driverless AI server of the first interpretation to in the list.
