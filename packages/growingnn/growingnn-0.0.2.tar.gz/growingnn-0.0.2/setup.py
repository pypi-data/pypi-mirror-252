...
setup(
    ...
    install_reqs = ["numpy", "matplotlib", "opencv-python", "scipy", "imgaug", "sklearn", "scikit-learn", "pyvis"],
    #pkg_resources.parse_requirements('requirements.txt'),# numpy, matplotlib opencv-python scipy imgaug sklearn scikit-learn pyvis
