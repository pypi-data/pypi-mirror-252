...
DEFAULT_FILEPATH = 'C:\\Users\\HOME\\PycharmProjects\\dmspreader_repo\\pydmsp\\tests\\j4f0787122'
...
def get_flight_number(filepath=DEFAULT_FILEPATH):
    path, filename = md.get_filepath_and_filename(filepath)
    flight_num = 'F' + filename[3:5]
    return flight_num


def get_sensor_number(filepath=DEFAULT_FILEPATH):
    path, filename = md.get_filepath_and_filename(filepath)
...
def make_transform_dataset(filepath=DEFAULT_FILEPATH):
    '''
