...
def get_flight_number(filepath='C:\\Users\\HOME\\PycharmProjects\\viktoriatestdmspreader\\j4f0787122'):
    path, filename = md.get_filepath_and_filename(filepath)
    flight_num = 'F' + filename[3:5]
    return flight_num


def get_sensor_number(filepath='C:\\Users\\HOME\\PycharmProjects\\viktoriatestdmspreader\\j4f0787122'):
    path, filename = md.get_filepath_and_filename(filepath)
...
def make_transform_dataset(filepath='C:\\Users\\HOME\\PycharmProjects\\viktoriatestdmspreader\\j4f0787122'):
    '''
    ...
    diff_num_flux_sec_res = get_Ji(data)
    diff_energy_flux_sec_res = get_JEi(data)
    interg_num_flux_sec_res = get_J(data)
    integr_energy_flux_sec_res = get_JE(data)
    mean_energy_sec_res = get_E_avg(data)
    ...
    metadata = {
        ...
        'generated by': 'pypi package, dmsp_data_reader v.___, class ssj_reader v.___',
