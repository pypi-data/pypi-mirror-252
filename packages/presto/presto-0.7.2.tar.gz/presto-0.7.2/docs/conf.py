...
# -*- coding: utf-8 -*-
#
# presto documentation build configuration file, created by
# sphinx-quickstart on Tue Sep 15 13:52:12 2015.
#
...
if os.environ.get('READTHEDOCS', None) == 'True':
    ...
    mock_modules = ['numpy', 'scipy', 'scipy.stats', 'scipy.spatial', 'scipy.spatial.distance',
                    'pandas', 'Bio', 'Bio.Align', 'Bio.Seq', 'Bio.SeqRecord']
...
version = presto.Version.__version__
# The full version, including alpha/beta/rc tags.
release = '%s-%s' % (presto.Version.__version__, presto.Version.__date__)
...
latex_documents = [
  ('index', 'presto.tex', 'presto Documentation',
...
man_pages = [
    ('index', 'presto', 'presto Documentation',
...
texinfo_documents = [
  ('index', 'presto', 'presto Documentation',
   'Jason Anthony Vander Heiden', 'presto', 'One line description of project.',
   'Miscellaneous'),
]
