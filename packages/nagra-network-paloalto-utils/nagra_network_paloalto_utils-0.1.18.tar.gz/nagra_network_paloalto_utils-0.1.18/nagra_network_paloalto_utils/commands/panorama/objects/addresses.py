...
def cmd_generate_missing_addresses(
    ...
    log.debug(repo)
    input_objects = addr_utils.extract_addresses(get_yaml_data(file))
    ...
    addresses_to_create = addr_utils.prepare_addresses_to_create(
    ...
    print("address.py -> output:", output.resolve())
