...
from .constants import SERVICE_REGEX
...
class Services(BaseRegistry):
    def get_data(self):
        ...
        return [
            *self.client.objects.Services.get(device_group="DG1_GLOBAL"),
            *self.client.objects.ServiceGroups.get(device_group="DG1_GLOBAL"),
