...
class SQLAlchemyModelBaseService:
    ...
    def get_table_structure(cls):
        ...
        foreign_keys = inspect.get_foreign_keys(table_name, database_name)
        ...
        foreign_key_list = [
            {"constrained_columns": _.get("constrained_columns"),
             "referred_table": _.get('referred_table'),
             "referred_columns": _.get("referred_columns")} for _ in
            foreign_keys]
        table = {
