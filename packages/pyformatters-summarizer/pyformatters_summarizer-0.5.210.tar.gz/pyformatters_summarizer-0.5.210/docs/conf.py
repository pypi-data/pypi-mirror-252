...
import pyformatters_summarizer


# -- Project information -----------------------------------------------------

project = "pyformatters_summarizer"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyformatters_summarizer.__version__
release = pyformatters_summarizer.__version__
...
apidoc_module_dir = os.path.dirname(pyformatters_summarizer.__file__)
