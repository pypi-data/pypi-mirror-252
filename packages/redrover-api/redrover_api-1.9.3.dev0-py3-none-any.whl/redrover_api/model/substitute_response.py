...
class SubstituteResponse(
        ...
        class properties:
            ...
            class attributes(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['SubstituteAttributeResponse']:
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["attributes"], typing_extensions.Literal["relatedOrgIds"], typing_extensions.Literal["id"], typing_extensions.Literal["orgId"], typing_extensions.Literal["createdUtc"], typing_extensions.Literal["changedUtc"], typing_extensions.Literal["externalId"], typing_extensions.Literal["firstName"], typing_extensions.Literal["middleName"], typing_extensions.Literal["lastName"], typing_extensions.Literal["email"], typing_extensions.Literal["notificationEmail"], typing_extensions.Literal["loginEmail"], typing_extensions.Literal["dateOfBirth"], typing_extensions.Literal["address1"], typing_extensions.Literal["address2"], typing_extensions.Literal["city"], typing_extensions.Literal["state"], typing_extensions.Literal["postalCode"], typing_extensions.Literal["country"], typing_extensions.Literal["phoneNumber"], typing_extensions.Literal["active"], typing_extensions.Literal["permissionSetId"], typing_extensions.Literal["isDeleted"], ]):
