...
class Reason(
    ...
    class MetaOapg:
        ...
        class properties:
            absenceReasonId = schemas.Int32Schema
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["absenceReasonId"], typing_extensions.Literal["externalId"], typing_extensions.Literal["name"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["absenceReasonId"], typing_extensions.Literal["externalId"], typing_extensions.Literal["name"], ]):
