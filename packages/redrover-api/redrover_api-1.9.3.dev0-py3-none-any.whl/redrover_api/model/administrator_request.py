...
class AdministratorRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def accessControl() -> typing.Type['AccessControlRequest']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["accessControl"]) -> 'AccessControlRequest': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["accessControl"], typing_extensions.Literal["replaceExistingRelatedOrgs"], typing_extensions.Literal["isSuperUser"], typing_extensions.Literal["relatedOrgIds"], typing_extensions.Literal["id"], typing_extensions.Literal["secondaryIdentifier"], typing_extensions.Literal["externalId"], typing_extensions.Literal["firstName"], typing_extensions.Literal["middleName"], typing_extensions.Literal["lastName"], typing_extensions.Literal["email"], typing_extensions.Literal["notificationEmail"], typing_extensions.Literal["dateOfBirth"], typing_extensions.Literal["address1"], typing_extensions.Literal["address2"], typing_extensions.Literal["city"], typing_extensions.Literal["postalCode"], typing_extensions.Literal["badgeNumber"], typing_extensions.Literal["state"], typing_extensions.Literal["country"], typing_extensions.Literal["phoneNumber"], typing_extensions.Literal["active"], typing_extensions.Literal["permissionSet"], typing_extensions.Literal["removeFutureAssignmentsOnInactivate"], typing_extensions.Literal["inviteImmediately"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["accessControl"]) -> 'AccessControlRequest': ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        isSuperUser: typing.Union[MetaOapg.properties.isSuperUser, None, bool, schemas.Unset] = schemas.unset,
