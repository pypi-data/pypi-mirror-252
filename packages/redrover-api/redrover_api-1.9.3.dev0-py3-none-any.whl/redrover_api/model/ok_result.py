...
class OkResult(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["statusCode"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["statusCode"], ]):
