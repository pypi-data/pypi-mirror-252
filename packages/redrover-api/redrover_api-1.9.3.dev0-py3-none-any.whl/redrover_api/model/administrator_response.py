...
class AdministratorResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def accessControl() -> typing.Type['AccessControlResponse']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["accessControl"]) -> 'AccessControlResponse': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["isSuperUser"], typing_extensions.Literal["accessControl"], typing_extensions.Literal["relatedOrgIds"], typing_extensions.Literal["id"], typing_extensions.Literal["orgId"], typing_extensions.Literal["createdUtc"], typing_extensions.Literal["changedUtc"], typing_extensions.Literal["externalId"], typing_extensions.Literal["firstName"], typing_extensions.Literal["middleName"], typing_extensions.Literal["lastName"], typing_extensions.Literal["email"], typing_extensions.Literal["notificationEmail"], typing_extensions.Literal["loginEmail"], typing_extensions.Literal["dateOfBirth"], typing_extensions.Literal["address1"], typing_extensions.Literal["address2"], typing_extensions.Literal["city"], typing_extensions.Literal["state"], typing_extensions.Literal["postalCode"], typing_extensions.Literal["country"], typing_extensions.Literal["phoneNumber"], typing_extensions.Literal["active"], typing_extensions.Literal["permissionSetId"], typing_extensions.Literal["isDeleted"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["accessControl"]) -> typing.Union['AccessControlResponse', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        accessControl: typing.Union['AccessControlResponse', schemas.Unset] = schemas.unset,
