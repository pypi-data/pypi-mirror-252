...
# Query params
FileFormatSchema = FileFormat
IncludeHeadersSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'includeHeaders': typing.Union[IncludeHeadersSchema, bool, ],
...
request_query_include_headers = api_client.QueryParameter(
    name="includeHeaders",
    style=api_client.ParameterStyle.FORM,
    schema=IncludeHeadersSchema,
    explode=True,
)
...
SchemaFor403ResponseBodyApplicationJson = ForbidResult
...
class DownloadReport0(BaseApi):
    ...
    def download_report_0(
        ...
        return self._download_report_0_oapg(
            body=body,
