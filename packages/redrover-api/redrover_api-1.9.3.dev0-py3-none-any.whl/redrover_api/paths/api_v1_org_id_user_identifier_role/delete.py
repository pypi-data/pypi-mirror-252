...
SchemaFor200ResponseBodyApplicationJson = OkResult
...
class DeleteUserRole(BaseApi):
    ...
    def delete_user_role(
        ...
        return self._delete_user_role_oapg(
