...
SchemaFor200ResponseBodyApplicationJson = AbsenceReasonResponse
...
class GetAbsenceReason(BaseApi):
    ...
    def get_absence_reason(
        ...
        return self._get_absence_reason_oapg(
