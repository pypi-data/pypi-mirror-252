...
# body param
SchemaForRequestBodyApplicationJsonPatchjson = WebhookUpdateRequest
SchemaForRequestBodyApplicationJson = WebhookUpdateRequest
SchemaForRequestBodyTextJson = WebhookUpdateRequest
SchemaForRequestBodyApplicationJson = WebhookUpdateRequest


request_body_webhook_update_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyTextPlain = WebhookResponse
SchemaFor200ResponseBodyApplicationJson = WebhookResponse
SchemaFor200ResponseBodyTextJson = WebhookResponse
...
class BaseApi(api_client.Api):
    ...
    def _put_webhook_uri_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_webhook_update_request.serialize(body, content_type)
...
class PutWebhookUri(BaseApi):
    ...
    def put_webhook_uri(
        ...
        return self._put_webhook_uri_oapg(
            body=body,
