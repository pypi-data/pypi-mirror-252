...
class ImageDataGenerator(Sequence):
    ...
    def __init__(self, dataframe, batch_size, target_size_hw=None, target_size_wh=None, shuffle=True, image_path_col='image_path', target_col='target', weight_col=None, process_image=None, mult_input_proc=None, file_cache=None, rgb=True, scale_colors=True, mode=None, n_jobs=-1, parallel_one_epoch_only=True):
        """
        :param dataframe:
        :param batch_size:
        ...
        :param mode: 'fit', 'predict-train', 'predict-test', 'memory'
        """
