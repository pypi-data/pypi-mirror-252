...
class TestRefreshIpOperation(TestCase):
    ...
    def test_refresh_ip(self):
        ...
        self.cloudshell_session.GetResourceDetails.return_value.ResourceAttributes = [
            attribute
        ]
        ...
        self.cloudshell_session.UpdateResourceAddress.assert_called_with(
            resource_name, instance.private_ip_address
        )

        self.cloudshell_session.SetAttributeValue.assert_called_with(
            resource_name, attr_name, instance.public_ip_address
        )
