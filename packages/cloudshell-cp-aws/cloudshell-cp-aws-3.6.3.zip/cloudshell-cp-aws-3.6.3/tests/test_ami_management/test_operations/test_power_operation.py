...
class TestPowerOperations(TestCase):
    def setUp(self):
        ...
        self.instance = Mock()
        self.aws_ec2_service.get_active_instance_by_id = Mock(
    ...
    def test_power_on_already_powered_on(self):
        ...
        self.assertTrue(
            self.aws_ec2_service.get_active_instance_by_id.called_with(
                self.ec2_session, "id"
            )
        )
    ...
    def test_power_off_on_running_instance(self):
        self.instance.state = {"Name": "running"}
        result = self.power_operations.power_off(self.ec2_session, "id")
        self.assertTrue(result)
        self.assertTrue(
