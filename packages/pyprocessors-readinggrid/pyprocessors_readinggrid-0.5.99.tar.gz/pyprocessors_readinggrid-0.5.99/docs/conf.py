...
import pyprocessors_readinggrid


# -- Project information -----------------------------------------------------

project = "pyprocessors_readinggrid"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyprocessors_readinggrid.__version__
release = pyprocessors_readinggrid.__version__
...
apidoc_module_dir = os.path.dirname(pyprocessors_readinggrid.__file__)
