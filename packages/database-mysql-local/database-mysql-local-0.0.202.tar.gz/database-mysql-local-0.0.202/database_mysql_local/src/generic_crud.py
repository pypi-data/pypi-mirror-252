...
from .constants import DEFAULT_SQL_SELECT_LIMIT, logger_crud_object
...
logger = Logger.create_logger(object=logger_crud_object)
    ...
    def insert(self, *, schema_name: str = None, table_name: str = None, data_json: dict = None,
        ...
        try:
            ...
            logger.exception(self._log_error_message(message="Error inserting data_json",
                                                     sql_statement=insert_query), object=exception)
            logger.end()
            raise
    ...
    def update_by_where(self, *, schema_name: str = None, table_name: str = None, where: str = None,
        ...
        try:
            ...
            logger.exception(self._log_error_message(message="Error updating data_json",
                                                     sql_statement=update_query), object=exception)
            logger.end()
            raise
