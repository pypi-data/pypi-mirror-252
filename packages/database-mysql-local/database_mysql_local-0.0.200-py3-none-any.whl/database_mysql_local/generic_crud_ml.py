...
class GenericCRUDML(GenericCRUD):
    ...
    def get_id_by_name(self, name: str, lang_code: LangCode = None,
        ...
        try:
            ...
            logger.warning("select_one_tuple_by_where was not successful for name and lang_code. Error: " + str(e),
            ...
            try:
                ...
                logger.exception("Error selecting data_json", object=e)
                raise
        finally:
            logger.end(object={"result": result})
        if result:
    ...
    def delete_by_name(self, name: str,
        ...
        try:
            ...
            logger.warning("delete_by_where was not successful for name and lang_code Error: " + str(e),
                           object={"title": name, "lang_code": lang_code})
            try:
                # this call is not tested because test_mysql_ml_table does not have a `name` column
                ...
                logger.warning("delete_by_where was not successful for name and lang_code. Error: " + str(e),
                               object={"name": name, "lang_code": lang_code})
                logger.exception("Error deleting data_json", object=e)
                raise
        finally:
            logger.end()
