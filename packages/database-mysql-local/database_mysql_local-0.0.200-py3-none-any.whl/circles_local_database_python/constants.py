...
logger_connector_test_object = logger_connector_object.copy()
...
logger_crud_test_object = logger_crud_object.copy()
logger_crud_test_object['component_category'] = LoggerComponentEnum.ComponentCategory.Unit_Test.value

# generic_crud_ml
DATABASE_MYSQL_GENERIC_CRUD_ML_COMPONENT_ID = 206  # TODO: should we change the component id?
...
logger_crud_ml_test_object = logger_crud_ml_object.copy()
logger_crud_ml_test_object['component_category'] = LoggerComponentEnum.ComponentCategory.Unit_Test.value

# generic_mapping
DATABASE_MYSQL_PYTHON_GENERIC_MAPPING_COMPONENT_ID = 206  # TODO: should we change the component id?
...
logger_mapping_test_object = logger_mapping_object.copy()
