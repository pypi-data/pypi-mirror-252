...
def main():
    ...
    sub_parser.add_argument("otp_url")
    sub_parser.add_argument("otp_timeout", type=int, default=20)
    ...
    if sub_command == "authorize":
        run_async(
            cli.auth.login(args.username, args.password, args.otp_url, args.otp_timeout)
        )
        return
