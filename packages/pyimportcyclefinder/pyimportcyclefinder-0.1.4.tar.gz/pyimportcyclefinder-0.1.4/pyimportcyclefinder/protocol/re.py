...
@runtime_checkable
class ReBuiltInPatternProtocol(Protocol[AnyStr]):
    @property
    def flags(self) -> int: ...
    ...
    @overload
    def search(
            self: "ReBuiltInPatternProtocol[str]",
            string: str,
            pos: int = ...,
            endpos: int = ...,
            concurrent: bool | None = ...,
            timeout: float | None = ...,
    ) -> "Optional[ReBuiltInMatchProtocol[str]]": ...

    @overload
    def search(
            self: "ReBuiltInPatternProtocol[bytes]",
            string: ReadableBuffer,
            pos: int = ...,
            endpos: int = ...,
            concurrent: bool | None = ...,
            timeout: float | None = ...,
    ) -> "Optional[ReBuiltInMatchProtocol[bytes]]": ...
    ...
    @overload
    def split(
            self: "ReBuiltInPatternProtocol[str]", string: str, maxsplit: int = ...,
    ...
    def finditer(
            ...
            concurrent: bool | None = ...,
            timeout: float | None = ...,
    ) -> "Iterator[ReBuiltInMatchProtocol[str]]": ...
    ...
    def finditer(
            ...
            concurrent: bool | None = ...,
            timeout: float | None = ...,
    ) -> "Iterator[ReBuiltInMatchProtocol[bytes]]": ...

    @overload
    def sub(
            self: "ReBuiltInPatternProtocol[str]",
            repl: str | Callable[["ReBuiltInMatchProtocol[str]"], str],
            string: str,
            count: int = ...,
            flags: int = ...,
            pos: int | None = ...,
    ...
    def sub(
            self: "ReBuiltInPatternProtocol[bytes]",
            repl: ReadableBuffer | Callable[["ReBuiltInMatchProtocol[bytes]"], ReadableBuffer],
            string: ReadableBuffer,
            count: int = ...,
            flags: int = ...,
            pos: int | None = ...,
...
@runtime_checkable
class ReBuiltInMatchProtocol(Protocol[AnyStr]):
    @property
    def pos(self) -> int: ...
    ...
    @property
    def re(self) -> "ReBuiltInPatternProtocol": ...
...
@runtime_checkable
class ReBuiltInScannerProtocol(Protocol[AnyStr]):
    @property
    def pattern(self) -> ReBuiltInPatternProtocol[AnyStr]: ...

    def __iter__(self) -> Self: ...

    def __next__(self) -> ReBuiltInMatchProtocol[AnyStr]: ...

    def match(self) -> Optional[ReBuiltInMatchProtocol[AnyStr]]: ...

    def search(self) -> Optional[ReBuiltInMatchProtocol[AnyStr]]: ...
