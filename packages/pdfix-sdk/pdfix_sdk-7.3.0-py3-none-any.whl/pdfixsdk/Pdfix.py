...
# 
(kContentMarkMcid, kContentMarkArtifact, kContentMarkAny) = (0x01, 0x02, 0xFF)
# 
...
# 
(kCommandNone, kCommandNeedSave, kCommandRunInBackground, kCommandParamRequired, kCommandParamOptional) = (0x00, 0x01, 0x02, 0x04, 0x08)
...
class zz_PdfJsonParams(Structure):
    _fields_ = [("struct_tree", c_int), ("page_map", c_int), ("page_content", c_int), ("text", c_int), ("text_style", c_int), ("text_state", c_int), ("images", c_int), ("bbox", c_int), ("graphics_state", c_int), ("content_marks", c_int)]
...
class PdfJsonParams(Structure):
    ...
    def GetIntStruct(self):
        ...
        result.content_marks = self.content_marks
        return result
    def SetIntStruct(self, struct):
        ...
        self.content_marks = struct.content_marks
...
class PdfDoc(_PdfixBase):
    ...
    def InsertPages(self, _index: int, _doc: PdfDoc, _index_from: int, _index_to: int, _insert_flags: int, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PdfDocInsertPages(self.obj, _index, _doc.obj if _doc else None, _index_from, _index_to, _insert_flags, _cancel_proc, _cancel_data)
        return ret
    ...
    def AddTags(self, _tag_params: PdfTagsParams, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PdfDocAddTags(self.obj, _tag_params.GetIntStruct() if _tag_params else None, _cancel_proc, _cancel_data)
        return ret
    ...
    def EmbedFont(self, _font: PdfFont, _subset: bool, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PdfDocEmbedFont(self.obj, _font.obj if _font else None, _subset, _cancel_proc, _cancel_data)
        return ret
    ...
    def MakeAccessible(self, _params: PdfAccessibleParams, _title, _language, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PdfDocMakeAccessible(self.obj, _params.GetIntStruct() if _params else None, _title, _language, _cancel_proc, _cancel_data)
        return ret
    ...
    def EnumPageObjects(self, _content: PdsContent, _proc, _cancel_proc, _cancel_data: int, _client_data: int, _flags: int) -> int: 
        global PdfixLib
        ret = PdfixLib.PdfDocEnumPageObjects(self.obj, _content.obj if _content else None, _proc, _cancel_proc, _cancel_data, _client_data, _flags)
        return ret

    def EnumStructTree(self, _structElem: PdsStructElement, _proc, _cancel_proc, _cancel_data: int, _client_data: int, _flags: int) -> int: 
        global PdfixLib
        ret = PdfixLib.PdfDocEnumStructTree(self.obj, _structElem.obj if _structElem else None, _proc, _cancel_proc, _cancel_data, _client_data, _flags)
        return ret
...
class PdfPage(_PdfixBase):
    ...
    def DrawContent(self, _params: PdfPageRenderParams, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PdfPageDrawContent(self.obj, _params.GetIntStruct() if _params else None, _cancel_proc, _cancel_data)
        return ret
    ...
    def FlattenAnnot(self, _annot: PdfAnnot, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PdfPageFlattenAnnot(self.obj, _annot.obj if _annot else None, _cancel_proc, _cancel_data)
        return ret
...
class PdePageMap(_PdfixBase):
    ...
    def GetWhitespace(self, _params: PdfWhitespaceParams, _index: int, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        result = PdfRect()
        _bbox = result.GetIntStruct()
        PdfixLib.PdePageMapGetWhitespace(self.obj, _params.GetIntStruct(), _index, _cancel_proc, _cancel_data, _bbox)
        result.SetIntStruct(_bbox)
        return result
    ...
    def AddTags(self, _element: PdsStructElement, _sibling: bool, _tag_params: PdfTagsParams, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PdePageMapAddTags(self.obj, _element.obj if _element else None, _sibling, _tag_params.GetIntStruct() if _tag_params else None, _cancel_proc, _cancel_data)
        return ret
...
class PdfConversion(_PdfixBase):
    ...
    def SaveToStream(self, _stream: PsStream, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PdfConversionSaveToStream(self.obj, _stream.obj if _stream else None, _cancel_proc, _cancel_data)
        return ret
...
class PsCommand(_PdfixBase):
    ...
    def AddObject(self, _object: PdsObject) -> bool: 
        global PdfixLib
        ret = PdfixLib.PsCommandAddObject(self.obj, _object.obj if _object else None)
        return ret

    def AddPageObject(self, _page_object: PdsPageObject) -> bool: 
        global PdfixLib
        ret = PdfixLib.PsCommandAddPageObject(self.obj, _page_object.obj if _page_object else None)
        return ret
    ...
    def SaveCommandsToStream(self, _stream: PsStream, _format: int, _flags: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PsCommandSaveCommandsToStream(self.obj, _stream.obj if _stream else None, _format, _flags)
        return ret
    ...
    def ConvertToJson(self, _page: PdfPage, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PsCommandConvertToJson(self.obj, _page.obj if _page else None, _cancel_proc, _cancel_data)
        return ret
    ...
    def SetPdfUAStandard(self) -> bool: 
        global PdfixLib
        ret = PdfixLib.PsCommandSetPdfUAStandard(self.obj)
        return ret
    ...
    def ArtifactContent(self, _page: PdfPage, _bbox: PdfRect, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PsCommandArtifactContent(self.obj, _page.obj if _page else None, _bbox.GetIntStruct() if _bbox else None, _cancel_proc, _cancel_data)
        return ret

    def FlattenFormXObject(self, _page: PdfPage, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PsCommandFlattenFormXObject(self.obj, _page.obj if _page else None, _cancel_proc, _cancel_data)
        return ret

    def SetTabsKey(self, _page: PdfPage, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PsCommandSetTabsKey(self.obj, _page.obj if _page else None, _cancel_proc, _cancel_data)
        return ret

    def DeleteTags(self, _struc_elem: PdsStructElement, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PsCommandDeleteTags(self.obj, _struc_elem.obj if _struc_elem else None, _cancel_proc, _cancel_data)
        return ret

    def ApplyStandardTags(self, _struc_elem: PdsStructElement, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PsCommandApplyStandardTags(self.obj, _struc_elem.obj if _struc_elem else None, _cancel_proc, _cancel_data)
        return ret

    def AddTagId(self, _struc_elem: PdsStructElement, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PsCommandAddTagId(self.obj, _struc_elem.obj if _struc_elem else None, _cancel_proc, _cancel_data)
        return ret

    def FixPlacement(self, _struc_elem: PdsStructElement, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PsCommandFixPlacement(self.obj, _struc_elem.obj if _struc_elem else None, _cancel_proc, _cancel_data)
        return ret

    def RemoveTagData(self, _struct_elem: PdsStructElement, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PsCommandRemoveTagData(self.obj, _struct_elem.obj if _struct_elem else None, _cancel_proc, _cancel_data)
        return ret

    def FlattenAnnot(self, _page: PdfPage, _annot: PdfAnnot, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PsCommandFlattenAnnot(self.obj, _page.obj if _page else None, _annot.obj if _annot else None, _cancel_proc, _cancel_data)
        return ret

    def SetAnnotContents(self, _page: PdfPage, _annot: PdfAnnot, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PsCommandSetAnnotContents(self.obj, _page.obj if _page else None, _annot.obj if _annot else None, _cancel_proc, _cancel_data)
        return ret

    def RemoveContentMarks(self, _page: PdfPage, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PsCommandRemoveContentMarks(self.obj, _page.obj if _page else None, _cancel_proc, _cancel_data)
        return ret

    def SetStructureAttribute(self, _elem: PdsStructElement, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PsCommandSetStructureAttribute(self.obj, _elem.obj if _elem else None, _cancel_proc, _cancel_data)
        return ret

    def FixStructureSpaces(self, _elem: PdsStructElement, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PsCommandFixStructureSpaces(self.obj, _elem.obj if _elem else None, _cancel_proc, _cancel_data)
        return ret

    def RotatePages(self, _page: PdfPage, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PsCommandRotatePages(self.obj, _page.obj if _page else None, _cancel_proc, _cancel_data)
        return ret

    def ImportTag(self, _element: PdsStructElement, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PsCommandImportTag(self.obj, _element.obj if _element else None, _cancel_proc, _cancel_data)
        return ret
...
def Pdfix_init(path):
    ...
    PdfixLib.PdfPageFlattenAnnot.argtypes = [c_void_p, c_void_p, c_int, c_void_p]
    ...
    PdfixLib.PdePageMapGetWhitespace.argtypes = [c_void_p, POINTER(zz_PdfWhitespaceParams), c_int, c_int, c_void_p, POINTER(zz_PdfRect)]
    ...
    PdfixLib.PsCommandSetPdfUAStandard.restype = c_int
    PdfixLib.PsCommandSetPdfUAStandard.argtypes = [c_void_p]
    ...
    PdfixLib.PsCommandArtifactContent.argtypes = [c_void_p, c_void_p, POINTER(zz_PdfRect), c_int, c_void_p]
    ...
    PdfixLib.PsCommandDeleteTags.restype = c_int
    PdfixLib.PsCommandDeleteTags.argtypes = [c_void_p, c_void_p, c_int, c_void_p]
    ...
    PdfixLib.PsCommandRemoveContentMarks.restype = c_int
    PdfixLib.PsCommandRemoveContentMarks.argtypes = [c_void_p, c_void_p, c_int, c_void_p]
    PdfixLib.PsCommandSetStructureAttribute.restype = c_int
    PdfixLib.PsCommandSetStructureAttribute.argtypes = [c_void_p, c_void_p, c_int, c_void_p]
    PdfixLib.PsCommandFixStructureSpaces.restype = c_int
    PdfixLib.PsCommandFixStructureSpaces.argtypes = [c_void_p, c_void_p, c_int, c_void_p]
    PdfixLib.PsCommandRotatePages.restype = c_int
    PdfixLib.PsCommandRotatePages.argtypes = [c_void_p, c_void_p, c_int, c_void_p]
    PdfixLib.PsCommandImportTag.restype = c_int
    PdfixLib.PsCommandImportTag.argtypes = [c_void_p, c_void_p, c_int, c_void_p]
