...
def create_git_hooks():
    for os_type in SUPPORTED_OS_TYPES.keys():
        os.makedirs(f"{GIT_HOOKS_DIRECTORY}/{os_type}", exist_ok=True)

        create_git_hook_from_template(os_type)
...
if __name__ == "__main__":
    ...
    print(f"Success: commit-msg git-hook configured for {SUPPORTED_OS_TYPES[os_type]}.\n")
