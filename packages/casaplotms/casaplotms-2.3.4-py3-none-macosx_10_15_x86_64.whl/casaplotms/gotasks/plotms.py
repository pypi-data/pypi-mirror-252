...
##################### 7632f20be650bdce31219395dd789e29 ##############################
from __future__ import absolute_import
from casashell.private.stack_manip import find_local as __sf__
from casashell.private.stack_manip import find_frame as _find_frame
from casatools.typecheck import validator as _pc
from casatools.coercetype import coerce as _coerce
from casaplotms import plotms as _plotms_t
...
class _plotms:
    ...
    in a cal table, including ratio plots ("/").  The antenna
    selection string is used to select antenna1 only, rather than
    baselines as in an MS. When plotting parameterized CalTables, such
    as delays, antpos, gaincurve, or opacity, plotms will plot the
    simple parameters contained in the table, not the effective
    amplitudes or phases sampled at observing times, frequencies etc.
    BPOLY and GSPLINE tables are supported but interactive flagging is
    not allowed.  Features currently unsupported for CalTables include
...
}, 'symboloutline': {'type': 'cVariant', 'coerce': [_coerce.to_variant]}, 'coloraxis': {'type': 'cStr', 'coerce': _coerce.to_str, 'allowed': [ 'baseline', 'Antenna1', 'Baseline', 'ant1', 'corr', 'observation', 'Intent', 'Observation', 'Channel', 'Scan', 'intent', 'channel', 'Time', 'antenna2', 'Antenna2', 'spw', 'chan', 'Field', 'ant2', 'Corr', '', 'antenna1', 'time', 'field', 'Spw', 'scan' ]}, 'customflaggedsymbol': {'type': 'cVariant', 'coerce': [_coerce.to_variant]}, 'flaggedsymbolshape': {'type': 'cVariant', 'coerce': [_coerce.to_variant] # <allowed> IS NOT ALLOWED FOR A PARAMETER OF TYPE any
    ...
    def __call__( self, vis=None, gridrows=None, gridcols=None, rowindex=None, colindex=None, plotindex=None, xaxis=None, xdatacolumn=None, xframe=None, xinterp=None, yaxis=None, ydatacolumn=None, yframe=None, yinterp=None, yaxislocation=None, selectdata=None, field=None, spw=None, timerange=None, uvrange=None, antenna=None, scan=None, correlation=None, array=None, observation=None, intent=None, feed=None, msselect=None, averagedata=None, avgchannel=None, avgtime=None, avgscan=None, avgfield=None, avgbaseline=None, avgantenna=None, avgspw=None, scalar=None, transform=None, freqframe=None, restfreq=None, veldef=None, phasecenter=None, extendflag=None, extcorr=None, extchannel=None, iteraxis=None, xselfscale=None, yselfscale=None, xsharedaxis=None, ysharedaxis=None, customsymbol=None, symbolshape=None, symbolsize=None, symbolcolor=None, symbolfill=None, symboloutline=None, coloraxis=None, customflaggedsymbol=None, flaggedsymbolshape=None, flaggedsymbolsize=None, flaggedsymbolcolor=None, flaggedsymbolfill=None, flaggedsymboloutline=None, xconnector=None, timeconnector=None, plotrange=None, title=None, titlefont=None, xlabel=None, xaxisfont=None, ylabel=None, yaxisfont=None, showmajorgrid=None, majorwidth=None, majorstyle=None, majorcolor=None, showminorgrid=None, minorwidth=None, minorstyle=None, minorcolor=None, showlegend=None, legendposition=None, plotfile=None, expformat=None, verbose=None, exprange=None, highres=None, dpi=None, width=None, height=None, overwrite=None, showgui=None, clearplots=None, callib=None, headeritems=None, showatm=None, showtsky=None, showimage=None, colorizeoverlay=None ):
        ...
        _arguments = [vis,gridrows,gridcols,rowindex,colindex,plotindex,xaxis,xdatacolumn,xframe,xinterp,yaxis,ydatacolumn,yframe,yinterp,yaxislocation,selectdata,field,spw,timerange,uvrange,antenna,scan,correlation,array,observation,intent,feed,msselect,averagedata,avgchannel,avgtime,avgscan,avgfield,avgbaseline,avgantenna,avgspw,scalar,transform,freqframe,restfreq,veldef,phasecenter,extendflag,extcorr,extchannel,iteraxis,xselfscale,yselfscale,xsharedaxis,ysharedaxis,customsymbol,symbolshape,symbolsize,symbolcolor,symbolfill,symboloutline,coloraxis,customflaggedsymbol,flaggedsymbolshape,flaggedsymbolsize,flaggedsymbolcolor,flaggedsymbolfill,flaggedsymboloutline,xconnector,timeconnector,plotrange,title,titlefont,xlabel,xaxisfont,ylabel,yaxisfont,showmajorgrid,majorwidth,majorstyle,majorcolor,showminorgrid,minorwidth,minorstyle,minorcolor,showlegend,legendposition,plotfile,expformat,verbose,exprange,highres,dpi,width,height,overwrite,showgui,clearplots,callib,headeritems,showatm,showtsky,showimage,colorizeoverlay]
        _invocation_parameters = OrderedDict( )
        ...
        try:
            _return_result_ = _plotms_t( _invocation_parameters['vis'],_invocation_parameters['gridrows'],_invocation_parameters['gridcols'],_invocation_parameters['rowindex'],_invocation_parameters['colindex'],_invocation_parameters['plotindex'],_invocation_parameters['xaxis'],_invocation_parameters['xdatacolumn'],_invocation_parameters['xframe'],_invocation_parameters['xinterp'],_invocation_parameters['yaxis'],_invocation_parameters['ydatacolumn'],_invocation_parameters['yframe'],_invocation_parameters['yinterp'],_invocation_parameters['yaxislocation'],_invocation_parameters['selectdata'],_invocation_parameters['field'],_invocation_parameters['spw'],_invocation_parameters['timerange'],_invocation_parameters['uvrange'],_invocation_parameters['antenna'],_invocation_parameters['scan'],_invocation_parameters['correlation'],_invocation_parameters['array'],_invocation_parameters['observation'],_invocation_parameters['intent'],_invocation_parameters['feed'],_invocation_parameters['msselect'],_invocation_parameters['averagedata'],_invocation_parameters['avgchannel'],_invocation_parameters['avgtime'],_invocation_parameters['avgscan'],_invocation_parameters['avgfield'],_invocation_parameters['avgbaseline'],_invocation_parameters['avgantenna'],_invocation_parameters['avgspw'],_invocation_parameters['scalar'],_invocation_parameters['transform'],_invocation_parameters['freqframe'],_invocation_parameters['restfreq'],_invocation_parameters['veldef'],_invocation_parameters['phasecenter'],_invocation_parameters['extendflag'],_invocation_parameters['extcorr'],_invocation_parameters['extchannel'],_invocation_parameters['iteraxis'],_invocation_parameters['xselfscale'],_invocation_parameters['yselfscale'],_invocation_parameters['xsharedaxis'],_invocation_parameters['ysharedaxis'],_invocation_parameters['customsymbol'],_invocation_parameters['symbolshape'],_invocation_parameters['symbolsize'],_invocation_parameters['symbolcolor'],_invocation_parameters['symbolfill'],_invocation_parameters['symboloutline'],_invocation_parameters['coloraxis'],_invocation_parameters['customflaggedsymbol'],_invocation_parameters['flaggedsymbolshape'],_invocation_parameters['flaggedsymbolsize'],_invocation_parameters['flaggedsymbolcolor'],_invocation_parameters['flaggedsymbolfill'],_invocation_parameters['flaggedsymboloutline'],_invocation_parameters['xconnector'],_invocation_parameters['timeconnector'],_invocation_parameters['plotrange'],_invocation_parameters['title'],_invocation_parameters['titlefont'],_invocation_parameters['xlabel'],_invocation_parameters['xaxisfont'],_invocation_parameters['ylabel'],_invocation_parameters['yaxisfont'],_invocation_parameters['showmajorgrid'],_invocation_parameters['majorwidth'],_invocation_parameters['majorstyle'],_invocation_parameters['majorcolor'],_invocation_parameters['showminorgrid'],_invocation_parameters['minorwidth'],_invocation_parameters['minorstyle'],_invocation_parameters['minorcolor'],_invocation_parameters['showlegend'],_invocation_parameters['legendposition'],_invocation_parameters['plotfile'],_invocation_parameters['expformat'],_invocation_parameters['verbose'],_invocation_parameters['exprange'],_invocation_parameters['highres'],_invocation_parameters['dpi'],_invocation_parameters['width'],_invocation_parameters['height'],_invocation_parameters['overwrite'],_invocation_parameters['showgui'],_invocation_parameters['clearplots'],_invocation_parameters['callib'],_invocation_parameters['headeritems'],_invocation_parameters['showatm'],_invocation_parameters['showtsky'],_invocation_parameters['showimage'],_invocation_parameters['colorizeoverlay'] )
