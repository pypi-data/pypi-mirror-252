...
setup(
    ...
    packages=find_packages(
        include=['layernext', 'layernext.datalake', 'layernext.dataset', 'layernext.studio',
                 'layernext.automatic_analysis']),
    install_requires=['requests', 'uuid', 'python-dotenv', 'azure-storage-blob', 'tqdm', 'PyYAML', 'Deprecated'],
    keywords=['python', 'datalake', 'datasetsync', 'ai',
              'annotation', 'layernext', 'layernext', 'machine learning'],
    classifiers=[
