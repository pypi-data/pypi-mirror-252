...
from trader1x import logger, quant1x_data_path
...
def proxy_start() -> int:
    ...
    log_config = {
        ...
        "handlers": {
            "file_handler": {
                ...
                "filename": f'{quant1x_data_path}logfile.log',
            },
        },
        "root": {
    ...
    cfg = uvicorn.Config(app='trader1x.proxy:app', host=__config.proxy_address, port=__config.proxy_port,
...
if __name__ == '__main__':
    ...
    if argc <= 1:
        ...
        if len(argv) == 1:
            ...
            win32serviceutil.HandleCommandLine(ProxyService, argv=argv)
    else:
