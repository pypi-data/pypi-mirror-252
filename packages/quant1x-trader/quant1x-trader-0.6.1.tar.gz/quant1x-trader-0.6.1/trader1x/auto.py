...
def head_trading(ctx: QmtContext, trader: thinktrader.ThinkTrader):
    """
    早盘交易
    :param ctx: 上下文
    :param trader: 交易实例
...
def tail_trading(ctx: QmtContext, trader: thinktrader.ThinkTrader):
    """
    尾盘交易
    :param ctx:
    :param trader:
...
def tick_trading(ctx: QmtContext, trader: thinktrader.ThinkTrader, strategy_no: int = 81):
    """
    盘中交易
    :param ctx: 上下文
    :param trader: 交易实例
...
def positions_sell(ctx: QmtContext, trader: thinktrader.ThinkTrader):
    """
    持仓卖出
    :param ctx:
    :param trader:
...
def marker_review(ctx: QmtContext, trader: thinktrader.ThinkTrader):
    """
    盘后复盘
    :return:
    """
...
def stat(ctx: QmtContext, trader: thinktrader.ThinkTrader):
    """
    统计
    :param ctx:
    :param trader:
