...
class CfnDataSource(
    ...
    def __init__(
        ...
        *,
        ...
        :param project_identifier: The identifier of the Amazon DataZone project in which you want to add the data source.
        :param type: The type of the data source.
        :param asset_forms_input: The metadata forms that are to be attached to the assets that this data source works with.
        ...
        :param recommendation: The recommendation to be updated as part of the UpdateDataSource action.
    ...
    class DataSourceConfigurationInputProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param glue_run_configuration: 
            :param redshift_run_configuration: The configuration details of the Amazon Redshift data source.
    ...
    class FilterExpressionProperty:
        def __init__(self, *, expression: builtins.str, type: builtins.str) -> None:
            ...
            :param expression: 
            :param type: The search filter expression type.
    ...
    class RedshiftRunConfigurationInputProperty:
        def __init__(
            ...
            *,
            ...
            :param redshift_credential_configuration: The ARN of a secret manager for an Amazon Redshift cluster.
            ...
            :param relational_filter_configurations: The relational filter configurations included in the configuration details of the Amazon Redshift data source.
            :param data_access_role: The data access role included in the configuration details of the AWS Glue data source.
    ...
    class RedshiftStorageProperty:
        def __init__(
            ...
            *,
            ...
            :param redshift_cluster_source: The name of an Amazon Redshift cluster.
            :param redshift_serverless_source: The details of the Amazon Redshift Serverless workgroup storage.
...
class CfnDomain(
    ...
    def __init__(
        ...
        *,
        ...
        :param single_sign_on: The single-sign on configuration of the Amazon DataZone domain.
...
class CfnEnvironment(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: Scope in which this resource is defined.
        :param id: Construct identifier for this resource (unique in its scope).
        :param domain_identifier: The identifier of the Amazon DataZone domain in which the environment would be created.
        :param environment_profile_identifier: The ID of the environment profile with which the Amazon DataZone environment would be created.
        :param name: The name of the environment.
        :param project_identifier: The ID of the Amazon DataZone project in which the environment would be created.
        :param description: The description of the Amazon DataZone environment.
        :param glossary_terms: The glossary terms that can be used in the Amazon DataZone environment.
        :param user_parameters: The user parameters of the Amazon DataZone environment.
        '''
        if __debug__:
    ...
    class EnvironmentParameterProperty:
        def __init__(
            ...
            *,
            ...
            :param name: The name of an environment parameter.
            :param value: The value of an environment parameter.
...
class CfnEnvironmentBlueprintConfiguration(
    ...
    def __init__(
        ...
        *,
        ...
        :param manage_access_role_arn: 
        :param provisioning_role_arn: 
...
class CfnEnvironmentProfile(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: Scope in which this resource is defined.
        :param id: Construct identifier for this resource (unique in its scope).
        :param domain_identifier: The ID of the Amazon DataZone domain in which this environment profile is created.
        :param environment_blueprint_identifier: The ID of the blueprint with which this environment profile is created.
        :param name: The name of this Amazon DataZone environment profile.
        :param project_identifier: The identifier of the project in which to create the environment profile.
        :param aws_account_id: The AWS account in which the Amazon DataZone environment is created.
        :param aws_account_region: The AWS region in which this environment profile is created.
    ...
    def aws_account_region(self) -> typing.Optional[builtins.str]:
        ...
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "awsAccountRegion"))

    @aws_account_region.setter
    def aws_account_region(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
...
class CfnProject(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: Scope in which this resource is defined.
        :param id: Construct identifier for this resource (unique in its scope).
        :param domain_identifier: The ID of the Amazon DataZone domain in which this project is created.
        :param name: The name of the Amazon DataZone project.
...
class CfnSubscriptionTarget(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: Scope in which this resource is defined.
        :param id: Construct identifier for this resource (unique in its scope).
        :param applicable_asset_types: The asset types that can be included in the subscription target.
        :param authorized_principals: The authorized principals of the subscription target.
        :param domain_identifier: The ID of the Amazon DataZone domain in which subscription target would be created.
        :param environment_identifier: The ID of the environment in which subscription target would be created.
