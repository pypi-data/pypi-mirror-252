...
class VisualTest:
    ...
    def capture(self, name, options: dict={}):
        ...
        if 'element' in options:
            ...
            imageType = 'fullpage'
        resizedImage, resizedImageWidth, resizedImageHeight = ImageTools.resizeImageByDpr(screenshotResult['imageBinary'], self.browser.devicePixelRatio)
        ...
        imageApiResult = self._api.saveImage(self._settings['testRunName'], self._settings['testGroupName'], imageData, screenshotResult['imageBinary'], json.dumps(self.browser.dom))
