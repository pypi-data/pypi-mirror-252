...
icons = {
    ...
    "charger_2": pkg_resources.resource_filename('EVsSimulator', "vizuals/icons/charging-station_2_port.png"),
    "charger_wallbox": pkg_resources.resource_filename('EVsSimulator', "vizuals/icons/charging-station_wallbox.png"),
