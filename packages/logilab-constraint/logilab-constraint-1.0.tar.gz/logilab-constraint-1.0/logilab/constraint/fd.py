...
class FiniteDomain(AbstractDomain, set):
    ...
    def __repr__(self):
        return f"<FiniteDomain {list(self)}>"
...
class AllDistinct(AbstractConstraint):
    ...
    def __repr__(self):
        return f"<AllDistinct {str(self._variables)}>"
    ...
    def narrow(self, domains):
        ...
        variables = [
            (domains[variable].size(), variable, domains[variable])
...
class Expression(AbstractConstraint):
    ...
    def __init__(self, variables, formula, type="fd.Expression"):
        ...
        try:
            ...
            self.filterFunc = eval(f"lambda {','.join(variables)}: {formula}", {}, {})
    ...
    def __repr__(self):
        return f'<{self.type} "{self.formula}">'
