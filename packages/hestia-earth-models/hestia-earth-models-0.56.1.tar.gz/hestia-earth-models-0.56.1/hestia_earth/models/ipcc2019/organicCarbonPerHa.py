...
def _should_run_tier_1(site: dict) -> tuple:
    ...
    soc_measurement_value, initial_soc_stock_date = most_relevant_measurement_value_by_depth_and_date(
        measurement_nodes,
        TERM_ID,
    ...
    initial_soc_stock_datetime = safe_parse_date(initial_soc_stock_date)
    soc_measurement_year = (
        initial_soc_stock_datetime.year if initial_soc_stock_datetime else None
    )
    ...
    print(ipcc_land_use_categories)

    logShouldRun(
        site, MODEL, TERM_ID, should_run,
        timestamps=log_as_table(timestamps),
        ipcc_land_use_categories=log_as_table(ipcc_land_use_categories),
        ipcc_management_categories=log_as_table(ipcc_management_categories),
        ipcc_carbon_input_categories=log_as_table(ipcc_carbon_input_categories),
