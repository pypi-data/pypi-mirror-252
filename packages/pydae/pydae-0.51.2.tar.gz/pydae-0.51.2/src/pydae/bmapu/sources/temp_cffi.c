...
: (
   ((u[2] < u[3] + u[2]) ? (
      u[4] < -sqrt(1 - pow(u[2], 2))
   )
   : (
      u[4] < -sqrt(1 - pow(u[3] + u[2], 2))
   ))
))) ? (
   -sqrt(1 - ((u[3] + u[2] < 0) ? (
      0.0
