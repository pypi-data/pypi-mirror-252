...
class model: 
    ...
    def __init__(self): 
        ...
        self.N_z = 5 
        self.N_store = 100000 
        self.params_list = ['S_base', 'U_1_n', 'S_n_1', 'K_p_agc', 'K_i_agc', 'K_xif'] 
        self.params_values_list  = [100000000, 20000, 10000000, 0, 0, 1e-06] 
        self.inputs_ini_list = ['P_1', 'Q_1', 'p_in_1', 'Dp_r_1', 'Dq_r_1', 'v_ref_1_0', 'theta_ref_1_0'] 
        self.inputs_ini_values_list  = [0, 0, 0.5, 0.0, 0.0, 1.0, 0.0] 
        self.inputs_run_list = ['P_1', 'Q_1', 'p_in_1', 'Dp_r_1', 'Dq_r_1', 'v_ref_1_0', 'theta_ref_1_0'] 
        self.inputs_run_values_list = [0, 0, 0.5, 0.0, 0.0, 1.0, 0.0] 
        self.outputs_list = ['V_1', 'p_in_1', 'Dp_r_1', 'Dq_r_1', 'V_dummy_1_0'] 
        self.x_list = ['V_dummy_1_0', 'xi_freq'] 
        self.y_run_list = ['V_1', 'theta_1', 'p_out_1', 'q_out_1', 'omega_coi', 'p_agc'] 
        self.xy_list = self.x_list + self.y_run_list 
        self.y_ini_list = ['V_1', 'theta_1', 'p_out_1', 'q_out_1', 'omega_coi', 'p_agc'] 
...
def sp_jac_ini_vectors():
    ...
    sp_jac_ini_ia = [0, 1, 6, 2, 3, 4, 5, 6, 1, 6, 7]
    sp_jac_ini_ja = [0, 1, 3, 4, 5, 6, 7, 8, 11]
    sp_jac_ini_nia = 8
    sp_jac_ini_nja = 8
...
def sp_jac_run_vectors():
    ...
    sp_jac_run_ia = [0, 1, 6, 2, 3, 4, 5, 6, 1, 6, 7]
    sp_jac_run_ja = [0, 1, 3, 4, 5, 6, 7, 8, 11]
    sp_jac_run_nia = 8
    sp_jac_run_nja = 8
...
def sp_jac_trap_vectors():
    ...
    sp_jac_trap_ia = [0, 1, 6, 2, 3, 4, 5, 6, 1, 6, 7]
    sp_jac_trap_ja = [0, 1, 3, 4, 5, 6, 7, 8, 11]
    sp_jac_trap_nia = 8
    sp_jac_trap_nja = 8
