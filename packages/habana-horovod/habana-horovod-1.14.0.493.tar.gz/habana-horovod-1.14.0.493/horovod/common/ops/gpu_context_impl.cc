...
#if HAVE_HCCL
  // Added by Habana.
  // Deleting pimpl also deletes the composed gpu_context in civilized manner, rather than waiting for global variable cleanup.
  // This prevents a segmentation fault in synDeviceRelease().
  pimpl.reset();
#endif
}
