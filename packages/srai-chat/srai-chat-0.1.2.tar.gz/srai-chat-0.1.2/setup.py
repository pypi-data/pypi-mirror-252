...
setup(
    ...
    description="A chat library frontend for srai services.",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/southriverai/srai-chat",
    download_url="https://github.com/southriverai/srai-chat/archive/v_01.tar.gz",
    keywords=["SRAI", "TOOLS"],
    classifiers=[
