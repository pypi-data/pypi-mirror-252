...
class MessageLocal(Item, CompoundMessage, GenericCRUD):
    ...
    def __init__(self, *, campaign_id: int, to_recipients: List[Recipient], api_type_id: int,
        ...
        logger.start()
        CompoundMessage.__init__(self,
                                 message_id=message_id, campaign_id=campaign_id, body=original_body,
    ...
    def get_body_after_text_template(self, recipient: Recipient = None,
        ...
        body = ""
        for profile_block in self.__compound_message[message_channel.name]["bodyBlocks"]["profileBlocks"]:
    ...
    def insert_message(self, parent_message_id: int = None,
        ...
        message_id = super().insert(data_json=data_json)
        return message_id
