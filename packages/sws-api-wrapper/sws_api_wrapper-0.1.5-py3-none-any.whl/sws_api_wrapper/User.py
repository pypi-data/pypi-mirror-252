...
class User:
    ...
    def __init__(self, token: str) -> None:       
        ...
        self.id: int = get_sws_id_from_token(self.token)
        
        self.institution: dict[str, Any] = get_institution_infos(self.token)
    ...
    def is_course_signed(self, course: Course) -> bool:
        ...
        return result != {} and result['status'] == "signed"
    ...
    def __str__(self) -> str:
        return f"Course({self.id} --- {self.institution})"
