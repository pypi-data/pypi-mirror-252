...
def get_hate(table, column, enum, description):
    ...
    description += " " + "'"+column+"_hate' column provides information about whether the '"+column+"' column' contains hate speech - "+"IMPORTANT: the values of '" +column+"_hate' column can only be 'implicit_hate', 'explicit_hate', and 'not_hate' - both 'implicit_hate' and 'explicit_hate' imply that the '"+column+"' column contains hate speech; "
        ...
        },
        {
            ...
            "parameters": {
                ...
                "properties": {
                    "column": {
                        "type": "string",
                        "description": "The column to apply (high-level) hate speech detection. You have to select one column in the 'enum' field to apply sentiment analysis based on the description: "+description,
                        "enum": column_description
                    }
                },
                "required": ["column"]
        ...
        },
        {
            ...
            "parameters": {
                ...
                "properties": {
                    "column": {
                        "type": "string",
                        "description": "The column to apply (fine-grained) implicit hate speech classification. You have to select one column in the 'enum' field to apply sentiment analysis based on the description: "+description,
                        "enum": column_description
                    }
                },
                "required": ["column"]
