...
def schema_gpt(user_query, column_description, description):
    ...
    functions = [
        ...
        # },
        {
            ...
            "description": 
            ''' 
            This function takes in one column of text and one column of emotion class as input, extracts the triggering sentence in the text column that triggers a specific emotion in the emotion class column, and generates a new column to include those.
            ''',
            "parameters": {
                "type": "object",
                "properties": {"column": {
