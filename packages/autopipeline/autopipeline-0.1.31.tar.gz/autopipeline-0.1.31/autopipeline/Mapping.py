...
def get_emotion(table, column, enum, description):
    ...
    description += " " + "'"+column+"_emotion' column provides emotion identified from the '"+column+"' column'."+"IMPORTANT: sentiment values of '" +column+"_sentiment' column can only be either 'sadness', 'joy', 'love', 'anger', 'fear', or 'surprise'; "
