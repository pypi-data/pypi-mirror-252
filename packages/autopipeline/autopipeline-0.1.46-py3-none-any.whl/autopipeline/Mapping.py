...
def get_hate(table, column, enum, description):
    ...
    description += " " + "'"+column+"_hate' column, whose values can ONLY be one of 'implicit_hate', 'explicit_hate', or 'not_hate', provides information about whether the '"+column+"' column' contains hate speech - "+"IMPORTANT: both 'implicit_hate' and 'explicit_hate' imply that the '"+column+"' column contains hate speech; "
