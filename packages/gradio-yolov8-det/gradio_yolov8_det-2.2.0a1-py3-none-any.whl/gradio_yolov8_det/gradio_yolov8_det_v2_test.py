...
EXAMPLES_DET = [
    [ROOT / "img_examples/bus.jpg", "yolov8s", "cpu", 640, 0.6, 0.5, 100, [], "所有尺寸"],
    [
        ROOT / "img_examples/giraffe.jpg",
        "yolov8l",
        "cpu",
        320,
        0.5,
    ...
    [
        ROOT / "img_examples/Millenial-at-work.jpg",
        "yolov8x",
        "cpu",
        1280,
        0.5,
...
EXAMPLES_CLAS = [
    [ROOT / "img_examples/img_clas/ILSVRC2012_val_00000008.JPEG", "cpu", "yolov8s-cls"],
    [ROOT / "img_examples/img_clas/ILSVRC2012_val_00000018.JPEG", "cpu", "yolov8l-cls"],
    [ROOT / "img_examples/img_clas/ILSVRC2012_val_00000023.JPEG", "cpu", "yolov8m-cls"],
    [ROOT / "img_examples/img_clas/ILSVRC2012_val_00000067.JPEG", "cpu", "yolov8m-cls"],
    [ROOT / "img_examples/img_clas/ILSVRC2012_val_00000077.JPEG", "cpu", "yolov8m-cls"],
    [ROOT / "img_examples/img_clas/ILSVRC2012_val_00000247.JPEG", "cpu", "yolov8m-cls"],
]
...
def yolo_det_img(
    ...
    if xyxy_list != []:
        ...
        tracks = model.track(img_cv2, persist=False, show=False)

        img_heatmap = heatmap_obj.generate_heatmap(img_cv2, tracks)

        # ------------ 下载图片 ------------
        img_heatmap_pil = Image.fromarray(cv2.cvtColor(img_heatmap, cv2.COLOR_BGR2RGB))
        images = (det_img, img_heatmap_pil, img_cp)
        images_names = ("det", "heatmap", "raw")
        ...
        if img_cmpt_show == "raw&det":
            return (det_img, img_cp), images_paths, objSize_dict, clsRatio_dict
        elif img_cmpt_show == "raw&heatmap":
            return (img_heatmap_pil, img_cp), images_paths, objSize_dict, clsRatio_dict
        elif img_cmpt_show == "det&heatmap":
            return (det_img, img_heatmap_pil), images_paths, objSize_dict, clsRatio_dict
        else:
            raise gr.Error("显示模式出现问题！")
    else:
