...
class Token(Span):
    text: Optional[str] = Field(
        None, description="Text of the token", example="did"
    )
    pos: Optional[str] = Field(
        None, description="Part of speechof the token", example="VERB"
    )
    lemma: Optional[str] = Field(
        None, description="Lemma of the token", example="do"
    )
    properties: Optional[Dict[str, Any]] = Field(
        None, description="Properties of the token"
    )
...
class Document(BaseModel):
    ...
    tokens: Optional[List[Token]] = Field(
        None, description="Document tokens"
    )
