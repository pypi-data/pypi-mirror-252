...
class MySql2S3(
    ...
    def __init__(
        ...
        *,
        ...
        my_sql_source_endpoint_settings: typing.Union["MySqlSettings", typing.Dict[builtins.str, typing.Any]],
        ...
        :param bucket_arn: 
        :param database_name: 
        :param my_sql_source_endpoint_settings: 
        ...
        props = MySql2S3Props(
            ...
            my_sql_source_endpoint_settings=my_sql_source_endpoint_settings,
...
@jsii.data_type(
    ...
    name_mapping={
        ...
        "my_sql_source_endpoint_settings": "mySqlSourceEndpointSettings",
...
class MySql2S3Props:
    def __init__(
        ...
        *,
        ...
        :param task_settings: 
        '''
        if isinstance(my_sql_source_endpoint_settings, dict):
            my_sql_source_endpoint_settings = MySqlSettings(**my_sql_source_endpoint_settings)
        ...
        if __debug__:
            ...
            check_type(argname="argument my_sql_source_endpoint_settings", value=my_sql_source_endpoint_settings, expected_type=type_hints["my_sql_source_endpoint_settings"])
    ...
    @builtins.property
    def my_sql_source_endpoint_settings(self) -> "MySqlSettings":
        result = self._values.get("my_sql_source_endpoint_settings")
        assert result is not None, "Required property 'my_sql_source_endpoint_settings' is missing"
...
@jsii.data_type(
    jsii_type="dms-patterns.MySqlSourceProps",
    jsii_struct_bases=[],
    name_mapping={
        "database_name": "databaseName",
...
class MySqlSourceProps:
    def __init__(
        ...
        *,
        ...
        if isinstance(my_sql_source_endpoint_settings, dict):
            my_sql_source_endpoint_settings = MySqlSettings(**my_sql_source_endpoint_settings)
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__68ede98c5a69e20feb3fa37a3aede2983e5c53298789d6da530a4b09027b520c)
            check_type(argname="argument database_name", value=database_name, expected_type=type_hints["database_name"])
    ...
    def __repr__(self) -> str:
        return "MySqlSourceProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class PostgreSQLEndpoint(
    ...
    def __init__(
        ...
        *,
        ...
        endpoint_identifier: builtins.str,
        endpoint_type: builtins.str,
        postgres_source_endpoint_settings: typing.Union["PostgreSqlSettings", typing.Dict[builtins.str, typing.Any]],
        ...
        :param endpoint_identifier: The database endpoint identifier. Identifiers must begin with a letter and must contain only ASCII letters, digits, and hyphens. They can't end with a hyphen, or contain two consecutive hyphens.
        :param endpoint_type: The type of endpoint.
        :param postgres_source_endpoint_settings: The settings for the source postgres endpoint.
        ...
        if __debug__:
            ...
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        props = PostgresSourceProps(
            database_name=database_name,
            endpoint_identifier=endpoint_identifier,
            endpoint_type=endpoint_type,
            postgres_source_endpoint_settings=postgres_source_endpoint_settings,
            port=port,
            ssl_mode=ssl_mode,
        )
...
@jsii.data_type(
    jsii_type="dms-patterns.PostgresSourceProps",
    jsii_struct_bases=[],
    name_mapping={
        "database_name": "databaseName",
        "endpoint_identifier": "endpointIdentifier",
        "endpoint_type": "endpointType",
        "postgres_source_endpoint_settings": "postgresSourceEndpointSettings",
        "port": "port",
        "ssl_mode": "sslMode",
    },
)
class PostgresSourceProps:
    def __init__(
        self,
        *,
        database_name: builtins.str,
        ...
        :param ssl_mode: The Secure Sockets Layer (SSL) mode to use for the SSL connection. The default is ``none`` . .. epigraph:: When ``engine_name`` is set to S3, the only allowed value is ``none`` .
        '''
        if isinstance(postgres_source_endpoint_settings, dict):
            postgres_source_endpoint_settings = PostgreSqlSettings(**postgres_source_endpoint_settings)
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f2c1b9f8d04f4c1808a5ecca919ac64f9800187cd39bb34d0d2729e049f72dc5)
            check_type(argname="argument database_name", value=database_name, expected_type=type_hints["database_name"])
            check_type(argname="argument endpoint_identifier", value=endpoint_identifier, expected_type=type_hints["endpoint_identifier"])
            check_type(argname="argument endpoint_type", value=endpoint_type, expected_type=type_hints["endpoint_type"])
            check_type(argname="argument postgres_source_endpoint_settings", value=postgres_source_endpoint_settings, expected_type=type_hints["postgres_source_endpoint_settings"])
    ...
    @builtins.property
    def postgres_source_endpoint_settings(self) -> PostgreSqlSettings:
        '''The settings for the source postgres endpoint.'''
        result = self._values.get("postgres_source_endpoint_settings")
        assert result is not None, "Required property 'postgres_source_endpoint_settings' is missing"
        return typing.cast(PostgreSqlSettings, result)
    ...
    def __repr__(self) -> str:
        return "PostgresSourceProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class S3Schema(metaclass=jsii.JSIIMeta, jsii_type="dms-patterns.S3Schema"):
    ...
    def add_table(
        self,
        *,
        table_columns: typing.Sequence[typing.Union["TableColumn", typing.Dict[builtins.str, typing.Any]]],
...
class Table:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__41588d0601f6b9dcf229ca80e3fa5a39bd4e422182e6c777c3f994e0c29aa5b3)
...
@jsii.data_type(
    jsii_type="dms-patterns.TableColumn",
    jsii_struct_bases=[],
    name_mapping={
...
class TableColumn:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1ce684c71dee3bd68d9af049cf8da2d60016d29134c6c1b0cb408b6a8431f151)
...
def _typecheckingstub__68ede98c5a69e20feb3fa37a3aede2983e5c53298789d6da530a4b09027b520c(
    *,
    database_name: builtins.str,
    endpoint_identifier: builtins.str,
    endpoint_type: builtins.str,
...
def _typecheckingstub__f2c1b9f8d04f4c1808a5ecca919ac64f9800187cd39bb34d0d2729e049f72dc5(
    *,
    database_name: builtins.str,
    endpoint_identifier: builtins.str,
    endpoint_type: builtins.str,
...
def _typecheckingstub__41588d0601f6b9dcf229ca80e3fa5a39bd4e422182e6c777c3f994e0c29aa5b3(
    *,
    table_columns: typing.Sequence[typing.Union[TableColumn, typing.Dict[builtins.str, typing.Any]]],
    table_name: builtins.str,
    table_owner: builtins.str,
...
def _typecheckingstub__1ce684c71dee3bd68d9af049cf8da2d60016d29134c6c1b0cb408b6a8431f151(
    *,
    column_name: builtins.str,
    column_type: S3DataType,
    column_date_format: typing.Optional[builtins.str] = None,
