class KhansaarRelations:
    def __init__(self):
        self.relations = {}
        self.vote_counts = {
        "ghaniyar": {"vaali": 3, "gurung": 3, "cheeka": 3, "ranga": 3, "narang": 3, "vishnu": 0},
        "mannar": {"shiva_mannar": 0, "raja_mannar": 15, "varadha_raj_mannar": 1,
                   "baachi": 0, "rudra": 3, "radha_rama": 0, "om": 3},
        "shouryaanga": {"dhaara": 1, "devaratha_raisaar": 1, "baarava": 1, "dheera": 1}
    }
...
if __name__ == "__main__":
    salaar_relations = KhansaarRelations()
