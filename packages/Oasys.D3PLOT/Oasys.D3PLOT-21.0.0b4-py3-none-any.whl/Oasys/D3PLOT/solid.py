...
# Static methods
    ...
    def GetMultipleData(component, items):
        """
        ...
        None
            No return value
        """
        return Oasys.D3PLOT._connection.classMethod(__class__.__name__, "GetMultipleData", component, items)
...
# Instance methods
    ...
    def GetData(self, component):
        ...
        """
        return Oasys.D3PLOT._connection.instanceMethod(self.__class__.__name__, self._handle, "GetData", component)
    ...
    def PlasticStrain(self):
        ...
        float
            Plastic strain
        """
        return Oasys.D3PLOT._connection.instanceMethod(self.__class__.__name__, self._handle, "PlasticStrain")
    ...
    def StrainTensor(self):
        ...
        """
        return Oasys.D3PLOT._connection.instanceMethod(self.__class__.__name__, self._handle, "StrainTensor")
    ...
    def StressTensor(self):
        ...
        """
        return Oasys.D3PLOT._connection.instanceMethod(self.__class__.__name__, self._handle, "StressTensor")
    ...
    def VonMisesStress(self):
        ...
        float
            von Mises stress
        """
        return Oasys.D3PLOT._connection.instanceMethod(self.__class__.__name__, self._handle, "VonMisesStress")
