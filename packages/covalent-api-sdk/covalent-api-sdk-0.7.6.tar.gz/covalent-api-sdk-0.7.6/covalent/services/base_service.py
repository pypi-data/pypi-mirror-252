...
class BaseService:
    ...
    def get_block(self, chain_name: Union[chain, Chains], block_height: str) -> Response[BlockResponse]:
        """
    ...
    def get_resolved_address(self, chain_name: Union[chain, Chains], wallet_address: str) -> Response[ResolvedAddress]:
        """
    ...
    async def get_block_heights(self, chain_name: Union[chain, Chains], start_date: str, end_date: str, page_size: Optional[int] = None, page_number: Optional[int] = None) -> AsyncIterable[Block]:
        """
    ...
    def get_block_heights_by_page(self, chain_name: Union[chain, Chains], start_date: str, end_date: str, page_size: Optional[int] = None, page_number: Optional[int] = None) -> Response[BlockResponse]:
        """
        Commonly used to get all the block heights within a particular date range. Useful for rendering a display where you sort blocks by day.
    ...
    def get_logs(self, chain_name: Union[chain, Chains], starting_block: Optional[int] = None, ending_block: Optional[str] = None, address: Optional[str] = None, topics: Optional[str] = None, block_hash: Optional[str] = None, skip_decode: Optional[bool] = None) -> Response[GetLogsResponse]:
        """
    ...
    async def get_log_events_by_address(self, chain_name: Union[chain, Chains], contract_address: str, starting_block: Optional[int] = None, ending_block: Optional[str] = None, page_size: Optional[int] = None, page_number: Optional[int] = None) -> AsyncIterable[LogEvent]:
        """
    ...
    def get_log_events_by_address_by_page(self, chain_name: Union[chain, Chains], contract_address: str, starting_block: Optional[int] = None, ending_block: Optional[str] = None, page_size: Optional[int] = None, page_number: Optional[int] = None) -> Response[LogEventsByAddressResponse]:
        """
        Commonly used to get all the event logs emitted from a particular contract address. Useful for building dashboards that examine on-chain interactions.
    ...
    async def get_log_events_by_topic_hash(self, chain_name: Union[chain, Chains], topic_hash: str, starting_block: Optional[int] = None, ending_block: Optional[str] = None, secondary_topics: Optional[str] = None, page_size: Optional[int] = None, page_number: Optional[int] = None) -> AsyncIterable[LogEvent]:
        """
    ...
    def get_log_events_by_topic_hash_by_page(self, chain_name: Union[chain, Chains], topic_hash: str, starting_block: Optional[int] = None, ending_block: Optional[str] = None, secondary_topics: Optional[str] = None, page_size: Optional[int] = None, page_number: Optional[int] = None) -> Response[LogEventsByTopicHashResponse]:
        """
        Commonly used to get all event logs of the same topic hash across all contracts within a particular chain. Useful for cross-sectional analysis of event logs that are emitted on-chain.
    ...
    def get_gas_prices(self, chain_name: Union[chain, Chains], event_type: str, quote_currency: Optional[quote] = None) -> Response[GasPricesResponse]:
        """
        Parameters:
