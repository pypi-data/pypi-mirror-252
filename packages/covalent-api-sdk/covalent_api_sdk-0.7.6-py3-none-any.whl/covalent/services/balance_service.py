...
class BalanceService:
    ...
    def get_token_balances_for_wallet_address(self, chain_name: Union[chain, Chains], wallet_address: str, quote_currency: Optional[quote] = None, nft: Optional[bool] = None, no_nft_fetch: Optional[bool] = None, no_spam: Optional[bool] = None, no_nft_asset_metadata: Optional[bool] = None) -> Response[BalancesResponse]:
        """
    ...
    def get_historical_portfolio_for_wallet_address(self, chain_name: Union[chain, Chains], wallet_address: str, quote_currency: Optional[quote] = None, days: Optional[int] = None) -> Response[PortfolioResponse]:
        """
    ...
    async def get_token_holders_v2_for_token_address(self, chain_name: Union[chain, Chains], token_address: str, block_height: Optional[int] = None, date: Optional[str] = None, page_size: Optional[int] = None, page_number: Optional[int] = None) -> AsyncIterable[TokenHolder]:
        """
    ...
    def get_token_holders_v2_for_token_address_by_page(self, chain_name: Union[chain, Chains], token_address: str, block_height: Optional[int] = None, date: Optional[str] = None, page_size: Optional[int] = None, page_number: Optional[int] = None) -> Response[TokenHoldersResponse]:
        """
        Commonly used to get a list of all the token holders for a specified ERC20 or ERC721 token. Returns historic token holders when block-height is set (defaults to `latest`). Useful for building pie charts of token holders.
    ...
    def get_native_token_balance(self, chain_name: Union[chain, Chains], wallet_address: str, quote_currency: Optional[quote] = None, block_height: Optional[int] = None) -> Response[TokenBalanceNativeResponse]:
        """
        Parameters:
