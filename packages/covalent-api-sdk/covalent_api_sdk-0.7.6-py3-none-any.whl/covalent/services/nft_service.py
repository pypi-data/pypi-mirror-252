...
class NftService:
    ...
    async def get_chain_collections(self, chain_name: Union[chain, Chains], page_size: Optional[int] = None, page_number: Optional[int] = None, no_spam: Optional[bool] = None) -> AsyncIterable[ChainCollectionItem]:
        """
    ...
    def get_chain_collections_by_page(self, chain_name: Union[chain, Chains], page_size: Optional[int] = None, page_number: Optional[int] = None, no_spam: Optional[bool] = None) -> Response[ChainCollectionResponse]:
        """
        Commonly used to fetch the list of NFT collections with downloaded and cached off chain data like token metadata and asset files.
    ...
    def get_nfts_for_address(self, chain_name: Union[chain, Chains], wallet_address: str, no_spam: Optional[bool] = None, no_nft_asset_metadata: Optional[bool] = None, with_uncached: Optional[bool] = None) -> Response[NftAddressBalanceNftResponse]:
        """
    ...
    async def get_token_ids_for_contract_with_metadata(self, chain_name: Union[chain, Chains], contract_address: str, no_metadata: Optional[bool] = None, page_size: Optional[int] = None, page_number: Optional[int] = None, traits_filter: Optional[str] = None, values_filter: Optional[str] = None, with_uncached: Optional[bool] = None) -> AsyncIterable[NftTokenContract]:
        """
    ...
    def get_token_ids_for_contract_with_metadata_by_page(self, chain_name: Union[chain, Chains], contract_address: str, no_metadata: Optional[bool] = None, page_size: Optional[int] = None, page_number: Optional[int] = None, traits_filter: Optional[str] = None, values_filter: Optional[str] = None, with_uncached: Optional[bool] = None) -> Response[NftMetadataResponse]:
        """
        Commonly used to get NFT token IDs with metadata from a collection. Useful for building NFT card displays.
    ...
    def get_nft_metadata_for_given_token_id_for_contract(self, chain_name: Union[chain, Chains], contract_address: str, token_id: str, no_metadata: Optional[bool] = None, with_uncached: Optional[bool] = None) -> Response[NftMetadataResponse]:
        """
    ...
    def get_nft_transactions_for_contract_token_id(self, chain_name: Union[chain, Chains], contract_address: str, token_id: str, no_spam: Optional[bool] = None) -> Response[NftTransactionsResponse]:
        """
    ...
    def get_traits_for_collection(self, chain_name: Union[chain, Chains], collection_contract: str) -> Response[NftCollectionTraitsResponse]:
        """
    ...
    def get_attributes_for_trait_in_collection(self, chain_name: Union[chain, Chains], collection_contract: str, trait: str) -> Response[NftCollectionAttributesForTraitResponse]:
        """
    ...
    def get_collection_traits_summary(self, chain_name: Union[chain, Chains], collection_contract: str) -> Response[NftCollectionTraitSummaryResponse]:
        """
    ...
    def check_ownership_in_nft(self, chain_name: Union[chain, Chains], wallet_address: str, collection_contract: str) -> Response[NftOwnershipForCollectionResponse]:
        """
    ...
    def check_ownership_in_nft_for_specific_token_id(self, chain_name: Union[chain, Chains], wallet_address: str, collection_contract: str, token_id: str) -> Response[NftOwnershipForCollectionResponse]:
        """
    ...
    def get_nft_market_sale_count(self, chain_name: Union[chain, Chains], contract_address: str, days: Optional[int] = None, quote_currency: Optional[quote] = None) -> Response[NftMarketSaleCountResponse]:
        """
    ...
    def get_nft_market_volume(self, chain_name: Union[chain, Chains], contract_address: str, days: Optional[int] = None, quote_currency: Optional[quote] = None) -> Response[NftMarketVolumeResponse]:
        """
    ...
    def get_nft_market_floor_price(self, chain_name: Union[chain, Chains], contract_address: str, days: Optional[int] = None, quote_currency: Optional[quote] = None) -> Response[NftMarketFloorPriceResponse]:
        """
