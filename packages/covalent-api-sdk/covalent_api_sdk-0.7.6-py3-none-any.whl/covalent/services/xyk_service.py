...
class XykService:
    ...
    def get_pools(self, chain_name: Union[chain, Chains], dex_name: str) -> Response[PoolResponse]:
        """
    ...
    def get_dex_for_pool_address(self, chain_name: Union[chain, Chains], pool_address: str) -> Response[PoolToDexResponse]:
        """
    ...
    def get_pool_by_address(self, chain_name: Union[chain, Chains], dex_name: str, pool_address: str) -> Response[PoolByAddressResponse]:
        """
    ...
    def get_pools_for_token_address(self, chain_name: Union[chain, Chains], token_address: str, page: int, quote_currency: Optional[quote] = None, dex_name: Optional[str] = None) -> Response[PoolsDexDataResponse]:
        """
    ...
    def get_address_exchange_balances(self, chain_name: Union[chain, Chains], dex_name: str, account_address: str) -> Response[AddressExchangeBalancesResponse]:
        """
    ...
    def get_pools_for_wallet_address(self, chain_name: Union[chain, Chains], wallet_address: str, page: int, token_address: Optional[str] = None, quote_currency: Optional[quote] = None, dex_name: Optional[str] = None) -> Response[PoolsDexDataResponse]:
        """
    ...
    def get_network_exchange_tokens(self, chain_name: Union[chain, Chains], dex_name: str) -> Response[NetworkExchangeTokensResponse]:
        """
    ...
    def get_single_network_exchange_token(self, chain_name: Union[chain, Chains], dex_name: str, token_address: str) -> Response[SingleNetworkExchangeTokenResponse]:
        """
    ...
    def get_transactions_for_account_address(self, chain_name: Union[chain, Chains], dex_name: str, account_address: str) -> Response[TransactionsForAccountAddressResponse]:
        """
    ...
    def get_transactions_for_token_address(self, chain_name: Union[chain, Chains], dex_name: str, token_address: str) -> Response[TransactionsForTokenAddressResponse]:
        """
    ...
    def get_transactions_for_exchange(self, chain_name: Union[chain, Chains], dex_name: str, pool_address: str) -> Response[TransactionsForExchangeResponse]:
        """
    ...
    def get_ecosystem_chart_data(self, chain_name: Union[chain, Chains], dex_name: str) -> Response[EcosystemChartDataResponse]:
        """
    ...
    def get_health_data(self, chain_name: Union[chain, Chains], dex_name: str) -> Response[HealthDataResponse]:
        """
