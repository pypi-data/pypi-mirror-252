...
class TransactionService:
    ...
    def get_transaction(self, chain_name: Union[chain, Chains], tx_hash: str, quote_currency: Optional[quote] = None, no_logs: Optional[bool] = None, with_dex: Optional[bool] = None, with_nft_sales: Optional[bool] = None, with_lending: Optional[bool] = None, with_safe: Optional[bool] = None) -> Response[TransactionResponse]:
        """
    ...
    async def get_all_transactions_for_address(self, chain_name: Union[chain, Chains], wallet_address: str, quote_currency: Optional[quote] = None, no_logs: Optional[bool] = None, block_signed_at_asc: Optional[bool] = None, with_safe: Optional[bool] = None) -> AsyncIterable[Transaction]:
        """
    ...
    def get_all_transactions_for_address_by_page(self, chain_name: Union[chain, Chains], wallet_address: str, quote_currency: Optional[quote] = None, no_logs: Optional[bool] = None, block_signed_at_asc: Optional[bool] = None, with_safe: Optional[bool] = None) -> Response[RecentTransactionsResponse]:
        """
        Commonly used to fetch and render the most recent transactions involving an address. Frequently seen in wallet applications.
    ...
    def get_transactions_for_block(self, chain_name: Union[chain, Chains], block_height: int, quote_currency: Optional[quote] = None, no_logs: Optional[bool] = None, with_safe: Optional[bool] = None) -> Response[TransactionsBlockResponse]:
        """
    ...
    def get_transaction_summary(self, chain_name: Union[chain, Chains], wallet_address: str) -> Response[TransactionsSummaryResponse]:
        """
    ...
    def get_transactions_for_address_v3(self, chain_name: Union[chain, Chains], wallet_address: str, page: int, quote_currency: Optional[quote] = None, no_logs: Optional[bool] = None, block_signed_at_asc: Optional[bool] = None, with_safe: Optional[bool] = None) -> Response[TransactionsResponse]:
        """
        Parameters:
    ...
    def get_time_bucket_transactions_for_address(self, chain_name: Union[chain, Chains], wallet_address: str, time_bucket: int, quote_currency: Optional[quote] = None, no_logs: Optional[bool] = None, with_safe: Optional[bool] = None) -> Response[TransactionsTimeBucketResponse]:
        """
        Parameters:
