...
class SecurityService:
    ...
    def get_approvals(self, chain_name: Union[chain, Chains], wallet_address: str) -> Response[ApprovalsResponse]:
        """
    ...
    def get_nft_approvals(self, chain_name: Union[chain, Chains], wallet_address: str) -> Response[NftApprovalsResponse]:
        """
        Parameters:
