...
class PricingService:
    ...
    def get_token_prices(self, chain_name: Union[chain, Chains], quote_currency: quote, contract_address: str, _from: Optional[str] = None, _to: Optional[str] = None, prices_at_asc: Optional[bool] = None) -> Response[TokenPricesResponse]:
        """
