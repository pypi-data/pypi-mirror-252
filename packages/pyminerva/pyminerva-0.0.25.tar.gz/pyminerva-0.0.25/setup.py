...
python -m twine upload dist/*
    ...
    pypi-AgEIcHlwaS5vcmcCJDA3ZTk5YzFiLWJiNzItNDVjOS1iZGZiLWU1MjFjNmUwNmQyYgACEVsxLFsicHltaW5lcnZhIl1dAAIsWzIsWyI4MWRjZDdlNC00NWEzLTQ1NGItOTU2ZC01YmNiN2UxZGNlOTciXV0AAAYgsXZcq3TpT-Ap4InjQYoRNeRkJlWaZr5pcUavLJ1xD3E
    )
...
setup(
    name='pyminerva',
    version='0.0.25',    # version.directory.file
