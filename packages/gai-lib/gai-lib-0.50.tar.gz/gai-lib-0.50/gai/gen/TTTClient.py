...
from gai.gen.OpenAIChunkWrapper import OpenAIChunkWrapper
from gai.gen.AnthropicChunkWrapper import AnthropicChunkWrapper
...
class TTTClient:
    ...
    def api(self, generator=None, messages=None, stream=True, **generator_params):
        ...
        try:
            cli_baseurl = cli_config["generators"][generator]["url"]
            response = http_post(f"{cli_baseurl}/completions",data)
        except HttpException as he:
            if he.code=="context_length_exceeded":
                try:
                    data["model"]="mistral7b_128k-exllama"
