...
def batch_rename(
    ...
    ''' Rename multiple items at once :File: `startup/bl_operators/wm.py\:3209 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/wm.py#L3209>`__
...
def drop_blend_file(
        ...
        *,
        filepath: typing.Union[str, typing.Any] = ""):
    ''' Undocumented, consider `contributing <https://developer.blender.org/>`__. :File: `startup/bl_operators/wm.py\:3560 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/wm.py#L3560>`__
