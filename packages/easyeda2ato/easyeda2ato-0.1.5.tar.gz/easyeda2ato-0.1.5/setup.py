...
setup(
    ...
    long_description="Credit to uPeasy, forked from https://pypi.org/project/easyeda2kicad/",
    long_description_content_type="text/markdown",
    version="0.1.5",
    author="Narayan Powderly",
    author_email="",
    url="https://github.com/napowderly/easyeda2kicad.py",
    project_urls={
        "Code": "https://github.com/napowderly/easyeda2kicad.py",
    },
    # download_url='',
    license="AGPL-3.0",
