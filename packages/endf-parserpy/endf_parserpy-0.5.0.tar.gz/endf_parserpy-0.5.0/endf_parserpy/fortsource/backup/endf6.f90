...
!
 interface readmf3mt
   module procedure readmf3mt_std
   module procedure readmf3mt_ext
 end interface readmf3mt
!
 interface wrtmf3mt
   module procedure wrtmf3mt_std
   module procedure wrtmf3mt_ext
   module procedure wrtmf3mt_law
   module procedure wrtmf3mt_lin
 end interface wrtmf3mt 
!
 contains
!
! 1. Procedures for reading and writing ENDF-6 records:
! ----------------------------------------------------
!
! ========================================================================================
...
! =========================================================================================
!
! 2. Auxiliary procedures for preparing ENDF-6 records:
! ----------------------------------------------------
!  
! =========================================================================================
...
!                       ibtu = array containing the interpolation law between (Xi,Xi+1) 
! ========================================================================================
  subroutine unpackibt(nr,nbt,ibt,nru,ibtu)
...
! ========================================================================================  
!
! 3. Procedures for reading/writing ENDF-6 tapes and searching [mat,mf,mt] structures:
! -----------------------------------------------------------------------------------
!
! ========================================================================================
...
! ========================================================================================  
!
! 4. Procedures for reading and writing ENDF-6/MF3/MT sections:
! ------------------------------------------------------------
!
! ========================================================================================
! subroutine readmf3mt_std: Read one MF3 section MT(cross section data). Use packed ibt
! ======================================================================================== 
  subroutine readmf3mt_std(nin,jin,za,awr,qm,qi,lr,nr,nbt,ibt,np,x,y)
    implicit real*8 (a-h, o-z)
    character*80 nin(*)
    dimension nbt(*),ibt(*),x(*),y(*)
...
! ========================================================================================
  subroutine readmf3mt_ext(nin,jin,za,awr,qm,qi,lr,nr,ibt,np,x,y)
    implicit real*8 (a-h, o-z)
    parameter (nrmax=20)
    character*80 nin(*)
    dimension ibt(*),x(*),y(*)
    dimension nbt(nrmax),jbt(nrmax)
    call readmf3mt_std(nin,jin,za,awr,qm,qi,lr,nrj,nbt,jbt,np,x,y)
    call unpackibt(nrj,nbt,jbt,nr,ibt)
    return
  end subroutine readmf3mt_ext 
! ========================================================================================
! subroutine wrtmf3mt_std: Write one MF3 section MT(cross section data). Use packed ibt
! ======================================================================================== 
  subroutine wrtmf3mt_std(nou,jou,mat,mf,mt,za,awr,qm,qi,lr,nr,nbt,ibt,np,x,y)
    implicit real*8 (a-h, o-z)
    character*80 nou(*)
    dimension nbt(*),ibt(*),x(*),y(*)
    l1=0
...
! ========================================================================================
  subroutine wrtmf3mt_ext(nou,jou,mat,mf,mt,za,awr,qm,qi,lr,nr,ibt,np,x,y)
    implicit real*8 (a-h, o-z)
    parameter (nrmax=20)
    character*80 nou(*)
    dimension ibt(*),x(*),y(*)
    ...
    call wrtmf3mt_std(nou,jou,mat,mf,mt,za,awr,qm,qi,lr,nrj,nbt,jbt,np,x,y)
    return
  end subroutine wrtmf3mt_ext
! ========================================================================================
! subroutine wrtmf3mt_law: Write one MF3 section MT(cross section data). Use lin-lin 
! ========================================================================================  
  subroutine wrtmf3mt_law(nou,jou,mat,mf,mt,za,awr,qm,qi,lr,ilaw,np,x,y)
    implicit real*8 (a-h, o-z)
    character*80 nou(*)
    dimension x(*),y(*)
    ...
    nbt(1)=np
    ibt(1)=ilaw
    call wrtmf3mt_std(nou,jou,mat,mf,mt,za,awr,qm,qi,lr,nr,nbt,ibt,np,x,y)
    return
