...
class ExecutorAgent(BaseAgent):
    ...
    def _arun_step(self, output_message: Message, query: Message, self_memory: Memory, 
        ...
        prompt = self.prompt_manager.generate_full_prompt(
            previous_agent_message=query, agent_long_term_memory=self_memory, ui_history=history, chain_summary_messages=background, memory_pool=memory_manager.current_memory,
