...
class StatuspageConfigV1Config(BaseModel):
    """
    ...
    api_key: Optional[SecretStr] = Field(default=None, description="Your Statuspage API Key.")
    organization: Optional[StrictStr] = Field(default=None, description="Your Statuspage Organization ID.")
    __properties: ClassVar[List[str]] = ["schema", "api_key", "organization"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StatuspageConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StatuspageConfigV1Config from a dict"""
        if obj is None:
            return None
