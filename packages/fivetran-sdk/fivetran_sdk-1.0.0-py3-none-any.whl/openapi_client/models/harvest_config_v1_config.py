...
class HarvestConfigV1Config(BaseModel):
    """
    ...
    account_id: Optional[StrictStr] = Field(default=None, description="Your Harvest Account ID.")
    personal_access_token: Optional[SecretStr] = Field(default=None, description="Your Harvest Personal Access Token.")
    __properties: ClassVar[List[str]] = ["schema", "account_id", "personal_access_token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HarvestConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HarvestConfigV1Config from a dict"""
        if obj is None:
            return None
