...
class StripeConfigV1Auth(BaseModel):
    """
    
    """ # noqa: E501
    access_token: Optional[StrictStr] = Field(default=None, description="The Stripe API Restricted Key")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StripeConfigV1Auth from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StripeConfigV1Auth from a dict"""
        if obj is None:
            return None
