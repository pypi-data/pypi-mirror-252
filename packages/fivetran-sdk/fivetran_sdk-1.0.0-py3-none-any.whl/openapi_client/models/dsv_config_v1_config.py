...
class DsvConfigV1Config(BaseModel):
    """
    ...
    dsv_subscription_key: Optional[SecretStr] = None
    dsv_service_auth: Optional[SecretStr] = None
    __properties: ClassVar[List[str]] = ["schema", "dsv_subscription_key", "dsv_service_auth"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DsvConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DsvConfigV1Config from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "dsv_subscription_key": obj.get("dsv_subscription_key"),
            "dsv_service_auth": obj.get("dsv_service_auth")
        })
        return _obj
