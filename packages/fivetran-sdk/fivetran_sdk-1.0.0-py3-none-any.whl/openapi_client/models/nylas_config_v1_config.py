...
class NylasConfigV1Config(BaseModel):
    """
    
    """ # noqa: E501
    access_token: Optional[SecretStr] = Field(default=None, description="Your Nylas access_token.")
    ...
    sub_domain: Optional[Dict[str, Any]] = Field(default=None, description="Your Nylas subdomain.")
    __properties: ClassVar[List[str]] = ["access_token", "schema", "sub_domain"]
    ...
    def sub_domain_validate_enum(cls, value):
        ...
        if value not in ('ireland.api', 'api'):
            raise ValueError("must be one of enum values ('ireland.api', 'api')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NylasConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NylasConfigV1Config from a dict"""
        if obj is None:
            return None
