...
class AzureSqlManagedDbConfigV1Config(BaseModel):
    """
    
    """ # noqa: E501
    tenant_id: Optional[SecretStr] = Field(default=None, description="Azure AD tenant ID.")
    ...
    auth_method: Optional[Dict[str, Any]] = Field(default=None, description="Authentication Method.")
    ...
    __properties: ClassVar[List[str]] = ["tenant_id", "public_key", "connection_type", "update_method", "always_encrypted", "tunnel_user", "tunnel_port", "auth_method", "database", "password", "port", "host", "tunnel_host", "schema_prefix", "user"]
    ...
    def auth_method_validate_enum(cls, value):
        ...
        if value not in ('ActiveDirectory', 'Password'):
            raise ValueError("must be one of enum values ('ActiveDirectory', 'Password')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AzureSqlManagedDbConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AzureSqlManagedDbConfigV1Config from a dict"""
        if obj is None:
            return None
