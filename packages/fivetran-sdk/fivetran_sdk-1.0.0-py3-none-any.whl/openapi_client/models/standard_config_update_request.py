...
class StandardConfigUpdateRequest(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StandardConfigUpdateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StandardConfigUpdateRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "schemas": dict(
                (_k, SchemaUpdateRequest.from_dict(_v))
