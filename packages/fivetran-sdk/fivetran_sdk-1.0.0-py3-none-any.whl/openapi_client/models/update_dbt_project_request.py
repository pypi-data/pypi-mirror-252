...
class UpdateDbtProjectRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["threads", "dbt_version", "target_name", "environment_vars"]
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'GIT': 'GITUpdateDbtProjectRequest'
    }
    ...
    def from_json(cls, json_str: str) -> Optional[Union[Self]]:
        """Create an instance of UpdateDbtProjectRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[Self]]:
        """Create an instance of UpdateDbtProjectRequest from a dict"""
        ...
        if object_type:
            ...
            raise ValueError("UpdateDbtProjectRequest failed to lookup discriminator value from " +
...
UpdateDbtProjectRequest.model_rebuild(raise_errors=False)
