...
class AivenKafkaWhConfigV1Config(BaseModel):
    """
    ...
    def schema_registry_validate_enum(cls, value):
        ...
        if value not in ('AIVEN_KARAPACE', 'CONFLUENT_CLOUD'):
            raise ValueError("must be one of enum values ('AIVEN_KARAPACE', 'CONFLUENT_CLOUD')")
        return value
    ...
    def sasl_mechanism_validate_enum(cls, value):
        ...
        if value not in ('SCRAM_SHA_512', 'SCRAM_SHA_256'):
            raise ValueError("must be one of enum values ('SCRAM_SHA_512', 'SCRAM_SHA_256')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AivenKafkaWhConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AivenKafkaWhConfigV1Config from a dict"""
        if obj is None:
            return None
