...
class YotpoConfigV1Config(BaseModel):
    """
    ...
    secret_key: Optional[SecretStr] = Field(default=None, description="Your Yotpo Secret key")
    app_key: Optional[StrictStr] = Field(default=None, description="Your Yotpo App Key")
    __properties: ClassVar[List[str]] = ["schema", "secret_key", "app_key"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of YotpoConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of YotpoConfigV1Config from a dict"""
        if obj is None:
            return None
