...
class PingdomConfigV1Config(BaseModel):
    """
    ...
    username: Optional[StrictStr] = Field(default=None, description="Your Pingdom Username.")
    __properties: ClassVar[List[str]] = ["schema", "username"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PingdomConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PingdomConfigV1Config from a dict"""
        if obj is None:
            return None
