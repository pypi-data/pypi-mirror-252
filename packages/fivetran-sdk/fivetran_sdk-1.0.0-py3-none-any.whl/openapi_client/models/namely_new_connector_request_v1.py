...
class NamelyNewConnectorRequestV1(NewConnectorRequestV1):
    """
    NamelyNewConnectorRequestV1
    """ # noqa: E501
    config: Optional[NamelyConfigV1Config] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NamelyNewConnectorRequestV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NamelyNewConnectorRequestV1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "config": NamelyConfigV1Config.from_dict(obj["config"]) if obj.get("config") is not None else None,
