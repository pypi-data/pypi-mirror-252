...
from pydantic import BaseModel, SecretStr, StrictBool, StrictInt, StrictStr
from typing import Any, ClassVar, Dict, List, Optional
from typing import Optional, Set
from typing_extensions import Self

class SplunkLogConfigV1Config(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["port", "host", "channel", "enable_ssl", "token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SplunkLogConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SplunkLogConfigV1Config from a dict"""
        if obj is None:
            return None
