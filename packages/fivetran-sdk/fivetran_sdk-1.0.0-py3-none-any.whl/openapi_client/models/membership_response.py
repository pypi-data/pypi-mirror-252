...
class MembershipResponse(BaseModel):
    ...
    MembershipResponse
    """ # noqa: E501
    id: StrictStr = Field(description="The membership entity unique identifier")
    role: StrictStr = Field(description="The role the user has within the entity")
    created_at: datetime = Field(description="The timestamp that the user created their Fivetran account")
    __properties: ClassVar[List[str]] = ["id", "role", "created_at"]
