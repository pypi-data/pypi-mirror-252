...
class Dynamics365ConfigV1Config(BaseModel):
    """
    ...
    resource_url: Optional[StrictStr] = Field(default=None, description="URL at which Dynamics 365 is accessed")
    domain_name: Optional[StrictStr] = Field(default=None, description="The custom domain name associated with Dynamics 365.")
    __properties: ClassVar[List[str]] = ["schema", "resource_url", "domain_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Dynamics365ConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Dynamics365ConfigV1Config from a dict"""
        if obj is None:
            return None
