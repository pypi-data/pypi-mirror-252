...
class Dynamics365FoConfigV1Config(BaseModel):
    """
    ...
    update_method: Optional[Dict[str, Any]] = Field(default=None, description="Update Method")
    ...
    user: Optional[StrictStr] = Field(default=None, description="The user name. The format must be `user@domain`.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Dynamics365FoConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Dynamics365FoConfigV1Config from a dict"""
        if obj is None:
            return None
