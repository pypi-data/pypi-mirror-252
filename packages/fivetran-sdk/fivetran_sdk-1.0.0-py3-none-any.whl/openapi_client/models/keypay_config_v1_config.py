...
class KeypayConfigV1Config(BaseModel):
    """
    ...
    api_key: Optional[SecretStr] = Field(default=None, description="Your KeyPay API key.")
    region: Optional[Dict[str, Any]] = Field(default=None, description="Your KeyPay region.")
    ...
    def region_validate_enum(cls, value):
        ...
        if value not in ('au', 'sg', 'uk', 'nz', 'my'):
            raise ValueError("must be one of enum values ('au', 'sg', 'uk', 'nz', 'my')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KeypayConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KeypayConfigV1Config from a dict"""
        if obj is None:
            return None
