...
class DropColumnsRequest(BaseModel):
    ...
    DropColumnsRequest
    """ # noqa: E501
    schemas: Optional[Dict[str, DropColumnSchemaRequest]] = Field(default=None, description="The set of schemas within your connector schema config that are synced into the destination")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DropColumnsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DropColumnsRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "schemas": dict(
                (_k, DropColumnSchemaRequest.from_dict(_v))
