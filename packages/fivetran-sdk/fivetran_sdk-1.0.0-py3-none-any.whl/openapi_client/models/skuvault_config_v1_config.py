...
class SkuvaultConfigV1Config(BaseModel):
    """
    ...
    password: Optional[SecretStr] = Field(default=None, description="Your SkuVault password.")
    email: Optional[StrictStr] = Field(default=None, description="Your SkuVault email.")
    __properties: ClassVar[List[str]] = ["schema", "password", "email"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SkuvaultConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SkuvaultConfigV1Config from a dict"""
        if obj is None:
            return None
