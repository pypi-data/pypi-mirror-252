...
class AutodeskBim360NewConnectorRequestV1(NewConnectorRequestV1):
    """
    AutodeskBim360NewConnectorRequestV1
    """ # noqa: E501
    config: Optional[AutodeskBim360ConfigV1Config] = None
    auth: Optional[AutodeskBim360ConfigV1Auth] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AutodeskBim360NewConnectorRequestV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AutodeskBim360NewConnectorRequestV1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "auth": AutodeskBim360ConfigV1Auth.from_dict(obj["auth"]) if obj.get("auth") is not None else None
        })
        return _obj
