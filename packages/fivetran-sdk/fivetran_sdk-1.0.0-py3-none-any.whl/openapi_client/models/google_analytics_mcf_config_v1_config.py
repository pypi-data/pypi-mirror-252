...
class GoogleAnalyticsMcfConfigV1Config(BaseModel):
    """
    
    """ # noqa: E501
    sync_mode: Optional[Dict[str, Any]] = Field(default=None, description="Whether to sync all accounts or specific accounts. Default value: `ALL_ACCOUNTS`")
    ...
    profiles: Optional[List[StrictStr]] = Field(default=None, description="Specific User Profile IDs to sync.  Must be populated if `sync_mode` is set to `SPECIFIC_ACCOUNTS`.")
    accounts: Optional[List[StrictStr]] = Field(default=None, description="Specific Account IDs to sync.  Must be populated if `sync_mode` is set to `SPECIFIC_ACCOUNTS`.")
    __properties: ClassVar[List[str]] = ["sync_mode", "schema", "timeframe_months", "profiles", "accounts"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleAnalyticsMcfConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleAnalyticsMcfConfigV1Config from a dict"""
        if obj is None:
            return None
