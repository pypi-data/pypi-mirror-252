...
class HelpshiftConfigV1Config(BaseModel):
    """
    ...
    domain_name: Optional[StrictStr] = Field(default=None, description="Your Helpshift domain name.")
    api_key: Optional[SecretStr] = Field(default=None, description="Your Helpshift API Key.")
    __properties: ClassVar[List[str]] = ["schema", "domain_name", "api_key"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HelpshiftConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HelpshiftConfigV1Config from a dict"""
        if obj is None:
            return None
