...
class DclLogisticsConfigV1Config(BaseModel):
    """
    ...
    api_key: Optional[SecretStr] = Field(default=None, description="Your DCL Logistics API key.")
    username: Optional[StrictStr] = Field(default=None, description="Your DCL Logistics username.")
    __properties: ClassVar[List[str]] = ["schema", "api_key", "username"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DclLogisticsConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DclLogisticsConfigV1Config from a dict"""
        if obj is None:
            return None
