...
class Db2ConfigV1Config(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["public_key", "tunnel_port", "database", "password", "connection_type", "port", "host", "tunnel_host", "schema_prefix", "always_encrypted", "user", "tunnel_user"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Db2ConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Db2ConfigV1Config from a dict"""
        if obj is None:
            return None
