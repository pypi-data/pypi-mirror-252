...
class FountainConfigV1Config(BaseModel):
    """
    ...
    api_token: Optional[SecretStr] = Field(default=None, description="Your Fountain API token.")
    sub_domain: Optional[StrictStr] = Field(default=None, description="Your Fountain subdomain.")
    __properties: ClassVar[List[str]] = ["schema", "api_token", "sub_domain"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FountainConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FountainConfigV1Config from a dict"""
        if obj is None:
            return None
