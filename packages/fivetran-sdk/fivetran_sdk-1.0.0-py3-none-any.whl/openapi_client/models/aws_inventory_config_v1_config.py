...
class AwsInventoryConfigV1Config(BaseModel):
    """
    
    """ # noqa: E501
    bucket: Optional[StrictStr] = Field(default=None, description="The AWS bucket name that is configured for AWS Config.")
    ...
    prefix: Optional[StrictStr] = Field(default=None, description="The prefix if you used one when configuring the bucket.")
    __properties: ClassVar[List[str]] = ["bucket", "schema", "role_arn", "prefix"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AwsInventoryConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AwsInventoryConfigV1Config from a dict"""
        if obj is None:
            return None
