...
class OutbrainConfigV1Config(BaseModel):
    """
    ...
    password: Optional[SecretStr] = Field(default=None, description="The Outbrain user's password.")
    ...
    user: Optional[StrictStr] = Field(default=None, description="The username or email of the Outbrain user.")
    __properties: ClassVar[List[str]] = ["schema", "password", "timeframe_months", "user"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OutbrainConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OutbrainConfigV1Config from a dict"""
        if obj is None:
            return None
