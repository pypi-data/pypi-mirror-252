...
class MondayConfigV1Config(BaseModel):
    """
    ...
    personal_api_token: Optional[SecretStr] = Field(default=None, description="Your Monday.com Personal API Token.")
    __properties: ClassVar[List[str]] = ["schema", "personal_api_token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MondayConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MondayConfigV1Config from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "personal_api_token": obj.get("personal_api_token")
        })
        return _obj
