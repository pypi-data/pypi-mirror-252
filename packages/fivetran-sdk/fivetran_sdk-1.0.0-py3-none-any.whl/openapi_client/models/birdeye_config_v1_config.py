...
class BirdeyeConfigV1Config(BaseModel):
    """
    ...
    query_param_value: Optional[SecretStr] = Field(default=None, description="Your Birdeye query-param-value.")
    business_id: Optional[SecretStr] = Field(default=None, description="Your Birdeye Business ID.")
    __properties: ClassVar[List[str]] = ["schema", "query_param_value", "business_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BirdeyeConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BirdeyeConfigV1Config from a dict"""
        if obj is None:
            return None
