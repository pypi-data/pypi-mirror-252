...
class MailgunConfigV1Config(BaseModel):
    """
    ...
    api_key: Optional[SecretStr] = Field(default=None, description="Your Mailgun API key.")
    sub_domain: Optional[StrictStr] = Field(default=None, description="Your Mailgun subdomain.")
    username: Optional[StrictStr] = Field(default=None, description="Your Mailgun API username.")
    __properties: ClassVar[List[str]] = ["schema", "api_key", "sub_domain", "username"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MailgunConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MailgunConfigV1Config from a dict"""
        if obj is None:
            return None
