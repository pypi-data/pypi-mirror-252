...
class PrivateLinkCreateRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "service", "config", "group_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PrivateLinkCreateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PrivateLinkCreateRequest from a dict"""
        if obj is None:
            return None
