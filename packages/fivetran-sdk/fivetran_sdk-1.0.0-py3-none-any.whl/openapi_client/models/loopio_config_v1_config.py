...
class LoopioConfigV1Config(BaseModel):
    """
    ...
    app_key: Optional[StrictStr] = Field(default=None, description="Your Loopio App Key.")
    secret: Optional[SecretStr] = Field(default=None, description="Your Loopio Secret.")
    __properties: ClassVar[List[str]] = ["schema", "app_key", "secret"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LoopioConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LoopioConfigV1Config from a dict"""
        if obj is None:
            return None
