...
class ConcordConfigV1Config(BaseModel):
    """
    ...
    api_key: Optional[SecretStr] = Field(default=None, description="Your Concord API Key.")
    sub_domain: Optional[Dict[str, Any]] = Field(default=None, description="Your Concord Sub Domain.")
    ...
    def sub_domain_validate_enum(cls, value):
        ...
        if value not in ('uat', 'api'):
            raise ValueError("must be one of enum values ('uat', 'api')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConcordConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConcordConfigV1Config from a dict"""
        if obj is None:
            return None
