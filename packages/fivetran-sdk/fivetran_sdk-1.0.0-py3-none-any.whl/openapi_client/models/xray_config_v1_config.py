...
class XrayConfigV1Config(BaseModel):
    """
    ...
    client_secret: Optional[SecretStr] = Field(default=None, description="Your Xray Client Secret.")
    client_id: Optional[StrictStr] = Field(default=None, description="Your Xray Client ID.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of XrayConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of XrayConfigV1Config from a dict"""
        if obj is None:
            return None
