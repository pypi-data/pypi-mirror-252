...
class BraintreeConfigV1Config(BaseModel):
    """
    
    """ # noqa: E501
    public_key: Optional[StrictStr] = Field(default=None, description="The contents of your PEM certificate file.")
    ...
    private_key: Optional[SecretStr] = Field(default=None, description="The contents of your secret key file.")
    merchant_id: Optional[StrictStr] = Field(default=None, description="Your Braintree merchant ID.")
    __properties: ClassVar[List[str]] = ["public_key", "schema", "private_key", "merchant_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BraintreeConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BraintreeConfigV1Config from a dict"""
        if obj is None:
            return None
