...
class DestiniConfigV1Config(BaseModel):
    """
    ...
    api_key: Optional[SecretStr] = Field(default=None, description="Your Destini API Key.")
    client_name: Optional[StrictStr] = Field(default=None, description="Your Destini Client Name.")
    __properties: ClassVar[List[str]] = ["schema", "api_key", "client_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DestiniConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DestiniConfigV1Config from a dict"""
        if obj is None:
            return None
