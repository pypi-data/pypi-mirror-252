...
class MixpanelConfigV1Config(BaseModel):
    """
    ...
    region: Optional[Dict[str, Any]] = Field(default=None, description="Data Region")
    api_secret: Optional[SecretStr] = Field(default=None, description="Mixpanel API Secret.")
    __properties: ClassVar[List[str]] = ["schema", "region", "api_secret"]
    ...
    def region_validate_enum(cls, value):
        ...
        if value not in ('EU', 'US'):
            raise ValueError("must be one of enum values ('EU', 'US')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MixpanelConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MixpanelConfigV1Config from a dict"""
        if obj is None:
            return None
