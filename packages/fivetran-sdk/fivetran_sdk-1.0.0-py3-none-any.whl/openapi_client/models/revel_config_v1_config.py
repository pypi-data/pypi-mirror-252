...
class RevelConfigV1Config(BaseModel):
    """
    ...
    api_key_api_secret: Optional[SecretStr] = Field(default=None, description="Your Revel Systems API Key and API Secret.")
    sub_domain: Optional[StrictStr] = Field(default=None, description="Your Revel Systems subDomain.")
    __properties: ClassVar[List[str]] = ["schema", "api_key_api_secret", "sub_domain"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RevelConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RevelConfigV1Config from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "api_key_api_secret": obj.get("api_key_api_secret"),
