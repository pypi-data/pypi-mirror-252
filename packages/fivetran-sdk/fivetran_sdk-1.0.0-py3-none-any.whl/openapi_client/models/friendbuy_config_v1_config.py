...
class FriendbuyConfigV1Config(BaseModel):
    """
    ...
    api_key: Optional[StrictStr] = Field(default=None, description="Your Friendbuy API key.")
    api_secret: Optional[SecretStr] = Field(default=None, description="Your Friendbuy API secret.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FriendbuyConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FriendbuyConfigV1Config from a dict"""
        if obj is None:
            return None
