...
class DelightedConfigV1Config(BaseModel):
    """
    ...
    api_key: Optional[SecretStr] = Field(default=None, description="API Key for your Delighted account")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DelightedConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DelightedConfigV1Config from a dict"""
        if obj is None:
            return None
