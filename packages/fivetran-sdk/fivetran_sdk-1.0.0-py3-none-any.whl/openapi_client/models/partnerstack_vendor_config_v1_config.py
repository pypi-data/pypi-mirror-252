...
class PartnerstackVendorConfigV1Config(BaseModel):
    """
    
    """ # noqa: E501
    public_key: Optional[StrictStr] = Field(default=None, description="Your PartnerStack Vendor Public key.")
    ...
    secret_key: Optional[SecretStr] = Field(default=None, description="Your PartnerStack Vendor Secret key.")
    __properties: ClassVar[List[str]] = ["public_key", "schema", "secret_key"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PartnerstackVendorConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PartnerstackVendorConfigV1Config from a dict"""
        if obj is None:
            return None
