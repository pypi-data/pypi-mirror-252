...
class ShipstationConfigV1Config(BaseModel):
    """
    ...
    password: Optional[SecretStr] = Field(default=None, description="Your ShipStation password.")
    username: Optional[StrictStr] = Field(default=None, description="Your ShipStation username.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ShipstationConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ShipstationConfigV1Config from a dict"""
        if obj is None:
            return None
