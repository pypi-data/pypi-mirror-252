...
class LoggingServiceSetupTestResponse(BaseModel):
    """
    LoggingServiceSetupTestResponse
    """ # noqa: E501
    setup_tests: Optional[List[SetupTestResultResponse]] = None
    __properties: ClassVar[List[str]] = ["setup_tests"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LoggingServiceSetupTestResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LoggingServiceSetupTestResponse from a dict"""
        if obj is None:
            return None
