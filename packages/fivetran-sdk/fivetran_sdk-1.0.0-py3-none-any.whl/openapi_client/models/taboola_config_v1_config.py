...
class TaboolaConfigV1Config(BaseModel):
    """
    ...
    account_ids: Optional[List[StrictStr]] = Field(default=None, description="Specific Account IDs to sync.  Must be populated if `syncMode` is set to `SpecificAccounts`.")
    ...
    client_secret: Optional[SecretStr] = Field(default=None, description="The Taboola client secret.")
    client_id: Optional[StrictStr] = Field(default=None, description="The Taboola client ID.")
    __properties: ClassVar[List[str]] = ["sync_mode", "schema", "account_ids", "timeframe_months", "client_secret", "client_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TaboolaConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TaboolaConfigV1Config from a dict"""
        if obj is None:
            return None
