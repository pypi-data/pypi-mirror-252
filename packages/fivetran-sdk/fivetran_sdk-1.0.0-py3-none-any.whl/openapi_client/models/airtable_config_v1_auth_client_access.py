...
class AirtableConfigV1AuthClientAccess(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AirtableConfigV1AuthClientAccess from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AirtableConfigV1AuthClientAccess from a dict"""
        if obj is None:
            return None
