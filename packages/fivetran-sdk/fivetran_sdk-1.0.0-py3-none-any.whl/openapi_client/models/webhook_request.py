...
class WebhookRequest(BaseModel):
    ...
    active: Optional[StrictBool] = Field(default=None, description="Boolean, if set to true, webhooks are immediately sent in response to events.")
    secret: Optional[StrictStr] = Field(default=None, description="The secret string used for payload signing.")
    __properties: ClassVar[List[str]] = ["url", "events", "active", "secret"]
