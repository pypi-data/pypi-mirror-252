...
class BusinessCentralConfigV1Config(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenant_id", "schema", "companies", "environment_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BusinessCentralConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BusinessCentralConfigV1Config from a dict"""
        if obj is None:
            return None
