...
class TwitterAdsNewConnectorRequestV1(NewConnectorRequestV1):
    """
    TwitterAdsNewConnectorRequestV1
    """ # noqa: E501
    config: Optional[TwitterAdsConfigV1Config] = None
    auth: Optional[TwitterAdsConfigV1Auth] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TwitterAdsNewConnectorRequestV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TwitterAdsNewConnectorRequestV1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "config": TwitterAdsConfigV1Config.from_dict(obj["config"]) if obj.get("config") is not None else None,
            "auth": TwitterAdsConfigV1Auth.from_dict(obj["auth"]) if obj.get("auth") is not None else None
        })
        return _obj
