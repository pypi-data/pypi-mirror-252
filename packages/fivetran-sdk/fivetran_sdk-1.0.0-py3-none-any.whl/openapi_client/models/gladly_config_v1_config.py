...
class GladlyConfigV1Config(BaseModel):
    """
    ...
    api_token: Optional[SecretStr] = Field(default=None, description="Your Gladly API Token.")
    organization: Optional[StrictStr] = Field(default=None, description="Your Gladly Organization Name.")
    username: Optional[StrictStr] = Field(default=None, description="Your Gladly Username.")
    __properties: ClassVar[List[str]] = ["schema", "api_token", "organization", "username"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GladlyConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GladlyConfigV1Config from a dict"""
        if obj is None:
            return None
