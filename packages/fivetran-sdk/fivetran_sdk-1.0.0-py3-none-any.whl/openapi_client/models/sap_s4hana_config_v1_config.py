...
class SapS4hanaConfigV1Config(BaseModel):
    """
    ...
    connection_type: Optional[Dict[str, Any]] = Field(default=None, description="Connection Method")
    ...
    password: Optional[SecretStr] = Field(default=None, description="Your SAP S/4 password.")
    port: Optional[StrictInt] = Field(default=None, description="The SAP S/4 port number.")
    host: Optional[StrictStr] = Field(default=None, description="The SAP S/4 host or IP address.")
    ...
    user: Optional[StrictStr] = Field(default=None, description="Your SAP S/4 user name.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SapS4hanaConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SapS4hanaConfigV1Config from a dict"""
        if obj is None:
            return None
