...
class UpdateTransformationRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["schedule", "run_tests", "paused"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateTransformationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateTransformationRequest from a dict"""
        if obj is None:
            return None
