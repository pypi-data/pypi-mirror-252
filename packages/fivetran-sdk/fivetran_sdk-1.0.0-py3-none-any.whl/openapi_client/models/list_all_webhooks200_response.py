...
class ListAllWebhooks200Response(BaseModel):
    """
    ...
    data: ListAllWebhooks200ResponseData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": ListAllWebhooks200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
