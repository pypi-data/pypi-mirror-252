...
class CheckrConfigV1Config(BaseModel):
    """
    ...
    secret_key: Optional[SecretStr] = Field(default=None, description="Your Checkr Secret key.")
    sub_domain: Optional[Dict[str, Any]] = Field(default=None, description="Your Checkr Subdomain.")
    __properties: ClassVar[List[str]] = ["schema", "secret_key", "sub_domain"]
    ...
    def sub_domain_validate_enum(cls, value):
        ...
        if value not in ('checkr-staging.com', 'checkr.com'):
            raise ValueError("must be one of enum values ('checkr-staging.com', 'checkr.com')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CheckrConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CheckrConfigV1Config from a dict"""
        if obj is None:
            return None
