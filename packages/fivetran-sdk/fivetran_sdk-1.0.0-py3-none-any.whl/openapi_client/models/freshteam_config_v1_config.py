...
class FreshteamConfigV1Config(BaseModel):
    """
    ...
    api_key: Optional[SecretStr] = Field(default=None, description="Your Freshteam API key.")
    base_domain: Optional[StrictStr] = Field(default=None, description="Your company's Freshteam base domain name (usually **company**.freshteam.com).")
    __properties: ClassVar[List[str]] = ["schema", "api_key", "base_domain"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FreshteamConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FreshteamConfigV1Config from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "base_domain": obj.get("base_domain")
        })
        return _obj
