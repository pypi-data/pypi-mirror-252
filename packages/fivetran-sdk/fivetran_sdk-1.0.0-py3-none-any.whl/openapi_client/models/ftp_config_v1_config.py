...
class FtpConfigV1Config(BaseModel):
    """
    ...
    is_secure: Optional[StrictBool] = Field(default=None, description="Whether the server supports FTPS.")
    ...
    password: Optional[SecretStr] = Field(default=None, description="FTP password.")
    ...
    port: Optional[StrictInt] = Field(default=None, description="FTP port.")
    ...
    host: Optional[StrictStr] = Field(default=None, description="FTP host address.")
    ...
    user: Optional[StrictStr] = Field(default=None, description="FTP user.")
    ...
    __properties: ClassVar[List[str]] = ["schema", "append_file_option", "prefix", "pattern", "is_secure", "escape_char", "json_delivery_mode", "skip_after", "line_separator", "password", "empty_header", "skip_before", "null_sequence", "port", "file_type", "delimiter", "host", "on_error", "compression", "user", "table", "archive_pattern"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FtpConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FtpConfigV1Config from a dict"""
        if obj is None:
            return None
