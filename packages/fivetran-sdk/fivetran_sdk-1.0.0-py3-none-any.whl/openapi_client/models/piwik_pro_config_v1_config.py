...
class PiwikProConfigV1Config(BaseModel):
    """
    ...
    sub_domain: Optional[StrictStr] = Field(default=None, description="Your Piwik PRO subdomain.")
    client_secret: Optional[SecretStr] = Field(default=None, description="Your Piwik PRO client secret.")
    client_id: Optional[StrictStr] = Field(default=None, description="Your Piwik PRO client ID.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PiwikProConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PiwikProConfigV1Config from a dict"""
        if obj is None:
            return None
