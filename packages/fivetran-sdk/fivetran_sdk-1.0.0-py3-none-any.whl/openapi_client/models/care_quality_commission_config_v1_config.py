...
class CareQualityCommissionConfigV1Config(BaseModel):
    """
    ...
    partner_code: Optional[StrictStr] = Field(default=None, description="Your Care Quality Commission partner code.")
    __properties: ClassVar[List[str]] = ["schema", "partner_code"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CareQualityCommissionConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CareQualityCommissionConfigV1Config from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "partner_code": obj.get("partner_code")
        })
        return _obj
