...
class EzofficeinventoryConfigV1Config(BaseModel):
    """
    ...
    secret_key: Optional[SecretStr] = Field(default=None, description="Your EZOfficeInventory API secret key.")
    sub_domain: Optional[StrictStr] = Field(default=None, description="Your EZOfficeInventory Subdomain.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EzofficeinventoryConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EzofficeinventoryConfigV1Config from a dict"""
        if obj is None:
            return None
