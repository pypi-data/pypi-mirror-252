...
class RetailnextConfigV1Config(BaseModel):
    """
    ...
    secret_key: Optional[SecretStr] = Field(default=None, description="Your RetailNext secret key.")
    access_key: Optional[StrictStr] = Field(default=None, description="Your RetailNext access key.")
    subscription: Optional[StrictStr] = Field(default=None, description="Your RetailNext subscription.")
    __properties: ClassVar[List[str]] = ["schema", "secret_key", "access_key", "subscription"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RetailnextConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RetailnextConfigV1Config from a dict"""
        if obj is None:
            return None
