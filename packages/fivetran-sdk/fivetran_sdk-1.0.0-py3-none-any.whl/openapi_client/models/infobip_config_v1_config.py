...
class InfobipConfigV1Config(BaseModel):
    """
    ...
    api_key: Optional[SecretStr] = Field(default=None, description="Your Infobip API key.")
    sub_domain: Optional[StrictStr] = Field(default=None, description="Your Infobip sub_domain.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InfobipConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InfobipConfigV1Config from a dict"""
        if obj is None:
            return None
