...
class SapHanaDbConfigV1Config(BaseModel):
    """
    ...
    sysnr: Optional[StrictStr] = None
    user: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["public_key", "connection_type", "always_encrypted", "tunnel_user", "tunnel_port", "database", "password", "port", "host", "tunnel_host", "client", "schema_prefix", "sysnr", "user"]
    ...
    def connection_type_validate_enum(cls, value):
        ...
        if value not in ('SshTunnel'):
            raise ValueError("must be one of enum values ('SshTunnel')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SapHanaDbConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SapHanaDbConfigV1Config from a dict"""
        if obj is None:
            return None
