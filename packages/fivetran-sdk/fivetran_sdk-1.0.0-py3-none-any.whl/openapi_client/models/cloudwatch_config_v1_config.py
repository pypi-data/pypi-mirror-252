...
class CloudwatchConfigV1Config(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["log_group_name", "role_arn", "external_id", "region"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CloudwatchConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CloudwatchConfigV1Config from a dict"""
        if obj is None:
            return None
