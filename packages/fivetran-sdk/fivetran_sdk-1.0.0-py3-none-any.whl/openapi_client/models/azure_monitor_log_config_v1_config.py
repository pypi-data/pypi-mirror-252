...
class AzureMonitorLogConfigV1Config(BaseModel):
    """
    
    """ # noqa: E501
    workspace_id: Optional[StrictStr] = None
    primary_key: Optional[SecretStr] = None
    __properties: ClassVar[List[str]] = ["workspace_id", "primary_key"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AzureMonitorLogConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AzureMonitorLogConfigV1Config from a dict"""
        if obj is None:
            return None
