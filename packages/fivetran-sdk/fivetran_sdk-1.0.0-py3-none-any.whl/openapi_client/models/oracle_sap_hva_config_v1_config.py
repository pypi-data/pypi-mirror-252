...
class OracleSapHvaConfigV1Config(BaseModel):
    """
    ...
    asm_option: Optional[StrictBool] = Field(default=None, description="Default value: `false`. Set to `true` if you are using ASM on a non-RAC instance.")
    ...
    asm_password: Optional[SecretStr] = Field(default=None, description="The ASM user's password. Mandatory if `use_oracle_rac` or `asm_option` is set to `true`.")
    ...
    tns: Optional[StrictStr] = Field(default=None, description="Single-tenant database: The database SID. <br> Multi-tenant database: The database TNS.")
    ...
    sap_user: Optional[StrictStr] = Field(default=None, description="The Oracle schema name where the SAP tables reside.")
    asm_oracle_home: Optional[StrictStr] = Field(default=None, description="The Oracle ASM home directory.")
    user: Optional[StrictStr] = Field(default=None, description="The username.")
    asm_user: Optional[StrictStr] = Field(default=None, description="The ASM user. Mandatory if `use_oracle_rac` or `asm_option` is set to `true`.")
    __properties: ClassVar[List[str]] = ["public_key", "agent_user", "update_method", "agent_password", "agent_public_cert", "tunnel_port", "database", "password", "asm_tns", "asm_option", "host", "schema_prefix", "agent_host", "asm_password", "connection_type", "pdb_name", "use_oracle_rac", "always_encrypted", "tunnel_user", "port", "tns", "tunnel_host", "agent_ora_home", "agent_port", "sap_user", "asm_oracle_home", "user", "asm_user"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OracleSapHvaConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OracleSapHvaConfigV1Config from a dict"""
        if obj is None:
            return None
