...
class OneDriveConfigV1Config(BaseModel):
    """
    ...
    folder_path: Optional[StrictStr] = Field(default=None, description="Your OneDrive folder URL")
    __properties: ClassVar[List[str]] = ["schema", "folder_path"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OneDriveConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OneDriveConfigV1Config from a dict"""
        if obj is None:
            return None
