...
class OracleMoatAnalyticsConfigV1Config(BaseModel):
    """
    ...
    brand_id: Optional[StrictStr] = Field(default=None, description="Your Oracle Moat Analytics Brand ID.")
    token: Optional[SecretStr] = Field(default=None, description="Your Oracle Moat Analytics Token.")
    __properties: ClassVar[List[str]] = ["schema", "brand_id", "token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OracleMoatAnalyticsConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OracleMoatAnalyticsConfigV1Config from a dict"""
        if obj is None:
            return None
