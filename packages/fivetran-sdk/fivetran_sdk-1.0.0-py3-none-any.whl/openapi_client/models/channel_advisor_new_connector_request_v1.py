...
class ChannelAdvisorNewConnectorRequestV1(NewConnectorRequestV1):
    """
    ChannelAdvisorNewConnectorRequestV1
    """ # noqa: E501
    config: Optional[AutodeskBim360ConfigV1Config] = None
    auth: Optional[AzureBoardsConfigV1Auth] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChannelAdvisorNewConnectorRequestV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChannelAdvisorNewConnectorRequestV1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "auth": AzureBoardsConfigV1Auth.from_dict(obj["auth"]) if obj.get("auth") is not None else None
        })
        return _obj
