...
class CalabrioConfigV1Config(BaseModel):
    """
    
    """ # noqa: E501
    access_token: Optional[SecretStr] = Field(default=None, description="Your Calabrio access token.")
    ...
    domain_name: Optional[StrictStr] = Field(default=None, description="Your Calabrio domain name")
    __properties: ClassVar[List[str]] = ["access_token", "schema", "domain_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CalabrioConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CalabrioConfigV1Config from a dict"""
        if obj is None:
            return None
