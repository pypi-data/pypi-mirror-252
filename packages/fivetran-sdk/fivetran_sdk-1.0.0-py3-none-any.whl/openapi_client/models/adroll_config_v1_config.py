...
class AdrollConfigV1Config(BaseModel):
    """
    
    """ # noqa: E501
    sync_mode: Optional[Dict[str, Any]] = Field(default=None, description="Whether to sync all advertisables or specific advertisables. Default value: `AllAdvertisables`.")
    ...
    advertisables: Optional[List[StrictStr]] = Field(default=None, description="Specific advertisables to sync. Must be populated if `sync_mode` is set to `SpecificAdvertisables`.")
    metrics: Optional[List[StrictStr]] = Field(default=None, description="The metrics that you want to sync.")
    report_type: Optional[Dict[str, Any]] = Field(default=None, description="The report type you want. Default value: `ALL_ADS`.")
    ...
    dimensions: Optional[List[StrictStr]] = Field(default=None, description="The dimenstions that you want to sync.")
    __properties: ClassVar[List[str]] = ["sync_mode", "schema", "timeframe_months", "advertisables", "metrics", "report_type", "table", "dimensions"]
    ...
    def sync_mode_validate_enum(cls, value):
        ...
        if value not in ('AllAdvertisables', 'SpecificAdvertisables'):
            raise ValueError("must be one of enum values ('AllAdvertisables', 'SpecificAdvertisables')")
        return value
    ...
    def report_type_validate_enum(cls, value):
        ...
        if value not in ('ALL_ADS', 'ALL_ADGROUPS', 'ALL_ADVERTISABLES', 'ALL_CAMPAIGNS', 'ALL_AUDIENCE', 'CONVERSIONS'):
            raise ValueError("must be one of enum values ('ALL_ADS', 'ALL_ADGROUPS', 'ALL_ADVERTISABLES', 'ALL_CAMPAIGNS', 'ALL_AUDIENCE', 'CONVERSIONS')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdrollConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdrollConfigV1Config from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "advertisables": obj.get("advertisables"),
