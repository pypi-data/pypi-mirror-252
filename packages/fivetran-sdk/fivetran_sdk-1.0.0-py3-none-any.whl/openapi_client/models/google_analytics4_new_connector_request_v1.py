...
class GoogleAnalytics4NewConnectorRequestV1(NewConnectorRequestV1):
    """
    GoogleAnalytics4NewConnectorRequestV1
    """ # noqa: E501
    config: Optional[GoogleAnalytics4ConfigV1Config] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleAnalytics4NewConnectorRequestV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleAnalytics4NewConnectorRequestV1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "config": GoogleAnalytics4ConfigV1Config.from_dict(obj["config"]) if obj.get("config") is not None else None,
