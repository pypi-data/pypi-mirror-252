...
class SalesloftConfigV1Config(BaseModel):
    """
    ...
    client_secret: Optional[SecretStr] = Field(default=None, description="`Client Secret` of your Salesloft client application.")
    client_id: Optional[StrictStr] = Field(default=None, description="`Client ID` of your Salesloft client application.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SalesloftConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SalesloftConfigV1Config from a dict"""
        if obj is None:
            return None
