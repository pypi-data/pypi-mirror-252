...
class HerokuPostgresConfigV1Config(BaseModel):
    """
    ...
    def update_method_validate_enum(cls, value):
        ...
        if value not in ('XMIN', 'TELEPORT'):
            raise ValueError("must be one of enum values ('XMIN', 'TELEPORT')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HerokuPostgresConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HerokuPostgresConfigV1Config from a dict"""
        if obj is None:
            return None
