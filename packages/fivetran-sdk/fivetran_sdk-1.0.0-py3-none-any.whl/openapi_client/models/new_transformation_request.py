...
class NewTransformationRequest(BaseModel):
    ...
    """ # noqa: E501
    dbt_model_id: StrictStr = Field(description="The unique identifier for the dbt Model within the Fivetran system.")
    ...
    __properties: ClassVar[List[str]] = ["dbt_model_id", "schedule", "run_tests", "paused"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NewTransformationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NewTransformationRequest from a dict"""
        if obj is None:
            return None
