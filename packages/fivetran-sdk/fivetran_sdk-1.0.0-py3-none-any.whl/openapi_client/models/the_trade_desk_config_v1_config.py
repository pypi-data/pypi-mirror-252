...
class TheTradeDeskConfigV1Config(BaseModel):
    """
    ...
    password: Optional[SecretStr] = Field(default=None, description="The Trade Desk password. It is a part of the login credentials.")
    partners: Optional[List[StrictStr]] = Field(default=None, description="Specific Partner IDs to sync.  Must be populated if `syncMode` is set to `SpecificAccounts`.")
    ...
    login: Optional[StrictStr] = Field(default=None, description="The Trade Desk email. It is a part of the login credentials.")
    __properties: ClassVar[List[str]] = ["sync_mode", "schema", "password", "partners", "timeframe_months", "login"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TheTradeDeskConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TheTradeDeskConfigV1Config from a dict"""
        if obj is None:
            return None
