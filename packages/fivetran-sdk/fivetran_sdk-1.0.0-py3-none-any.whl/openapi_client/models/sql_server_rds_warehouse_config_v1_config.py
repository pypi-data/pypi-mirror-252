...
class SqlServerRdsWarehouseConfigV1Config(BaseModel):
    """
    ...
    resource_id: Optional[StrictStr] = Field(default=None, description="Field to test Self serve Private Link")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SqlServerRdsWarehouseConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SqlServerRdsWarehouseConfigV1Config from a dict"""
        if obj is None:
            return None
