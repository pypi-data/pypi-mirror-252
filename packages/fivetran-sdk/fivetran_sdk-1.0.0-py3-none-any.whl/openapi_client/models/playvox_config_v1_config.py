...
class PlayvoxConfigV1Config(BaseModel):
    """
    ...
    user_id: Optional[StrictStr] = Field(default=None, description="Your Playvox User ID.")
    api_key: Optional[SecretStr] = Field(default=None, description="Your Playvox API Key.")
    sub_domain: Optional[StrictStr] = Field(default=None, description="Your Playvox Subdomain.")
    __properties: ClassVar[List[str]] = ["schema", "user_id", "api_key", "sub_domain"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlayvoxConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlayvoxConfigV1Config from a dict"""
        if obj is None:
            return None
