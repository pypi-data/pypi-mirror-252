...
class AzureEventHubConfigV1Config(BaseModel):
    """
    ...
    consumer_group: Optional[StrictStr] = Field(default=None, description="Name of consumer group created for Fivetran.")
    sync_type: Optional[Dict[str, Any]] = Field(default=None, description="Sync type.  Unpacked messages must be valid JSON.")
    message_type: Optional[Dict[str, Any]] = Field(default=None, description="Message type.")
    connection_string: Optional[SecretStr] = Field(default=None, description="Connection string of the Event Hub Namespace you want to sync.")
    __properties: ClassVar[List[str]] = ["schema", "consumer_group", "sync_type", "message_type", "connection_string"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AzureEventHubConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AzureEventHubConfigV1Config from a dict"""
        if obj is None:
            return None
