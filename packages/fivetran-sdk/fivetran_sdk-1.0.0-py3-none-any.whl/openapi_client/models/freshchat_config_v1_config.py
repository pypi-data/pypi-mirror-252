...
class FreshchatConfigV1Config(BaseModel):
    """
    ...
    bearer_token: Optional[SecretStr] = Field(default=None, description="Your Freshchat API Token.")
    sub_domain: Optional[StrictStr] = Field(default=None, description="Your Freshchat Sub Domain")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FreshchatConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FreshchatConfigV1Config from a dict"""
        if obj is None:
            return None
