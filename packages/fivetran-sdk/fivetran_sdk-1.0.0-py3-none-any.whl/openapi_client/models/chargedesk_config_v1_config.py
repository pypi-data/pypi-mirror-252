...
class ChargedeskConfigV1Config(BaseModel):
    """
    ...
    token_id: Optional[SecretStr] = Field(default=None, description="Your ChargeDesk token ID.")
    __properties: ClassVar[List[str]] = ["schema", "token_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChargedeskConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChargedeskConfigV1Config from a dict"""
        if obj is None:
            return None
