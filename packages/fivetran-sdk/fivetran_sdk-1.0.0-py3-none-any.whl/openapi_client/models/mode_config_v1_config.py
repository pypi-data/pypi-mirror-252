...
class ModeConfigV1Config(BaseModel):
    """
    ...
    workspace: Optional[StrictStr] = Field(default=None, description="Your Mode Workspace.")
    secret: Optional[SecretStr] = Field(default=None, description="Your Mode Secret.")
    token: Optional[StrictStr] = Field(default=None, description="Your Mode Token.")
    __properties: ClassVar[List[str]] = ["schema", "workspace", "secret", "token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModeConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModeConfigV1Config from a dict"""
        if obj is None:
            return None
