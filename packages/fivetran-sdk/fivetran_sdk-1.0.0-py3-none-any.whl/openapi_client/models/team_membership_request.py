...
class TeamMembershipRequest(BaseModel):
    ...
    role: Optional[StrictStr] = Field(default=None, description="The user's role within the team")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TeamMembershipRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TeamMembershipRequest from a dict"""
        if obj is None:
            return None
