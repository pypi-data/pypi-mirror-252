...
class CloudfrontConfigV1Config(BaseModel):
    """
    
    """ # noqa: E501
    bucket: Optional[StrictStr] = Field(default=None, description="The bucket name for CloudFront.")
    ...
    prefix: Optional[StrictStr] = Field(default=None, description="The name of the CloudFront folder in the bucket.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CloudfrontConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CloudfrontConfigV1Config from a dict"""
        if obj is None:
            return None
