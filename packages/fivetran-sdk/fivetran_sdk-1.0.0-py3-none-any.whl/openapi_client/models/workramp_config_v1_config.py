...
class WorkrampConfigV1Config(BaseModel):
    """
    
    """ # noqa: E501
    access_token: Optional[SecretStr] = Field(default=None, description="Your WorkRamp access token.")
    ...
    academy_id: Optional[StrictStr] = Field(default=None, description="Your WorkRamp academy ID.")
    __properties: ClassVar[List[str]] = ["access_token", "schema", "academy_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkrampConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkrampConfigV1Config from a dict"""
        if obj is None:
            return None
