...
class HeapConfigV1Config(BaseModel):
    """
    
    """ # noqa: E501
    bucket: Optional[StrictStr] = Field(default=None, description="The S3 bucket name.")
    ...
    __properties: ClassVar[List[str]] = ["bucket", "schema", "role_arn"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HeapConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HeapConfigV1Config from a dict"""
        if obj is None:
            return None
