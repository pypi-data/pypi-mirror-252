...
class ConfluenceConfigV1Config(BaseModel):
    """
    ...
    api_token: Optional[SecretStr] = Field(default=None, description="The Confluence API token.")
    organization_name: Optional[StrictStr] = Field(default=None, description="Your Confluence Organization name.")
    username: Optional[StrictStr] = Field(default=None, description="Your Confluence email address.")
    __properties: ClassVar[List[str]] = ["schema", "api_token", "organization_name", "username"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfluenceConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfluenceConfigV1Config from a dict"""
        if obj is None:
            return None
