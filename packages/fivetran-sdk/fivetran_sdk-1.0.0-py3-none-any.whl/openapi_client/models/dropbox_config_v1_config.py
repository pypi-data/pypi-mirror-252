...
class DropboxConfigV1Config(BaseModel):
    """
    ...
    folder: Optional[StrictStr] = Field(default=None, description="Your Dropbox Folder URL.")
    ...
    __properties: ClassVar[List[str]] = ["schema", "append_file_option", "prefix", "pattern", "escape_char", "json_delivery_mode", "skip_after", "line_separator", "skip_before", "empty_header", "null_sequence", "folder", "is_single_table_mode", "delimiter", "file_type", "on_error", "compression", "archive_pattern", "table"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DropboxConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DropboxConfigV1Config from a dict"""
        if obj is None:
            return None
