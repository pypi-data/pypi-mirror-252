...
class CustomerioConfigV1Config(BaseModel):
    """
    ...
    bearer_token: Optional[SecretStr] = Field(default=None, description="Your Customer.io App API Key.")
    sub_domain: Optional[Dict[str, Any]] = Field(default=None, description="Your Customer.io region-specific Subdomain.")
    __properties: ClassVar[List[str]] = ["schema", "bearer_token", "sub_domain"]
    ...
    def sub_domain_validate_enum(cls, value):
        ...
        if value not in ('api-eu', 'api'):
            raise ValueError("must be one of enum values ('api-eu', 'api')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CustomerioConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CustomerioConfigV1Config from a dict"""
        if obj is None:
            return None
