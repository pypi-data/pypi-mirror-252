...
class KissmetricsConfigV1Config(BaseModel):
    """
    ...
    password: Optional[SecretStr] = Field(default=None, description="Your Kissmetrics API Password.")
    username: Optional[StrictStr] = Field(default=None, description="Your Kissmetrics API Username.")
    __properties: ClassVar[List[str]] = ["schema", "password", "username"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KissmetricsConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KissmetricsConfigV1Config from a dict"""
        if obj is None:
            return None
