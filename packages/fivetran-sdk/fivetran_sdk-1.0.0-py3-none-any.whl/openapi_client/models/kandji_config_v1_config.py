...
class KandjiConfigV1Config(BaseModel):
    """
    ...
    api_token: Optional[SecretStr] = Field(default=None, description="Your Kandji API token.")
    sub_domain: Optional[StrictStr] = Field(default=None, description="Your Kandji Subdomain.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KandjiConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KandjiConfigV1Config from a dict"""
        if obj is None:
            return None
