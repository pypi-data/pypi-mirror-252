...
class SharePointConfigV1Config(BaseModel):
    """
    ...
    access_type: Optional[Dict[str, Any]] = Field(default=None, description="Access Type")
    ...
    prefix: Optional[StrictStr] = Field(default=None, description="All files and folders under this folder path link will be searched for files to sync. This can be any shared folder link.")
    ...
    share_url: Optional[StrictStr] = Field(default=None, description="Your SharePoint folder URL. You can find the folder URL by following the steps mentioned [here](/docs/files/share-point/setup-guide).")
    ...
    __properties: ClassVar[List[str]] = ["schema", "access_type", "append_file_option", "prefix", "pattern", "escape_char", "json_delivery_mode", "skip_after", "line_separator", "skip_before", "empty_header", "null_sequence", "is_single_table_mode", "share_url", "delimiter", "file_type", "on_error", "compression", "archive_pattern", "table"]
    ...
    def access_type_validate_enum(cls, value):
        ...
        if value not in ('SPECIFIC_SITES', 'ALL_SITES'):
            raise ValueError("must be one of enum values ('SPECIFIC_SITES', 'ALL_SITES')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SharePointConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SharePointConfigV1Config from a dict"""
        if obj is None:
            return None
