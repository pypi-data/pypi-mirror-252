...
class AwinConfigV1Config(BaseModel):
    """
    ...
    api_token: Optional[SecretStr] = Field(default=None, description="Your Awin API Token.")
    region: Optional[Dict[str, Any]] = Field(default=None, description="Your Awin Region.")
    __properties: ClassVar[List[str]] = ["schema", "api_token", "region"]
    ...
    def region_validate_enum(cls, value):
        ...
        if value not in ('DE', 'NO', 'BE', 'FI', 'CH', 'DK', 'IT', 'FR', 'ES', 'BR', 'SE', 'AT', 'BU', 'AU', 'GB', 'IE', 'PL', 'CA', 'NL', 'US'):
            raise ValueError("must be one of enum values ('DE', 'NO', 'BE', 'FI', 'CH', 'DK', 'IT', 'FR', 'ES', 'BR', 'SE', 'AT', 'BU', 'AU', 'GB', 'IE', 'PL', 'CA', 'NL', 'US')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AwinConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AwinConfigV1Config from a dict"""
        if obj is None:
            return None
