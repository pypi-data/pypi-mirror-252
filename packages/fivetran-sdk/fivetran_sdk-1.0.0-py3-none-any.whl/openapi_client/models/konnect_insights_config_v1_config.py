...
class KonnectInsightsConfigV1Config(BaseModel):
    """
    ...
    account_token: Optional[SecretStr] = Field(default=None, description="Your Konnect Insights Account Token.")
    user_token: Optional[SecretStr] = Field(default=None, description="Your Konnect Insights User Token.")
    __properties: ClassVar[List[str]] = ["schema", "account_token", "user_token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KonnectInsightsConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KonnectInsightsConfigV1Config from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "account_token": obj.get("account_token"),
