...
class ConnectCardConfigRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["connect_card_config"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConnectCardConfigRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConnectCardConfigRequest from a dict"""
        if obj is None:
            return None
