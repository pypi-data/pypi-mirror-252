...
class AircallConfigV1Config(BaseModel):
    """
    ...
    api_id: Optional[StrictStr] = Field(default=None, description="Your Aircall API ID.")
    api_token: Optional[SecretStr] = Field(default=None, description="Your Aircall API Token.")
    __properties: ClassVar[List[str]] = ["schema", "api_id", "api_token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AircallConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AircallConfigV1Config from a dict"""
        if obj is None:
            return None
