...
class SurveyMonkeyNewConnectorRequestV1(NewConnectorRequestV1):
    """
    SurveyMonkeyNewConnectorRequestV1
    """ # noqa: E501
    config: Optional[SurveyMonkeyConfigV1Config] = None
    auth: Optional[SurveyMonkeyConfigV1Auth] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SurveyMonkeyNewConnectorRequestV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SurveyMonkeyNewConnectorRequestV1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "config": SurveyMonkeyConfigV1Config.from_dict(obj["config"]) if obj.get("config") is not None else None,
            "auth": SurveyMonkeyConfigV1Auth.from_dict(obj["auth"]) if obj.get("auth") is not None else None
        })
        return _obj
