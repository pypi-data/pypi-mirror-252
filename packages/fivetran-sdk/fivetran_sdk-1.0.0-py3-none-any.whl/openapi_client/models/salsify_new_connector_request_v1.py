...
class SalsifyNewConnectorRequestV1(NewConnectorRequestV1):
    """
    SalsifyNewConnectorRequestV1
    """ # noqa: E501
    config: Optional[SalsifyConfigV1Config] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SalsifyNewConnectorRequestV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SalsifyNewConnectorRequestV1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "config": SalsifyConfigV1Config.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
        return _obj
