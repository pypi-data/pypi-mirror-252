...
class WebhookTestResponse(BaseModel):
    ...
    WebhookTestResponse
    """ # noqa: E501
    succeed: StrictBool = Field(description="Test result.")
    status: StrictInt = Field(description="Test status.")
    message: Optional[StrictStr] = Field(default=None, description="Test message.")
    __properties: ClassVar[List[str]] = ["succeed", "status", "message"]
