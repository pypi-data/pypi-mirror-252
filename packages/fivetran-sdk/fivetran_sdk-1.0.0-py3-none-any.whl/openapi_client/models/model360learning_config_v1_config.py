...
class Model360learningConfigV1Config(BaseModel):
    """
    ...
    company_id: Optional[StrictStr] = Field(default=None, description="Your 360Learning Company ID.")
    api_key: Optional[SecretStr] = Field(default=None, description="Your 360Learning API Key.")
    __properties: ClassVar[List[str]] = ["schema", "company_id", "api_key"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Model360learningConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Model360learningConfigV1Config from a dict"""
        if obj is None:
            return None
