...
class AlchemerConfigV1Config(BaseModel):
    """
    ...
    sub_domain: Optional[StrictStr] = Field(default=None, description="Your Alchemer sub-domain.")
    query_param_value: Optional[SecretStr] = Field(default=None, description="Your Alchemer API key.")
    api_secret_key: Optional[SecretStr] = Field(default=None, description="Your Alchemer API Secret key.")
    __properties: ClassVar[List[str]] = ["schema", "sub_domain", "query_param_value", "api_secret_key"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AlchemerConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AlchemerConfigV1Config from a dict"""
        if obj is None:
            return None
