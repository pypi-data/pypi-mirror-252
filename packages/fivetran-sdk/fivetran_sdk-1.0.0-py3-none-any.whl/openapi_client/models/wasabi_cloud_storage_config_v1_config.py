...
class WasabiCloudStorageConfigV1Config(BaseModel):
    """
    ...
    json_delivery_mode: Optional[Dict[str, Any]] = Field(default=None, description="Specifies how Fivetran should handle your JSON data. Default value: `Packed`.")
    ...
    use_pgp_encryption_options: Optional[StrictBool] = Field(default=None, description="Set to `true` if files are encrypted using PGP in the Wasabi Cloud Storage bucket. Default value: `false`.")
    ...
    auth_type: Optional[Dict[str, Any]] = Field(default=None, description="The Wasabi Cloud Storage Access approach. Required for connector creation. Default value: `ACCESS_KEY`.")
    ...
    bucket: Optional[StrictStr] = Field(default=None, description="The Wasabi Cloud Storage bucket name. Required for connector creation.")
    ...
    region: Optional[Dict[str, Any]] = Field(default=None, description="The Wasabi Cloud Storage bucket region. Required for connector creation. Default value: `US_EAST_1`.")
    ...
    __properties: ClassVar[List[str]] = ["access_key_id", "schema", "prefix", "pattern", "json_delivery_mode", "skip_after", "empty_header", "use_pgp_encryption_options", "skip_before", "signer_public_key", "delimiter", "file_type", "on_error", "table", "archive_pattern", "pgp_secret_key", "auth_type", "append_file_option", "escape_char", "bucket", "line_separator", "null_sequence", "access_key_secret", "region", "compression", "pgp_pass_phrase"]
    ...
    def auth_type_validate_enum(cls, value):
        ...
        if value not in ('PUBLIC_BUCKET', 'ACCESS_KEY'):
            raise ValueError("must be one of enum values ('PUBLIC_BUCKET', 'ACCESS_KEY')")
        return value
    ...
    def region_validate_enum(cls, value):
        ...
        if value not in ('AP_NORTHEAST_2', 'AP_NORTHEAST_1', 'CA_CENTRAL_1', 'US_WEST_1', 'US_EAST_2', 'EU_CENTRAL_2', 'US_EAST_1', 'EU_CENTRAL_1', 'AP_SOUTHEAST_1', 'AP_SOUTHEAST_2', 'US_CENTRAL_1', 'EU_WEST_1', 'EU_WEST_2'):
            raise ValueError("must be one of enum values ('AP_NORTHEAST_2', 'AP_NORTHEAST_1', 'CA_CENTRAL_1', 'US_WEST_1', 'US_EAST_2', 'EU_CENTRAL_2', 'US_EAST_1', 'EU_CENTRAL_1', 'AP_SOUTHEAST_1', 'AP_SOUTHEAST_2', 'US_CENTRAL_1', 'EU_WEST_1', 'EU_WEST_2')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WasabiCloudStorageConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WasabiCloudStorageConfigV1Config from a dict"""
        if obj is None:
            return None
