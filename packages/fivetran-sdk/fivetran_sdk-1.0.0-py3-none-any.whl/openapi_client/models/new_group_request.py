...
class NewGroupRequest(BaseModel):
    ...
    NewGroupRequest
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of the group within your account.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NewGroupRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NewGroupRequest from a dict"""
        if obj is None:
            return None
