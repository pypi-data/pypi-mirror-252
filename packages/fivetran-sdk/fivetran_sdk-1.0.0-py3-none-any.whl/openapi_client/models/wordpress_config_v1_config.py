...
class WordpressConfigV1Config(BaseModel):
    """
    ...
    sub_domain: Optional[StrictStr] = Field(default=None, description="Your WordPress subdomain.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WordpressConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WordpressConfigV1Config from a dict"""
        if obj is None:
            return None
