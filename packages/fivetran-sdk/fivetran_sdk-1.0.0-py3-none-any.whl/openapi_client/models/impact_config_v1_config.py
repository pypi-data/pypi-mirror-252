...
class ImpactConfigV1Config(BaseModel):
    """
    ...
    password: Optional[SecretStr] = Field(default=None, description="Your Impact Account Token")
    username: Optional[StrictStr] = Field(default=None, description="Your Impact Account SID")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ImpactConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ImpactConfigV1Config from a dict"""
        if obj is None:
            return None
