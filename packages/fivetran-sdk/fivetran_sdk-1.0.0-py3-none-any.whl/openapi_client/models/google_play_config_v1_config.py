...
class GooglePlayConfigV1Config(BaseModel):
    """
    
    """ # noqa: E501
    bucket: Optional[StrictStr] = Field(default=None, description="The Google Cloud Storage source bucket.")
    ...
    __properties: ClassVar[List[str]] = ["bucket", "schema"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GooglePlayConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GooglePlayConfigV1Config from a dict"""
        if obj is None:
            return None
