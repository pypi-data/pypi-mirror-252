...
class PosthogConfigV1Config(BaseModel):
    """
    ...
    api_key: Optional[SecretStr] = Field(default=None, description="Your PostHog API key.")
    sub_domain: Optional[Dict[str, Any]] = Field(default=None, description="Your PostHog data region (`app` or `eu`).")
    ...
    def sub_domain_validate_enum(cls, value):
        ...
        if value not in ('app', 'eu'):
            raise ValueError("must be one of enum values ('app', 'eu')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PosthogConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PosthogConfigV1Config from a dict"""
        if obj is None:
            return None
