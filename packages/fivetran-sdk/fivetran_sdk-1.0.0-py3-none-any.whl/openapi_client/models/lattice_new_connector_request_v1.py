...
class LatticeNewConnectorRequestV1(NewConnectorRequestV1):
    """
    LatticeNewConnectorRequestV1
    """ # noqa: E501
    config: Optional[LatticeConfigV1Config] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LatticeNewConnectorRequestV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LatticeNewConnectorRequestV1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "config": LatticeConfigV1Config.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
        return _obj
