...
class DearConfigV1Config(BaseModel):
    """
    ...
    account_id: Optional[StrictStr] = Field(default=None, description="Your Dear Account ID.")
    application_key: Optional[SecretStr] = Field(default=None, description="Your Dear Application key.")
    __properties: ClassVar[List[str]] = ["schema", "account_id", "application_key"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DearConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DearConfigV1Config from a dict"""
        if obj is None:
            return None
