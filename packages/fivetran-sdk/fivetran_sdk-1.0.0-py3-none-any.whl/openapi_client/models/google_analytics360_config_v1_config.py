...
class GoogleAnalytics360ConfigV1Config(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["schema", "project_id", "dataset_id", "bucket_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleAnalytics360ConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleAnalytics360ConfigV1Config from a dict"""
        if obj is None:
            return None
