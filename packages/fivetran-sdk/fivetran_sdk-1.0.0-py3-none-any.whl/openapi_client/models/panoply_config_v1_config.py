...
class PanoplyConfigV1Config(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["public_key", "auth_type", "connection_type", "cluster_region", "external_id", "always_encrypted", "tunnel_user", "cluster_id", "tunnel_port", "database", "password", "role_arn", "port", "host", "tunnel_host", "resource_id", "user"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PanoplyConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PanoplyConfigV1Config from a dict"""
        if obj is None:
            return None
