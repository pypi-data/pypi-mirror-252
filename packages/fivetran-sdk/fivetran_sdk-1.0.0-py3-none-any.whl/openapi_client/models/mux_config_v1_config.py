...
class MuxConfigV1Config(BaseModel):
    """
    ...
    token_secret_key: Optional[SecretStr] = Field(default=None, description="Your Mux token secret key")
    token_id: Optional[SecretStr] = Field(default=None, description="Your Mux token ID")
    __properties: ClassVar[List[str]] = ["schema", "token_secret_key", "token_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MuxConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MuxConfigV1Config from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "token_secret_key": obj.get("token_secret_key"),
