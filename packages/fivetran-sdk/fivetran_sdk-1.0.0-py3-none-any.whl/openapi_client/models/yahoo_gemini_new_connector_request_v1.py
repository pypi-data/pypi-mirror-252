...
class YahooGeminiNewConnectorRequestV1(NewConnectorRequestV1):
    """
    YahooGeminiNewConnectorRequestV1
    """ # noqa: E501
    config: Optional[YahooGeminiConfigV1Config] = None
    auth: Optional[YahooGeminiConfigV1Auth] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of YahooGeminiNewConnectorRequestV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of YahooGeminiNewConnectorRequestV1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "config": YahooGeminiConfigV1Config.from_dict(obj["config"]) if obj.get("config") is not None else None,
            "auth": YahooGeminiConfigV1Auth.from_dict(obj["auth"]) if obj.get("auth") is not None else None
        })
        return _obj
