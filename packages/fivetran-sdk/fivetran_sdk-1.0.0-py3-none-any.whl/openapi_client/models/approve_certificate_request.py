...
class ApproveCertificateRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["hash", "encoded_cert"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApproveCertificateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApproveCertificateRequest from a dict"""
        if obj is None:
            return None
