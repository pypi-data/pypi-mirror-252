...
class StatsigConfigV1Config(BaseModel):
    """
    ...
    secret_key: Optional[SecretStr] = Field(default=None, description="Your Statsig secret key.")
    __properties: ClassVar[List[str]] = ["schema", "secret_key"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StatsigConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StatsigConfigV1Config from a dict"""
        if obj is None:
            return None
