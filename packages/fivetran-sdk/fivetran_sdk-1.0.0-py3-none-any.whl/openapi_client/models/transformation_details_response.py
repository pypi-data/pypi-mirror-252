...
class TransformationDetailsResponse(BaseModel):
    ...
    model_ids: Optional[List[StrictStr]] = Field(default=None, description="Identifiers of related models")
    connector_ids: Optional[List[StrictStr]] = Field(default=None, description="Identifiers of related connectors")
    __properties: ClassVar[List[str]] = ["id", "status", "schedule", "paused", "last_run", "output_model_name", "dbt_project_id", "dbt_model_id", "next_run", "created_at", "run_tests", "model_ids", "connector_ids"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransformationDetailsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransformationDetailsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "connector_ids": obj.get("connector_ids")
        })
        return _obj
