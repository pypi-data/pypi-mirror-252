...
class WorkableConfigV1Config(BaseModel):
    """
    
    """ # noqa: E501
    access_token: Optional[SecretStr] = Field(default=None, description="Your Workable Access Token.")
    ...
    sub_domain: Optional[StrictStr] = Field(default=None, description="Your Workable Subdomain.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkableConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkableConfigV1Config from a dict"""
        if obj is None:
            return None
