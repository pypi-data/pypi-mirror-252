...
class ModeNewConnectorRequestV1(NewConnectorRequestV1):
    """
    ModeNewConnectorRequestV1
    """ # noqa: E501
    config: Optional[ModeConfigV1Config] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModeNewConnectorRequestV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModeNewConnectorRequestV1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "config": ModeConfigV1Config.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
        return _obj
