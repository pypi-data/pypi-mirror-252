...
class ResourceManagementBySmartsheetConfigV1Config(BaseModel):
    """
    ...
    api_token: Optional[SecretStr] = Field(default=None, description="Your Resource Management by Smartsheet API Token.")
    __properties: ClassVar[List[str]] = ["schema", "api_token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResourceManagementBySmartsheetConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResourceManagementBySmartsheetConfigV1Config from a dict"""
        if obj is None:
            return None
