...
class SlabConfigV1Config(BaseModel):
    """
    
    """ # noqa: E501
    access_token: Optional[SecretStr] = Field(default=None, description="Your Slab API key.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SlabConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SlabConfigV1Config from a dict"""
        if obj is None:
            return None
