...
class ResyncConnectorRequest(BaseModel):
    ...
    """ # noqa: E501
    scope: Optional[Dict[str, List[StrictStr]]] = Field(default=None, description="A map containing an array of tables to re-sync for each schema, must be non-empty. The parameter is optional")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResyncConnectorRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResyncConnectorRequest from a dict"""
        if obj is None:
            return None
