...
class IronsourceConfigV1Config(BaseModel):
    """
    ...
    secret_key: Optional[SecretStr] = Field(default=None, description="Your Ironsource `Client ID`.")
    refresh_token: Optional[SecretStr] = Field(default=None, description="Your Ironsource `Client Secret`.")
    __properties: ClassVar[List[str]] = ["schema", "secret_key", "refresh_token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IronsourceConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IronsourceConfigV1Config from a dict"""
        if obj is None:
            return None
