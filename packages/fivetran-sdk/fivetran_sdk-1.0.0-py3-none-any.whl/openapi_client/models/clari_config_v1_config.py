...
class ClariConfigV1Config(BaseModel):
    """
    ...
    api_token: Optional[SecretStr] = Field(default=None, description="Your Clari API token.")
    forecast_id: Optional[StrictStr] = Field(default=None, description="Your Clari Forecast id .")
    __properties: ClassVar[List[str]] = ["schema", "api_token", "forecast_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClariConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClariConfigV1Config from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "forecast_id": obj.get("forecast_id")
        })
        return _obj
