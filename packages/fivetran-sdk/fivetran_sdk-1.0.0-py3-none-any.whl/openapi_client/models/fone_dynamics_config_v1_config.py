...
class FoneDynamicsConfigV1Config(BaseModel):
    """
    ...
    api_token: Optional[SecretStr] = Field(default=None, description="Your Fone Dynamics API Token.")
    account_sid: Optional[StrictStr] = Field(default=None, description="Your Fone Dynamics Account SID.")
    __properties: ClassVar[List[str]] = ["schema", "api_token", "account_sid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FoneDynamicsConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FoneDynamicsConfigV1Config from a dict"""
        if obj is None:
            return None
