...
class ForjCommunityConfigV1Config(BaseModel):
    """
    ...
    api_key: Optional[StrictStr] = Field(default=None, description="Your Forj Community API key.")
    api_secret: Optional[SecretStr] = Field(default=None, description="Your Forj Community API secret.")
    __properties: ClassVar[List[str]] = ["schema", "api_key", "api_secret"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ForjCommunityConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ForjCommunityConfigV1Config from a dict"""
        if obj is None:
            return None
