...
class ChurnzeroConfigV1Config(BaseModel):
    """
    ...
    api_key: Optional[SecretStr] = Field(default=None, description="Your ChurnZero API key.")
    sub_domain: Optional[StrictStr] = None
    username: Optional[StrictStr] = Field(default=None, description="Your ChurnZero username.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChurnzeroConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChurnzeroConfigV1Config from a dict"""
        if obj is None:
            return None
