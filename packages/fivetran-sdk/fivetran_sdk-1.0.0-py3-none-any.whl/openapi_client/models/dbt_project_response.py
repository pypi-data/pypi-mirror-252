...
class DbtProjectResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "created_at", "created_by_id", "group_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DbtProjectResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DbtProjectResponse from a dict"""
        if obj is None:
            return None
