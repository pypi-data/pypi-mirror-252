...
class ConfluentCloudWhConfigV1Config(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["schema_registry_api_secret", "schema_registry", "data_format", "replication_factor", "schema_registry_api_key", "sasl_plain_secret", "bootstrap_servers", "connection_method", "schema_registry_url", "sasl_plain_key", "sasl_mechanism", "security_protocol", "num_of_partitions"]
    ...
    def schema_registry_validate_enum(cls, value):
        ...
        if value not in ('AIVEN_KARAPACE', 'CONFLUENT_CLOUD', 'AWS_GLUE'):
            raise ValueError("must be one of enum values ('AIVEN_KARAPACE', 'CONFLUENT_CLOUD', 'AWS_GLUE')")
        return value
    ...
    def sasl_mechanism_validate_enum(cls, value):
        ...
        if value not in ('PLAIN', 'SCRAM_SHA_512', 'SCRAM_SHA_256', 'AWS_IAM'):
            raise ValueError("must be one of enum values ('PLAIN', 'SCRAM_SHA_512', 'SCRAM_SHA_256', 'AWS_IAM')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfluentCloudWhConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfluentCloudWhConfigV1Config from a dict"""
        if obj is None:
            return None
