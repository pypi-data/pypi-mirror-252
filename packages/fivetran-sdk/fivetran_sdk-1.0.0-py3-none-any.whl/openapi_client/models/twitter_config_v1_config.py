...
class TwitterConfigV1Config(BaseModel):
    """
    ...
    consumer_key: Optional[SecretStr] = Field(default=None, description="API Key of your app")
    ...
    consumer_secret: Optional[SecretStr] = Field(default=None, description="API Secret of your app")
    timeframe_months: Optional[Dict[str, Any]] = Field(default=None, description="Number of months' worth of data you'd like to include in your initial sync. This cannot be modified once the connector is created. Default value: `THREE`.")
    ...
    __properties: ClassVar[List[str]] = ["sync_mode", "consumer_key", "schema", "consumer_secret", "timeframe_months", "accounts"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TwitterConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TwitterConfigV1Config from a dict"""
        if obj is None:
            return None
