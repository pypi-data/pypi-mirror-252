...
class CopperConfigV1Config(BaseModel):
    """
    ...
    api_key: Optional[SecretStr] = Field(default=None, description="Your Copper API key.")
    email: Optional[StrictStr] = Field(default=None, description="Your Copper email address.")
    __properties: ClassVar[List[str]] = ["schema", "api_key", "email"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CopperConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CopperConfigV1Config from a dict"""
        if obj is None:
            return None
