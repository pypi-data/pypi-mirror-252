...
class ShopwareConfigV1Config(BaseModel):
    """
    ...
    password: Optional[SecretStr] = Field(default=None, description="Your Shopware password.")
    domain: Optional[StrictStr] = Field(default=None, description="Your Shopware Domain.")
    username: Optional[StrictStr] = Field(default=None, description="Your Shopware username.")
    __properties: ClassVar[List[str]] = ["schema", "password", "domain", "username"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ShopwareConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ShopwareConfigV1Config from a dict"""
        if obj is None:
            return None
