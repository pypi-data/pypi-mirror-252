...
class BigCommerceConfigV1Config(BaseModel):
    """
    
    """ # noqa: E501
    access_token: Optional[SecretStr] = Field(default=None, description="API access token of your store.")
    ...
    store_hash: Optional[StrictStr] = Field(default=None, description="The BigCommerce store hash.")
    __properties: ClassVar[List[str]] = ["access_token", "schema", "store_hash"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BigCommerceConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BigCommerceConfigV1Config from a dict"""
        if obj is None:
            return None
