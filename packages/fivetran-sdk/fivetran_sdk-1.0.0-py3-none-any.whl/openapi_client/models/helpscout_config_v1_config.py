...
class HelpscoutConfigV1Config(BaseModel):
    """
    ...
    conversation_webhook_url: Optional[StrictStr] = Field(default=None, description="Your conversation webhook URL")
    __properties: ClassVar[List[str]] = ["schema", "conversation_webhook_url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HelpscoutConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HelpscoutConfigV1Config from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "conversation_webhook_url": obj.get("conversation_webhook_url")
        })
        return _obj
