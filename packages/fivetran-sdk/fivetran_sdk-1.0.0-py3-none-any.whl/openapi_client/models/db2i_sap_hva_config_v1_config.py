...
class Db2iSapHvaConfigV1Config(BaseModel):
    """
    ...
    connection_type: Optional[Dict[str, Any]] = Field(default=None, description="Possible values:`SshTunnel`. `SshTunnel` is used as a value if this parameter is omitted in the request and any of the following parameter's values is specified: `tunnel_host`, `tunnel_port`, `tunnel_user`.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Db2iSapHvaConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Db2iSapHvaConfigV1Config from a dict"""
        if obj is None:
            return None
