...
class SplitioConfigV1Config(BaseModel):
    """
    ...
    admin_api_key: Optional[SecretStr] = Field(default=None, description="Your Split admin api key.")
    __properties: ClassVar[List[str]] = ["schema", "admin_api_key"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SplitioConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SplitioConfigV1Config from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "admin_api_key": obj.get("admin_api_key")
        })
        return _obj
