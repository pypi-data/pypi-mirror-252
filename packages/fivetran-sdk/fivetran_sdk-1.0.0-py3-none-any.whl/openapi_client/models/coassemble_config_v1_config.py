...
class CoassembleConfigV1Config(BaseModel):
    """
    ...
    api_key: Optional[SecretStr] = Field(default=None, description="Your Coassemble API key.")
    user_id: Optional[StrictStr] = Field(default=None, description="Your Coassemble user ID.")
    host_name: Optional[StrictStr] = Field(default=None, description="Your Coassemble Hostname.")
    __properties: ClassVar[List[str]] = ["schema", "api_key", "user_id", "host_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoassembleConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoassembleConfigV1Config from a dict"""
        if obj is None:
            return None
