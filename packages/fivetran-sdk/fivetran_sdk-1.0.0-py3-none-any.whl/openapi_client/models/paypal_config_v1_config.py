...
class PaypalConfigV1Config(BaseModel):
    """
    ...
    secret_key: Optional[SecretStr] = Field(default=None, description="`Client Secret` of your PayPal client application.")
    client_id: Optional[StrictStr] = Field(default=None, description="`Client ID` of your PayPal client application.")
    __properties: ClassVar[List[str]] = ["schema", "secret_key", "client_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaypalConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaypalConfigV1Config from a dict"""
        if obj is None:
            return None
