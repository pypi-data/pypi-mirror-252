...
class HanaSapHvaB1ConfigV1Config(BaseModel):
    """
    ...
    sap_source_schema: Optional[StrictStr] = Field(default=None, description="The schema name where the HANA tables reside.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HanaSapHvaB1ConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HanaSapHvaB1ConfigV1Config from a dict"""
        if obj is None:
            return None
