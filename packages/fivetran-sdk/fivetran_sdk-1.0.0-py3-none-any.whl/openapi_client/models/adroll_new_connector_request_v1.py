...
class AdrollNewConnectorRequestV1(NewConnectorRequestV1):
    """
    AdrollNewConnectorRequestV1
    """ # noqa: E501
    config: Optional[AdrollConfigV1Config] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdrollNewConnectorRequestV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdrollNewConnectorRequestV1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "config": AdrollConfigV1Config.from_dict(obj["config"]) if obj.get("config") is not None else None,
