...
class IvantiConfigV1Config(BaseModel):
    """
    ...
    tenant_url: Optional[StrictStr] = Field(default=None, description="Your Ivanti Tenant URL.")
    api_key: Optional[SecretStr] = Field(default=None, description="Your Ivanti API Key.")
    __properties: ClassVar[List[str]] = ["schema", "tenant_url", "api_key"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IvantiConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IvantiConfigV1Config from a dict"""
        if obj is None:
            return None
