...
class SimplesatConfigV1Config(BaseModel):
    """
    ...
    account_key: Optional[SecretStr] = Field(default=None, description="Your Simplesat account key.")
    __properties: ClassVar[List[str]] = ["schema", "account_key"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SimplesatConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SimplesatConfigV1Config from a dict"""
        if obj is None:
            return None
