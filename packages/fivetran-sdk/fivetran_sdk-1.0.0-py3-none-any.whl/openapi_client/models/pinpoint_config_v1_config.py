...
class PinpointConfigV1Config(BaseModel):
    """
    ...
    api_key: Optional[SecretStr] = Field(default=None, description="Your Pinpoint API key.")
    sub_domain: Optional[StrictStr] = Field(default=None, description="Your Pinpoint sub domain name.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PinpointConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PinpointConfigV1Config from a dict"""
        if obj is None:
            return None
