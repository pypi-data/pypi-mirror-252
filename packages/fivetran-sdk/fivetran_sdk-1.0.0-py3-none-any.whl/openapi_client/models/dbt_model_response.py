...
class DbtModelResponse(BaseModel):
    ...
    scheduled: Optional[StrictBool] = Field(default=None, description="Boolean specifying whether the model is selected for execution in the dashboard")
    model_name: Optional[StrictStr] = Field(default=None, description="The dbt Model name.")
    __properties: ClassVar[List[str]] = ["id", "scheduled", "model_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DbtModelResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DbtModelResponse from a dict"""
        if obj is None:
            return None
