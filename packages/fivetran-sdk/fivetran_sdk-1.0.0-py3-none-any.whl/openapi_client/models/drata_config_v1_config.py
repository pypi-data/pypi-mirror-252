...
class DrataConfigV1Config(BaseModel):
    """
    ...
    api_key: Optional[SecretStr] = Field(default=None, description="Your Drata API Key.")
    sub_domain: Optional[Dict[str, Any]] = Field(default=None, description="Your Drata sub_domain.")
    ...
    def sub_domain_validate_enum(cls, value):
        ...
        if value not in ('', '.eu'):
            raise ValueError("must be one of enum values ('', '.eu')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DrataConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DrataConfigV1Config from a dict"""
        if obj is None:
            return None
