...
class RingoverConfigV1Config(BaseModel):
    """
    ...
    api_key: Optional[SecretStr] = Field(default=None, description="Your Ringover API key.")
    region: Optional[Dict[str, Any]] = Field(default=None, description="Your Ringover region.")
    __properties: ClassVar[List[str]] = ["schema", "api_key", "region"]
    ...
    def region_validate_enum(cls, value):
        ...
        if value not in ('-api-us', '-api'):
            raise ValueError("must be one of enum values ('-api-us', '-api')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RingoverConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RingoverConfigV1Config from a dict"""
        if obj is None:
            return None
