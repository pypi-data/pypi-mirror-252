...
class OracleEbsConfigV1Config(BaseModel):
    """
    ...
    pdb_name: Optional[StrictStr] = Field(default=None, description="<strong>Optional:</strong> Required only for containerized database.")
    ...
    __properties: ClassVar[List[str]] = ["public_key", "connection_type", "update_method", "pdb_name", "always_encrypted", "tunnel_user", "tunnel_port", "database", "password", "port", "host", "tunnel_host", "schema_prefix", "user"]
    ...
    def update_method_validate_enum(cls, value):
        ...
        if value not in ('LOGMINER', 'TELEPORT'):
            raise ValueError("must be one of enum values ('LOGMINER', 'TELEPORT')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OracleEbsConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OracleEbsConfigV1Config from a dict"""
        if obj is None:
            return None
