...
class TogglTrackConfigV1Config(BaseModel):
    """
    ...
    password: Optional[Dict[str, Any]] = Field(default=None, description="Your Toggl Track Password")
    api_token: Optional[SecretStr] = Field(default=None, description="Your Toggl Track API token")
    __properties: ClassVar[List[str]] = ["schema", "password", "api_token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TogglTrackConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TogglTrackConfigV1Config from a dict"""
        if obj is None:
            return None
