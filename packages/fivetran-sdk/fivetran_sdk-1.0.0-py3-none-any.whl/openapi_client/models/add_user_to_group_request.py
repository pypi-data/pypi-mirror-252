...
class AddUserToGroupRequest(BaseModel):
    ...
    """ # noqa: E501
    email: Optional[StrictStr] = Field(default=None, description="The email address that the user has associated with their user profile.")
    role: Optional[StrictStr] = Field(default=None, description="The group role that you would like to assign this new user to. Supported group roles: ‘Destination Administrator‘, ‘Destination Reviewer‘, ‘Destination Analyst‘, ‘Connector Creator‘, or a custom destination role")
