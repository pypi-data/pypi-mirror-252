...
class CollibraConfigV1Config(BaseModel):
    """
    ...
    password: Optional[SecretStr] = Field(default=None, description="Your collibra password.")
    sub_domain: Optional[StrictStr] = Field(default=None, description="Your collibra subdomain.")
    username: Optional[StrictStr] = Field(default=None, description="Your collibra username.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CollibraConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CollibraConfigV1Config from a dict"""
        if obj is None:
            return None
