...
class ShopifyConfigV1Auth(BaseModel):
    """
    
    """ # noqa: E501
    access_token: Optional[StrictStr] = Field(default=None, description="The Shopify access token.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ShopifyConfigV1Auth from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ShopifyConfigV1Auth from a dict"""
        if obj is None:
            return None
