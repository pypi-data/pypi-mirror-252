...
class IroncladConfigV1Config(BaseModel):
    """
    
    """ # noqa: E501
    access_token: Optional[SecretStr] = Field(default=None, description="Your Ironclad access token.")
    ...
    base_url: Optional[StrictStr] = Field(default=None, description="Your Ironclad base url.")
    __properties: ClassVar[List[str]] = ["access_token", "schema", "base_url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IroncladConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IroncladConfigV1Config from a dict"""
        if obj is None:
            return None
