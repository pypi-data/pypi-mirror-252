...
class ListAllWebhooks200ResponseData(BaseModel):
    """
    ListAllWebhooks200ResponseData
    """ # noqa: E501
    items: List[WebhookResponse] = Field(description="The collection of return items")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListAllWebhooks200ResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListAllWebhooks200ResponseData from a dict"""
        if obj is None:
            return None
