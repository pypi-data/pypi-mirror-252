...
class ThinkificConfigV1Config(BaseModel):
    """
    ...
    client_key: Optional[StrictStr] = Field(default=None, description="Your Thinkific client key.")
    sub_domain: Optional[StrictStr] = Field(default=None, description="Your Thinkific subdomain.")
    client_secret: Optional[SecretStr] = Field(default=None, description="Your Thinkific client secret.")
    __properties: ClassVar[List[str]] = ["schema", "client_key", "sub_domain", "client_secret"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ThinkificConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ThinkificConfigV1Config from a dict"""
        if obj is None:
            return None
