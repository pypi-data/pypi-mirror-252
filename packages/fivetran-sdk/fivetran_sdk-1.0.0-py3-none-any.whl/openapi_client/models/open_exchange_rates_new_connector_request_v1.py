...
class OpenExchangeRatesNewConnectorRequestV1(NewConnectorRequestV1):
    """
    OpenExchangeRatesNewConnectorRequestV1
    """ # noqa: E501
    config: Optional[OpenExchangeRatesConfigV1Config] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OpenExchangeRatesNewConnectorRequestV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OpenExchangeRatesNewConnectorRequestV1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "config": OpenExchangeRatesConfigV1Config.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
        return _obj
