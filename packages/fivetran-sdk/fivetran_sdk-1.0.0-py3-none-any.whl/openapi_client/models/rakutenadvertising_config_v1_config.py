...
class RakutenadvertisingConfigV1Config(BaseModel):
    """
    ...
    report_keys: Optional[StrictStr] = Field(default=None, description="Your Rakuten Advertising Report keys.")
    api_token: Optional[SecretStr] = Field(default=None, description="Your Rakuten Advertising API token.")
    __properties: ClassVar[List[str]] = ["schema", "report_keys", "api_token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RakutenadvertisingConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RakutenadvertisingConfigV1Config from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "report_keys": obj.get("report_keys"),
