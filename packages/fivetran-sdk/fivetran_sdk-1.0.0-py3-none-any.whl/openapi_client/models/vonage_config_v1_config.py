...
class VonageConfigV1Config(BaseModel):
    """
    ...
    api_key: Optional[StrictStr] = Field(default=None, description="Your Vonage API Key.")
    api_secret: Optional[SecretStr] = Field(default=None, description="Your Vonage API Secret.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VonageConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VonageConfigV1Config from a dict"""
        if obj is None:
            return None
