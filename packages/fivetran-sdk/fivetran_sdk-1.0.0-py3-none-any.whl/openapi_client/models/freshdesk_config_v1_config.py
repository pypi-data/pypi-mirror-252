...
class FreshdeskConfigV1Config(BaseModel):
    """
    ...
    api_key: Optional[SecretStr] = Field(default=None, description="Your Freshdesk API Key.")
    subdomain: Optional[StrictStr] = Field(default=None, description="Your company's freshdesk subdomain (usually **company**.freshdesk.com).")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FreshdeskConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FreshdeskConfigV1Config from a dict"""
        if obj is None:
            return None
