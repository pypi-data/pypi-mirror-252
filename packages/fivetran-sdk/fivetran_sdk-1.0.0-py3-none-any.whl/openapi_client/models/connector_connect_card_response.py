...
class ConnectorConnectCardResponse(BaseModel):
    ...
    connector_id: StrictStr = Field(description="The connector identifier")
    connect_card_config: Optional[ConnectCardConfig] = None
    __properties: ClassVar[List[str]] = ["connect_card", "connector_id", "connect_card_config"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConnectorConnectCardResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConnectorConnectCardResponse from a dict"""
        if obj is None:
            return None
