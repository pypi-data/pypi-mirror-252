...
class MegaphoneConfigV1Config(BaseModel):
    """
    ...
    organization_id: Optional[StrictStr] = Field(default=None, description="Your Megaphone organization ID.")
    api_token: Optional[SecretStr] = Field(default=None, description="Your Megaphone API token.")
    __properties: ClassVar[List[str]] = ["schema", "organization_id", "api_token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MegaphoneConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MegaphoneConfigV1Config from a dict"""
        if obj is None:
            return None
