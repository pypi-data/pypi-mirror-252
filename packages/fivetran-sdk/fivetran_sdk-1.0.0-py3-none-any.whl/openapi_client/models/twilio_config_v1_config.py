...
class TwilioConfigV1Config(BaseModel):
    """
    ...
    secret: Optional[SecretStr] = Field(default=None, description="The Twilio API secret")
    ...
    sid: Optional[StrictStr] = Field(default=None, description="The Twilio API key SID")
    __properties: ClassVar[List[str]] = ["sync_mode", "schema", "secret", "accounts", "sid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TwilioConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TwilioConfigV1Config from a dict"""
        if obj is None:
            return None
