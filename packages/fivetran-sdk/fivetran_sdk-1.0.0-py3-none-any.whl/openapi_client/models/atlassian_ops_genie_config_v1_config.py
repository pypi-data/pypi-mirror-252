...
class AtlassianOpsGenieConfigV1Config(BaseModel):
    """
    ...
    api_key: Optional[SecretStr] = Field(default=None, description="Your Opsgenie API key")
    region: Optional[StrictStr] = Field(default=None, description="Your company's Osgenie region (usually **company**.opsgenie.com)")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AtlassianOpsGenieConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AtlassianOpsGenieConfigV1Config from a dict"""
        if obj is None:
            return None
