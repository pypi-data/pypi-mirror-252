...
class DeputyConfigV1Config(BaseModel):
    """
    
    """ # noqa: E501
    access_token: Optional[SecretStr] = Field(default=None, description="Your Deputy API access token.")
    ...
    sub_domain: Optional[StrictStr] = Field(default=None, description="Your Deputy subdomain.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeputyConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeputyConfigV1Config from a dict"""
        if obj is None:
            return None
