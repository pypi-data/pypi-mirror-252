...
class AppfiguresConfigV1Config(BaseModel):
    """
    ...
    client_key: Optional[SecretStr] = Field(default=None, description="Your Appfigures Client Key.")
    password: Optional[SecretStr] = Field(default=None, description="Your Appfigures Password.")
    username: Optional[StrictStr] = Field(default=None, description="Your Appfigures Username.")
    __properties: ClassVar[List[str]] = ["schema", "client_key", "password", "username"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AppfiguresConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AppfiguresConfigV1Config from a dict"""
        if obj is None:
            return None
