...
class GongioConfigV1Config(BaseModel):
    """
    ...
    access_key: Optional[SecretStr] = Field(default=None, description="Your Gongio Access key.")
    access_key_secret: Optional[SecretStr] = Field(default=None, description="Your Gongio Access Key Secret.")
    base_url: Optional[StrictStr] = Field(default=None, description="Your Gong API Base URL.")
    __properties: ClassVar[List[str]] = ["schema", "access_key", "access_key_secret", "base_url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GongioConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GongioConfigV1Config from a dict"""
        if obj is None:
            return None
