...
class TrelloConfigV1Config(BaseModel):
    """
    ...
    api_key: Optional[SecretStr] = Field(default=None, description="Your TRELLO api key.")
    api_token: Optional[SecretStr] = Field(default=None, description="Your TRELLO api token.")
    __properties: ClassVar[List[str]] = ["schema", "api_key", "api_token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrelloConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrelloConfigV1Config from a dict"""
        if obj is None:
            return None
