...
class LiftoffConfigV1Config(BaseModel):
    """
    ...
    api_key: Optional[SecretStr] = Field(default=None, description="Your Liftoff API key.")
    api_secret: Optional[SecretStr] = Field(default=None, description="Your Liftoff API secret.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LiftoffConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LiftoffConfigV1Config from a dict"""
        if obj is None:
            return None
