...
class RevxConfigV1Config(BaseModel):
    """
    ...
    password: Optional[SecretStr] = Field(default=None, description="Your RevX Password.")
    username: Optional[StrictStr] = Field(default=None, description="Your RevX Username.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RevxConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RevxConfigV1Config from a dict"""
        if obj is None:
            return None
