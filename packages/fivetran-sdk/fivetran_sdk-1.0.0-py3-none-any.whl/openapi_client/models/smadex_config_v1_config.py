...
class SmadexConfigV1Config(BaseModel):
    """
    ...
    password: Optional[SecretStr] = Field(default=None, description="Your Smadex Password.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SmadexConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SmadexConfigV1Config from a dict"""
        if obj is None:
            return None
