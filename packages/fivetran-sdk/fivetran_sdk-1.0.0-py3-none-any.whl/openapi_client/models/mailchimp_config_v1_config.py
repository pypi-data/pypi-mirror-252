...
class MailchimpConfigV1Config(BaseModel):
    """
    ...
    ecommerce_stores: Optional[List[StrictStr]] = Field(default=None, description="List of IDs of the Mailchimp E-Commerce Stores to Sync")
    __properties: ClassVar[List[str]] = ["schema", "ecommerce_stores"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MailchimpConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MailchimpConfigV1Config from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "ecommerce_stores": obj.get("ecommerce_stores")
        })
        return _obj
