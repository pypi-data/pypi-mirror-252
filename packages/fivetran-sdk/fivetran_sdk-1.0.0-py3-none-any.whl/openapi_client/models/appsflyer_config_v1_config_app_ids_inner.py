...
class AppsflyerConfigV1ConfigAppIdsInner(BaseModel):
    """
    *  App ID(s)
    """ # noqa: E501
    app_id: Optional[StrictStr] = Field(default=None, description="Your App ID")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AppsflyerConfigV1ConfigAppIdsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AppsflyerConfigV1ConfigAppIdsInner from a dict"""
        if obj is None:
            return None
