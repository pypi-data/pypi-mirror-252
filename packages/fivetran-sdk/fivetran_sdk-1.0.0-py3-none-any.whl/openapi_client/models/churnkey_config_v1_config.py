...
class ChurnkeyConfigV1Config(BaseModel):
    """
    ...
    api_key: Optional[SecretStr] = Field(default=None, description="Your Churnkey API Key.")
    app_id: Optional[StrictStr] = Field(default=None, description="Your Churnkey APP ID.")
    __properties: ClassVar[List[str]] = ["schema", "api_key", "app_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChurnkeyConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChurnkeyConfigV1Config from a dict"""
        if obj is None:
            return None
