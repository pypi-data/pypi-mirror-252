...
class SageIntacctConfigV1Config(BaseModel):
    """
    ...
    login_password: Optional[SecretStr] = Field(default=None, description="The login password. It is a part of the login credentials.")
    sender_password: Optional[SecretStr] = Field(default=None, description="Your Sender Password")
    user_id: Optional[StrictStr] = Field(default=None, description="User ID")
    sender_id: Optional[StrictStr] = Field(default=None, description="Your Sender ID")
    __properties: ClassVar[List[str]] = ["schema", "company_id", "login_password", "sender_password", "user_id", "sender_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SageIntacctConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SageIntacctConfigV1Config from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "sender_password": obj.get("sender_password"),
