...
class GainsightCustomerSuccessConfigV1Config(BaseModel):
    """
    ...
    access_key: Optional[SecretStr] = Field(default=None, description="The access key for API authentication.")
    sub_domain: Optional[StrictStr] = Field(default=None, description="The subdomain of your Gainsight account.")
    __properties: ClassVar[List[str]] = ["schema", "access_key", "sub_domain"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GainsightCustomerSuccessConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GainsightCustomerSuccessConfigV1Config from a dict"""
        if obj is None:
            return None
