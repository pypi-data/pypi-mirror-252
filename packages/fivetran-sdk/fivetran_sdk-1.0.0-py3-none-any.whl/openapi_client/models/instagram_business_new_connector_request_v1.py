...
class InstagramBusinessNewConnectorRequestV1(NewConnectorRequestV1):
    """
    InstagramBusinessNewConnectorRequestV1
    """ # noqa: E501
    config: Optional[InstagramBusinessConfigV1Config] = None
    auth: Optional[GooglePlayConfigV1Auth] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InstagramBusinessNewConnectorRequestV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InstagramBusinessNewConnectorRequestV1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "config": InstagramBusinessConfigV1Config.from_dict(obj["config"]) if obj.get("config") is not None else None,
            "auth": GooglePlayConfigV1Auth.from_dict(obj["auth"]) if obj.get("auth") is not None else None
        })
        return _obj
