...
class CrowddevConfigV1Config(BaseModel):
    """
    
    """ # noqa: E501
    tenant_id: Optional[SecretStr] = Field(default=None, description="Your  crowd.dev Tenant ID.")
    ...
    bearer_token: Optional[SecretStr] = Field(default=None, description="Your crowd.dev Auth Token.")
    __properties: ClassVar[List[str]] = ["tenant_id", "schema", "bearer_token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CrowddevConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CrowddevConfigV1Config from a dict"""
        if obj is None:
            return None
