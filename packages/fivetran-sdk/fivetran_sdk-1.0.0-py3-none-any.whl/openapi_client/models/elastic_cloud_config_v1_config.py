...
class ElasticCloudConfigV1Config(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["schema", "tunnel_port", "database", "password", "connection_type", "port", "host", "tunnel_host", "always_encrypted", "user", "tunnel_user"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ElasticCloudConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ElasticCloudConfigV1Config from a dict"""
        if obj is None:
            return None
