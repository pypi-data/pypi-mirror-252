...
class WorkdayFinancialManagementConfigV1Auth(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["refresh_token", "client_secret", "client_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkdayFinancialManagementConfigV1Auth from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkdayFinancialManagementConfigV1Auth from a dict"""
        if obj is None:
            return None
