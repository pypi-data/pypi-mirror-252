...
class AzurePostgresWarehouseConfigV1Config(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AzurePostgresWarehouseConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AzurePostgresWarehouseConfigV1Config from a dict"""
        if obj is None:
            return None
