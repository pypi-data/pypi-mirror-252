...
class FreshserviceConfigV1Config(BaseModel):
    """
    ...
    api_key: Optional[SecretStr] = Field(default=None, description="Your Freshservice API Key.")
    subdomain: Optional[StrictStr] = Field(default=None, description="Your company's freshservice subdomain (usually **company**.freshservice.com).")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FreshserviceConfigV1Config from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FreshserviceConfigV1Config from a dict"""
        if obj is None:
            return None
