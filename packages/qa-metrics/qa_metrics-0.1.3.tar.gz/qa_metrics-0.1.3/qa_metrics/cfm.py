...
class CFMatcher:
    def __init__(self):
        ...
        model_dir = os.path.join(os.path.dirname(__file__), 'lr_classifier')
        model_path = os.path.join(current_dir, 'classifier', 'lr_classifier.pkl')
        tokenizer_path = os.path.join(current_dir, 'classifier', 'tf-idf_vectorizer.pkl')
