...
class LumpedElement(VBAObjWrapper):
    ...
    def create_multipin(self):
        self.record_method('CreateMultipin')

    def modify(self):
        self.record_method('Modify')

    def set_type(self, elem_type: str):
        self.record_method('SetType', elem_type)

    def set_name(self, name: str):
        self.record_method('SetName', name)
    ...
    def set_radius(self, radius: float):
        self.record_method('SetRadius', radius)

    def set_wire(self, wire: str):
        self.record_method('Wire', wire)
