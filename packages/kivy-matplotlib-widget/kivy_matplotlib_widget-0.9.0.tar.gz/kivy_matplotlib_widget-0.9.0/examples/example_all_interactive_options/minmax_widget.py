        ...
        if val:
            ...
            if kind.get('axis') == 'x':
                ...
                if self.xaxis_formatter is None:
                    axis_formatter =  (self.current_axis.fmt_xdata if self.current_axis.fmt_xdata is not None
                ...
                if self.yaxis_formatter is None:
                    axis_formatter =  (self.current_axis.fmt_ydata if self.current_axis.fmt_ydata is not None
