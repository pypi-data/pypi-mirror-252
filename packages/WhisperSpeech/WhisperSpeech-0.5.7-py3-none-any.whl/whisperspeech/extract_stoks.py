...
# %% ../nbs/3B. Semantic token extraction.ipynb 4
@call_parse
def prepare_stoks(
    ...
    dl = wds.WebLoader(ds, num_workers=0, batch_size=None).unbatched().batched(batch_size)
