# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/03_cgsense_pip_package/94_mri.ipynb.
...
# %% ../nbs/03_cgsense_pip_package/94_mri.ipynb 2
from nbdev.showdoc import *
from fastcore.test import *
from fastcore.utils import *

# %% ../nbs/03_cgsense_pip_package/94_mri.ipynb 3
import h5py
import numpy as np
import scipy
import skimage
...
# %% ../nbs/03_cgsense_pip_package/94_mri.ipynb 4
from .plot import *
from .metrics import *
from .math import *
from .io import *
...
# %% ../nbs/03_cgsense_pip_package/94_mri.ipynb 6
def kb_func(
...
# %% ../nbs/03_cgsense_pip_package/94_mri.ipynb 8
def kb_kernel(
...
# %% ../nbs/03_cgsense_pip_package/94_mri.ipynb 10
def calc_deapodizer(
...
# %% ../nbs/03_cgsense_pip_package/94_mri.ipynb 18
...
# %% ../nbs/03_cgsense_pip_package/94_mri.ipynb 21
class NuFFT(BaseOperator):
    ...
    def __init__(self, par, trajectory, fft_dim=(-2, -1)):
        ...
        self.kwidth = par["FFT"]["kwidth"] / 2 #TODO
        ...
        for iproj, iread in itertools.product(range(self.num_projs),range(self.num_reads)):
            ...
            for gcount1 in np.arange(ixmin, ixmax+1):
                ...
                for gcount2 in np.arange(iymin, iymax+1):
                    ...
                    if dk < self.kwidth:
                        fracind = dk / self.kwidth * (self.num_kpoints - 1)
                        kidx = int(fracind)
                        fracdk = fracind - kidx
...
# %% ../nbs/03_cgsense_pip_package/94_mri.ipynb 28
def hanning_window(
...
# %% ../nbs/03_cgsense_pip_package/94_mri.ipynb 31
def coils_norm(
...
# %% ../nbs/03_cgsense_pip_package/94_mri.ipynb 33
def coil_sens(
...
# %% ../nbs/03_cgsense_pip_package/94_mri.ipynb 36
def prewhiten(
...
# %% ../nbs/03_cgsense_pip_package/94_mri.ipynb 39
def dcf(
...
# %% ../nbs/03_cgsense_pip_package/94_mri.ipynb 42
...
# %% ../nbs/03_cgsense_pip_package/94_mri.ipynb 47
class MriOperator:
    "MRI Operator Class"
...
# %% ../nbs/03_cgsense_pip_package/94_mri.ipynb 57
...
# %% ../nbs/03_cgsense_pip_package/94_mri.ipynb 59
def setup_params(
