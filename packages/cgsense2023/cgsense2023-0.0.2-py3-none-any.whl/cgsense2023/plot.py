# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/04_cgsense_PyPI/90_plot.ipynb.

# %% auto 0
__all__ = ['epsilon', 'show_image_grid', 'show_compared_images', 'show_trajectory', 'gen_radial_traj']

# %% ../nbs/04_cgsense_PyPI/90_plot.ipynb 2
from nbdev.showdoc import *
from fastcore.test import *
from fastcore.utils import *

# %% ../nbs/04_cgsense_PyPI/90_plot.ipynb 4
import numpy as np
import matplotlib.pyplot as plt

# %% ../nbs/04_cgsense_PyPI/90_plot.ipynb 5
plt.rcParams.update({'font.size': 13.25})
epsilon = 1e-10

# %% ../nbs/04_cgsense_PyPI/90_plot.ipynb 7
def show_image_grid(
...
# %% ../nbs/04_cgsense_PyPI/90_plot.ipynb 16
...
# %% ../nbs/04_cgsense_PyPI/90_plot.ipynb 21
def show_trajectory(
...
# %% ../nbs/04_cgsense_PyPI/90_plot.ipynb 23
def gen_radial_traj(
