# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/03_cgsense_pip_package/95_optim.ipynb.

# %% auto 0
__all__ = ['frobenius_norm', 'naive_steepest_descent', 'steepest_descent', 'conjugate_gradient']

# %% ../nbs/03_cgsense_pip_package/95_optim.ipynb 2
from nbdev.showdoc import *
from fastcore.test import *
from fastcore.utils import *

# %% ../nbs/03_cgsense_pip_package/95_optim.ipynb 3
import numpy as np
import h5py
import matplotlib.pyplot as plt

# %% ../nbs/03_cgsense_pip_package/95_optim.ipynb 4
from .plot import *
from .metrics import *
from .math import *
from .io import *
...
# %% ../nbs/03_cgsense_pip_package/95_optim.ipynb 6
def frobenius_norm(
...
# %% ../nbs/03_cgsense_pip_package/95_optim.ipynb 16
def naive_steepest_descent(
    ...
    if kfilter: x = kspace_filter(x, nreads, image_dim)
    if ref is not None:
        return x, res_norms, ref_norms
    else:
        return x, res_norms

# %% ../nbs/03_cgsense_pip_package/95_optim.ipynb 19
...
# %% ../nbs/03_cgsense_pip_package/95_optim.ipynb 22
