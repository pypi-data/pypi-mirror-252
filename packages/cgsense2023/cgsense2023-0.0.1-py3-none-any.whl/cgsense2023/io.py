# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/03_cgsense_pip_package/93_io.ipynb.

# %% auto 0
__all__ = ['epsilon', 'read_data']

# %% ../nbs/03_cgsense_pip_package/93_io.ipynb 2
from nbdev.showdoc import *
from fastcore.test import *
from fastcore.utils import *

# %% ../nbs/03_cgsense_pip_package/93_io.ipynb 4
import numpy as np
from prettytable import PrettyTable

# %% ../nbs/03_cgsense_pip_package/93_io.ipynb 5
from .plot import *
from .metrics import *
from .math import *

# %% ../nbs/03_cgsense_pip_package/93_io.ipynb 6
import h5py

# %% ../nbs/03_cgsense_pip_package/93_io.ipynb 7
epsilon = 1e-10

# %% ../nbs/03_cgsense_pip_package/93_io.ipynb 27
def read_data(
