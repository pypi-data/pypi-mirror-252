...
setup(
    ...
    description=(
        "Type annotations for aiobotocore.MigrationHubStrategyRecommendations 2.11.0 service"
    ...
    keywords=(
        "aiobotocore migrationhubstrategy type-annotations botocore mypy typeshed autocomplete"
    ),
