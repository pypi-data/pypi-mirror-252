...
import hexdoc_hexresearch

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class HexResearchPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return HexResearchModPlugin(branch=branch)


class HexResearchModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "hexresearch"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_hexresearch, "_templates"
