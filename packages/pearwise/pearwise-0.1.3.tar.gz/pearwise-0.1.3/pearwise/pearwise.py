...
class PearWise:
    """PearWise class for managing interactions with the API."""
    def __init__(self, api_key):
        """
        Initialize PearWise instance.
        ...
        self.evaluator_endpoint = EVALUATOR_ENDPOINT
    ...
    def autoscore(self, input:str, output:str, evaluator:str):
        ...
        response = requests.post(self.evaluator_endpoint, headers=headers, data=payload)
