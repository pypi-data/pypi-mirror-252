...
from endi.forms import public_file_appstruct
...
def connect_user(request, form_datas):
    ...
    logger.info(" + '{0}' id : {1} has been authenticated".format(login, login_id))
...
def get_browser_infos(request):
    ...
    if browser_version:
        ...
        logger.error("Navigateur sans version : probablement un BOT")
