...
from endi_celery.tasks.utils import (
    check_alive,
)
from endi.models.config import Config
from endi_celery.models import CsvImportJob
from endi_base.models.base import DBSESSION
from endi_celery.tasks.csv_import import async_import_datas
from endi.forms.csv_import import (
...
associer les champs de votre fichier avec les données de enDI."
    _schema = None
...
class ConfigFieldAssociationView(BaseFormView):
    ...
    help_message = "Vous vous apprêtez à importer des données depuis le \
