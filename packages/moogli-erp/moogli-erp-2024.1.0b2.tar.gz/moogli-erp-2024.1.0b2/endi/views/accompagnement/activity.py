...
from endi.utils.datetimes import format_datetime
from endi.utils.notification.activity import notify_activity_participants
from endi.utils.widgets import ViewLink
from endi.export.activity_pdf import activity_pdf
...
from endi.models import company
from endi.models.user.user import User
from endi.forms.activity import (
...
from endi.resources import activity_edit_js
...
def register_menus(config):
    from endi.views.user.layout import UserMenu
