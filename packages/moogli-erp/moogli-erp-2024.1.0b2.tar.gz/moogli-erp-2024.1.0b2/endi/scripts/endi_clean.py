...
def clean_entry_point():
    ...
    enDI cleaning tools
    Usage:
        endi-clean <config_uri> business
        endi-clean <config_uri> catalog_and_price_cache
