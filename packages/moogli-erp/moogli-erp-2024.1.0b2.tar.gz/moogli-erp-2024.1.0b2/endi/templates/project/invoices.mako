...
<div id="project_invoices_tab">
    ...
    <div class='table_container'>
        ${request.layout_manager.render_panel('task_list', records, datatype="invoice", is_admin_view=is_admin, is_project_view=True, tva_on_margin_display=request.context.project_type.default_business_type.tva_on_margin)}
    </div>
    ${pager(records)}
</div>
