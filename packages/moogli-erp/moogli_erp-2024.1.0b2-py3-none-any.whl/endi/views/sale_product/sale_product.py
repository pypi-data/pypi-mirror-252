...
from endi.forms.sale_product.json_import import JSONSalesCatalogImportSchema
from endi.views.csv_import import get_current_uploaded_filepath
...
from endi_celery.tasks.export import export_company_sales_catalog_to_json
from endi_celery.tasks.json_import import import_json_company_sales_catalog
...
class CompanyJSONSalesCatalogImportview(AsyncJobMixin, BaseFormView):
    ...
    exporté avec enDI (du même serveur ou d'un serveur différent) au format JSON.
    </p>
    <br />
