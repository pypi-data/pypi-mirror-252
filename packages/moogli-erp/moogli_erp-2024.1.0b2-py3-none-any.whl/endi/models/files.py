...
from endi.utils.filedepot import _to_fieldstorage
from endi.forms import EXCLUDED
...
class File(Node):
    ...
    def data_obj(self):
        try:
            return io.BytesIO(self.data.file.read())
        except IOError:
...
class FileType(ConfigurableOption):
    __colanderalchemy_config__ = {
        "title": "Type de documents utilisés dans enDI",
    ...
    def query_indicators(self):
        ...
        """
        from endi.models.indicators import SaleFileRequirement
