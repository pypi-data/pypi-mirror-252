...
def build_admin_menu_registry():
    ...
    result.add(
        AppMenuDropDown(
            name="validation", label="Centre de validation", permission="admin_invoices"
        )
    )
    ...
    result.add(HtmlAppMenuItem(html=ENDI_FORUM_LINK), "help")
    result.add(HtmlAppMenuItem(html=ENDI_DOC_LINK), "help")
...
def build_company_menu_registry():
    ...
    result.add(
        AppMenuDropDown(label="Aide", name="help", permission=deferred_submenu_perm)
    )
    result.add(HtmlAppMenuItem(html=ENDI_FORUM_LINK), "help")
    result.add(HtmlAppMenuItem(html=ENDI_DOC_LINK), "help")
    result.add(AppMenuItem(href="/release_notes", label="Notes de version"), "help")
...
def add_help_menu(config, **params):
    item = AppMenuItem(**params)
    config.registry.help_menu.add(item)
