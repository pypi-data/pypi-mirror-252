...
class Chat(Object):
    ...
    Parameters:
        ...
        type (:obj:`~pylogram.enums.ChatType`):
            Type of chat.
        ...
        photo (:obj:`~pylogram.types.ChatPhoto`, *optional*):
            Chat photo. Suitable for downloads only.

        bio (``str``, *optional*):
            Bio of the other party in a private chat.
            Returned only in :meth:`~pylogram.Client.get_chat`.
        ...
        restrictions (List of :obj:`~pylogram.types.Restriction`, *optional*):
            The list of reasons why this chat might be unavailable to some users.
            This field is available only in case *is_restricted* is True.

        permissions (:obj:`~pylogram.types.ChatPermissions` *optional*):
            Default chat member permissions, for groups and supergroups.

        distance (``int``, *optional*):
            Distance in meters of this group chat from your location.
            Returned only in :meth:`~pylogram.Client.get_nearby_chats`.

        linked_chat (:obj:`~pylogram.types.Chat`, *optional*):
            The linked discussion group (in case of channels) or the linked channel (in case of supergroups).
            Returned only in :meth:`~pylogram.Client.get_chat`.

        send_as_chat (:obj:`~pylogram.types.Chat`, *optional*):
            The default "send_as" chat.
            Returned only in :meth:`~pylogram.Client.get_chat`.

        available_reactions (:obj:`~pylogram.types.ChatReactions`, *optional*):
    ...
    async def archive(self):
        """Bound method *archive* of :obj:`~pylogram.types.Chat`.
    ...
    async def unarchive(self):
        """Bound method *unarchive* of :obj:`~pylogram.types.Chat`.
    ...
    async def set_title(self, title: str) -> bool:
        """Bound method *set_title* of :obj:`~pylogram.types.Chat`.
    ...
    async def set_description(self, description: str) -> bool:
        """Bound method *set_description* of :obj:`~pylogram.types.Chat`.
        ...
        *,
        ...
        Parameters:
            photo (``str`` | ``BinaryIO``, *optional*):
                New chat photo. You can pass a :obj:`~pylogram.types.Photo` file_id, a file path to upload a new photo
                from your local machine or a binary file-like object with its attribute
                ".name" set for in-memory uploads.

            video (``str`` | ``BinaryIO``, *optional*):
                New chat video. You can pass a :obj:`~pylogram.types.Video` file_id, a file path to upload a new video
                from your local machine or a binary file-like object with its attribute
                ".name" set for in-memory uploads.
    ...
    async def ban_member(
        ...
        Returns:
            :obj:`~pylogram.types.Message` | ``bool``: On success, a service message will be returned (when applicable), otherwise, in
    ...
    async def promote_member(
        ...
        Parameters:
            ...
            privileges (:obj:`~pylogram.types.ChatPrivileges`, *optional*):
                New user privileges.
    ...
    async def join(self):
        """Bound method *join* of :obj:`~pylogram.types.Chat`.
    ...
    async def leave(self):
        """Bound method *leave* of :obj:`~pylogram.types.Chat`.
    ...
    async def export_invite_link(self):
        """Bound method *export_invite_link* of :obj:`~pylogram.types.Chat`.
    ...
    def get_members(
        ...
        Parameters:
            query (``str``, *optional*):
                ...
                A query string is applicable only for :obj:`~pylogram.enums.ChatMembersFilter.SEARCH`,
                :obj:`~pylogram.enums.ChatMembersFilter.BANNED` and :obj:`~pylogram.enums.ChatMembersFilter.RESTRICTED`
                filters only.

            limit (``int``, *optional*):
                Limits the number of members to be retrieved.

            filter (:obj:`~pylogram.enums.ChatMembersFilter`, *optional*):
                Filter used to select the kind of members you want to retrieve. Only applicable for supergroups
                and channels.

        Returns:
            ``Generator``: On success, a generator yielding :obj:`~pylogram.types.ChatMember` objects is returned.
        """
    ...
    async def mark_unread(self, ) -> bool:
        """Bound method *mark_unread* of :obj:`~pylogram.types.Chat`.
    ...
    async def set_protected_content(self, enabled: bool) -> bool:
        """Bound method *set_protected_content* of :obj:`~pylogram.types.Chat`.
    ...
    async def unpin_all_messages(self) -> bool:
        """Bound method *unpin_all_messages* of :obj:`~pylogram.types.Chat`.
