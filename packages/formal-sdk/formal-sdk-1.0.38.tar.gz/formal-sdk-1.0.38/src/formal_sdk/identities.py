...
from .gen.admin.v1.identities_pb2 import (
	...
	GetHumanUserAuthTokenRequest,
	GetHumanUserAuthTokenResponse,
...
class UserService:
	...
	def GetHumanUserAuthToken(self, request: GetHumanUserAuthTokenRequest) -> GetHumanUserAuthTokenResponse:
		return self.stub.GetHumanUserAuthToken(request, metadata=self.headers)
