...
class CreateHumanUserAuthTokenResponse(_message.Message):
    __slots__ = ("token", "username", "expire_at")
    TOKEN_FIELD_NUMBER: _ClassVar[int]
    USERNAME_FIELD_NUMBER: _ClassVar[int]
    EXPIRE_AT_FIELD_NUMBER: _ClassVar[int]
    token: str
    username: str
    expire_at: _timestamp_pb2.Timestamp
    def __init__(self, token: _Optional[str] = ..., username: _Optional[str] = ..., expire_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
