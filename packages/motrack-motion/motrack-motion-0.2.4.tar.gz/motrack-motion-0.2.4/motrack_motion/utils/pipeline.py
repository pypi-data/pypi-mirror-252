...
from motrack_motion.common import project, formats, conventions
from motrack_motion.utils import rich
...
def store_run_history_config(output_dir: str, cfg: DictConfig, task_name: str) -> None:
    ...
    Args:
        ...
        task_name: Task name
    """
    experiment_path = conventions.get_experiment_path(output_dir, cfg.dataset.path, cfg.experiment)
