...
from greenstream.greenstream.generate_greenstream_launch_description import merge_cameras
...
def get_cameras_urdf(cameras: List[Camera], camera_overrides: List[CameraOverride], mode: str) -> Tuple[List[Link], List[Joint]]:
    ...
    for camera in cameras:
        ...
        camera_links, camera_joints = get_camera_urdf(camera, mode)
        links += camera_links
