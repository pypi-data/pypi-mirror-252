...
class ClusterProgressInfo(object):
    ...
    swagger_types = {
        ...
        'node_updater_started_at': 'datetime',
    ...
    attribute_map = {
        ...
        'node_updater_started_at': 'node_updater_started_at',
        'node_updater_finished_at': 'node_updater_finished_at'
    }

    def __init__(self, total_percentage=None, preparing_for_installation_stage_percentage=None, installing_stage_percentage=None, finalizing_stage_percentage=None, finalizing_stage=None, finalizing_stage_started_at=None, node_updater_started_at=None, node_updater_finished_at=None):  # noqa: E501
