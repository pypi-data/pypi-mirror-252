...
from copernicus_marine.catalogue_parser.request_structure import LoadRequest
from copernicus_marine.core_functions.deprecated import (
    deprecated_python_option,
    log_deprecated_message,
)
from copernicus_marine.core_functions.deprecated_options import (
    DEPRECATED_OPTIONS,
)
from copernicus_marine.core_functions.models import (
...
from copernicus_marine.download_functions.subset_parameters import (
    DepthParameters,
...
from copernicus_marine.python_interface.exception_handler import (
    log_exception_and_exit,
)
from copernicus_marine.python_interface.load_utils import (
    load_data_object_from_load_request,
)
from copernicus_marine.python_interface.utils import homogenize_datetime
