...
from copernicus_marine.command_line_interface.exception_handler import (
    log_exception_and_exit,
)
from copernicus_marine.command_line_interface.utils import (
...
from copernicus_marine.core_functions.services_utils import CommandType
from copernicus_marine.core_functions.subset import (
...
@click.option(
    ...
    default=False,
    is_flag=True,
    help=("Add a default compression to the NetCDF output file."),
)
@log_exception_and_exit
def subset(
