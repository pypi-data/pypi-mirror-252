...
from copernicus_marine.catalogue_parser.catalogue_parser import (
    CopernicusMarineDatasetServiceType,
    parse_catalogue,
)
from copernicus_marine.catalogue_parser.request_structure import (
    SubsetRequest,
    convert_motu_api_request_to_structure,
    subset_request_from_file,
)
from copernicus_marine.core_functions.credentials_utils import (
    get_and_check_username_password,
)
from copernicus_marine.core_functions.models import SubsetMethod
from copernicus_marine.core_functions.services_utils import (
    CommandType,
    RetrievalService,
    get_retrieval_service,
    parse_dataset_id_and_service_and_suffix_path_from_url,
)
from copernicus_marine.core_functions.utils import (
    ServiceNotSupported,
    delete_cache_folder,
    get_unique_filename,
)
from copernicus_marine.core_functions.versions_verifier import VersionVerifier
from copernicus_marine.download_functions.download_arco_series import (
    download_zarr,
)
from copernicus_marine.download_functions.download_motu import download_motu
from copernicus_marine.download_functions.download_opendap import (
    download_opendap,
)
from copernicus_marine.download_functions.subset_xarray import (
    check_dataset_subset_bounds,
)
from copernicus_marine.download_functions.utils import FileFormat
