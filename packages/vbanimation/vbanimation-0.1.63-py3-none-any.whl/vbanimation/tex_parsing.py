...
latex_maths_grammar = """
    ...
    meter: DECIMAL "\\m" | INTEGER "\\m" | WORD "\\m" | "\\m"
    tesla: DECIMAL "\\Tesla" | INTEGER "\\Tesla" | WORD "\\Tesla" | "\\Tesla"
    ampere: DECIMAL "\\Amp" | INTEGER "\\Amp" | WORD "\\Amp" | "\\Amp"
    newton: DECIMAL "\\N" | INTEGER "\\N" | WORD "\\N" | "\\N"
