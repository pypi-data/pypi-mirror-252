...
def save_whole_table(config: Configuration, conn: ClickHouseConnector, columns_list: str) -> None:
    """
...
def export_to_s3(config: Configuration) -> None:
    ...
    if metadata.engine.lower() not in ["join", "view", "merge", "null", "materializedview"]:
