...
def get_configuration() -> Configuration:
    ...
    raw_config = {
        "s3": {
            ...
            "S3_SECRET_KEY": args.s3_secret_key or os.getenv("S3_ACCESS_SECRET"),
        ...
        "BATCH_SIZE": args.batch_size or os.getenv("BATCH_SIZE"),
        "LOG_LEVEL": args.log_level,
        "DROP_DESTINATION_TABLE_IF_EXISTS": args.drop_destination_table_if_exists,
        "ON_CLUSTER_DIRECTIVE": args.on_cluster_directive
        or os.getenv("ON_CLUSTER_DIRECTIVE"),
