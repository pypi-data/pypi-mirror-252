...
Refer to the Terraform Registry for docs: [`cloudflare_load_balancer`](https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer).
'''
import abc
import builtins
import datetime
...
class LoadBalancer(
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer cloudflare_load_balancer} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param default_pool_ids: A list of pool IDs ordered by their failover priority. Used whenever ```pop_pools`` <#pop_pools>`_/```country_pools`` <#country_pools>`_/```region_pools`` <#region_pools>`_ are not defined. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#default_pool_ids LoadBalancer#default_pool_ids}
        :param fallback_pool_id: The pool ID to use when all other pools are detected as unhealthy. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#fallback_pool_id LoadBalancer#fallback_pool_id}
        :param name: The DNS hostname to associate with your load balancer. If this hostname already exists as a DNS record in Cloudflare's DNS, the load balancer will take precedence and the DNS record will not be used. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#name LoadBalancer#name}
        :param zone_id: The zone ID to add the load balancer to. **Modifying this attribute will force creation of a new resource.**. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#zone_id LoadBalancer#zone_id}
        :param adaptive_routing: adaptive_routing block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#adaptive_routing LoadBalancer#adaptive_routing}
        :param country_pools: country_pools block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#country_pools LoadBalancer#country_pools}
        :param description: Free text description. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#description LoadBalancer#description}
        :param enabled: Enable or disable the load balancer. Defaults to ``true``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#enabled LoadBalancer#enabled}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#id LoadBalancer#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param location_strategy: location_strategy block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#location_strategy LoadBalancer#location_strategy}
        :param pop_pools: pop_pools block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#pop_pools LoadBalancer#pop_pools}
        :param proxied: Whether the hostname gets Cloudflare's origin protection. Defaults to ``false``. Conflicts with ``ttl``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#proxied LoadBalancer#proxied}
        :param random_steering: random_steering block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#random_steering LoadBalancer#random_steering}
        :param region_pools: region_pools block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#region_pools LoadBalancer#region_pools}
        :param rules: rules block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#rules LoadBalancer#rules}
        :param session_affinity: Specifies the type of session affinity the load balancer should use unless specified as ``none`` or ``""`` (default). With value ``cookie``, on the first request to a proxied load balancer, a cookie is generated, encoding information of which origin the request will be forwarded to. Subsequent requests, by the same client to the same load balancer, will be sent to the origin server the cookie encodes, for the duration of the cookie and as long as the origin server remains healthy. If the cookie has expired or the origin server is unhealthy then a new origin server is calculated and used. Value ``ip_cookie`` behaves the same as ``cookie`` except the initial origin selection is stable and based on the client's IP address. Available values: ``""``, ``none``, ``cookie``, ``ip_cookie``, ``header``. Defaults to ``none``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#session_affinity LoadBalancer#session_affinity}
        :param session_affinity_attributes: session_affinity_attributes block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#session_affinity_attributes LoadBalancer#session_affinity_attributes}
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing LoadBalancer that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#import import section} in the documentation of this resource for the id to use
...
class LoadBalancerAdaptiveRouting:
    def __init__(
        ...
        *,
        ...
        '''
        :param failover_across_pools: Extends zero-downtime failover of requests to healthy origins from alternate pools, when no healthy alternate exists in the same pool, according to the failover order defined by traffic and origin steering. When set ``false``, zero-downtime failover will only occur between origins within the same pool. Defaults to ``false``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#failover_across_pools LoadBalancer#failover_across_pools}
        '''
        if __debug__:
...
class LoadBalancerCountryPools:
    def __init__(
        ...
        *,
        ...
        '''
        :param country: A country code which can be determined with the Load Balancing Regions API described `here <https://developers.cloudflare.com/load-balancing/reference/region-mapping-api/>`_. Multiple entries should not be specified with the same country. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#country LoadBalancer#country}
        :param pool_ids: A list of pool IDs in failover priority to use in the given country. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#pool_ids LoadBalancer#pool_ids}
        '''
        if __debug__:
...
class LoadBalancerLocationStrategy:
    def __init__(
        ...
        *,
        ...
        '''
        :param mode: Determines the authoritative location when ECS is not preferred, does not exist in the request, or its GeoIP lookup is unsuccessful. Value ``pop`` will use the Cloudflare PoP location. Value ``resolver_ip`` will use the DNS resolver GeoIP location. If the GeoIP lookup is unsuccessful, it will use the Cloudflare PoP location. Available values: ``pop``, ``resolver_ip``. Defaults to ``pop``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#mode LoadBalancer#mode}
        :param prefer_ecs: Whether the EDNS Client Subnet (ECS) GeoIP should be preferred as the authoritative location. Value ``always`` will always prefer ECS, ``never`` will never prefer ECS, ``proximity`` will prefer ECS only when ```steering_policy="proximity"`` <#steering_policy>`_, and ``geo`` will prefer ECS only when ```steering_policy="geo"`` <#steering_policy>`_. Available values: ``always``, ``never``, ``proximity``, ``geo``. Defaults to ``proximity``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#prefer_ecs LoadBalancer#prefer_ecs}
        '''
        if __debug__:
...
class LoadBalancerPopPools:
    def __init__(
        ...
        *,
        ...
        '''
        :param pool_ids: A list of pool IDs in failover priority to use for traffic reaching the given PoP. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#pool_ids LoadBalancer#pool_ids}
        :param pop: A 3-letter code for the Point-of-Presence. Allowed values can be found in the list of datacenters on the `status page <https://www.cloudflarestatus.com/>`_. Multiple entries should not be specified with the same PoP. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#pop LoadBalancer#pop}
        '''
        if __debug__:
...
class LoadBalancerRandomSteering:
    def __init__(
        ...
        *,
        ...
        '''
        :param default_weight: The default weight for pools in the load balancer that are not specified in the ```pool_weights`` <#pool_weights>`_ map. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#default_weight LoadBalancer#default_weight}
        :param pool_weights: A mapping of pool IDs to custom weights. The weight is relative to other pools in the load balancer. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#pool_weights LoadBalancer#pool_weights}
        '''
        if __debug__:
...
class LoadBalancerRegionPools:
    def __init__(
        ...
        *,
        ...
        '''
        :param pool_ids: A list of pool IDs in failover priority to use in the given region. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#pool_ids LoadBalancer#pool_ids}
        :param region: A region code which must be in the list defined `here <https://developers.cloudflare.com/load-balancing/reference/region-mapping-api/#list-of-load-balancer-regions>`_. Multiple entries should not be specified with the same region. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#region LoadBalancer#region}
        '''
        if __debug__:
...
class LoadBalancerRules:
    def __init__(
        ...
        *,
        ...
        '''
        :param name: Human readable name for this rule. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#name LoadBalancer#name}
        :param condition: The statement to evaluate to determine if this rule's effects should be applied. An empty condition is always true. See `load balancing rules <https://developers.cloudflare.com/load-balancing/understand-basics/load-balancing-rules>`_. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#condition LoadBalancer#condition}
        :param disabled: A disabled rule will not be executed. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#disabled LoadBalancer#disabled}
        :param fixed_response: fixed_response block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#fixed_response LoadBalancer#fixed_response}
        :param overrides: overrides block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#overrides LoadBalancer#overrides}
        :param priority: Priority used when determining the order of rule execution. Lower values are executed first. If not provided, the list order will be used. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#priority LoadBalancer#priority}
        :param terminates: Terminates indicates that if this rule is true no further rules should be executed. Note: setting a ```fixed_response`` <#fixed_response>`_ forces this field to ``true``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#terminates LoadBalancer#terminates}
        '''
...
class LoadBalancerRulesFixedResponse:
    def __init__(
        ...
        *,
        ...
        '''
        :param content_type: The value of the HTTP context-type header for this fixed response. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#content_type LoadBalancer#content_type}
        :param location: The value of the HTTP location header for this fixed response. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#location LoadBalancer#location}
        :param message_body: The text used as the html body for this fixed response. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#message_body LoadBalancer#message_body}
        :param status_code: The HTTP status code used for this fixed response. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#status_code LoadBalancer#status_code}
        '''
        if __debug__:
...
class LoadBalancerRulesOverrides:
    def __init__(
        ...
        *,
        ...
        :param adaptive_routing: adaptive_routing block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#adaptive_routing LoadBalancer#adaptive_routing}
        :param country_pools: country_pools block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#country_pools LoadBalancer#country_pools}
        :param default_pools: A list of pool IDs ordered by their failover priority. Used whenever ```pop_pools`` <#pop_pools>`_/```country_pools`` <#country_pools>`_/```region_pools`` <#region_pools>`_ are not defined. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#default_pools LoadBalancer#default_pools}
        :param fallback_pool: The pool ID to use when all other pools are detected as unhealthy. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#fallback_pool LoadBalancer#fallback_pool}
        :param location_strategy: location_strategy block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#location_strategy LoadBalancer#location_strategy}
        :param pop_pools: pop_pools block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#pop_pools LoadBalancer#pop_pools}
        :param random_steering: random_steering block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#random_steering LoadBalancer#random_steering}
        :param region_pools: region_pools block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#region_pools LoadBalancer#region_pools}
        :param session_affinity: Configure attributes for session affinity. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#session_affinity LoadBalancer#session_affinity}
        :param session_affinity_attributes: session_affinity_attributes block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#session_affinity_attributes LoadBalancer#session_affinity_attributes}
        :param session_affinity_ttl: Time, in seconds, until this load balancer's session affinity cookie expires after being created. This parameter is ignored unless a supported session affinity policy is set. The current default of ``82800`` (23 hours) will be used unless ```session_affinity_ttl`` <#session_affinity_ttl>`_ is explicitly set. Once the expiry time has been reached, subsequent requests may get sent to a different origin server. Valid values are between ``1800`` and ``604800``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#session_affinity_ttl LoadBalancer#session_affinity_ttl}
        :param steering_policy: The method the load balancer uses to determine the route to your origin. Value ``off`` uses ```default_pool_ids`` <#default_pool_ids>`_. Value ``geo`` uses ```pop_pools`` <#pop_pools>`_/```country_pools`` <#country_pools>`_/```region_pools`` <#region_pools>`_. For non-proxied requests, the ```country`` <#country>`_ for ```country_pools`` <#country_pools>`_ is determined by ```location_strategy`` <#location_strategy>`_. Value ``random`` selects a pool randomly. Value ``dynamic_latency`` uses round trip time to select the closest pool in ```default_pool_ids`` <#default_pool_ids>`_ (requires pool health checks). Value ``proximity`` uses the pools' latitude and longitude to select the closest pool using the Cloudflare PoP location for proxied requests or the location determined by ```location_strategy`` <#location_strategy>`_ for non-proxied requests. Value ``least_outstanding_requests`` selects a pool by taking into consideration ```random_steering`` <#random_steering>`_ weights, as well as each pool's number of outstanding requests. Pools with more pending requests are weighted proportionately less relative to others. Value ``least_connections`` selects a pool by taking into consideration ```random_steering`` <#random_steering>`_ weights, as well as each pool's number of open connections. Pools with more open connections are weighted proportionately less relative to others. Supported for HTTP/1 and HTTP/2 connections. Value ``""`` maps to ``geo`` if you use ```pop_pools`` <#pop_pools>`_/```country_pools`` <#country_pools>`_/```region_pools`` <#region_pools>`_ otherwise ``off``. Available values: ``off``, ``geo``, ``dynamic_latency``, ``random``, ``proximity``, ``least_outstanding_requests``, ``least_connections``, ``""`` Defaults to ``""``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#steering_policy LoadBalancer#steering_policy}
        :param ttl: Time to live (TTL) of the DNS entry for the IP address returned by this load balancer. This cannot be set for proxied load balancers. Defaults to ``30``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#ttl LoadBalancer#ttl}
        '''
        if __debug__:
...
class LoadBalancerRulesOverridesAdaptiveRouting:
    def __init__(
        ...
        *,
        ...
        '''
        :param failover_across_pools: Extends zero-downtime failover of requests to healthy origins from alternate pools, when no healthy alternate exists in the same pool, according to the failover order defined by traffic and origin steering. When set ``false``, zero-downtime failover will only occur between origins within the same pool. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#failover_across_pools LoadBalancer#failover_across_pools}
        '''
        if __debug__:
...
class LoadBalancerRulesOverridesLocationStrategy:
    def __init__(
        ...
        *,
        ...
        '''
        :param mode: Determines the authoritative location when ECS is not preferred, does not exist in the request, or its GeoIP lookup is unsuccessful. Value ``pop`` will use the Cloudflare PoP location. Value ``resolver_ip`` will use the DNS resolver GeoIP location. If the GeoIP lookup is unsuccessful, it will use the Cloudflare PoP location. Available values: ``pop``, ``resolver_ip``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#mode LoadBalancer#mode}
        :param prefer_ecs: Whether the EDNS Client Subnet (ECS) GeoIP should be preferred as the authoritative location. Value ``always`` will always prefer ECS, ``never`` will never prefer ECS, ``proximity`` will prefer ECS only when ```steering_policy="proximity"`` <#steering_policy>`_, and ``geo`` will prefer ECS only when ```steering_policy="geo"`` <#steering_policy>`_. Available values: ``always``, ``never``, ``proximity``, ``geo``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#prefer_ecs LoadBalancer#prefer_ecs}
        '''
        if __debug__:
...
class LoadBalancerRulesOverridesSessionAffinityAttributes:
    def __init__(
        ...
        *,
        ...
        '''
        :param headers: Configures the HTTP header names to use when header session affinity is enabled. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#headers LoadBalancer#headers}
        :param require_all_headers: Configures how headers are used when header session affinity is enabled. Set to true to require all headers to be present on requests in order for sessions to be created or false to require at least one header to be present. Defaults to ``false``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#require_all_headers LoadBalancer#require_all_headers}
        :param samesite: Configures the SameSite attribute on session affinity cookie. Value ``Auto`` will be translated to ``Lax`` or ``None`` depending if Always Use HTTPS is enabled. Note: when using value ``None``, then you can not set ```secure="Never"`` <#secure>`_. Available values: ``Auto``, ``Lax``, ``None``, ``Strict``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#samesite LoadBalancer#samesite}
        :param secure: Configures the Secure attribute on session affinity cookie. Value ``Always`` indicates the Secure attribute will be set in the Set-Cookie header, ``Never`` indicates the Secure attribute will not be set, and ``Auto`` will set the Secure attribute depending if Always Use HTTPS is enabled. Available values: ``Auto``, ``Always``, ``Never``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#secure LoadBalancer#secure}
        :param zero_downtime_failover: Configures the zero-downtime failover between origins within a pool when session affinity is enabled. Value ``none`` means no failover takes place for sessions pinned to the origin. Value ``temporary`` means traffic will be sent to another other healthy origin until the originally pinned origin is available; note that this can potentially result in heavy origin flapping. Value ``sticky`` means the session affinity cookie is updated and subsequent requests are sent to the new origin. This feature is currently incompatible with Argo, Tiered Cache, and Bandwidth Alliance. Available values: ``none``, ``temporary``, ``sticky``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#zero_downtime_failover LoadBalancer#zero_downtime_failover}
        '''
        if __debug__:
...
class LoadBalancerSessionAffinityAttributes:
    def __init__(
        ...
        *,
        ...
        '''
        :param drain_duration: Configures the drain duration in seconds. This field is only used when session affinity is enabled on the load balancer. Defaults to ``0``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#drain_duration LoadBalancer#drain_duration}
        :param headers: Configures the HTTP header names to use when header session affinity is enabled. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#headers LoadBalancer#headers}
        :param require_all_headers: Configures how headers are used when header session affinity is enabled. Set to true to require all headers to be present on requests in order for sessions to be created or false to require at least one header to be present. Defaults to ``false``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#require_all_headers LoadBalancer#require_all_headers}
        :param samesite: Configures the SameSite attribute on session affinity cookie. Value ``Auto`` will be translated to ``Lax`` or ``None`` depending if Always Use HTTPS is enabled. Note: when using value ``None``, then you can not set ```secure="Never"`` <#secure>`_. Available values: ``Auto``, ``Lax``, ``None``, ``Strict``. Defaults to ``Auto``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#samesite LoadBalancer#samesite}
        :param secure: Configures the Secure attribute on session affinity cookie. Value ``Always`` indicates the Secure attribute will be set in the Set-Cookie header, ``Never`` indicates the Secure attribute will not be set, and ``Auto`` will set the Secure attribute depending if Always Use HTTPS is enabled. Available values: ``Auto``, ``Always``, ``Never``. Defaults to ``Auto``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#secure LoadBalancer#secure}
        :param zero_downtime_failover: Configures the zero-downtime failover between origins within a pool when session affinity is enabled. Value ``none`` means no failover takes place for sessions pinned to the origin. Value ``temporary`` means traffic will be sent to another other healthy origin until the originally pinned origin is available; note that this can potentially result in heavy origin flapping. Value ``sticky`` means the session affinity cookie is updated and subsequent requests are sent to the new origin. This feature is currently incompatible with Argo, Tiered Cache, and Bandwidth Alliance. Available values: ``none``, ``temporary``, ``sticky``. Defaults to ``none``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/load_balancer#zero_downtime_failover LoadBalancer#zero_downtime_failover}
        '''
        if __debug__:
