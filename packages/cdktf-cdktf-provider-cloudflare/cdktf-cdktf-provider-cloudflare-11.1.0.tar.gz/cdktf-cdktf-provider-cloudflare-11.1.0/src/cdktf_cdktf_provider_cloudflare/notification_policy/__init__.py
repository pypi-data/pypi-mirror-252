...
class NotificationPolicy(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy cloudflare_notification_policy}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy cloudflare_notification_policy} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param account_id: The account identifier to target for the resource. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#account_id NotificationPolicy#account_id}
        :param alert_type: The event type that will trigger the dispatch of a notification. See the developer documentation for descriptions of `available alert types <https://developers.cloudflare.com/fundamentals/notifications/notification-available/>`_. Available values: ``advanced_http_alert_error``, ``access_custom_certificate_expiration_type``, ``advanced_ddos_attack_l4_alert``, ``advanced_ddos_attack_l7_alert``, ``bgp_hijack_notification``, ``billing_usage_alert``, ``block_notification_block_removed``, ``block_notification_new_block``, ``block_notification_review_rejected``, ``brand_protection_alert``, ``brand_protection_digest``, ``clickhouse_alert_fw_anomaly``, ``clickhouse_alert_fw_ent_anomaly``, ``custom_ssl_certificate_event_type``, ``dedicated_ssl_certificate_event_type``, ``dos_attack_l4``, ``dos_attack_l7``, ``expiring_service_token_alert``, ``failing_logpush_job_disabled_alert``, ``fbm_auto_advertisement``, ``fbm_dosd_attack``, ``fbm_volumetric_attack``, ``health_check_status_notification``, ``hostname_aop_custom_certificate_expiration_type``, ``http_alert_edge_error``, ``http_alert_origin_error``, ``incident_alert``, ``load_balancing_health_alert``, ``load_balancing_pool_enablement_alert``, ``logo_match_alert``, ``magic_tunnel_health_check_event``, ``maintenance_event_notification``, ``mtls_certificate_store_certificate_expiration_type``, ``pages_event_alert``, ``radar_notification``, ``real_origin_monitoring``, ``scriptmonitor_alert_new_code_change_detections``, ``scriptmonitor_alert_new_hosts``, ``scriptmonitor_alert_new_malicious_hosts``, ``scriptmonitor_alert_new_malicious_scripts``, ``scriptmonitor_alert_new_malicious_url``, ``scriptmonitor_alert_new_max_length_resource_url``, ``scriptmonitor_alert_new_resources``, ``secondary_dns_all_primaries_failing``, ``secondary_dns_primaries_failing``, ``secondary_dns_zone_successfully_updated``, ``secondary_dns_zone_validation_warning``, ``sentinel_alert``, ``stream_live_notifications``, ``traffic_anomalies_alert``, ``tunnel_health_event``, ``tunnel_update_event``, ``universal_ssl_event_type``, ``web_analytics_metrics_update``, ``weekly_account_overview``, ``workers_alert``, ``zone_aop_custom_certificate_expiration_type``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#alert_type NotificationPolicy#alert_type}
        :param enabled: The status of the notification policy. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#enabled NotificationPolicy#enabled}
        :param name: The name of the notification policy. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#name NotificationPolicy#name}
        :param description: Description of the notification policy. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#description NotificationPolicy#description}
        :param email_integration: email_integration block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#email_integration NotificationPolicy#email_integration}
        :param filters: filters block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#filters NotificationPolicy#filters}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#id NotificationPolicy#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param pagerduty_integration: pagerduty_integration block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#pagerduty_integration NotificationPolicy#pagerduty_integration}
        :param webhooks_integration: webhooks_integration block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#webhooks_integration NotificationPolicy#webhooks_integration}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing NotificationPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#import import section} in the documentation of this resource for the id to use
    ...
    def put_filters(
        ...
        *,
        ...
        '''
        :param actions: Targeted actions for alert. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#actions NotificationPolicy#actions}
        :param affected_components: Affected components for alert. Available values: ``API``, ``API Shield``, ``Access``, ``Always Online``, ``Analytics``, ``Apps Marketplace``, ``Argo Smart Routing``, ``Audit Logs``, ``Authoritative DNS``, ``Billing``, ``Bot Management``, ``Bring Your Own IP (BYOIP)``, ``Browser Isolation``, ``CDN Cache Purge``, ``CDN/Cache``, ``Cache Reserve``, ``Challenge Platform``, ``Cloud Access Security Broker (CASB)``, ``Community Site``, ``DNS Root Servers``, ``DNS Updates``, ``Dashboard``, ``Data Loss Prevention (DLP)``, ``Developer's Site``, ``Digital Experience Monitoring (DEX)``, ``Distributed Web Gateway``, ``Durable Objects``, ``Email Routing``, ``Ethereum Gateway``, ``Firewall``, ``Gateway``, ``Geo-Key Manager``, ``Image Resizing``, ``Images``, ``Infrastructure``, ``Lists``, ``Load Balancing and Monitoring``, ``Logs``, ``Magic Firewall``, ``Magic Transit``, ``Magic WAN``, ``Magic WAN Connector``, ``Marketing Site``, ``Mirage``, ``Network``, ``Notifications``, ``Observatory``, ``Page Shield``, ``Pages``, ``R2``, ``Radar``, ``Randomness Beacon``, ``Recursive DNS``, ``Registrar``, ``Registration Data Access Protocol (RDAP)``, ``SSL Certificate Provisioning``, ``SSL for SaaS Provisioning``, ``Security Center``, ``Snippets``, ``Spectrum``, ``Speed Optimizations``, ``Stream``, ``Support Site``, ``Time Services``, ``Trace``, ``Tunnel``, ``Turnstile``, ``WARP``, ``Waiting Room``, ``Web Analytics``, ``Workers``, ``Workers KV``, ``Workers Preview``, ``Zaraz``, ``Zero Trust``, ``Zero Trust Dashboard``, ``Zone Versioning``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#affected_components NotificationPolicy#affected_components}
        :param alert_trigger_preferences: Alert trigger preferences. Example: ``slo``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#alert_trigger_preferences NotificationPolicy#alert_trigger_preferences}
        :param enabled: State of the pool to alert on. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#enabled NotificationPolicy#enabled}
        :param environment: Environment of pages. Available values: ``ENVIRONMENT_PREVIEW``, ``ENVIRONMENT_PRODUCTION``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#environment NotificationPolicy#environment}
        :param event: Pages event to alert. Available values: ``EVENT_DEPLOYMENT_STARTED``, ``EVENT_DEPLOYMENT_FAILED``, ``EVENT_DEPLOYMENT_SUCCESS``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#event NotificationPolicy#event}
        :param event_source: Source configuration to alert on for pool or origin. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#event_source NotificationPolicy#event_source}
        :param event_type: Stream event type to alert on. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#event_type NotificationPolicy#event_type}
        :param group_by: Alert grouping. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#group_by NotificationPolicy#group_by}
        :param health_check_id: Identifier health check. Required when using ``filters.0.status``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#health_check_id NotificationPolicy#health_check_id}
        :param incident_impact: The incident impact level that will trigger the dispatch of a notification. Available values: ``INCIDENT_IMPACT_NONE``, ``INCIDENT_IMPACT_MINOR``, ``INCIDENT_IMPACT_MAJOR``, ``INCIDENT_IMPACT_CRITICAL``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#incident_impact NotificationPolicy#incident_impact}
        :param input_id: Stream input id to alert on. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#input_id NotificationPolicy#input_id}
        :param limit: A numerical limit. Example: ``100``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#limit NotificationPolicy#limit}
        :param megabits_per_second: Megabits per second threshold for dos alert. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#megabits_per_second NotificationPolicy#megabits_per_second}
        :param new_health: Health status to alert on for pool or origin. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#new_health NotificationPolicy#new_health}
        :param new_status: Tunnel health status to alert on. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#new_status NotificationPolicy#new_status}
        :param packets_per_second: Packets per second threshold for dos alert. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#packets_per_second NotificationPolicy#packets_per_second}
        :param pool_id: Load balancer pool identifier. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#pool_id NotificationPolicy#pool_id}
        :param product: Product name. Available values: ``worker_requests``, ``worker_durable_objects_requests``, ``worker_durable_objects_duration``, ``worker_durable_objects_data_transfer``, ``worker_durable_objects_stored_data``, ``worker_durable_objects_storage_deletes``, ``worker_durable_objects_storage_writes``, ``worker_durable_objects_storage_reads``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#product NotificationPolicy#product}
        :param project_id: Identifier of pages project. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#project_id NotificationPolicy#project_id}
        :param protocol: Protocol to alert on for dos. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#protocol NotificationPolicy#protocol}
        :param requests_per_second: Requests per second threshold for dos alert. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#requests_per_second NotificationPolicy#requests_per_second}
        :param selectors: Selectors for alert. Valid options depend on the alert type. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#selectors NotificationPolicy#selectors}
        :param services: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#services NotificationPolicy#services}.
        :param slo: A numerical limit. Example: ``99.9``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#slo NotificationPolicy#slo}
        :param status: Status to alert on. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#status NotificationPolicy#status}
        :param target_hostname: Target host to alert on for dos. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#target_hostname NotificationPolicy#target_hostname}
        :param target_zone_name: Target domain to alert on. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#target_zone_name NotificationPolicy#target_zone_name}
        :param tunnel_id: Tunnel IDs to alert on. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#tunnel_id NotificationPolicy#tunnel_id}
        :param where: Filter for alert. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#where NotificationPolicy#where}
        :param zones: A list of zone identifiers. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#zones NotificationPolicy#zones}
        '''
...
class NotificationPolicyConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def account_id(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#account_id NotificationPolicy#account_id}
        '''
    ...
    def enabled(self) -> typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#enabled NotificationPolicy#enabled}
        '''
    ...
    def name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#name NotificationPolicy#name}
        '''
    ...
    def description(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#description NotificationPolicy#description}
        '''
    ...
    def email_integration(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#email_integration NotificationPolicy#email_integration}
        '''
    ...
    def filters(self) -> typing.Optional["NotificationPolicyFilters"]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#filters NotificationPolicy#filters}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#id NotificationPolicy#id}.
    ...
    def pagerduty_integration(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#pagerduty_integration NotificationPolicy#pagerduty_integration}
        '''
    ...
    def webhooks_integration(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#webhooks_integration NotificationPolicy#webhooks_integration}
        '''
...
class NotificationPolicyEmailIntegration:
    def __init__(
        ...
        *,
        ...
        '''
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#id NotificationPolicy#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param name: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#name NotificationPolicy#name}.
        '''
        if __debug__:
...
class NotificationPolicyFilters:
    ...
    def actions(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#actions NotificationPolicy#actions}
        '''
    ...
    def affected_components(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#affected_components NotificationPolicy#affected_components}
        '''
    ...
    def alert_trigger_preferences(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#alert_trigger_preferences NotificationPolicy#alert_trigger_preferences}
        '''
    ...
    def environment(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#environment NotificationPolicy#environment}
        '''
    ...
    def event(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#event NotificationPolicy#event}
        '''
    ...
    def event_source(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#event_source NotificationPolicy#event_source}
        '''
    ...
    def event_type(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#event_type NotificationPolicy#event_type}
        '''
    ...
    def group_by(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#group_by NotificationPolicy#group_by}
        '''
    ...
    def health_check_id(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#health_check_id NotificationPolicy#health_check_id}
        '''
    ...
    def incident_impact(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#incident_impact NotificationPolicy#incident_impact}
        '''
    ...
    def input_id(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#input_id NotificationPolicy#input_id}
        '''
    ...
    def limit(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#limit NotificationPolicy#limit}
        '''
    ...
    def megabits_per_second(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#megabits_per_second NotificationPolicy#megabits_per_second}
        '''
    ...
    def new_health(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#new_health NotificationPolicy#new_health}
        '''
    ...
    def new_status(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#new_status NotificationPolicy#new_status}
        '''
    ...
    def packets_per_second(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#packets_per_second NotificationPolicy#packets_per_second}
        '''
    ...
    def pool_id(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#pool_id NotificationPolicy#pool_id}
        '''
    ...
    def product(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#product NotificationPolicy#product}
        '''
    ...
    def project_id(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#project_id NotificationPolicy#project_id}
        '''
    ...
    def protocol(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#protocol NotificationPolicy#protocol}
        '''
    ...
    def requests_per_second(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#requests_per_second NotificationPolicy#requests_per_second}
        '''
    ...
    def selectors(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#selectors NotificationPolicy#selectors}
        '''
    ...
    def services(self) -> typing.Optional[typing.List[builtins.str]]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#services NotificationPolicy#services}.'''
    ...
    def slo(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#slo NotificationPolicy#slo}
        '''
    ...
    def status(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#status NotificationPolicy#status}
        '''
    ...
    def target_hostname(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#target_hostname NotificationPolicy#target_hostname}
        '''
    ...
    def target_zone_name(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#target_zone_name NotificationPolicy#target_zone_name}
        '''
    ...
    def tunnel_id(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#tunnel_id NotificationPolicy#tunnel_id}
        '''
    ...
    def where(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#where NotificationPolicy#where}
        '''
    ...
    def zones(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/notification_policy#zones NotificationPolicy#zones}
        '''
