...
Refer to the Terraform Registry for docs: [`cloudflare_device_posture_rule`](https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule).
'''
import abc
import builtins
import datetime
...
class DevicePostureRule(
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule cloudflare_device_posture_rule} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param account_id: The account identifier to target for the resource. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#account_id DevicePostureRule#account_id}
        ...
        :param description: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#description DevicePostureRule#description}.
        :param expiration: Expire posture results after the specified amount of time. Must be in the format ``1h`` or ``30m``. Valid units are ``h`` and ``m``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#expiration DevicePostureRule#expiration}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#id DevicePostureRule#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param input: input block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#input DevicePostureRule#input}
        :param match: match block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#match DevicePostureRule#match}
        :param name: Name of the device posture rule. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#name DevicePostureRule#name}
        :param schedule: Tells the client when to run the device posture check. Must be in the format ``1h`` or ``30m``. Valid units are ``h`` and ``m``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#schedule DevicePostureRule#schedule}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DevicePostureRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#import import section} in the documentation of this resource for the id to use
...
class DevicePostureRuleInput:
    def __init__(
        ...
        *,
        ...
        '''
        :param active_threats: The number of active threats from SentinelOne. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#active_threats DevicePostureRule#active_threats}
        :param certificate_id: The UUID of a Cloudflare managed certificate. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#certificate_id DevicePostureRule#certificate_id}
        :param check_disks: Specific volume(s) to check for encryption. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#check_disks DevicePostureRule#check_disks}
        :param cn: The common name for a certificate. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#cn DevicePostureRule#cn}
        :param compliance_status: The workspace one device compliance status. Available values: ``compliant``, ``noncompliant``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#compliance_status DevicePostureRule#compliance_status}
        :param connection_id: The workspace one connection id. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#connection_id DevicePostureRule#connection_id}
        :param count_operator: The count comparison operator for kolide. Available values: ``>``, ``>=``, ``<``, ``<=``, ``==``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#count_operator DevicePostureRule#count_operator}
        :param domain: The domain that the client must join. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#domain DevicePostureRule#domain}
        :param eid_last_seen: The datetime a device last seen in RFC 3339 format from Tanium. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#eid_last_seen DevicePostureRule#eid_last_seen}
        :param enabled: True if the firewall must be enabled. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#enabled DevicePostureRule#enabled}
        :param exists: Checks if the file should exist. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#exists DevicePostureRule#exists}
        :param id: The Teams List id. Required for ``serial_number`` and ``unique_client_id`` rule types. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#id DevicePostureRule#id} Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param infected: True if SentinelOne device is infected. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#infected DevicePostureRule#infected}
        :param is_active: True if SentinelOne device is active. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#is_active DevicePostureRule#is_active}
        :param issue_count: The number of issues for kolide. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#issue_count DevicePostureRule#issue_count}
        :param network_status: The network status from SentinelOne. Available values: ``connected``, ``disconnected``, ``disconnecting``, ``connecting``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#network_status DevicePostureRule#network_status}
        :param operator: The version comparison operator. Available values: ``>``, ``>=``, ``<``, ``<=``, ``==``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#operator DevicePostureRule#operator}
        :param os: OS signal score from Crowdstrike. Value must be between 1 and 100. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#os DevicePostureRule#os}
        :param os_distro_name: The operating system excluding version information. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#os_distro_name DevicePostureRule#os_distro_name}
        :param os_distro_revision: The operating system version excluding OS name information or release name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#os_distro_revision DevicePostureRule#os_distro_revision}
        :param overall: Overall ZTA score from Crowdstrike. Value must be between 1 and 100. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#overall DevicePostureRule#overall}
        :param path: The path to the file. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#path DevicePostureRule#path}
        :param require_all: True if all drives must be encrypted. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#require_all DevicePostureRule#require_all}
        :param risk_level: The risk level from Tanium. Available values: ``low``, ``medium``, ``high``, ``critical``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#risk_level DevicePostureRule#risk_level}
        :param running: Checks if the application should be running. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#running DevicePostureRule#running}
        :param sensor_config: Sensor signal score from Crowdstrike. Value must be between 1 and 100. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#sensor_config DevicePostureRule#sensor_config}
        :param sha256: The sha256 hash of the file. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#sha256 DevicePostureRule#sha256}
        :param thumbprint: The thumbprint of the file certificate. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#thumbprint DevicePostureRule#thumbprint}
        :param total_score: The total score from Tanium. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#total_score DevicePostureRule#total_score}
        :param version: The operating system semantic version. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#version DevicePostureRule#version}
        :param version_operator: The version comparison operator for crowdstrike. Available values: ``>``, ``>=``, ``<``, ``<=``, ``==``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#version_operator DevicePostureRule#version_operator}
        '''
        if __debug__:
...
class DevicePostureRuleMatch:
    def __init__(self, *, platform: typing.Optional[builtins.str] = None) -> None:
        '''
        :param platform: The platform of the device. Available values: ``windows``, ``mac``, ``linux``, ``android``, ``ios``, ``chromeos``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/device_posture_rule#platform DevicePostureRule#platform}
        '''
        if __debug__:
