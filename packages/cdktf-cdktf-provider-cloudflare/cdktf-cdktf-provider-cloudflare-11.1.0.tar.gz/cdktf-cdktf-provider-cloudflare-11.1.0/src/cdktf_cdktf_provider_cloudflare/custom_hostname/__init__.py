...
Refer to the Terraform Registry for docs: [`cloudflare_custom_hostname`](https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname).
'''
import abc
import builtins
import datetime
...
class CustomHostname(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname cloudflare_custom_hostname}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname cloudflare_custom_hostname} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param hostname: Hostname you intend to request a certificate for. **Modifying this attribute will force creation of a new resource.**. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#hostname CustomHostname#hostname}
        :param zone_id: The zone identifier to target for the resource. **Modifying this attribute will force creation of a new resource.**. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#zone_id CustomHostname#zone_id}
        :param custom_metadata: Custom metadata associated with custom hostname. Only supports primitive string values, all other values are accessible via the API directly. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#custom_metadata CustomHostname#custom_metadata}
        :param custom_origin_server: The custom origin server used for certificates. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#custom_origin_server CustomHostname#custom_origin_server}
        :param custom_origin_sni: The `custom origin SNI <https://developers.cloudflare.com/ssl/ssl-for-saas/hostname-specific-behavior/custom-origin>`_ used for certificates. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#custom_origin_sni CustomHostname#custom_origin_sni}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#id CustomHostname#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param ssl: ssl block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#ssl CustomHostname#ssl}
        :param wait_for_ssl_pending_validation: Whether to wait for a custom hostname SSL sub-object to reach status ``pending_validation`` during creation. Defaults to ``false``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#wait_for_ssl_pending_validation CustomHostname#wait_for_ssl_pending_validation}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing CustomHostname that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#import import section} in the documentation of this resource for the id to use
...
class CustomHostnameConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def hostname(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#hostname CustomHostname#hostname}
        '''
    ...
    def zone_id(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#zone_id CustomHostname#zone_id}
        '''
    ...
    def custom_metadata(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#custom_metadata CustomHostname#custom_metadata}
        '''
    ...
    def custom_origin_server(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#custom_origin_server CustomHostname#custom_origin_server}
        '''
    ...
    def custom_origin_sni(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#custom_origin_sni CustomHostname#custom_origin_sni}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#id CustomHostname#id}.
    ...
    def ssl(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#ssl CustomHostname#ssl}
        '''
    ...
    def wait_for_ssl_pending_validation(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#wait_for_ssl_pending_validation CustomHostname#wait_for_ssl_pending_validation}
        '''
...
class CustomHostnameSsl:
    def __init__(
        ...
        *,
        ...
        '''
        :param bundle_method: A ubiquitous bundle has the highest probability of being verified everywhere, even by clients using outdated or unusual trust stores. An optimal bundle uses the shortest chain and newest intermediates. And the force bundle verifies the chain, but does not otherwise modify it. Available values: ``ubiquitous``, ``optimal``, ``force``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#bundle_method CustomHostname#bundle_method}
        :param certificate_authority: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#certificate_authority CustomHostname#certificate_authority}.
        :param custom_certificate: If a custom uploaded certificate is used. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#custom_certificate CustomHostname#custom_certificate}
        :param custom_key: The key for a custom uploaded certificate. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#custom_key CustomHostname#custom_key}
        :param method: Domain control validation (DCV) method used for this hostname. Available values: ``http``, ``txt``, ``email``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#method CustomHostname#method}
        :param settings: settings block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#settings CustomHostname#settings}
        :param type: Level of validation to be used for this hostname. Available values: ``dv``. Defaults to ``dv``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#type CustomHostname#type}
        :param wildcard: Indicates whether the certificate covers a wildcard. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#wildcard CustomHostname#wildcard}
        '''
        if __debug__:
    ...
    def bundle_method(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#bundle_method CustomHostname#bundle_method}
        '''
    ...
    def certificate_authority(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#certificate_authority CustomHostname#certificate_authority}.'''
    ...
    def custom_certificate(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#custom_certificate CustomHostname#custom_certificate}
        '''
    ...
    def custom_key(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#custom_key CustomHostname#custom_key}
        '''
    ...
    def method(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#method CustomHostname#method}
        '''
    ...
    def settings(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#settings CustomHostname#settings}
        '''
    ...
    def type(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#type CustomHostname#type}
        '''
    ...
    def wildcard(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#wildcard CustomHostname#wildcard}
        '''
...
class CustomHostnameSslSettings:
    def __init__(
        ...
        *,
        ...
        '''
        :param ciphers: List of SSL/TLS ciphers to associate with this certificate. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#ciphers CustomHostname#ciphers}
        :param early_hints: Whether early hints should be supported. Available values: ``on``, ``off``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#early_hints CustomHostname#early_hints}
        :param http2: Whether HTTP2 should be supported. Available values: ``on``, ``off``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#http2 CustomHostname#http2}
        :param min_tls_version: Lowest version of TLS this certificate should support. Available values: ``1.0``, ``1.1``, ``1.2``, ``1.3``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#min_tls_version CustomHostname#min_tls_version}
        :param tls13: Whether TLSv1.3 should be supported. Available values: ``on``, ``off``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#tls13 CustomHostname#tls13}
        '''
        if __debug__:
    ...
    def ciphers(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#ciphers CustomHostname#ciphers}
        '''
    ...
    def early_hints(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#early_hints CustomHostname#early_hints}
        '''
    ...
    def http2(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#http2 CustomHostname#http2}
        '''
    ...
    def min_tls_version(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#min_tls_version CustomHostname#min_tls_version}
        '''
    ...
    def tls13(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/custom_hostname#tls13 CustomHostname#tls13}
        '''
