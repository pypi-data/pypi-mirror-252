...
Refer to the Terraform Registry for docs: [`data_cloudflare_rulesets`](https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/data-sources/rulesets).
'''
import abc
import builtins
import datetime
...
class DataCloudflareRulesets(
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/data-sources/rulesets cloudflare_rulesets} Data Source.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param account_id: The account identifier to target for the resource. Must provide only one of ``zone_id``, ``account_id``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/data-sources/rulesets#account_id DataCloudflareRulesets#account_id}
        :param filter: filter block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/data-sources/rulesets#filter DataCloudflareRulesets#filter}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/data-sources/rulesets#id DataCloudflareRulesets#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param include_rules: Include rule data in response. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/data-sources/rulesets#include_rules DataCloudflareRulesets#include_rules}
        :param zone_id: The zone identifier to target for the resource. Must provide only one of ``zone_id``, ``account_id``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/data-sources/rulesets#zone_id DataCloudflareRulesets#zone_id}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataCloudflareRulesets that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/data-sources/rulesets#import import section} in the documentation of this resource for the id to use
    ...
    def put_filter(
        ...
        *,
        ...
        '''
        :param id: The ID of the Ruleset to target. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/data-sources/rulesets#id DataCloudflareRulesets#id} Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param kind: Type of Ruleset to create. Available values: ``custom``, ``managed``, ``root``, ``zone``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/data-sources/rulesets#kind DataCloudflareRulesets#kind}
        :param name: Name of the ruleset. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/data-sources/rulesets#name DataCloudflareRulesets#name}
        :param phase: Point in the request/response lifecycle where the ruleset will be created. Available values: ``ddos_l4``, ``ddos_l7``, ``http_config_settings``, ``http_custom_errors``, ``http_log_custom_fields``, ``http_ratelimit``, ``http_request_cache_settings``, ``http_request_dynamic_redirect``, ``http_request_firewall_custom``, ``http_request_firewall_managed``, ``http_request_late_transform``, ``http_request_origin``, ``http_request_redirect``, ``http_request_sanitize``, ``http_request_sbfm``, ``http_request_transform``, ``http_response_compression``, ``http_response_firewall_managed``, ``http_response_headers_transform``, ``magic_transit``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/data-sources/rulesets#phase DataCloudflareRulesets#phase}
        :param version: Version of the ruleset to filter on. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/data-sources/rulesets#version DataCloudflareRulesets#version}
        '''
