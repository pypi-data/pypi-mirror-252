...
class TunnelConfigA(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config cloudflare_tunnel_config}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config cloudflare_tunnel_config} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param account_id: The account identifier to target for the resource. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#account_id TunnelConfigA#account_id}
        :param config: config block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#config TunnelConfigA#config}
        :param tunnel_id: Identifier of the Tunnel to target for this configuration. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#tunnel_id TunnelConfigA#tunnel_id}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#id TunnelConfigA#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing TunnelConfigA that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#import import section} in the documentation of this resource for the id to use
    ...
    def put_config(
        ...
        *,
        ...
        '''
        :param ingress_rule: ingress_rule block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#ingress_rule TunnelConfigA#ingress_rule}
        :param origin_request: origin_request block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#origin_request TunnelConfigA#origin_request}
        :param warp_routing: warp_routing block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#warp_routing TunnelConfigA#warp_routing}
        '''
...
class TunnelConfigAConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def account_id(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#account_id TunnelConfigA#account_id}
        '''
    ...
    def config(self) -> "TunnelConfigConfig":
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#config TunnelConfigA#config}
        '''
    ...
    def tunnel_id(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#tunnel_id TunnelConfigA#tunnel_id}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#id TunnelConfigA#id}.
...
class TunnelConfigConfig:
    ...
    def ingress_rule(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#ingress_rule TunnelConfigA#ingress_rule}
        '''
    ...
    def origin_request(self) -> typing.Optional["TunnelConfigConfigOriginRequest"]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#origin_request TunnelConfigA#origin_request}
        '''
    ...
    def warp_routing(self) -> typing.Optional["TunnelConfigConfigWarpRouting"]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#warp_routing TunnelConfigA#warp_routing}
        '''
...
class TunnelConfigConfigIngressRule:
    def __init__(
        ...
        *,
        ...
        '''
        :param service: Name of the service to which the request will be sent. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#service TunnelConfigA#service}
        :param hostname: Hostname to match the incoming request with. If the hostname matches, the request will be sent to the service. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#hostname TunnelConfigA#hostname}
        :param origin_request: origin_request block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#origin_request TunnelConfigA#origin_request}
        :param path: Path of the incoming request. If the path matches, the request will be sent to the local service. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#path TunnelConfigA#path}
        '''
        if isinstance(origin_request, dict):
    ...
    def service(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#service TunnelConfigA#service}
        '''
    ...
    def hostname(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#hostname TunnelConfigA#hostname}
        '''
    ...
    def path(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#path TunnelConfigA#path}
        '''
...
class TunnelConfigConfigIngressRuleOriginRequest:
    def __init__(
        ...
        *,
        ...
        '''
        :param access: access block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#access TunnelConfigA#access}
        :param bastion_mode: Runs as jump host. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#bastion_mode TunnelConfigA#bastion_mode}
        :param ca_pool: Path to the certificate authority (CA) for the certificate of your origin. This option should be used only if your certificate is not signed by Cloudflare. Defaults to ``""``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#ca_pool TunnelConfigA#ca_pool}
        :param connect_timeout: Timeout for establishing a new TCP connection to your origin server. This excludes the time taken to establish TLS, which is controlled by ``tlsTimeout``. Defaults to ``30s``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#connect_timeout TunnelConfigA#connect_timeout}
        :param disable_chunked_encoding: Disables chunked transfer encoding. Useful if you are running a Web Server Gateway Interface (WSGI) server. Defaults to ``false``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#disable_chunked_encoding TunnelConfigA#disable_chunked_encoding}
        :param http2_origin: Enables HTTP/2 support for the origin connection. Defaults to ``false``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#http2_origin TunnelConfigA#http2_origin}
        :param http_host_header: Sets the HTTP Host header on requests sent to the local service. Defaults to ``""``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#http_host_header TunnelConfigA#http_host_header}
        :param ip_rules: ip_rules block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#ip_rules TunnelConfigA#ip_rules}
        :param keep_alive_connections: Maximum number of idle keepalive connections between Tunnel and your origin. This does not restrict the total number of concurrent connections. Defaults to ``100``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#keep_alive_connections TunnelConfigA#keep_alive_connections}
        :param keep_alive_timeout: Timeout after which an idle keepalive connection can be discarded. Defaults to ``1m30s``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#keep_alive_timeout TunnelConfigA#keep_alive_timeout}
        :param no_happy_eyeballs: Disable the “happy eyeballs” algorithm for IPv4/IPv6 fallback if your local network has misconfigured one of the protocols. Defaults to ``false``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#no_happy_eyeballs TunnelConfigA#no_happy_eyeballs}
        :param no_tls_verify: Disables TLS verification of the certificate presented by your origin. Will allow any certificate from the origin to be accepted. Defaults to ``false``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#no_tls_verify TunnelConfigA#no_tls_verify}
        :param origin_server_name: Hostname that cloudflared should expect from your origin server certificate. Defaults to ``""``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#origin_server_name TunnelConfigA#origin_server_name}
        :param proxy_address: cloudflared starts a proxy server to translate HTTP traffic into TCP when proxying, for example, SSH or RDP. This configures the listen address for that proxy. Defaults to ``127.0.0.1``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#proxy_address TunnelConfigA#proxy_address}
        :param proxy_port: cloudflared starts a proxy server to translate HTTP traffic into TCP when proxying, for example, SSH or RDP. This configures the listen port for that proxy. If set to zero, an unused port will randomly be chosen. Defaults to ``0``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#proxy_port TunnelConfigA#proxy_port}
        :param proxy_type: cloudflared starts a proxy server to translate HTTP traffic into TCP when proxying, for example, SSH or RDP. This configures what type of proxy will be started. Available values: ``""``, ``socks``. Defaults to ``""``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#proxy_type TunnelConfigA#proxy_type}
        :param tcp_keep_alive: The timeout after which a TCP keepalive packet is sent on a connection between Tunnel and the origin server. Defaults to ``30s``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#tcp_keep_alive TunnelConfigA#tcp_keep_alive}
        :param tls_timeout: Timeout for completing a TLS handshake to your origin server, if you have chosen to connect Tunnel to an HTTPS server. Defaults to ``10s``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#tls_timeout TunnelConfigA#tls_timeout}
        '''
    ...
    def access(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#access TunnelConfigA#access}
        '''
    ...
    def bastion_mode(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#bastion_mode TunnelConfigA#bastion_mode}
        '''
    ...
    def ca_pool(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#ca_pool TunnelConfigA#ca_pool}
        '''
    ...
    def connect_timeout(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#connect_timeout TunnelConfigA#connect_timeout}
        '''
    ...
    def disable_chunked_encoding(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#disable_chunked_encoding TunnelConfigA#disable_chunked_encoding}
        '''
    ...
    def http2_origin(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#http2_origin TunnelConfigA#http2_origin}
        '''
    ...
    def http_host_header(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#http_host_header TunnelConfigA#http_host_header}
        '''
    ...
    def ip_rules(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#ip_rules TunnelConfigA#ip_rules}
        '''
    ...
    def keep_alive_connections(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#keep_alive_connections TunnelConfigA#keep_alive_connections}
        '''
    ...
    def keep_alive_timeout(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#keep_alive_timeout TunnelConfigA#keep_alive_timeout}
        '''
    ...
    def no_happy_eyeballs(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#no_happy_eyeballs TunnelConfigA#no_happy_eyeballs}
        '''
    ...
    def no_tls_verify(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#no_tls_verify TunnelConfigA#no_tls_verify}
        '''
    ...
    def origin_server_name(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#origin_server_name TunnelConfigA#origin_server_name}
        '''
    ...
    def proxy_address(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#proxy_address TunnelConfigA#proxy_address}
        '''
    ...
    def proxy_port(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#proxy_port TunnelConfigA#proxy_port}
        '''
    ...
    def proxy_type(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#proxy_type TunnelConfigA#proxy_type}
        '''
    ...
    def tcp_keep_alive(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#tcp_keep_alive TunnelConfigA#tcp_keep_alive}
        '''
    ...
    def tls_timeout(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#tls_timeout TunnelConfigA#tls_timeout}
        '''
...
class TunnelConfigConfigIngressRuleOriginRequestAccess:
    def __init__(
        ...
        *,
        ...
        '''
        :param aud_tag: Audience tags of the access rule. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#aud_tag TunnelConfigA#aud_tag}
        :param required: Whether the access rule is required. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#required TunnelConfigA#required}
        :param team_name: Name of the team to which the access rule applies. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#team_name TunnelConfigA#team_name}
        '''
        if __debug__:
    ...
    def aud_tag(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#aud_tag TunnelConfigA#aud_tag}
        '''
    ...
    def required(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#required TunnelConfigA#required}
        '''
    ...
    def team_name(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#team_name TunnelConfigA#team_name}
        '''
...
class TunnelConfigConfigIngressRuleOriginRequestIpRules:
    def __init__(
        ...
        *,
        ...
        '''
        :param allow: Whether to allow the IP prefix. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#allow TunnelConfigA#allow}
        :param ports: Ports to use within the IP rule. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#ports TunnelConfigA#ports}
        :param prefix: IP rule prefix. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#prefix TunnelConfigA#prefix}
        '''
        if __debug__:
    ...
    def allow(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#allow TunnelConfigA#allow}
        '''
    ...
    def ports(self) -> typing.Optional[typing.List[jsii.Number]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#ports TunnelConfigA#ports}
        '''
    ...
    def prefix(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#prefix TunnelConfigA#prefix}
        '''
...
class TunnelConfigConfigOutputReference(
    ...
    def put_warp_routing(
        ...
        *,
        ...
        '''
        :param enabled: Whether WARP routing is enabled. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#enabled TunnelConfigA#enabled}
        '''
...
class TunnelConfigConfigWarpRouting:
    ...
    def enabled(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/tunnel_config#enabled TunnelConfigA#enabled}
        '''
