...
Refer to the Terraform Registry for docs: [`data_cloudflare_zones`](https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/data-sources/zones).
'''
import abc
import builtins
import datetime
...
class DataCloudflareZones(
    ...
    def __init__(
        ...
        *,
        ...
        :param filter: filter block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/data-sources/zones#filter DataCloudflareZones#filter}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/data-sources/zones#id DataCloudflareZones#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataCloudflareZones that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/data-sources/zones#import import section} in the documentation of this resource for the id to use
    ...
    def put_filter(
        ...
        *,
        ...
        '''
        :param account_id: The account identifier to target for the resource. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/data-sources/zones#account_id DataCloudflareZones#account_id}
        :param lookup_type: The type of search to perform for the ``name`` value when querying the zone API. Available values: ``contains``, ``exact``. Defaults to ``exact``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/data-sources/zones#lookup_type DataCloudflareZones#lookup_type}
        :param match: A RE2 compatible regular expression to filter the results. This is performed client side whereas the ``name`` and ``lookup_type`` are performed on the Cloudflare server side. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/data-sources/zones#match DataCloudflareZones#match}
        :param name: A string value to search for. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/data-sources/zones#name DataCloudflareZones#name}
        :param paused: Paused status of the zone to lookup. Defaults to ``false``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/data-sources/zones#paused DataCloudflareZones#paused}
        :param status: Status of the zone to lookup. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/data-sources/zones#status DataCloudflareZones#status}
        '''
