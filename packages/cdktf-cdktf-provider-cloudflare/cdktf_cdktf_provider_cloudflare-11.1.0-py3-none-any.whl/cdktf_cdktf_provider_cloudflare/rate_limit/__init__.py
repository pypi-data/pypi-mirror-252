...
Refer to the Terraform Registry for docs: [`cloudflare_rate_limit`](https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/rate_limit).
'''
import abc
import builtins
import datetime
...
class RateLimit(
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/rate_limit cloudflare_rate_limit} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param action: action block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/rate_limit#action RateLimit#action}
        :param period: The time in seconds to count matching traffic. If the count exceeds threshold within this period the action will be performed. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/rate_limit#period RateLimit#period}
        :param threshold: The threshold that triggers the rate limit mitigations, combine with period. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/rate_limit#threshold RateLimit#threshold}
        :param zone_id: The zone identifier to target for the resource. **Modifying this attribute will force creation of a new resource.**. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/rate_limit#zone_id RateLimit#zone_id}
        :param bypass_url_patterns: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/rate_limit#bypass_url_patterns RateLimit#bypass_url_patterns}.
        :param correlate: correlate block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/rate_limit#correlate RateLimit#correlate}
        :param description: A note that you can use to describe the reason for a rate limit. This value is sanitized and all tags are removed. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/rate_limit#description RateLimit#description}
        :param disabled: Whether this ratelimit is currently disabled. Defaults to ``false``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/rate_limit#disabled RateLimit#disabled}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/rate_limit#id RateLimit#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param match: match block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/rate_limit#match RateLimit#match}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing RateLimit that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/rate_limit#import import section} in the documentation of this resource for the id to use
    ...
    def put_action(
        ...
        *,
        ...
        '''
        :param mode: The type of action to perform. Available values: ``simulate``, ``ban``, ``challenge``, ``js_challenge``, ``managed_challenge``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/rate_limit#mode RateLimit#mode}
        :param response: response block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/rate_limit#response RateLimit#response}
        :param timeout: The time in seconds as an integer to perform the mitigation action. This field is required if the ``mode`` is either ``simulate`` or ``ban``. Must be the same or greater than the period. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/rate_limit#timeout RateLimit#timeout}
        '''
    ...
    def put_correlate(self, *, by: typing.Optional[builtins.str] = None) -> None:
        '''
        :param by: If set to 'nat', NAT support will be enabled for rate limiting. Available values: ``nat``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/rate_limit#by RateLimit#by}
        '''
    ...
    def put_match(
        ...
        *,
        ...
        '''
        :param request: request block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/rate_limit#request RateLimit#request}
        :param response: response block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/rate_limit#response RateLimit#response}
        '''
...
class RateLimitActionOutputReference(
    ...
    def put_response(self, *, body: builtins.str, content_type: builtins.str) -> None:
        '''
        :param body: The body to return, the content here should conform to the ``content_type``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/rate_limit#body RateLimit#body}
        :param content_type: The content-type of the body. Available values: ``text/plain``, ``text/xml``, ``application/json``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/rate_limit#content_type RateLimit#content_type}
        '''
...
class RateLimitMatchOutputReference(
    ...
    def put_request(
        ...
        *,
        ...
        '''
        :param methods: HTTP Methods to match traffic on. Available values: ``GET``, ``POST``, ``PUT``, ``DELETE``, ``PATCH``, ``HEAD``, ``_ALL_``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/rate_limit#methods RateLimit#methods}
        :param schemes: HTTP schemes to match traffic on. Available values: ``HTTP``, ``HTTPS``, ``_ALL_``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/rate_limit#schemes RateLimit#schemes}
        :param url_pattern: The URL pattern to match comprised of the host and path, i.e. example.org/path. Wildcard are expanded to match applicable traffic, query strings are not matched. Use _ for all traffic to your zone. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/rate_limit#url_pattern RateLimit#url_pattern}
        '''
    ...
    def put_response(
        ...
        *,
        ...
        '''
        :param headers: List of HTTP headers maps to match the origin response on. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/rate_limit#headers RateLimit#headers}
        :param origin_traffic: Only count traffic that has come from your origin servers. If true, cached items that Cloudflare serve will not count towards rate limiting. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/rate_limit#origin_traffic RateLimit#origin_traffic}
        :param statuses: HTTP Status codes, can be one, many or indicate all by not providing this value. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/rate_limit#statuses RateLimit#statuses}
        '''
