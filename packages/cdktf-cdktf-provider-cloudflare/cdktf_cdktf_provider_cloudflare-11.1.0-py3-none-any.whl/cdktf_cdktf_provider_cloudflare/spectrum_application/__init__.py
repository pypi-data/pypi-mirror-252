...
Refer to the Terraform Registry for docs: [`cloudflare_spectrum_application`](https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/spectrum_application).
'''
import abc
import builtins
import datetime
...
class SpectrumApplication(
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/spectrum_application cloudflare_spectrum_application} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param dns: dns block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/spectrum_application#dns SpectrumApplication#dns}
        :param protocol: The port configuration at Cloudflare's edge. e.g. ``tcp/22``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/spectrum_application#protocol SpectrumApplication#protocol}
        :param zone_id: The zone identifier to target for the resource. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/spectrum_application#zone_id SpectrumApplication#zone_id}
        :param argo_smart_routing: Enables Argo Smart Routing. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/spectrum_application#argo_smart_routing SpectrumApplication#argo_smart_routing}
        :param edge_ips: edge_ips block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/spectrum_application#edge_ips SpectrumApplication#edge_ips}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/spectrum_application#id SpectrumApplication#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param ip_firewall: Enables the IP Firewall for this application. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/spectrum_application#ip_firewall SpectrumApplication#ip_firewall}
        :param origin_direct: A list of destination addresses to the origin. e.g. ``tcp://192.0.2.1:22``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/spectrum_application#origin_direct SpectrumApplication#origin_direct}
        :param origin_dns: origin_dns block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/spectrum_application#origin_dns SpectrumApplication#origin_dns}
        :param origin_port: Origin port to proxy traffice to. Conflicts with ``origin_port_range``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/spectrum_application#origin_port SpectrumApplication#origin_port}
        :param origin_port_range: origin_port_range block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/spectrum_application#origin_port_range SpectrumApplication#origin_port_range}
        :param proxy_protocol: Enables a proxy protocol to the origin. Available values: ``off``, ``v1``, ``v2``, ``simple``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/spectrum_application#proxy_protocol SpectrumApplication#proxy_protocol}
        :param tls: TLS configuration option for Cloudflare to connect to your origin. Available values: ``off``, ``flexible``, ``full``, ``strict``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/spectrum_application#tls SpectrumApplication#tls}
        :param traffic_type: Sets application type. Available values: ``direct``, ``http``, ``https``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/spectrum_application#traffic_type SpectrumApplication#traffic_type}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing SpectrumApplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/spectrum_application#import import section} in the documentation of this resource for the id to use
    ...
    def put_dns(self, *, name: builtins.str, type: builtins.str) -> None:
        '''
        :param name: The name of the DNS record associated with the application. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/spectrum_application#name SpectrumApplication#name}
        :param type: The type of DNS record associated with the application. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/spectrum_application#type SpectrumApplication#type}
        '''
    ...
    def put_edge_ips(
        ...
        *,
        ...
        '''
        :param type: The type of edge IP configuration specified. Available values: ``dynamic``, ``static``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/spectrum_application#type SpectrumApplication#type}
        :param connectivity: The IP versions supported for inbound connections on Spectrum anycast IPs. Required when ``type`` is not ``static``. Available values: ``all``, ``ipv4``, ``ipv6``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/spectrum_application#connectivity SpectrumApplication#connectivity}
        :param ips: The collection of customer owned IPs to broadcast via anycast for this hostname and application. Requires `Bring Your Own IP <https://developers.cloudflare.com/spectrum/getting-started/byoip/>`_ provisioned. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/spectrum_application#ips SpectrumApplication#ips}
        '''
    ...
    def put_origin_dns(self, *, name: builtins.str) -> None:
        '''
        :param name: Fully qualified domain name of the origin. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/spectrum_application#name SpectrumApplication#name}
        '''
    ...
    def put_origin_port_range(self, *, end: jsii.Number, start: jsii.Number) -> None:
        '''
        :param end: Upper bound of the origin port range. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/spectrum_application#end SpectrumApplication#end}
        :param start: Lower bound of the origin port range. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/spectrum_application#start SpectrumApplication#start}
        '''
