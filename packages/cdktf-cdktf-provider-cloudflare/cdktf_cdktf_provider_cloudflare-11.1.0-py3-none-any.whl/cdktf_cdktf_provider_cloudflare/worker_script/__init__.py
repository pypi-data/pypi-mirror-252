...
Refer to the Terraform Registry for docs: [`cloudflare_worker_script`](https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script).
'''
import abc
import builtins
import datetime
...
class WorkerScript(
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script cloudflare_worker_script} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param account_id: The account identifier to target for the resource. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#account_id WorkerScript#account_id}
        :param content: The script content. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#content WorkerScript#content}
        :param name: The name for the script. **Modifying this attribute will force creation of a new resource.**. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#name WorkerScript#name}
        :param analytics_engine_binding: analytics_engine_binding block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#analytics_engine_binding WorkerScript#analytics_engine_binding}
        :param compatibility_date: The date to use for the compatibility flag. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#compatibility_date WorkerScript#compatibility_date}
        :param compatibility_flags: Compatibility flags used for Worker Scripts. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#compatibility_flags WorkerScript#compatibility_flags}
        :param d1_database_binding: d1_database_binding block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#d1_database_binding WorkerScript#d1_database_binding}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#id WorkerScript#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param kv_namespace_binding: kv_namespace_binding block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#kv_namespace_binding WorkerScript#kv_namespace_binding}
        :param logpush: Enabling allows Worker events to be sent to a defined Logpush destination. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#logpush WorkerScript#logpush}
        :param module: Whether to upload Worker as a module. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#module WorkerScript#module}
        :param placement: placement block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#placement WorkerScript#placement}
        :param plain_text_binding: plain_text_binding block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#plain_text_binding WorkerScript#plain_text_binding}
        :param queue_binding: queue_binding block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#queue_binding WorkerScript#queue_binding}
        :param r2_bucket_binding: r2_bucket_binding block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#r2_bucket_binding WorkerScript#r2_bucket_binding}
        :param secret_text_binding: secret_text_binding block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#secret_text_binding WorkerScript#secret_text_binding}
        :param service_binding: service_binding block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#service_binding WorkerScript#service_binding}
        :param webassembly_binding: webassembly_binding block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#webassembly_binding WorkerScript#webassembly_binding}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing WorkerScript that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#import import section} in the documentation of this resource for the id to use
...
class WorkerScriptAnalyticsEngineBinding:
    def __init__(self, *, dataset: builtins.str, name: builtins.str) -> None:
        '''
        :param dataset: The name of the Analytics Engine dataset to write to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#dataset WorkerScript#dataset}
        :param name: The global variable for the binding in your Worker code. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#name WorkerScript#name}
        '''
        if __debug__:
...
class WorkerScriptD1DatabaseBinding:
    def __init__(self, *, database_id: builtins.str, name: builtins.str) -> None:
        '''
        :param database_id: Database ID of D1 database to use. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#database_id WorkerScript#database_id}
        :param name: The global variable for the binding in your Worker code. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#name WorkerScript#name}
        '''
        if __debug__:
...
class WorkerScriptKvNamespaceBinding:
    def __init__(self, *, name: builtins.str, namespace_id: builtins.str) -> None:
        '''
        :param name: The global variable for the binding in your Worker code. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#name WorkerScript#name}
        :param namespace_id: ID of the KV namespace you want to use. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#namespace_id WorkerScript#namespace_id}
        '''
        if __debug__:
...
class WorkerScriptPlacement:
    def __init__(self, *, mode: builtins.str) -> None:
        '''
        :param mode: The placement mode for the Worker. Available values: ``smart``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#mode WorkerScript#mode}
        '''
        if __debug__:
...
class WorkerScriptPlainTextBinding:
    def __init__(self, *, name: builtins.str, text: builtins.str) -> None:
        '''
        :param name: The global variable for the binding in your Worker code. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#name WorkerScript#name}
        :param text: The plain text you want to store. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#text WorkerScript#text}
        '''
        if __debug__:
...
class WorkerScriptQueueBinding:
    def __init__(self, *, binding: builtins.str, queue: builtins.str) -> None:
        '''
        :param binding: The name of the global variable for the binding in your Worker code. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#binding WorkerScript#binding}
        :param queue: Name of the queue you want to use. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#queue WorkerScript#queue}
        '''
        if __debug__:
...
class WorkerScriptR2BucketBinding:
    def __init__(self, *, bucket_name: builtins.str, name: builtins.str) -> None:
        '''
        :param bucket_name: The name of the Bucket to bind to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#bucket_name WorkerScript#bucket_name}
        :param name: The global variable for the binding in your Worker code. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#name WorkerScript#name}
        '''
        if __debug__:
...
class WorkerScriptSecretTextBinding:
    def __init__(self, *, name: builtins.str, text: builtins.str) -> None:
        '''
        :param name: The global variable for the binding in your Worker code. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#name WorkerScript#name}
        :param text: The secret text you want to store. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#text WorkerScript#text}
        '''
        if __debug__:
...
class WorkerScriptServiceBinding:
    def __init__(
        ...
        *,
        ...
        '''
        :param name: The global variable for the binding in your Worker code. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#name WorkerScript#name}
        :param service: The name of the Worker to bind to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#service WorkerScript#service}
        :param environment: The name of the Worker environment to bind to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#environment WorkerScript#environment}
        '''
        if __debug__:
...
class WorkerScriptWebassemblyBinding:
    def __init__(self, *, module: builtins.str, name: builtins.str) -> None:
        '''
        :param module: The base64 encoded wasm module you want to store. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#module WorkerScript#module}
        :param name: The global variable for the binding in your Worker code. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.23.0/docs/resources/worker_script#name WorkerScript#name}
        '''
        if __debug__:
