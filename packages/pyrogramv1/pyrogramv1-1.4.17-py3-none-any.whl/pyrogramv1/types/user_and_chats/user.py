...
class User(Object, Update):
    ...
    async def archive(self):
        """Bound method *archive* of :obj:`~pyrogramv1.types.User`.
    ...
    async def unarchive(self):
        """Bound method *unarchive* of :obj:`~pyrogramv1.types.User`.
    ...
    def block(self):
        """Bound method *block* of :obj:`~pyrogramv1.types.User`.
    ...
    def unblock(self):
        """Bound method *unblock* of :obj:`~pyrogramv1.types.User`.
    ...
    def get_common_chats(self):
        """Bound method *get_common_chats* of :obj:`~pyrogramv1.types.User`.
