...
class InlineQuery(Object, Update):
    ...
    Parameters:
        ...
        matches (List of regex Matches, *optional*):
            ...
            the query of this inline query. Only applicable when using :obj:`Filters.regex <pyrogramv1.Filters.regex>`.
    """
    ...
    async def answer(
        ...
        """Bound method *answer* of :obj:`~pyrogramv1.types.InlineQuery`.
        ...
        Parameters:
            results (List of :obj:`~pyrogramv1.types.InlineQueryResult`):
