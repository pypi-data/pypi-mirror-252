...
import pyrogramv1
from pyrogramv1 import __version__
from pyrogramv1.parser import Parser
from pyrogramv1.session.internals import MsgId
...
class Scaffold:
    ...
    def __init__(self):
        try:
            ...
            asyncio.set_event_loop(pyrogramv1.main_event_loop)
