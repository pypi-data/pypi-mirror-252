...
class AcceptAuthorization(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        scope: ``str``
        public_key: ``str``
        value_hashes: List of :obj:`SecureValueHash <pyrogramv1.raw.base.SecureValueHash>`
        credentials: :obj:`SecureCredentialsEncrypted <pyrogramv1.raw.base.SecureCredentialsEncrypted>`
