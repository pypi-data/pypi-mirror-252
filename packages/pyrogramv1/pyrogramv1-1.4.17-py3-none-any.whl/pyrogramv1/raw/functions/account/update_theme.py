...
class UpdateTheme(TLObject):  # type: ignore
    ...
    Parameters:
        format: ``str``
        theme: :obj:`InputTheme <pyrogramv1.raw.base.InputTheme>`
        slug (optional): ``str``
        title (optional): ``str``
        document (optional): :obj:`InputDocument <pyrogramv1.raw.base.InputDocument>`
        settings (optional): List of :obj:`InputThemeSettings <pyrogramv1.raw.base.InputThemeSettings>`

    Returns:
        :obj:`Theme <pyrogramv1.raw.base.Theme>`
    """
