...
class UpdatePasswordSettings(TLObject):  # type: ignore
    ...
    Parameters:
        password: :obj:`InputCheckPasswordSRP <pyrogramv1.raw.base.InputCheckPasswordSRP>`
        new_settings: :obj:`account.PasswordInputSettings <pyrogramv1.raw.base.account.PasswordInputSettings>`
