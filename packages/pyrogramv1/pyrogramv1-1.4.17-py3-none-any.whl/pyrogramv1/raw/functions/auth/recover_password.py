...
class RecoverPassword(TLObject):  # type: ignore
    ...
    Parameters:
        code: ``str``
        new_settings (optional): :obj:`account.PasswordInputSettings <pyrogramv1.raw.base.account.PasswordInputSettings>`

    Returns:
        :obj:`auth.Authorization <pyrogramv1.raw.base.auth.Authorization>`
    """
