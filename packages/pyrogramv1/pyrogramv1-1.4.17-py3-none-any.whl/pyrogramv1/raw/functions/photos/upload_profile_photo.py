...
class UploadProfilePhoto(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        bot (optional): :obj:`InputUser <pyrogramv1.raw.base.InputUser>`
        file (optional): :obj:`InputFile <pyrogramv1.raw.base.InputFile>`
        video (optional): :obj:`InputFile <pyrogramv1.raw.base.InputFile>`
        video_start_ts (optional): ``float`` ``64-bit``
        video_emoji_markup (optional): :obj:`VideoSize <pyrogramv1.raw.base.VideoSize>`

    Returns:
        :obj:`photos.Photo <pyrogramv1.raw.base.photos.Photo>`
    """
