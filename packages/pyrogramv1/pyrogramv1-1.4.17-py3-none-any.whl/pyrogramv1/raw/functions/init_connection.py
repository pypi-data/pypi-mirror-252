...
class InitConnection(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        lang_pack: ``str``
        lang_code: ``str``
        query: Any method from :obj:`~pyrogramv1.raw.functions`
        proxy (optional): :obj:`InputClientProxy <pyrogramv1.raw.base.InputClientProxy>`
        params (optional): :obj:`JSONValue <pyrogramv1.raw.base.JSONValue>`

    Returns:
        Any object from :obj:`~pyrogramv1.raw.types`
    """
