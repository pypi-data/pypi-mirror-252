...
class SendEncryptedFile(TLObject):  # type: ignore
    ...
    Parameters:
        peer: :obj:`InputEncryptedChat <pyrogramv1.raw.base.InputEncryptedChat>`
        random_id: ``int`` ``64-bit``
        data: ``bytes``
        file: :obj:`InputEncryptedFile <pyrogramv1.raw.base.InputEncryptedFile>`
        silent (optional): ``bool``

    Returns:
        :obj:`messages.SentEncryptedMessage <pyrogramv1.raw.base.messages.SentEncryptedMessage>`
    """
