...
class TranslateText(TLObject):  # type: ignore
    ...
    Parameters:
        to_lang: ``str``
        peer (optional): :obj:`InputPeer <pyrogramv1.raw.base.InputPeer>`
        id (optional): List of ``int`` ``32-bit``
        text (optional): List of :obj:`TextWithEntities <pyrogramv1.raw.base.TextWithEntities>`

    Returns:
        :obj:`messages.TranslatedText <pyrogramv1.raw.base.messages.TranslatedText>`
    """
