...
class GetBotCallbackAnswer(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        game (optional): ``bool``
        data (optional): ``bytes``
        password (optional): :obj:`InputCheckPasswordSRP <pyrogramv1.raw.base.InputCheckPasswordSRP>`

    Returns:
        :obj:`messages.BotCallbackAnswer <pyrogramv1.raw.base.messages.BotCallbackAnswer>`
    """
