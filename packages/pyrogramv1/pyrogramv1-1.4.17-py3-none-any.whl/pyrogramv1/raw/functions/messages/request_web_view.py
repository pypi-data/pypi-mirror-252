...
class RequestWebView(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        bot: :obj:`InputUser <pyrogramv1.raw.base.InputUser>`
        platform: ``str``
        from_bot_menu (optional): ``bool``
        silent (optional): ``bool``
        url (optional): ``str``
        start_param (optional): ``str``
        theme_params (optional): :obj:`DataJSON <pyrogramv1.raw.base.DataJSON>`
    ...
    Returns:
        :obj:`WebViewResult <pyrogramv1.raw.base.WebViewResult>`
    """
