...
class GetParticipants(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        filter: :obj:`ChannelParticipantsFilter <pyrogramv1.raw.base.ChannelParticipantsFilter>`
        offset: ``int`` ``32-bit``
        limit: ``int`` ``32-bit``
        hash: ``int`` ``64-bit``

    Returns:
        :obj:`channels.ChannelParticipants <pyrogramv1.raw.base.channels.ChannelParticipants>`
    """
