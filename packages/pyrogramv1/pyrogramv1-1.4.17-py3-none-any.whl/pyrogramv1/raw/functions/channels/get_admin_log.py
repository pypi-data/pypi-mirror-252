...
class GetAdminLog(TLObject):  # type: ignore
    ...
    Parameters:
        channel: :obj:`InputChannel <pyrogramv1.raw.base.InputChannel>`
        q: ``str``
        max_id: ``int`` ``64-bit``
        min_id: ``int`` ``64-bit``
        limit: ``int`` ``32-bit``
        events_filter (optional): :obj:`ChannelAdminLogEventsFilter <pyrogramv1.raw.base.ChannelAdminLogEventsFilter>`
        admins (optional): List of :obj:`InputUser <pyrogramv1.raw.base.InputUser>`

    Returns:
        :obj:`channels.AdminLogResults <pyrogramv1.raw.base.channels.AdminLogResults>`
    """
