...
class Photo(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.Photo`.
    ...
    Parameters:
        ...
        date: ``int`` ``32-bit``
        sizes: List of :obj:`PhotoSize <pyrogramv1.raw.base.PhotoSize>`
        dc_id: ``int`` ``32-bit``
        has_stickers (optional): ``bool``
        video_sizes (optional): List of :obj:`VideoSize <pyrogramv1.raw.base.VideoSize>`
    """
