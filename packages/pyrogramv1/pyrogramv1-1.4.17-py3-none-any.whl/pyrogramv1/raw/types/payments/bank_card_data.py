...
class BankCardData(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.payments.BankCardData`.
    ...
    Parameters:
        title: ``str``
        open_urls: List of :obj:`BankCardOpenUrl <pyrogramv1.raw.base.BankCardOpenUrl>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`payments.GetBankCardData <pyrogramv1.raw.functions.payments.GetBankCardData>`
    """
