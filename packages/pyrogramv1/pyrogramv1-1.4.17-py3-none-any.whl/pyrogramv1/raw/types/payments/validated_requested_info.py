...
class ValidatedRequestedInfo(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.payments.ValidatedRequestedInfo`.
    ...
    Parameters:
        id (optional): ``str``
        shipping_options (optional): List of :obj:`ShippingOption <pyrogramv1.raw.base.ShippingOption>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`payments.ValidateRequestedInfo <pyrogramv1.raw.functions.payments.ValidateRequestedInfo>`
    """
