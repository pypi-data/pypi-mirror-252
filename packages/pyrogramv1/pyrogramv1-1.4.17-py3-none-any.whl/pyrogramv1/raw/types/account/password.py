...
class Password(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.account.Password`.
    ...
    Parameters:
        new_algo: :obj:`PasswordKdfAlgo <pyrogramv1.raw.base.PasswordKdfAlgo>`
        new_secure_algo: :obj:`SecurePasswordKdfAlgo <pyrogramv1.raw.base.SecurePasswordKdfAlgo>`
        secure_random: ``bytes``
        has_recovery (optional): ``bool``
        has_secure_values (optional): ``bool``
        has_password (optional): ``bool``
        current_algo (optional): :obj:`PasswordKdfAlgo <pyrogramv1.raw.base.PasswordKdfAlgo>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.GetPassword <pyrogramv1.raw.functions.account.GetPassword>`
    """
