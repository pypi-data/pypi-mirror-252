...
class WallPapers(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.account.WallPapers`.
    ...
    Parameters:
        hash: ``int`` ``64-bit``
        wallpapers: List of :obj:`WallPaper <pyrogramv1.raw.base.WallPaper>`
