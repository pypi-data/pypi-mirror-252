...
class PasswordSettings(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.account.PasswordSettings`.
    ...
    Parameters:
        email (optional): ``str``
        secure_settings (optional): :obj:`SecureSecretSettings <pyrogramv1.raw.base.SecureSecretSettings>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.GetPasswordSettings <pyrogramv1.raw.functions.account.GetPasswordSettings>`
    """
