...
class Authorizations(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.account.Authorizations`.
    ...
    Parameters:
        ...
        authorizations: List of :obj:`Authorization <pyrogramv1.raw.base.Authorization>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.GetAuthorizations <pyrogramv1.raw.functions.account.GetAuthorizations>`
    """
