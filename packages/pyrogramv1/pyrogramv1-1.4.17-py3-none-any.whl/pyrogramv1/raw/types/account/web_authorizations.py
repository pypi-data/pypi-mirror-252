...
class WebAuthorizations(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.account.WebAuthorizations`.
    ...
    Parameters:
        authorizations: List of :obj:`WebAuthorization <pyrogramv1.raw.base.WebAuthorization>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.GetWebAuthorizations <pyrogramv1.raw.functions.account.GetWebAuthorizations>`
    """
