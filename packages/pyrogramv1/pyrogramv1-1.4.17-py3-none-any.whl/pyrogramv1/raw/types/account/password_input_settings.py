...
class PasswordInputSettings(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.account.PasswordInputSettings`.
    ...
    Parameters:
        new_algo (optional): :obj:`PasswordKdfAlgo <pyrogramv1.raw.base.PasswordKdfAlgo>`
        new_password_hash (optional): ``bytes``
        hint (optional): ``str``
        email (optional): ``str``
        new_secure_settings (optional): :obj:`SecureSecretSettings <pyrogramv1.raw.base.SecureSecretSettings>`
    """
