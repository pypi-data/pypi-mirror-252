...
class SavedRingtones(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.account.SavedRingtones`.
    ...
    Parameters:
        hash: ``int`` ``64-bit``
        ringtones: List of :obj:`Document <pyrogramv1.raw.base.Document>`
