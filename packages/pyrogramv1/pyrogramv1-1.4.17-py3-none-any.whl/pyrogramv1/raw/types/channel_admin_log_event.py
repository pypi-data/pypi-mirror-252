...
class ChannelAdminLogEvent(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.ChannelAdminLogEvent`.
    ...
    Parameters:
        ...
        date: ``int`` ``32-bit``
        user_id: ``int`` ``64-bit``
        action: :obj:`ChannelAdminLogEventAction <pyrogramv1.raw.base.ChannelAdminLogEventAction>`
    """
