...
class RequestPeerTypeChat(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.RequestPeerType`.
    ...
    Parameters:
        ...
        bot_participant (optional): ``bool``
        has_username (optional): ``bool``
        forum (optional): ``bool``
        user_admin_rights (optional): :obj:`ChatAdminRights <pyrogramv1.raw.base.ChatAdminRights>`
        bot_admin_rights (optional): :obj:`ChatAdminRights <pyrogramv1.raw.base.ChatAdminRights>`
    """
