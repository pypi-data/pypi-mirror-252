...
class SentCodeTypeEmailCode(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.auth.SentCodeType`.
    ...
    Parameters:
        ...
        reset_available_period (optional): ``int`` ``32-bit``
        reset_pending_date (optional): ``int`` ``32-bit``
    """
