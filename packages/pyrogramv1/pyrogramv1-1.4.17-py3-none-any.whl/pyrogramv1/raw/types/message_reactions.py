...
class MessageReactions(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.MessageReactions`.
    ...
    Parameters:
        results: List of :obj:`ReactionCount <pyrogramv1.raw.base.ReactionCount>`
        min (optional): ``bool``
        can_see_list (optional): ``bool``
        recent_reactions (optional): List of :obj:`MessagePeerReaction <pyrogramv1.raw.base.MessagePeerReaction>`
    """
