...
class PremiumPromo(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        status_text: ``str``
        status_entities: List of :obj:`MessageEntity <pyrogramv1.raw.base.MessageEntity>`
        video_sections: List of ``str``
        videos: List of :obj:`Document <pyrogramv1.raw.base.Document>`
        period_options: List of :obj:`PremiumSubscriptionOption <pyrogramv1.raw.base.PremiumSubscriptionOption>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`help.GetPremiumPromo <pyrogramv1.raw.functions.help.GetPremiumPromo>`
    """
