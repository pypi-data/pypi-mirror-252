...
class CountriesList(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.help.CountriesList`.
    ...
    Parameters:
        countries: List of :obj:`help.Country <pyrogramv1.raw.base.help.Country>`
        hash: ``int`` ``32-bit``
