...
class ConfigSimple(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.help.ConfigSimple`.
    ...
    Parameters:
        date: ``int`` ``32-bit``
        expires: ``int`` ``32-bit``
        rules: List of :obj:`AccessPointRule <pyrogramv1.raw.base.AccessPointRule>`
    """
