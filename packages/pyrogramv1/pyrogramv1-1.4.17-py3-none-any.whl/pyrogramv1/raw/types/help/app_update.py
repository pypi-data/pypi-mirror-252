...
class AppUpdate(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.help.AppUpdate`.
    ...
    Parameters:
        ...
        version: ``str``
        text: ``str``
        entities: List of :obj:`MessageEntity <pyrogramv1.raw.base.MessageEntity>`
        can_not_skip (optional): ``bool``
        document (optional): :obj:`Document <pyrogramv1.raw.base.Document>`
        url (optional): ``str``
        sticker (optional): :obj:`Document <pyrogramv1.raw.base.Document>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`help.GetAppUpdate <pyrogramv1.raw.functions.help.GetAppUpdate>`
    """
