...
class AttachMenuBot(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.AttachMenuBot`.
    ...
    Parameters:
        bot_id: ``int`` ``64-bit``
        short_name: ``str``
        peer_types: List of :obj:`AttachMenuPeerType <pyrogramv1.raw.base.AttachMenuPeerType>`
        icons: List of :obj:`AttachMenuBotIcon <pyrogramv1.raw.base.AttachMenuBotIcon>`
        inactive (optional): ``bool``
        has_settings (optional): ``bool``
