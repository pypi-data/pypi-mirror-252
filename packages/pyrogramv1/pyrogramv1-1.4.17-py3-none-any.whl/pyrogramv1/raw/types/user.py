...
class User(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.User`.
    ...
    Parameters:
        ...
        phone (optional): ``str``
        photo (optional): :obj:`UserProfilePhoto <pyrogramv1.raw.base.UserProfilePhoto>`
        status (optional): :obj:`UserStatus <pyrogramv1.raw.base.UserStatus>`
        bot_info_version (optional): ``int`` ``32-bit``
        restriction_reason (optional): List of :obj:`RestrictionReason <pyrogramv1.raw.base.RestrictionReason>`
        bot_inline_placeholder (optional): ``str``
        lang_code (optional): ``str``
        emoji_status (optional): :obj:`EmojiStatus <pyrogramv1.raw.base.EmojiStatus>`
        usernames (optional): List of :obj:`Username <pyrogramv1.raw.base.Username>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.UpdateProfile <pyrogramv1.raw.functions.account.UpdateProfile>`
            - :obj:`account.UpdateUsername <pyrogramv1.raw.functions.account.UpdateUsername>`
            - :obj:`account.ChangePhone <pyrogramv1.raw.functions.account.ChangePhone>`
            - :obj:`users.GetUsers <pyrogramv1.raw.functions.users.GetUsers>`
            - :obj:`contacts.ImportContactToken <pyrogramv1.raw.functions.contacts.ImportContactToken>`
    """
