...
class PaymentRequestedInfo(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.PaymentRequestedInfo`.
    ...
    Parameters:
        ...
        phone (optional): ``str``
        email (optional): ``str``
        shipping_address (optional): :obj:`PostAddress <pyrogramv1.raw.base.PostAddress>`
    """
