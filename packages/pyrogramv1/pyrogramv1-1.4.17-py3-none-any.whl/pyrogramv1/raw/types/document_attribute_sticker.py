...
class DocumentAttributeSticker(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.DocumentAttribute`.
    ...
    Parameters:
        alt: ``str``
        stickerset: :obj:`InputStickerSet <pyrogramv1.raw.base.InputStickerSet>`
        mask (optional): ``bool``
        mask_coords (optional): :obj:`MaskCoords <pyrogramv1.raw.base.MaskCoords>`
    """
