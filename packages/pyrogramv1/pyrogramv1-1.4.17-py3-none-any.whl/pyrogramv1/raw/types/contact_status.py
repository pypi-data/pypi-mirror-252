...
class ContactStatus(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.ContactStatus`.
    ...
    Parameters:
        user_id: ``int`` ``64-bit``
        status: :obj:`UserStatus <pyrogramv1.raw.base.UserStatus>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`contacts.GetStatuses <pyrogramv1.raw.functions.contacts.GetStatuses>`
    """
