...
class CdnConfig(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.CdnConfig`.
    ...
    Parameters:
        public_keys: List of :obj:`CdnPublicKey <pyrogramv1.raw.base.CdnPublicKey>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`help.GetCdnConfig <pyrogramv1.raw.functions.help.GetCdnConfig>`
    """
