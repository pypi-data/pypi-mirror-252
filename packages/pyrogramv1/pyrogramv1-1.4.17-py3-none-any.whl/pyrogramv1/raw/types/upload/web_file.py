...
class WebFile(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.upload.WebFile`.
    ...
    Parameters:
        size: ``int`` ``32-bit``
        mime_type: ``str``
        file_type: :obj:`storage.FileType <pyrogramv1.raw.base.storage.FileType>`
        mtime: ``int`` ``32-bit``
        bytes: ``bytes``
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`upload.GetWebFile <pyrogramv1.raw.functions.upload.GetWebFile>`
    """
