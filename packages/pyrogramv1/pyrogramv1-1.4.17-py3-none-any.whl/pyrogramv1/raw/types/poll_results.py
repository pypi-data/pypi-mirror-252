...
class PollResults(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.PollResults`.
    ...
    Parameters:
        min (optional): ``bool``
        results (optional): List of :obj:`PollAnswerVoters <pyrogramv1.raw.base.PollAnswerVoters>`
        total_voters (optional): ``int`` ``32-bit``
        recent_voters (optional): List of ``int`` ``64-bit``
        solution (optional): ``str``
        solution_entities (optional): List of :obj:`MessageEntity <pyrogramv1.raw.base.MessageEntity>`
    """
