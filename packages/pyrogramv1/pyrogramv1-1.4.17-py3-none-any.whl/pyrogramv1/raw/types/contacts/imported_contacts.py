...
class ImportedContacts(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.contacts.ImportedContacts`.
    ...
    Parameters:
        imported: List of :obj:`ImportedContact <pyrogramv1.raw.base.ImportedContact>`
        popular_invites: List of :obj:`PopularContact <pyrogramv1.raw.base.PopularContact>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`contacts.ImportContacts <pyrogramv1.raw.functions.contacts.ImportContacts>`
    """
