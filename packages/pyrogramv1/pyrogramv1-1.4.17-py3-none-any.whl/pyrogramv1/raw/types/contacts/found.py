...
class Found(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.contacts.Found`.
    ...
    Parameters:
        my_results: List of :obj:`Peer <pyrogramv1.raw.base.Peer>`
        results: List of :obj:`Peer <pyrogramv1.raw.base.Peer>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`contacts.Search <pyrogramv1.raw.functions.contacts.Search>`
    """
