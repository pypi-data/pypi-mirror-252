...
class BotInlineResult(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.BotInlineResult`.
    ...
    Parameters:
        id: ``str``
        type: ``str``
        send_message: :obj:`BotInlineMessage <pyrogramv1.raw.base.BotInlineMessage>`
        title (optional): ``str``
        description (optional): ``str``
        url (optional): ``str``
        thumb (optional): :obj:`WebDocument <pyrogramv1.raw.base.WebDocument>`
        content (optional): :obj:`WebDocument <pyrogramv1.raw.base.WebDocument>`
    """
