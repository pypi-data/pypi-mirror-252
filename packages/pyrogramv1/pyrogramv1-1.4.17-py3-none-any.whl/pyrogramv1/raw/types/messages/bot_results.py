...
class BotResults(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.messages.BotResults`.
    ...
    Parameters:
        query_id: ``int`` ``64-bit``
        results: List of :obj:`BotInlineResult <pyrogramv1.raw.base.BotInlineResult>`
        cache_time: ``int`` ``32-bit``
        users: List of :obj:`User <pyrogramv1.raw.base.User>`
        gallery (optional): ``bool``
        next_offset (optional): ``str``
        switch_pm (optional): :obj:`InlineBotSwitchPM <pyrogramv1.raw.base.InlineBotSwitchPM>`
        switch_webview (optional): :obj:`InlineBotWebView <pyrogramv1.raw.base.InlineBotWebView>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetInlineBotResults <pyrogramv1.raw.functions.messages.GetInlineBotResults>`
    """
