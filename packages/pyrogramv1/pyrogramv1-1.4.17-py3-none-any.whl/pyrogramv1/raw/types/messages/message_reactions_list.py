...
class MessageReactionsList(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.messages.MessageReactionsList`.
    ...
    Parameters:
        count: ``int`` ``32-bit``
        reactions: List of :obj:`MessagePeerReaction <pyrogramv1.raw.base.MessagePeerReaction>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetMessageReactionsList <pyrogramv1.raw.functions.messages.GetMessageReactionsList>`
    """
