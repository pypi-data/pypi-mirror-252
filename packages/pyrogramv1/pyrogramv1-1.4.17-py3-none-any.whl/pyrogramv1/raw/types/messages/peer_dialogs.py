...
class PeerDialogs(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.messages.PeerDialogs`.
    ...
    Parameters:
        dialogs: List of :obj:`Dialog <pyrogramv1.raw.base.Dialog>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetPeerDialogs <pyrogramv1.raw.functions.messages.GetPeerDialogs>`
            - :obj:`messages.GetPinnedDialogs <pyrogramv1.raw.functions.messages.GetPinnedDialogs>`
    """
