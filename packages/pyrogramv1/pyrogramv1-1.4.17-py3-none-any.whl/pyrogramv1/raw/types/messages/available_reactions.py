...
class AvailableReactions(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.messages.AvailableReactions`.
    ...
    Parameters:
        hash: ``int`` ``32-bit``
        reactions: List of :obj:`AvailableReaction <pyrogramv1.raw.base.AvailableReaction>`
