...
class VotesList(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.messages.VotesList`.
    ...
    Parameters:
        count: ``int`` ``32-bit``
        votes: List of :obj:`MessageUserVote <pyrogramv1.raw.base.MessageUserVote>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetPollVotes <pyrogramv1.raw.functions.messages.GetPollVotes>`
    """
