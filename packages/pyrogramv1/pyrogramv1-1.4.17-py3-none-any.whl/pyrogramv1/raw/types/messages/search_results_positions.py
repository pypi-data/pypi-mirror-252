...
class SearchResultsPositions(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.messages.SearchResultsPositions`.
    ...
    Parameters:
        count: ``int`` ``32-bit``
        positions: List of :obj:`SearchResultsPosition <pyrogramv1.raw.base.SearchResultsPosition>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetSearchResultsPositions <pyrogramv1.raw.functions.messages.GetSearchResultsPositions>`
    """
