...
class ExportedChatInvites(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.messages.ExportedChatInvites`.
    ...
    Parameters:
        count: ``int`` ``32-bit``
        invites: List of :obj:`ExportedChatInvite <pyrogramv1.raw.base.ExportedChatInvite>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetExportedChatInvites <pyrogramv1.raw.functions.messages.GetExportedChatInvites>`
    """
