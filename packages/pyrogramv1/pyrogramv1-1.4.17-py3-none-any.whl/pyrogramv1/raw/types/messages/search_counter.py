...
class SearchCounter(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.messages.SearchCounter`.
    ...
    Parameters:
        filter: :obj:`MessagesFilter <pyrogramv1.raw.base.MessagesFilter>`
        count: ``int`` ``32-bit``
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetSearchCounters <pyrogramv1.raw.functions.messages.GetSearchCounters>`
    """
