...
class SecureRequiredTypeOneOf(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.SecureRequiredType`.
    ...
    Parameters:
        types: List of :obj:`SecureRequiredType <pyrogramv1.raw.base.SecureRequiredType>`
    """
