...
class MessageExtendedMediaPreview(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.MessageExtendedMedia`.
    ...
    Parameters:
        ...
        thumb (optional): :obj:`PhotoSize <pyrogramv1.raw.base.PhotoSize>`
        video_duration (optional): ``int`` ``32-bit``
    """
