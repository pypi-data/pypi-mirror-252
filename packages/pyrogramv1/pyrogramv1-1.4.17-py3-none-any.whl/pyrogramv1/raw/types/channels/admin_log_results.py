...
class AdminLogResults(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.channels.AdminLogResults`.
    ...
    Parameters:
        events: List of :obj:`ChannelAdminLogEvent <pyrogramv1.raw.base.ChannelAdminLogEvent>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`channels.GetAdminLog <pyrogramv1.raw.functions.channels.GetAdminLog>`
    """
