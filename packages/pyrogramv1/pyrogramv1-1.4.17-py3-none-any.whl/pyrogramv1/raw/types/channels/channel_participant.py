...
class ChannelParticipant(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.channels.ChannelParticipant`.
    ...
    Parameters:
        participant: :obj:`ChannelParticipant <pyrogramv1.raw.base.ChannelParticipant>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`channels.GetParticipant <pyrogramv1.raw.functions.channels.GetParticipant>`
    """
