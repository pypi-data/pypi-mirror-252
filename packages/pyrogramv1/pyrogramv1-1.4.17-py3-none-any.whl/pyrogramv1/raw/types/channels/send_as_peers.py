...
class SendAsPeers(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.channels.SendAsPeers`.
    ...
    Parameters:
        peers: List of :obj:`SendAsPeer <pyrogramv1.raw.base.SendAsPeer>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`channels.GetSendAs <pyrogramv1.raw.functions.channels.GetSendAs>`
    """
