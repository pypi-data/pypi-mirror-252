...
class UpdateChatParticipant(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        user_id: ``int`` ``64-bit``
        qts: ``int`` ``32-bit``
        prev_participant (optional): :obj:`ChatParticipant <pyrogramv1.raw.base.ChatParticipant>`
        new_participant (optional): :obj:`ChatParticipant <pyrogramv1.raw.base.ChatParticipant>`
