...
class Message(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.Message`.
    ...
    Parameters:
        id: ``int`` ``32-bit``
        peer_id: :obj:`Peer <pyrogramv1.raw.base.Peer>`
        date: ``int`` ``32-bit``
        message: ``str``
        out (optional): ``bool``
        ...
        from_id (optional): :obj:`Peer <pyrogramv1.raw.base.Peer>`
        fwd_from (optional): :obj:`MessageFwdHeader <pyrogramv1.raw.base.MessageFwdHeader>`
        via_bot_id (optional): ``int`` ``64-bit``
        reply_to (optional): :obj:`MessageReplyHeader <pyrogramv1.raw.base.MessageReplyHeader>`
        media (optional): :obj:`MessageMedia <pyrogramv1.raw.base.MessageMedia>`
        reply_markup (optional): :obj:`ReplyMarkup <pyrogramv1.raw.base.ReplyMarkup>`
        entities (optional): List of :obj:`MessageEntity <pyrogramv1.raw.base.MessageEntity>`
        views (optional): ``int`` ``32-bit``
        forwards (optional): ``int`` ``32-bit``
        replies (optional): :obj:`MessageReplies <pyrogramv1.raw.base.MessageReplies>`
        edit_date (optional): ``int`` ``32-bit``
        post_author (optional): ``str``
        grouped_id (optional): ``int`` ``64-bit``
        reactions (optional): :obj:`MessageReactions <pyrogramv1.raw.base.MessageReactions>`
