...
class SecureSecretSettings(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.SecureSecretSettings`.
    ...
    Parameters:
        secure_algo: :obj:`SecurePasswordKdfAlgo <pyrogramv1.raw.base.SecurePasswordKdfAlgo>`
        secure_secret: ``bytes``
