...
class Config(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.Config`.
    ...
    Parameters:
        ...
        test_mode: ``bool``
        this_dc: ``int`` ``32-bit``
        dc_options: List of :obj:`DcOption <pyrogramv1.raw.base.DcOption>`
        ...
        reactions_default (optional): :obj:`Reaction <pyrogramv1.raw.base.Reaction>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`help.GetConfig <pyrogramv1.raw.functions.help.GetConfig>`
    """
