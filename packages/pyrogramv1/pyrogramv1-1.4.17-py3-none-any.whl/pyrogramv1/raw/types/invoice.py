...
class Invoice(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.Invoice`.
    ...
    Parameters:
        currency: ``str``
        prices: List of :obj:`LabeledPrice <pyrogramv1.raw.base.LabeledPrice>`
        test (optional): ``bool``
        ...
        recurring_terms_url (optional): ``str``
    """
