...
class InputBotInlineResult(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.InputBotInlineResult`.
    ...
    Parameters:
        id: ``str``
        type: ``str``
        send_message: :obj:`InputBotInlineMessage <pyrogramv1.raw.base.InputBotInlineMessage>`
        title (optional): ``str``
        description (optional): ``str``
        url (optional): ``str``
        thumb (optional): :obj:`InputWebDocument <pyrogramv1.raw.base.InputWebDocument>`
        content (optional): :obj:`InputWebDocument <pyrogramv1.raw.base.InputWebDocument>`
    """
