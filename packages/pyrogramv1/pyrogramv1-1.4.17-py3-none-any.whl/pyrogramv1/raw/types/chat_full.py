...
class ChatFull(TLObject):  # type: ignore
    ...
    Parameters:
        id: ``int`` ``64-bit``
        about: ``str``
        participants: :obj:`ChatParticipants <pyrogramv1.raw.base.ChatParticipants>`
        ...
        chat_photo (optional): :obj:`Photo <pyrogramv1.raw.base.Photo>`
        exported_invite (optional): :obj:`ExportedChatInvite <pyrogramv1.raw.base.ExportedChatInvite>`
        bot_info (optional): List of :obj:`BotInfo <pyrogramv1.raw.base.BotInfo>`
