...
class MessageStats(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.stats.MessageStats`.
    ...
    Parameters:
        views_graph: :obj:`StatsGraph <pyrogramv1.raw.base.StatsGraph>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`stats.GetMessageStats <pyrogramv1.raw.functions.stats.GetMessageStats>`
    """
