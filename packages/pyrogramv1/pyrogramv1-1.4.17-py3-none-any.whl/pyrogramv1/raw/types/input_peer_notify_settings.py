...
class InputPeerNotifySettings(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.InputPeerNotifySettings`.
    ...
    Parameters:
        ...
        sound (optional): :obj:`NotificationSound <pyrogramv1.raw.base.NotificationSound>`
    """
