...
class GroupCall(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.phone.GroupCall`.
    ...
    Parameters:
        call: :obj:`GroupCall <pyrogramv1.raw.base.GroupCall>`
        participants: List of :obj:`GroupCallParticipant <pyrogramv1.raw.base.GroupCallParticipant>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`phone.GetGroupCall <pyrogramv1.raw.functions.phone.GetGroupCall>`
    """
