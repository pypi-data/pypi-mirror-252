...
class BotInfo(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogramv1.raw.base.BotInfo`.
    ...
    Parameters:
        user_id (optional): ``int`` ``64-bit``
        description (optional): ``str``
        description_photo (optional): :obj:`Photo <pyrogramv1.raw.base.Photo>`
        description_document (optional): :obj:`Document <pyrogramv1.raw.base.Document>`
        commands (optional): List of :obj:`BotCommand <pyrogramv1.raw.base.BotCommand>`
        menu_button (optional): :obj:`BotMenuButton <pyrogramv1.raw.base.BotMenuButton>`
    """
