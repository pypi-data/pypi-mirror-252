...
class PageListOrderedItem:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`PageListOrderedItemBlocks <pyrogramv1.raw.types.PageListOrderedItemBlocks>`
            - :obj:`PageListOrderedItemText <pyrogramv1.raw.types.PageListOrderedItemText>`
    """

    QUALNAME = "pyrogramv1.raw.base.PageListOrderedItem"
