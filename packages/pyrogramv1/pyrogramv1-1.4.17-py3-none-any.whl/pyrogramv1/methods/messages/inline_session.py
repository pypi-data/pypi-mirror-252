...
from pyrogramv1.errors import AuthBytesInvalid
from pyrogramv1.session import Session
from pyrogramv1.session.auth import Auth


async def get_session(client: "pyrogramv1.Client", dc_id: int):
