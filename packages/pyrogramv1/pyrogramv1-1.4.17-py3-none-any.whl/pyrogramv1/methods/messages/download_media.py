...
from pyrogramv1.file_id import FileId, FileType, PHOTO_TYPES
...
class DownloadMedia(Scaffold):
    async def download_media(
        ...
        Parameters:
            message (:obj:`~pyrogramv1.types.Message` | ``str``):
        ...
        Returns:
            ...
            the download failed or was deliberately stopped with :meth:`~pyrogramv1.Client.stop_transmission`, None is
            returned.
