...
class SearchGlobal(Scaffold):
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~pyrogramv1.Client.search_global_count`.
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~pyrogramv1.types.Message` objects.

        Example:
            .. code-block:: python

                # Search for "pyrogramv1". Get the first 50 results
                for message in app.search_global("pyrogramv1", limit=50):
                    print(message.text)
