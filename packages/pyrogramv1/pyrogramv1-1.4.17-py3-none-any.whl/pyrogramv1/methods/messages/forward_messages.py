...
class ForwardMessages(Scaffold):
    async def forward_messages(
        ...
        Returns:
            :obj:`~pyrogramv1.types.Message` | List of :obj:`~pyrogramv1.types.Message`: In case *message_ids* was an
        ...
        Example:
            .. code-block:: python
                ...
                app.forward_messages("me", "pyrogramv1", 20)

                # Forward multiple messages at once
                app.forward_messages("me", "pyrogramv1", [3, 20, 27])
        """
