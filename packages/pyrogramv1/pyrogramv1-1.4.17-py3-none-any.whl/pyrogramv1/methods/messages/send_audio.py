...
from pyrogramv1 import StopTransmission
from pyrogramv1 import raw
from pyrogramv1 import types
from pyrogramv1 import utils
from pyrogramv1.errors import FilePartMissing
from pyrogramv1.file_id import FileType
...
class SendAudio(Scaffold):
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~pyrogramv1.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~pyrogramv1.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~pyrogramv1.Client.stop_transmission`, None is returned.
