...
class OnChosenInlineResult(Scaffold):
    def on_chosen_inline_result(
        ...
        :obj:`~pyrogramv1.handlers.ChosenInlineResultHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyrogramv1.Client):
                self.add_handler(pyrogramv1.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyrogramv1.handlers.ChosenInlineResultHandler(func, self),
