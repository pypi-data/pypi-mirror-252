...
from pyrogramv1 import types, raw, utils
...
class IterDialogs(Scaffold):
    async def iter_dialogs(
        ...
        This convenience method does the same as repeatedly calling :meth:`~pyrogramv1.Client.get_dialogs` in a loop,
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~pyrogramv1.types.Dialog` objects.
