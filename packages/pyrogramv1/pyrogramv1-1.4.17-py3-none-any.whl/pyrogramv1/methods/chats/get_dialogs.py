...
class GetDialogs(Scaffold):
    async def get_dialogs(
        ...
        For a more convenient way of getting a user's dialogs see :meth:`~pyrogramv1.Client.iter_dialogs`.

        Parameters:
            offset_date (``int``):
                The offset date in Unix time taken from the top message of a :obj:`~pyrogramv1.types.Dialog`.
        ...
        Returns:
            List of :obj:`~pyrogramv1.types.Dialog`: On success, a list of dialogs is returned.
