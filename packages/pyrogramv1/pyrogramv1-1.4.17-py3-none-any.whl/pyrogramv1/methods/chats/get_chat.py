...
class GetChat(Scaffold):
    async def get_chat(
        ...
        Returns:
            :obj:`~pyrogramv1.types.Chat` | :obj:`~pyrogramv1.types.ChatPreview`: On success, if you've already joined the chat, a chat object is returned,
