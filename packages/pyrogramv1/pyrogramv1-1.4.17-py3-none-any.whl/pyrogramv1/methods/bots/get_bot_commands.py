...
class GetBotCommands(Scaffold):
    async def get_bot_commands(
        ...
        Parameters:
            scope (:obj:`~pyrogramv1.types.BotCommandScope`, *optional*):
                An object describing the scope of users for which the commands are relevant.
                Defaults to :obj:`~pyrogramv1.types.BotCommandScopeDefault`.
        ...
        Returns:
            List of :obj:`~pyrogramv1.types.BotCommand`: On success, the list of bot commands is returned.
