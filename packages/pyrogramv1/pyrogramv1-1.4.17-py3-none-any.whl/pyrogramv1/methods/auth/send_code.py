...
from pyrogramv1.errors import PhoneMigrate, NetworkMigrate
from pyrogramv1.scaffold import Scaffold
from pyrogramv1.session import Session, Auth
...
class SendCode(Scaffold):
    async def send_code(self, phone_number: str) -> "types.SentCode":
        ...
        Returns:
            :obj:`~pyrogramv1.types.SentCode`: On success, an object containing information on the sent confirmation code
            is returned.
