...
class SentCode(Object):
    ...
    Parameters:
        ...
        phone_code_hash (``str``):
            ...
            :meth:`~pyrogramv1.Client.sign_in` or :meth:`~pyrogramv1.Client.sign_up`).

        next_type (``str``):
            Type of the next code to be sent with :meth:`~pyrogramv1.Client.resend_code`.
        ...
        timeout (``int``):
            Delay in seconds before calling :meth:`~pyrogramv1.Client.resend_code`.
    """
