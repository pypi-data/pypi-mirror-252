...
class ChatEvent(Object):
    ...
    Parameters:
        ...
        user (:obj:`~pyrogramv1.types.User`):
        ...
        old_linked_chat, new_linked_chat (:obj:`~pyrogramv1.types.Chat`, *optional*):
            Previous and new linked chat.
            For "linked_chat_changed" only.

        old_photo, new_photo (:obj:`~pyrogramv1.types.Photo`, *optional*):
        ...
        old_chat_permissions, new_chat_permissions (:obj:`~pyrogramv1.types.ChatPermissions`, *optional*):
            Previous and new default chat permissions.
            For "chat_permissions_changed" only.

        deleted_message (:obj:`~pyrogramv1.types.Message`, *optional*):
            Deleted message.
            For "deleted_message" only.

        old_message, new_message (:obj:`~pyrogramv1.types.Message`, *optional*):
            Previous and new message before it has been edited.
            For "message_edited" only.

        invited_member (:obj:`~pyrogramv1.types.ChatMember`, *optional*):
            New invited chat member.
            For "member_invited" only.

        old_admin_rights, new_admin_rights (:obj:`~pyrogramv1.types.ChatMember`, *optional*):
            Previous and new administrator rights.
            For "admin_rights_changed" only.

        old_member_permissions, new_member_permissions (:obj:`~pyrogramv1.types.ChatMember`, *optional*):
            Previous and new member permissions.
            For "member_permissions_changed" only.

        stopped_poll (:obj:`~pyrogramv1.types.Message`, *optional*):
        ...
        unpinned_message (:obj:`~pyrogramv1.types.Message`, *optional*):
            Unpinned message.
            For "unpinned_message" only.

        old_invite_link, new_invite_link (:obj:`~pyrogramv1.types.ChatInviteLink`, *optional*):
            Previous and new edited invite link.
            For "invite_link_edited" only.

        revoked_invite_link (:obj:`~pyrogramv1.types.ChatInviteLink`, *optional*):
            Revoked invite link.
            For "invite_link_revoked" only.

        deleted_invite_link (:obj:`~pyrogramv1.types.ChatInviteLink`, *optional*):
            Deleted invite link.
