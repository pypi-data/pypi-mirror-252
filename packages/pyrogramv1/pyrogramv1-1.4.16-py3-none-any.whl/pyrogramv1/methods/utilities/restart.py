...
class Restart(Scaffold):
    async def restart(self, block: bool = True):
        ...
        This method will first call :meth:`~pyrogramv1.Client.stop` and then :meth:`~pyrogramv1.Client.start` in a row in
        ...
        Returns:
            :obj:`~pyrogramv1.Client`: The restarted client itself.
