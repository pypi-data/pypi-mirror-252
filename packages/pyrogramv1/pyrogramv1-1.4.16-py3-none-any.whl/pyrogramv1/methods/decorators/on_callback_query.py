...
class OnCallbackQuery(Scaffold):
    def on_callback_query(
        ...
        :obj:`~pyrogramv1.handlers.CallbackQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyrogramv1.Client):
                self.add_handler(pyrogramv1.handlers.CallbackQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyrogramv1.handlers.CallbackQueryHandler(func, self),
