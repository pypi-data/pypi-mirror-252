...
class OnInlineQuery(Scaffold):
    def on_inline_query(
        ...
        :obj:`~pyrogramv1.handlers.InlineQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyrogramv1.Client):
                self.add_handler(pyrogramv1.handlers.InlineQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyrogramv1.handlers.InlineQueryHandler(func, self),
