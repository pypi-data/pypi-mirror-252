...
class IterHistory(Scaffold):
    async def iter_history(
        ...
        This convenience method does the same as repeatedly calling :meth:`~pyrogramv1.Client.get_history` in a loop, thus saving
        ...
        Example:
            .. code-block:: python
                ...
                for message in app.iter_history("pyrogramv1"):
                    print(message.text)
        """
