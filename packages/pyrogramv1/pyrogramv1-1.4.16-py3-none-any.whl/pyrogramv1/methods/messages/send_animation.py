...
class SendAnimation(Scaffold):
    async def send_animation(
        ...
        Returns:
            :obj:`~pyrogramv1.types.Message` | ``None``: On success, the sent animation message is returned, otherwise,
            in case the upload is deliberately stopped with :meth:`~pyrogramv1.Client.stop_transmission`, None is
            returned.
