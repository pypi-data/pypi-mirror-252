...
from pyrogramv1.errors import UnknownError
...
class GetInlineBotResults(Scaffold):
    async def get_inline_bot_results(
        ...
        You can then send a result using :meth:`~pyrogramv1.Client.send_inline_bot_result`
        ...
        Returns:
            :obj:`BotResults <pyrogramv1.api.types.messages.BotResults>`: On Success.
        ...
        Example:
            .. code-block:: python
                ...
                results = app.get_inline_bot_results("pyrogramv1bot")
                print(results)
        """
