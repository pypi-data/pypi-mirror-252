...
class IterProfilePhotos(Scaffold):
    async def iter_profile_photos(
        ...
        This convenience method does the same as repeatedly calling :meth:`~pyrogramv1.Client.get_profile_photos` in a
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~pyrogramv1.types.Photo` objects.
