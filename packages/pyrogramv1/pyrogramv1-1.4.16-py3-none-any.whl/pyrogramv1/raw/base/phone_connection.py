...
class PhoneConnection:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`PhoneConnection <pyrogramv1.raw.types.PhoneConnection>`
            - :obj:`PhoneConnectionWebrtc <pyrogramv1.raw.types.PhoneConnectionWebrtc>`
    """

    QUALNAME = "pyrogramv1.raw.base.PhoneConnection"
