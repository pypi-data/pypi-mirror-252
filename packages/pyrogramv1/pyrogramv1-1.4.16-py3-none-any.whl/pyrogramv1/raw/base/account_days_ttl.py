...
class AccountDaysTTL:  # type: ignore
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`AccountDaysTTL <pyrogramv1.raw.types.AccountDaysTTL>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.GetAccountTTL <pyrogramv1.raw.functions.account.GetAccountTTL>`
    """

    QUALNAME = "pyrogramv1.raw.base.AccountDaysTTL"
