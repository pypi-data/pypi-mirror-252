...
class OnChatMemberUpdated(Scaffold):
    def on_chat_member_updated(
        ...
        :obj:`~pyrogramv1.handlers.ChatMemberUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyrogramv1.Client):
                self.add_handler(pyrogramv1.handlers.ChatMemberUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyrogramv1.handlers.ChatMemberUpdatedHandler(func, self),
