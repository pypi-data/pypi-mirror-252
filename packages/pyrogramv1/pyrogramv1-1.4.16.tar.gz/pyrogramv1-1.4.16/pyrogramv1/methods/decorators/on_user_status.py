...
class OnUserStatus(Scaffold):
    def on_user_status(
        ...
        :obj:`~pyrogramv1.handlers.UserStatusHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyrogramv1.Client):
                self.add_handler(pyrogramv1.handlers.UserStatusHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyrogramv1.handlers.UserStatusHandler(func, self),
