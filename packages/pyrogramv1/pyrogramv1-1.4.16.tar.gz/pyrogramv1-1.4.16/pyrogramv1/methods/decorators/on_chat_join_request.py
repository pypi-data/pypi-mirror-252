...
class OnChatJoinRequest(Scaffold):
    def on_chat_join_request(
        ...
        :obj:`~pyrogramv1.handlers.ChatJoinRequestHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyrogramv1.Client):
                self.add_handler(pyrogramv1.handlers.ChatJoinRequestHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyrogramv1.handlers.ChatJoinRequestHandler(func, self),
