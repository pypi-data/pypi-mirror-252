...
from pyrogramv1.handlers import DisconnectHandler
...
class RemoveHandler(Scaffold):
    def remove_handler(self, handler: "Handler", group: int = 0):
        ...
        :meth:`~pyrogramv1.Client.add_handler` method, a tuple of *(handler, group)*, and pass it directly.
        ...
        Example:
            .. code-block:: python
                ...
                from pyrogramv1.handlers import MessageHandler
