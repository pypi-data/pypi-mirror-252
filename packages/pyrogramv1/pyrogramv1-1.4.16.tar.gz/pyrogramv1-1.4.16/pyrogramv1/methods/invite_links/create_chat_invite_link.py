...
class CreateChatInviteLink(Scaffold):
    async def create_chat_invite_link(
        ...
        The link can be revoked using the method :meth:`~pyrogramv1.Client.revoke_chat_invite_link`.
        ...
        Returns:
            :obj:`~pyrogramv1.types.ChatInviteLink`: On success, the new invite link is returned.
