...
import pyrogramv1
from pyrogramv1.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "pyrogramv1.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``callable``):
            ...
            The *client* argument refers to the :obj:`~pyrogramv1.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~pyrogramv1.handlers.MessageHandler` the *update* argument will be a :obj:`~pyrogramv1.types.Message`; in a :obj:`~pyrogramv1.handlers.CallbackQueryHandler` the *update* will be a :obj:`~pyrogramv1.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~pyrogramv1.filters.command` or :meth:`~pyrogramv1.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~pyrogramv1.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~pyrogramv1.types.Document` objects."""
...
"""Filter messages that contain :obj:`~pyrogramv1.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~pyrogramv1.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~pyrogramv1.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~pyrogramv1.types.Game` objects."""
...
"""Filter messages that contain :obj:`~pyrogramv1.types.Video` objects."""
...
"""Filter messages that contain :obj:`~pyrogramv1.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~pyrogramv1.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~pyrogramv1.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~pyrogramv1.types.Location` objects."""
...
"""Filter messages that contain :obj:`~pyrogramv1.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~pyrogramv1.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~pyrogramv1.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~pyrogramv1.types.Message`.
    ...
    async def func(flt, client: pyrogramv1.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~pyrogramv1.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~pyrogramv1.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~pyrogramv1.types.InlineQuery`: The filter will match ``query``.
