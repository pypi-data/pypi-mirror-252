...
import pyrogramv1
from pyrogramv1 import raw, utils
...
class ChatJoinRequest(Object, Update):
    ...
    Parameters:
        chat (:obj:`~pyrogramv1.types.Chat`):
        ...
        invite_link (:obj:`~pyrogramv1.types.ChatInviteLink`, *optional*):
    ...
    async def approve(self) -> bool:
        """Bound method *approve* of :obj:`~pyrogramv1.types.ChatJoinRequest`.
    ...
    async def decline(self) -> bool:
        """Bound method *decline* of :obj:`~pyrogramv1.types.ChatJoinRequest`.
