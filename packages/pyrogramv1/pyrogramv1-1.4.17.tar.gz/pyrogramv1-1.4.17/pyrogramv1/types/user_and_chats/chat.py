...
class Chat(Object):
    ...
    Parameters:
        ...
        photo (:obj:`~pyrogramv1.types.ChatPhoto`, *optional*):
            Chat photo. Suitable for downloads only.

        bio (``str``, *optional*):
            Bio of the other party in a private chat.
            Returned only in :meth:`~pyrogramv1.Client.get_chat`.
        ...
        restrictions (List of :obj:`~pyrogramv1.types.Restriction`, *optional*):
            The list of reasons why this chat might be unavailable to some users.
            This field is available only in case *is_restricted* is True.

        permissions (:obj:`~pyrogramv1.types.ChatPermissions` *optional*):
            Default chat member permissions, for groups and supergroups.

        distance (``int``, *optional*):
            Distance in meters of this group chat from your location.
            Returned only in :meth:`~pyrogramv1.Client.get_nearby_chats`.

        linked_chat (:obj:`~pyrogramv1.types.Chat`, *optional*):
            The linked discussion group (in case of channels) or the linked channel (in case of supergroups).
            Returned only in :meth:`~pyrogramv1.Client.get_chat`.

        send_as_chat (:obj:`~pyrogramv1.types.Chat`, *optional*):
    ...
    async def archive(self):
        """Bound method *archive* of :obj:`~pyrogramv1.types.Chat`.
    ...
    async def unarchive(self):
        """Bound method *unarchive* of :obj:`~pyrogramv1.types.Chat`.
    ...
    async def set_title(self, title: str) -> bool:
        """Bound method *set_title* of :obj:`~pyrogramv1.types.Chat`.
    ...
    async def set_description(self, description: str) -> bool:
        """Bound method *set_description* of :obj:`~pyrogramv1.types.Chat`.
    ...
    async def set_photo(self, photo: str) -> bool:
        """Bound method *set_photo* of :obj:`~pyrogramv1.types.Chat`.
        ...
        Parameters:
            photo (``str``):
                New chat photo. You can pass a :obj:`~pyrogramv1.types.Photo` id or a file path to upload a new photo.
    ...
    async def ban_member(
        ...
        """Bound method *ban_member* of :obj:`~pyrogramv1.types.Chat`.
        ...
        Returns:
            :obj:`~pyrogramv1.types.Message` | ``bool``: On success, a service message will be returned (when applicable), otherwise, in
    ...
    async def unban_member(
        ...
        """Bound method *unban_member* of :obj:`~pyrogramv1.types.Chat`.
    ...
    async def restrict_member(
        ...
        Parameters:
            ...
            permissions (:obj:`~pyrogramv1.types.ChatPermissions`):
        ...
        Returns:
            :obj:`~pyrogramv1.types.Chat`: On success, a chat object is returned.
    ...
    async def promote_member(
        ...
        """Bound method *promote_member* of :obj:`~pyrogramv1.types.Chat`.
    ...
    async def join(self):
        """Bound method *join* of :obj:`~pyrogramv1.types.Chat`.
    ...
    async def leave(self):
        """Bound method *leave* of :obj:`~pyrogramv1.types.Chat`.
    ...
    async def export_invite_link(self):
        """Bound method *export_invite_link* of :obj:`~pyrogramv1.types.Chat`.
    ...
    async def get_member(
        ...
        """Bound method *get_member* of :obj:`~pyrogramv1.types.Chat`.
        ...
        Returns:
            :obj:`~pyrogramv1.types.ChatMember`: On success, a chat member is returned.
        """
    ...
    async def get_members(
        ...
        """Bound method *get_members* of :obj:`~pyrogramv1.types.Chat`.
        ...
        Returns:
            List of :obj:`~pyrogramv1.types.ChatMember`: On success, a list of chat members is returned.
        """
    ...
    def iter_members(
        ...
        """Bound method *iter_members* of :obj:`~pyrogramv1.types.Chat`.
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~pyrogramv1.types.ChatMember` objects.
        """
    ...
    async def add_members(
        ...
        """Bound method *add_members* of :obj:`~pyrogramv1.types.Chat`.
    ...
    async def mark_unread(self, ) -> bool:
        """Bound method *mark_unread* of :obj:`~pyrogramv1.types.Chat`.
    ...
    async def set_protected_content(self, enabled: bool) -> bool:
        """Bound method *set_protected_content* of :obj:`~pyrogramv1.types.Chat`.
    ...
    async def unpin_all_messages(self) -> bool:
        """Bound method *unpin_all_messages* of :obj:`~pyrogramv1.types.Chat`.
