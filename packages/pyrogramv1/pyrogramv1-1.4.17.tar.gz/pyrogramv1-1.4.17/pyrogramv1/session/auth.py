...
from pyrogramv1.crypto import aes, rsa, prime
from pyrogramv1.errors import SecurityCheckMismatch
from pyrogramv1.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "pyrogramv1.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
