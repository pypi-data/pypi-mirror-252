...
class ResendCode(Scaffold):
    async def resend_code(self, phone_number: str, phone_code_hash: str) -> "types.SentCode":
        ...
        :obj:`~pyrogramv1.types.SentCode` object returned by :meth:`send_code`.
        ...
        Returns:
            :obj:`~pyrogramv1.types.SentCode`: On success, an object containing information on the re-sent confirmation
            code is returned.
