...
class Send(Scaffold):
    async def send(
        ...
        Available functions are listed in the :obj:`functions <pyrogramv1.api.functions>` package and may accept compound
        data types from :obj:`types <pyrogramv1.api.types>` as well as bare types such as ``int``, ``str``, etc...
