...
class SendMediaGroup(Scaffold):
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~pyrogramv1.types.InputMediaPhoto`, :obj:`~pyrogramv1.types.InputMediaVideo`, :obj:`~pyrogramv1.types.InputMediaAudio` and :obj:`~pyrogramv1.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~pyrogramv1.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from pyrogramv1.types import InputMediaPhoto, InputMediaVideo
