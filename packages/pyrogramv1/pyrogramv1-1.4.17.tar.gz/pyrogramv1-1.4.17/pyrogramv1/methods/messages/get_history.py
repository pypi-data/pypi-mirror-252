...
class GetHistory(Scaffold):
    async def get_history(
        ...
        For a more convenient way of getting a chat history see :meth:`~pyrogramv1.Client.iter_history`.
        ...
        Returns:
            List of :obj:`~pyrogramv1.types.Message` - On success, a list of the retrieved messages is returned.
