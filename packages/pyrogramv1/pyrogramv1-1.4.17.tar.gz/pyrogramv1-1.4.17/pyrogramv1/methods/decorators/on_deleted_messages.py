...
class OnDeletedMessages(Scaffold):
    def on_deleted_messages(
        ...
        :obj:`~pyrogramv1.handlers.DeletedMessagesHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyrogramv1.Client):
                self.add_handler(pyrogramv1.handlers.DeletedMessagesHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyrogramv1.handlers.DeletedMessagesHandler(func, self),
