...
class OnMessage(Scaffold):
    def on_message(
        ...
        :obj:`~pyrogramv1.handlers.MessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyrogramv1.Client):
                self.add_handler(pyrogramv1.handlers.MessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyrogramv1.handlers.MessageHandler(func, self),
